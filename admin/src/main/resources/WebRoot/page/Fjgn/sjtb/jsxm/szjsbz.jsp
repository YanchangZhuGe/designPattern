   ...
   var xmlx="${fns:getParamValue('xmlx')}";
    ...
    function initWindow_zqxxtb_contentForm_tab_xmsy_grid_right(js_year,xm_id,XMLX_ID,JSD_ID){
        var headerJson = [
            ...
            {dataIndex: "ZXAMT", type: "string", text: "执行数（万元）",
                editor: {xtype: 'numberFieldFormat', hideTrigger: true,decimalPrecision:6,
                    value: 0,maxValue:9999999999, minValue: 0,allowBlank:false,readOnly:!is_edit,editable:is_edit}, width: 120,
                renderer: function (value) {
    ...
    function initWindow_zqxxtb_contentForm_tab_xmsy_grid_left(js_year,xm_id,XMLX_ID,JSD_ID) {
        var headerJson = [
            ...
            {dataIndex: "ZXAMT", type: "string", text: "执行数（万元）",
                editor: {xtype: 'numberFieldFormat', hideTrigger: true,decimalPrecision:6,
                    value: 0,maxValue:9999999999, minValue: 0,readOnly:!is_edit,editable:is_edit}, width: 120,
                renderer: function (value) {
                    return value!=''?Ext.util.Format.number(value, '0,000.00'):0;
                }
            },
    ...
    function getNewName(self,value){
        var name={"02":"二、本年收到土地储备项目资金","0201":"（一）本年土地储备专项债券资金","0202":"（二）财政安排土地储备专项债券付息资金","0203":"（三）本年其他财政预算资金"};

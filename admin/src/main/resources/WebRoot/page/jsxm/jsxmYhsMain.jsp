...
<script type="text/javascript">
    ...
    var is_ln = sysAdcode == '21' ? true : false; // 判断是否为辽宁
    ...
    function initContent() {
        if(IS_XMBCXX == '1'){
            if(IS_FZJCK=='1'||is_show==false){
                var tab_items = {'jbqk':{},'csqk':{},'bcxx':{},'tzjh':{},'szys':{},'sdgc':{},'clzw':{},/*'xmzc':{},*/'ztb':{},/*'jsjd':{},*/'szjs':{},'sjsy':{},'bgjl':{},'sbjl':{},'xmfj':{},'zjhc':{},'zjpf':{}};
            }else{
                var tab_items = {'jbqk':{},'bcxx':{},'tzjh':{},'szys':{},'sdgc':{},'clzw':{},/*'xmzc':{},*/'ztb':{},/*'jsjd':{},*/'szjs':{},'sjsy':{},'bgjl':{},'xmfj':{},'sbjl':{}};
            }
        }else{
            if(IS_FZJCK=='1'||is_show==false){
                var tab_items = {'jbqk':{},'csqk':{},'tzjh':{},'szys':{},'sdgc':{},'clzw':{},/*'xmzc':{},*/'ztb':{},/*'jsjd':{},*/'szjs':{},'sjsy':{},'bgjl':{},'xmfj':{}};
            }else{
                var tab_items = {'jbqk':{},'tzjh':{},'szys':{},'sdgc':{},'clzw':{},/*'xmzc':{},*/'ztb':{},/*'jsjd':{},*/'szjs':{},'sjsy':{},'bgjl':{},'xmfj':{}};
            }
        }
        //2021090710_dengzq_一户式穿透绩效隐藏
        // 添加事前绩效评估页签

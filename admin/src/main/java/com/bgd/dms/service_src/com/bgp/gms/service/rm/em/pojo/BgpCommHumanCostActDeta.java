...
public class BgpCommHumanCostActDeta {
	...
	public String getActualDetaId() {
		return actualDetaId;
	}
	public void setActualDetaId(String actualDetaId) {
		this.actualDetaId = actualDetaId;
	}
	...
	public String getMarkCost() {
		return markCost;
	}
	public void setMarkCost(String markCost) {
	...
	public String getReemCost() {
		return reemCost;
	}
	public void setReemCost(String reemCost) {
		this.reemCost = reemCost;
	}

...
public class ExportExcelAction extends WSAction {
    ...
    throws Exception{
    	...
    	if(datas!=null){
    		String[] titles = {"物资编码","物资分类码","名称","计量单位","单价","单元用量","备注"};
    		String[] names={"wz_id","coding_code_id","wz_name","wz_prickie","wz_price","unit_num","note"};
...
//    		}
			...
			// 设置 response 显示标头
			response.setHeader("Content-Disposition","attachment;  filename=" + "wzPlate" + ".xls");

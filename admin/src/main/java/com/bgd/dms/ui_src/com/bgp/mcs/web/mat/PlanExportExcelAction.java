...
public class PlanExportExcelAction extends WSAction {
    ...
    throws Exception{
    	...
    	if(datas!=null){
    		String[] titles = {"物资编码","物资分类码","名称","计量单位","单价","需求数量","日期"};
    		String[] names={"wz_id","coding_code_id","wz_name","wz_prickie","wz_price","demand_num","demand_date"};

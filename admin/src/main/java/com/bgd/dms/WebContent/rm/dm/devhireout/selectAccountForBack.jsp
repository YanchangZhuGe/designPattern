...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model,license_num,self_num,dev_sign){
		...
		var str = "select * from gms_device_account account where account.bsflag='0' and account.owning_sub_id like '<%=org_sub_id%>%' and account.account_stat='0110000013000000005' ";

      	...
      	<div id="list_table">
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      <td class="bt_info_odd" exp="<input type='checkbox' name='rdo_entity_id' value='{human_detail_no}-{employee_id}' id='rdo_entity_id'/>" >
...
<script type="text/javascript">
	...
	function refreshData(arrObj){	 
		...
		var str="projectInfoNo=<%=projectInfoNo%>&szFather=0&paramsType=<%=paramsType%>&yorn="+yorn;	
	...
	function toSave(){ 
		...
		var sql1 = "update bgp_human_prepare_human_detail t set t.project_father_no='<%=user.getProjectInfoNo()%>',t.modifi_date=sysdate where t.human_detail_no in ("+detailNos.substr(1)+") ";
	...
	//	var retObject = syncRequest('Post',path,"deleteSql="+sql2+"&ids="+employeeIds);

...
//    for (var i=yearMin; i<=yearMax; i++) strIframe += "<option value='"+i+"'>"+i+"年</option>";
    ...
    "    style='background:#66CCFF;border:0px;width:50px'></td><td><input"+
    "    name=baoyang type=button value='待工' style='background:#FF0033;border:0px;width:50px'>"+
    "    </td>"+
    "    <td><input name=shijia  type=button value='事假'"+
    "    style='background:#CC00FF;border:0px;width:50px'></td><td><input"+
    "    name=bingjia type=button value='病假' style='background:#33FF00;border:0px;width:50px'>"+
    "    </td>"+"<td><input"+
    "    name=kuanggong type=button value='旷工' style='background:#FFFF00;border:0px;width:50px'>"+
    "    </td>"+"<td><input"+
    "    name=kuanggong type=button value='休假' style='background:#FF7A22;border:0px;width:50px'>"+
    "    </td>"+
...
//        {WebCalendar.dayObj[i].bgColor = WebCalendar.todayColor; WebCalendar.dayObj[i].style.color = WebCalendar.lightColor;}
    ...
    for(var x=0;x<obj.length;x++){
    		...
    		//√--出勤
    		if(obj[x].timesheet_symbol=='5110000052000000001')
    			WebCalendar.dayObj[obj[x].day*1+dstart].bgColor = "#66CCFF";
    		//△--事假
    		else if(obj[x].timesheet_symbol=='5110000052000000003')
    			WebCalendar.dayObj[obj[x].day*1+dstart].bgColor = "#CC00FF";
    		//o--待工
    		else if(obj[x].timesheet_symbol=='5110000052000000002')
    			WebCalendar.dayObj[obj[x].day*1+dstart].bgColor = "#FF0033";
    		//⊙--病假
    		else if(obj[x].timesheet_symbol=='5110000052000000004')
    			WebCalendar.dayObj[obj[x].day*1+dstart].bgColor = "#33FF00";
    		//×--旷工
    		else if(obj[x].timesheet_symbol=='5110000052000000005')
    			WebCalendar.dayObj[obj[x].day*1+dstart].bgColor = "#FFFF00";
    		//--未进项目
    		else if(obj[x].timesheet_symbol=='5110000052000000006')
    			WebCalendar.dayObj[obj[x].day*1+dstart].bgColor = "#CCCCCC";
    		//◇休假
     		else if(obj[x].timesheet_symbol=='5110000052000000007')
    			WebCalendar.dayObj[obj[x].day*1+dstart].bgColor = "#FF7A22";

      	...
      	<div id="list_table">
			...
			<div id="table_box">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      <td class="bt_info_odd" exp="<input type='checkbox' name='rdo_entity_id' value='{project_info_no},{daily_no_ws},{produce_date}' id='rdo_entity_id_{daily_no}' onclick=doCheck(this)/>" >选择</td>
			      ...
			      <td class="bt_info_even" exp="{project_survey_shot_workload}" >累计采集炮点数</td>
			      <td class="bt_info_odd" exp="{project_geophone_num}" >完成%</td>			
			      <td class="bt_info_even" exp="{project_survey_shot_num}" >累计测量测点数</td>
			      <td class="bt_info_odd" exp="{project_radio_num}" >完成%</td>
			      <td class="bt_info_even" exp="{project_survey_geophone_num}" >累计表层点数</td>
			      <td class="bt_info_odd" exp="{project_measue_num}" >完成%</td>
			        <td class="bt_info_even" exp="{project_survey_incept_workload}" >累计钻井炮点数</td>
			      <td class="bt_info_odd" exp="{project_measue_radio_num}" >完成%</td>
			        <td class="bt_info_even" exp="{project_micro_measue_num}" >累计试验炮数</td>
			      <td class="bt_info_odd" exp="{project_total_meadio}" >完成%</td>

...
<script type="text/javascript">
	...
	function getTab3(index) {
		...
		if(index==0){//仪表盘
			parent.assessFrame.location.href = "<%=contextPath%>/dms_info/assess_tagOther.jsp";
		}else if(index==1){//管理要素
			parent.assessFrame.location.href = "<%=contextPath%>/dms_info/indicatorWTCMonitor.jsp";
		}
	}	
</script>
</html>

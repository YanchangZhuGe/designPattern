...
document.getElementById("end_date").value = endDate;
 ...
 function getFusionChart(){
	...
	var retObj = jcdpCallService("WorkloadStatisticsSrv","getDepartmentWorkload","subOrgId="+subOrgId+"&startDate=" + startDate + "&endDate="+endDate);
...
function inBrowse(projectInfoNo){
	var startDate = document.getElementById("start_date").value;
	var endDate =  document.getElementById("end_date").value;
	window.location.href = "<%=contextPath%>/pm/workloadStatistics/project.jsp?projectInfoNo="+projectInfoNo+"&startDate=" + startDate + "&endDate="+endDate;
}
</script>
<script type="text/javascript">
	/**/function frameSize() {

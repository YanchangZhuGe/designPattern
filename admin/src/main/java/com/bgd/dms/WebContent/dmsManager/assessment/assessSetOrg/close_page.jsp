...
<%
	...
	String assessorg = (String)resultMsg.getValue("assessorgid");
	if(assessorg==null || assessorg.equals("")){
		assessorg = "";
	}
%>
...
<script language="javaScript">
	...
	var mainRightFrame=list.contentWindow.document.frames['mainRightframe'];
	//调用刷新方法
	mainRightFrame.refreshData("",assess_org);

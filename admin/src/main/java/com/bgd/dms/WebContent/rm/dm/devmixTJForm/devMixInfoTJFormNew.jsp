...
<div id="new_table_box" style="width:98%">
  <div id="new_table_box_content" style="width:100%">
    <div id="new_table_box_bg" style="width:95%">
	  ...
	  <fieldset style="margin-left:2px"><legend>调剂数量明细</legend>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr>
          ...
          <td width="5%"><span class="xg"><a href="#" id="modifibtn" onclick='toModifyMixInfos()' title="修改数量明细"></a></span></td>
          <td width="90%"></td>
        </tr>
      </table>
      <fieldset style="margin-left:2px"><legend>调剂台账明细</legend>
		<div id="tab_box" class="tab_box" style="overflow:auto;display:none">
			<table style="width:97.9%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		       <tr>
		       		<td class="bt_info_even" width="10%">班组</td>
...
<script type="text/javascript"> 
		...
		$("input[type='checkbox'][name='detinfo']").each(function(i){
			if(this.checked){
				...
				for(var j = 0;j<parseInt(mixnuminfo);j++){
					...
					innerhtml += "<td width='9%'><input name='detownorgname"+seqinfo+"' id='detownorgname"+seqinfo+"' style='line-height:18px;' size='9' value='' readonly/></td>";
	...
	function refreshData(){
		...
		if('<%=devappid%>'!=null){
			//回填基本信息
			var str = "select devapp.device_app_id,devapp.device_mixapp_id,devapp.device_mixapp_no,to_char(devapp.appdate,'yyyy-mm-dd') as appdate,"
			...
			+"devapp.mix_org_id,devapp.mix_type_id "
			...
			if(retObj!=undefined && retObj.length>0){
				...
				$("#device_app_id").val(retObj[0].device_app_id);//大港使用
			}
			//回填明细信息
			var prosql = "select appdet.device_mixapp_detid,appdet.team,appdet.apply_num,appdet.purpose,appdet.isdevicecode,";
				...
				prosql += "appdet.dev_name as dev_ci_name,appdet.dev_type as dev_ci_model,appdet.dev_ci_code,unitsd.coding_name as unit_name,teamsd.coding_name as team_name ";
				...
				prosql += "where appdet.device_mixapp_id='<%=devappid%>'";
		...
		if(retObj!=undefined){
			for(var index=0;index<retObj.length;index++){
				...
				innerhtml += "<td width='5%'><input type='checkbox' name='detinfo' id='"+index+"' value='"+retObj[index].device_mixapp_detid+"' checked/></td>";
				...
				innerhtml += "<td width='7%'><input name='mixnum"+index+"' id='mixnum"+index+"' detindex='"+index+"' value='' onkeyup='checkAssignNum(this)' size='5' type='text' />";

			...
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			   <td class="ali_cdn_name">转资单号</td>
			    ...
			    <td class="ali_cdn_input">
			    	<input id="cg_order_num" name="cg_order_num" type="text" class="input_width" />
			    </td>
			...
			<div id="table_box">
			  <table style="width:98.5%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr id='zz_id{zz_id}' name='zz_id' ondblclick='toModifyDetail(this)' idinfo='{zz_id}'>
					...
					<td class="bt_info_even" exp="{cg_order_num}">采购订单号</td>
					<td class="bt_info_odd" exp="{zz_num}">转资台数</td>
					<td class="bt_info_odd" exp="{zz_money}">转资总金额</td>
					<td class="bt_info_odd" exp="{batch_plan}">批次计划</td>
					<td class="bt_info_odd" exp="{creator}">创建人</td>
					<!-- <td class="bt_info_even" exp="{org_name}">转资机构</td> -->
					<td class="bt_info_even" exp="{lifnr_name}">供应商名称</td>
			...
			<div id="tab_box" class="tab_box">
				<div id="tab_box_content0" name="tab_box_content0" class="tab_box_content">
					...
					<tr>
				      ...
				      <td  class="inquire_form6"><input id="cg_order_num" class="input_width" type="text"  value="" disabled/> &nbsp;</td>
				...
				<div id="tab_box_content1" name="tab_box_content1" class="tab_box_content">
					<table border="0" cellpadding="0" cellspacing="0"  class="tab_line_height" width="100%" style="margin-top:10px;background:#efefef"> 
						<tr class="bt_info">
							...
							<td class="bt_info_odd" width="10%">转资机构</td><!-- 新增的 -->
							<td class="bt_info_even" width="5%">投产日期</td>
							<td class="bt_info_odd" width="10%">购置金额</td>
				        </tr>
...
$(function(){
	...
	function searchDevData(){
		...
		var cg_order_num = document.getElementById("cg_order_num").value;
		var zz_state = document.getElementById("zz_state").value;
		refreshData(zz_no,cg_order_num,zz_state);
	}
	function clearQueryText(){
		document.getElementById("zz_no").value = "";
		document.getElementById("cg_order_num").value = "";
		document.getElementById("zz_state").value = "";
		refreshData("","","");
	}
    function refreshData(zz_no,cg_order_num,zz_state){
      	var temp = "";
		if(typeof zz_no!="undefined" && zz_no!=""){
			temp += "&zz_no="+zz_no;
		}
		if(typeof cg_order_num!="undefined" && cg_order_num!=""){
			temp += "&cg_order_num="+cg_order_num;
		}
    ...
    function loadDataDetail(zz_id){
		...
		$("#cg_order_num","#scrapeMap").val(retObj.deviceMap.cg_order_num);
	...
	function appendDataToDetailTab(filterobj,datas){
		for(var i=0;i<basedatas.length;i++){
			...
			innerHTML += "<td>"+datas[i].dev_coding+"</td><td>"+datas[i].org_name+"</td><td>"+datas[i].inbdt+"</td><td>"+datas[i].answt+"</td>";
			innerHTML += "</tr>";

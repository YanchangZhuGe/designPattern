      	...
      	<div id="list_table">
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>			     
			      <td class="bt_info_even" exp="<input type='checkbox' name='rdo_entity_id' value='{human_detail_no}-{employee_id}-{type_param}-{deploy_detail_id}' id='rdo_entity_id'/>" >
...
//		}else{
			...
			popWindow('<%=contextPath%>/rm/em/queryZHumanReturn.srq?ids='+detailNos.substr(1)+'&projectInfoNo=<%=projectInfoNo%>&pageSize='+tempIds.length,'900:700');
...
//		}
	...
	function toDownload(){
		...
		if(projectTyp!="" && projectTyp !="null"){
			if(projectTyp =="5000100004000000006"){  //深海模板
				elemIF.src = "<%=contextPath%>/rm/em/humanRequest/download.jsp?path=/rm/em/singleHuman/humanReturnZ/importHumanListZsh.xls&filename="+iName+".xls";
			}else if (projectTyp =="5000100004000000009"){  // 综合模板
				elemIF.src = "<%=contextPath%>/rm/em/humanRequest/download.jsp?path=/rm/em/singleHuman/humanReturnZ/importHumanListZzh.xls&filename="+iName+".xls";
			}else { //其他类型
				elemIF.src = "<%=contextPath%>/rm/em/humanRequest/download.jsp?path=/rm/em/singleHuman/humanReturnZ/importHumanListZld.xls&filename="+iName+".xls";
			}
		}
	...
	function importData(){
		popWindow('<%=contextPath%>/rm/em/singleHuman/humanReturnZ/humanPlanImportFile.jsp','700:600');

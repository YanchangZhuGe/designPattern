						...
						<td width="99%">
							<div class="tongyong_box">
								...
								<span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('sbdjclxhzqxx1')" title="导出excel"></a>
								</span>
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		...
		$("#_titleinfo").text("单机材料消耗钻取信息<"+codingname+">");
		var retObj2 = jcdpCallService("DevCommInfoSrv","getCostDrillForPopTable","projectInfoNo=<%=projectInfoNo%>&devtype=<%=code%>");
		var dataXml2 = retObj2.dataXML;
		$("#chartContainer2").append(dataXml2);
		
	}
	function popDevQueqinJianxiuDetail(obj){
		popWindow('<%=contextPath %>/rm/dm/panel/popDZDCLCostDetail.jsp?repair_info='+obj,'1000:600');
		}

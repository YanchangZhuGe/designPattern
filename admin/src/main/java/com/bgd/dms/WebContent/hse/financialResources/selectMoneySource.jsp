					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" style="margin-top: 10px;">
					  <tr>
				     	<td class="inquire_item6"></td>
				      	...
				      	<input type="checkbox"  name="selected" value="1">集团公司</input><br/>
				      	<input type="checkbox"  name="selected" value="2">公司</input><br/>
				      	<input type="checkbox"  name="selected" value="3">二级单位</input><br/>
				      	<input type="checkbox"  name="selected" value="4">基层单位</input><br/>
				      	</td>
				     </tr>
					</table>
				</div>

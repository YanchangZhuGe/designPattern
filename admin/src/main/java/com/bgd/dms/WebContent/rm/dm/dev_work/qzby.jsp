    ...
    <div id="new_table_box_bg" style="width: 95%">
	  ...
	  <table width="97%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		  ...
		  <tr>			
			...
			<td class="inquire_form6"><input name="WORK_HOUR" id="WORK_HOUR" class="input_width" type="text"  /></td>	
		  </tr>
		   <tr>		
		   <td class="inquire_item6" >工时费</td>
			...
			<td class="inquire_form6"><input id="MILEAGE_TOTAL" name="MILEAGE_TOTAL" class="input_width" type="text"  /></td>
			<td class="inquire_item6" >钻井进尺(米)</td>
			<td class="inquire_form6"><input name="DRILLING_FOOTAGE_TOTAL" id="DRILLING_FOOTAGE_TOTAL" class="input_width" type="text"  /></td>
			
		  </tr>
		   <tr><td class="inquire_item6" >工作小时(小时)</td>
			<td class="inquire_form6"><input id="WORK_HOUR_TOTAL" name="WORK_HOUR_TOTAL" class="input_width" type="text" /></td>			
...
// 				querySql +=" union all select MAIN.PROCURE_NO as TEAMMAT_OUT_ID,BASE.WZ_NAME,sub.out_detail_id,SUB.WZ_ID,SUB.MAT_NUM AS USE_NUM,base.WZ_PRICE,base.wz_prickie from GMS_MAT_TEAMMAT_OUT MAIN LEFT JOIN gms_mat_teammat_out_detail SUB ON MAIN.TEAMMAT_OUT_ID=SUB.TEAMMAT_OUT_ID LEFT JOIN gms_mat_infomation BASE ON SUB.WZ_ID=BASE.WZ_ID WHERE MAIN.BSFLAG='0' AND SUB.BSFLAG='0' AND BASE.BSFLAG='0' and sub.out_detail_id in "+vReturnValue+" "
	...
	function showDevAccountPage(){
		var obj = new Object();
		var dialogurl = "<%=contextPath%>/rm/dm/dev_work/selectAllAccount.jsp";
		...
		if(vReturnValue!=undefined){
			...
			document.getElementById("dev_appdet_id").value=content[0];

...
var list;
	...
	if(retObj.map == undefined || retObj.map.baseline_plan_object_id == undefined){
		...
		if(projectBaselineId != undefined && projectObjectId != undefined && projectBaselineId != ""){
			...
			var temp = jcdpCallService("P6ProjectSrv", "queryBaselineProject", "objectId="+projectObjectId);
			if(temp.datas != null){
			...
			var temp = jcdpCallService("ProjectPlanSrv", "getActivity", "objectId="+projectBaselineId+"&projectInfoNo="+ids);

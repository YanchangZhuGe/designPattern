...
function checkForm() {
	...
	function insertEpsCode(){
		if (!checkForm()) return;
		var form = document.forms[0];
		form.action="<%=contextPath%>/pm/eps/saveEpsCode.srq";
		form.submit();
	}
...
<div id="new_table_box">
  <div id="new_table_box_content">
   ...
   <td class="inquire_form4"><input name="epsid" type="text" value="" class="input_width" />
    <input name="parentid" type="hidden" value="<%=parentid%>"/>
   </td>
   <td class="inquire_item4"><font color="red">*</font>&nbsp;EPS名称：</td>
   <td class="inquire_form4"><input name="epsname" type="text" value="" class="input_width" />
  ...
  <tr>
   ...
   <input id="orgname" name="orgname" type="text" value="" class="input_width" readonly/>
  ...
  <div id="oper_div">
   	<span class="tj_btn"><a href="#" onclick="insertEpsCode()"></a></span>

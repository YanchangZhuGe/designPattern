...
<%
	...
	String normal_no = "0";
	String wrong_no = "0";
	String sql="select g.use_no,g.install_no,g.normal_no,g.wrong_no from bgp_hse_common c join bgp_hse_week_gps_out g on c.hse_common_id = g.hse_common_id where  c.bsflag = '0' and c.subflag = '1' and c.org_id='"+second_org+"' and c.week_end_date = to_date('"+week_end_date+"','yyyy-MM-dd')";

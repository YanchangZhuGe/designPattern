			...
			<div id="table_box">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="{total_sp_radio}" >累计完成占比</td>		
			      <td class="bt_info_odd" exp="{design_sp_num}" >设计工作量</td>
...
<script type="text/javascript">
	...
	function refreshData(q_projectName, q_orgName, q_projectStatus, q_auditStatus, q_projectType, q_orgSubjectionId){
		cruConfig.submitStr = "projectStatus="+q_projectStatus+"&orgSubjectionId="+q_orgSubjectionId+"&projectName="+q_projectName+"&auditStatus="+q_auditStatus+"&projectType="+q_projectType+"&orgName="+q_orgName+"&projectInfoNo="+projectInfoNo+"&multi=2";
		queryData(1);
	}

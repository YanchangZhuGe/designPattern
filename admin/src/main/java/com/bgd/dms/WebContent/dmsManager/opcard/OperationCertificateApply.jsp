		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td valign="top" id="td0">
											...
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													<span class="kb"><a href="####"></a></span>申请时间： <span id="apply_date1"></span><input type="hidden" id="apply_date" name="apply_date"/>
														&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;申请单位 :<span id="org_name01"><%=org_name %></span><input type="hidden" name="org_name" value="<%=org_name %>"/><span class="gd"><a href="####"></a></span>
			 	 ...
			 	 <img src="<%=contextPath%>/images/calendar.gif" id="employeebutton1" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(start_work_date1,employeebutton1);" /></td>
		 ...
		 <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
			<td  align="center"><span class="bc_btn"><a href="#" onclick="toSubmit()"></a></span>
...
$("#apply_date").val(" "+year+"年"+month+"月"+day+"日");
	...
	function addEmployee(){
		...
		htmls=htmls+'<img src="<%=contextPath%>/images/calendar.gif" id="employeebutton'+id_index+'" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(start_work_date'+id_index+',employeebutton'+id_index+');" /></td>';

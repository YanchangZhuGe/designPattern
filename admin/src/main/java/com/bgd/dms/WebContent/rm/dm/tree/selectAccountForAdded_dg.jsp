...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model,v_dev_sign,v_self_num,v_license_num,v_dev_type){
		...
		if(obj.pageselectedstr == null){
			str += "where (account.owning_sub_id like '"+usersubid+"%' or account.usage_sub_id like '"+usersubid+"%') and using_stat='0110000007000000002'";
		}else{
			str += "where (account.owning_sub_id like '"+usersubid+"%' or account.usage_sub_id like '"+usersubid+"%') and using_stat='0110000007000000002' and account.dev_acc_id not in ("+obj.pageselectedstr+") ";
		}
		str +="and account.bsflag= '0' ";

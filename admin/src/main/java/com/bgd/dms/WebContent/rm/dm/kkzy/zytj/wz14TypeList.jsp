					...
					<tr>
						<td width="99%">
							<div class="tongyong_box">
								...
								href="#"></a></span><a href="#">备件消耗明细</a>
								<span class="gd"><a href="#"></a></span>
								<span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('zy14type')" title="导出excel"></a>
								</span>
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj = jcdpCallServiceCache("EarthquakeTeamStatistics","getWz14TypeList","args=<%=args%>");
	...
	function exportDataDoc(exportFlag){
		...
		var submitStr = "args=<%=args%>&exportFlag="+exportFlag;
	...
	function popProjectBjUseDetail(args){
		popWindow('<%=contextPath %>/rm/dm/kkzy/zytj/popProjectBjUseDetail.jsp?args='+args,'800:600');
	}
</script>
</html>

...
<%
	...
	if(redirectUrl==null||"".equals(redirectUrl)){
		redirectUrl="/common/ExcelImportFile.jsp";
	}
	if(resultMsg!=null){
...
function import_device(){
	...
	form.action = "<%=contextPath%>/common/excel/fileTemplateImport.srq?modelName=<%=modelName%>&&redirectUrl=<%=redirectUrl%>";
	form.submit();
}
function back(){
...
<body>
<form action="<%=contextPath%>/common/excel/fileTemplateImport.srq?modelName=<%=modelName %>" id="fileForm" method="post" enctype="multipart/form-data">

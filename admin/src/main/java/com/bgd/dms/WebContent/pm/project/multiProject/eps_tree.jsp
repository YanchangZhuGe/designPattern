...
function clickNode(selectedNode){
	...
	var idss = ids.split(",");
	var projectType=""; 
	if("C105007"==idss[2]){//大港
		projectType = "5000100004000000001,5000100004000000002,5000100004000000010";
		parent.mainRightframe.location.href ="<%=contextPath%>/pm/project/multiProject/tqh/projectList.jsp?projectType="+projectType+"&action=<%=action%>&orgSubjectionId="+idss[2]+"&orgId="+idss[1]+"&epsObjectId="+idss[0]+"&clickNode=1&forwardJsp=/rm/dm/devdis/disMainInfoList.jsp";
	} else if("井中地震"==selectedNode.text){
		projectType="5000100004000000008";
		parent.mainRightframe.location.href ="<%=contextPath%>/pm/project/multiProject/ws/wsprojectList.jsp?projectType="+projectType+"&action=<%=action%>&orgSubjectionId="+idss[2]+"&orgId="+idss[1]+"&epsObjectId="+idss[0]+"&clickNode=1&forwardJsp=/rm/dm/devdis/disMainInfoList.jsp";
	} else if("综合物化探处"==selectedNode.text){
		projectType="5000100004000000009";
		parent.mainRightframe.location.href ="<%=contextPath%>/pm/project/multiProject/wt/projectList.jsp?projectType="+projectType+"&action=<%=action%>&orgSubjectionId="+idss[2]+"&orgId="+idss[1]+"&epsObjectId="+idss[0]+"&clickNode=1&forwardJsp=/rm/dm/devdis/disMainInfoList.jsp";
	} else if("深海物探处"==selectedNode.text){
		projectType="5000100004000000006";
		parent.mainRightframe.location.href ="<%=contextPath%>/pm/project/multiProject/sh/projectList.jsp?projectType="+projectType+"&action=<%=action%>&orgSubjectionId="+idss[2]+"&orgId="+idss[1]+"&epsObjectId="+idss[0]+"&clickNode=1&forwardJsp=/rm/dm/devdis/disMainInfoList.jsp";
	} else if( "陆地地震"==selectedNode.text && "新兴物探开发处"==selectedNode.parentNode.text){
		projectType="5000100004000000001";
		parent.mainRightframe.location.href ="<%=contextPath%>/pm/project/multiProject/ws/wsprojectList.jsp?projectType="+projectType+"&action=<%=action%>&orgSubjectionId="+idss[2]+"&orgId="+idss[1]+"&epsObjectId="+idss[0]+"&clickNode=1&forwardJsp=/rm/dm/devdis/disMainInfoList.jsp";
	} else if( "新兴物探开发处"==selectedNode.text ){
		//projectType="5000100004000000001,5000100004000000008";
		//parent.mainRightframe.location.href ="<%=contextPath%>/pm/project/multiProject/projectList.jsp?projectType="+projectType+"&action=<%=action%>&orgSubjectionId="+idss[2]+"&orgId="+idss[1]+"&epsObjectId="+idss[0]+"&clickNode=1&forwardJsp=/rm/dm/devdis/disMainInfoList.jsp";
    } else {
		projectType="5000100004000000001,5000100004000000008,5000100004000000006,5000100004000000009,5000100004000000002,5000100004000000010";
		parent.mainRightframe.location.href ="<%=contextPath%>/pm/project/multiProject/projectList.jsp?projectType="+projectType+"&action=<%=action%>&orgSubjectionId="+idss[2]+"&orgId="+idss[1]+"&epsObjectId="+idss[0]+"&clickNode=1&forwardJsp=/rm/dm/devdis/disMainInfoList.jsp";
	}
}

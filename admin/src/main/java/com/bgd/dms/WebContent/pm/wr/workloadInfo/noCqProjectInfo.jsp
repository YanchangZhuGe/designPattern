...
<table border="0" cellpadding="0" cellspacing="0" id="lineTable"  width="100%" class="tab_line_height">
    <tr class="bt_info">
    	<td colspan="2" align="center" ><span id="country0" value="1">国内<input type="hidden" name="workload_id0" value=""></span></td>
        <td colspan="2"  align="center"><span id="country1" value="2">国际<input type="hidden" name="workload_id1" value=""></span></td>
    </tr>
    <tr class="odd">
    <td class="inquire_item4">完成价值工作量:</td>
    <td class="inquire_form4"><input type="text" name="complete_2d_money0" class="input_width" value="" onkeypress="return key_press_check(this)" style="ime-mode:disabled"/></td>
    <td class="inquire_item4">完成价值工作量:</td>
    <td class="inquire_form4"><input type="text" name="complete_2d_money1" class="input_width" value="" onkeypress="return key_press_check(this)" style="ime-mode:disabled"/></td>
    </tr> 
</table>

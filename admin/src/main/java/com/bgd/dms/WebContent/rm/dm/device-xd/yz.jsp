    ...
    <div id="new_table_box_bg">
	  ...
	  <tr>
		  ...
		  <tr>
			...
			<td class="inquire_form6">
				<input id="mileage" name="mileage"  class="input_width" type="text" /></td>
...
<script type="text/javascript"> 
	...
	function submitInfo(){
		...
		if(confirm("提交后数据不能修改，确认提交？")){
			//调配数量提交
			document.getElementById("form1").action = "<%=contextPath%>/rm/dm/bgpCommDeviceOperationInfo.srq?state=9&ids="+dev_appdet_id;
	...
	function loadDataDetail(){
		...
		if(operation_info_id=="null"){
			var querySql="select dui.* from GMS_DEVICE_ACCOUNT_DUI dui where dui.dev_acc_id='"+dev_appdet_id+"'" ;
...
// 			$("#modify_date")[0].value=basedatas[0].modify_date;
			...
			var querySql="select info.*,dui.dev_name,dui.dev_coding,dui.dev_model,dui.self_num,dui.license_num from GMS_DEVICE_OPERATION_INFO info left join GMS_DEVICE_ACCOUNT_DUI dui on dui.dev_acc_id=info.dev_acc_id where info.operation_info_id='"+operation_info_id+"'" ;

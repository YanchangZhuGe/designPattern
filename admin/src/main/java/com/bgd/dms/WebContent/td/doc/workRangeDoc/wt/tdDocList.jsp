			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">踏勘报告</td>
			      <td class="bt_info_odd" exp="{written_unit}">踏勘组织单位</td>
...
<script type="text/javascript">
	...
	function refreshData(str){
		...
		cruConfig.queryStr = "select t.* from (select f.ucm_id,f.file_name,t.project_info_no,t.tecnical_id,t.title,t.written_time,t.test_start_date,t.writer,t.leader,t.auditor,t.written_unit,p.project_name "+
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/doc/workRangeDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'800:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/doc/workRangeDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&id='+id+'&isSingle='+isSingle,'800:680');
	}

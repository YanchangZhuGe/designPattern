...
<%
	...
	String hse_financial_id = request.getParameter("hse_financial_id");
...
<input type="hidden" id="hse_financial_id" name="hse_financial_id" value=""/>
    ...
    <div id="new_table_box_bg">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" style="margin-top: 10px;">
					  ...
					  <tr>
					    ...
					    <td class="inquire_form6"><input type="text" id="declare_person" name="declare_person" value="<%=userName %>" class="input_width" /></td>
					  </tr>
					  <tr>
					    ...
					    <td class="inquire_form6"><input type="text" id="declare_date" name="declare_date" class="input_width" value="<%=today %>" readonly="readonly"/>
...
var hse_financial_id = "<%=hse_financial_id %>";
var action = "<%=action %>"
...
function submitButton(){
	...
	form.action="<%=contextPath%>/hse/resource/addFinancial.srq";
	form.submit();
}

//点击资金来源，弹出页面选择，现在不用了，直接在页面上选择复选框

...
<body>
<form action="<%=contextPath%>/hse/notConforMcorrectiveAction/doseNotComplyNotice/humanImportFile_ts.jsp" id="fileForm" method="post" enctype="multipart/form-data" target="targetIframe">

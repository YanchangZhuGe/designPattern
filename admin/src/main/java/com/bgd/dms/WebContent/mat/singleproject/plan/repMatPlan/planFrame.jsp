...
//	String taskBackUrl = request.getParameter("taskBackUrl");
	...
	String wbsBackUrl = "/mat/singleproject/plan/repMatPlan/planItemList.jsp";
	String taskBackUrl = "/mat/singleproject/plan/repMatPlan/planItemList.jsp";
	String rootBackUrl = "/mat/singleproject/plan/repMatPlan/planSumList.jsp";
	String orgCode=user.getOrgCode();
	//如果是否大港C105007/开发时用superadmin改成C105
	if(orgCode.indexOf("C105007")>-1){
			wbsBackUrl =  "/mat/singleproject/plan/repMatPlan/planItemListDg.jsp";
			taskBackUrl = "/mat/singleproject/plan/repMatPlan/planItemListDg.jsp";
			rootBackUrl = "/mat/singleproject/plan/repMatPlan/planSumListDg.jsp";
	}
	
	String projectType = user.getProjectType();
	//项目类型为综合物化探的跳到另一个页面
	if(projectType!=null&&projectType.equals("5000100004000000009")){
		wbsBackUrl = "/mat/singleproject/plan/planRoughRepeat/planItemListRough.jsp";
		taskBackUrl = "/mat/singleproject/plan/planRoughRepeat/planItemListRough.jsp";
	}
%>

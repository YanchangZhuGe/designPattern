...
<body>
<form name="form1" id="form1" method="post"  action="<%=contextPath%>/market/addWuTanPerson.srq">
<table border="0" cellpadding="0" cellspacing="0" width="95%" height="800" class="form_info">
  ...
  <tr class="odd">
    ...
    <td class="inquire_form">
	  <input name="name" id="name" type="text" class="input_width" maxlength=16 />
	</td>
  ...
  <td class="inquire_item"><font color="red">* </font>组织机构:</td>
    <td class="inquire_form">
<select name="corpId" class="select_width">
  ...
  <td class="inquire_item">职务:</td>
    	<td class="inquire_form">
    	<input name="duty" type="text" class="input_width" maxlength=40/>
	</td>
	<td class="inquire_item">手机号码:</td>
    <td class="inquire_form">
	  <input name="mobilePhone" type="text" class="input_width" maxlength=16 />
	</td>
  ...
  <td class="inquire_item">办公电话:</td>
    <td class="inquire_form">
	  <input name="officePhone" type="text" class="input_width" maxlength=16 />
	</td>
    <td class="inquire_item">家庭电话:</td>
    <td class="inquire_form">
		<input name="homePhone" type="text" class="input_width" maxlength=16 />
	</td>
  ...
  <td class="inquire_item">传真:</td>
    <td class="inquire_form">
	  <input name="fax" type="text" class="input_width" maxlength=16 />
	</td>
	<td class="inquire_item">电子邮箱:</td>
    <td class="inquire_form">
	  <input name="email" type="text" class="input_width" isEmail msg="请按照正确格式输入邮箱地址"/>
	</td>
  ...
  <tr class="odd">
    ...
    <td class="inquire_form">
	  <input type="text" name="educationLevel" class="input_width" maxlength=50/>
	</td>
	<td class="inquire_item">籍贯:</td>
	<td class="inquire_form">
	   <input name="birthPlace" type="text" class="input_width" maxlength=25/>
	</td>
	</tr>
	<tr class="odd">
	<td class="inquire_item">个人爱好:</td>
    <td class="inquire_form">
	  <input name="hobby" type="text" class="input_width" maxlength=50/>
	</td>
	 <td class="inquire_item">家庭住址:</td>
    <td class="inquire_form">
    	<input name="homeAddress" type="text" class="input_width" maxlength=50 />
	</td>
	</tr>
  <tr class="odd">
  <td class="inquire_item">工作地点:</td>
    <td class="inquire_form">
	  <input name="workPlace" type="text" class="input_width" maxlength=25/>
	</td>
	<td class="inquire_item">所学专业:</td>
    	<td class="inquire_form"  >
    		 <input name="majorSubject" type="text" class="input_width" maxlength=16/>
		</td>
	</tr>
  <tr class="odd">
  <td class="inquire_item">毕业院校:</td>
    <td class="inquire_form">
	  <input name="graduateFrom" type="text" class="input_width" maxlength=32/>
	</td>
    ...
    <td class="inquire_form" >
    	 <input name="goodAt" type="text" class="input_width" maxlength=50/>
	</td>
	<td></td>
	<td></td>
	</tr>
  <tr class="odd">
	<td class="inquire_item">主管业务:</td>
	 <td class="inquire_form" colspan="3">
      <textarea name="inChargeOf" id="inChargeOf" max=16 msg="主管业务不超过16个汉字"></textarea>
	</td>
		</tr>
	<tr class="odd">
  ...
  <tr class="odd">
    ...
    <td class="inquire_form" colspan="3">
      <textarea name="memo" id="memo" max=2000 msg="个人简介不超过2000个汉字"></textarea>
	</td>
	</tr>
  <tr class="odd">

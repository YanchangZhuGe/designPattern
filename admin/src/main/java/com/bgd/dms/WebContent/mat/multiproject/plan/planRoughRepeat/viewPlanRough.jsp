...
//		var obj = event.srcElement;
		for(var i=1;i<row.length;i++){
			...
			row[i].cells[11].childNodes[2].name = "gucheng_num_"+i;
			row[i].cells[11].childNodes[4].name = "main_part_"+i;
			row[i].cells[11].childNodes[6].name = "kuerle_num_"+i;
			row[i].cells[11].childNodes[7].name = "main_part_value_"+i;
			
			debugger;
			//修改页面主板区域字段，对应复选框
			if(row[i].cells[11].childNodes[7].value!=""&&shuaId=="1"){
				var checkedValue = 	row[i].cells[11].childNodes[7].value.split(",");
			...
			row[i].cells[11].childNodes[7].value = ids;            //选中的项目部
			...
			if(row[i].cells[0].firstChild.checked==true){
				...
				if(row[i].cells[11].firstChild.checked == true){
					row[i].cells[11].childNodes[2].disabled = false;
					
					if(row[i].cells[11].childNodes[2].value!=""&&!re.test(row[i].cells[11].childNodes[2].value)){
					...
					row[i].cells[11].childNodes[2].disabled = true;
				}
				if(row[i].cells[11].childNodes[4].checked == true){
					row[i].cells[11].childNodes[6].disabled = false;
					
					if(row[i].cells[11].childNodes[6].value!=""&&!re.test(row[i].cells[11].childNodes[6].value)){
					...
					row[i].cells[11].childNodes[6].disabled = true;
				}
			}
		}
		return flag;

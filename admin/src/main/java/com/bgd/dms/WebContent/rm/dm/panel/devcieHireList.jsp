...
$(function(){
	...
	$("#dev_grid").datagrid({ 
		...
		url:"${pageContext.request.contextPath}/rm/dm/getListDataBySrvAndMethod.srq?JCDP_SRV_NAME=DevCommRemind&JCDP_OP_NAME=queryNotReturnProInfo"
	});
});
</script>
</html>
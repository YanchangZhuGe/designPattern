...
function save(){
	...
	form.action = "<%=contextPath%>/td/wt/toSaveMemorandumDoc.srq?businessType=<%=businessType%>&isSingle="+isSingle;
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if (!isTextPropertyNotNull("written_time", "编写时间")) return false;
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4">备忘录：</td>
									<td colspan="2">
										<input type="hidden" id="pk_0110000061000000071" name="pk_0110000061000000071" value=""/>
										<input type="file" name="0110000061000000071" id="0110000061000000071" class="input_width"/>
					    				<div id="down_0110000061000000071"></div>
									</td>

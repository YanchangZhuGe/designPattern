		...
		<div id="table_box">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
				<tr>
					...
					<td class="bt_info_even" exp="{tech_stat}">技术状态</td>
					<td class="bt_info_even" exp="{using_stat}">使用状态</td>
					<td class="bt_info_even" exp="{account_stat}">在帐状态</td>
					<td class="bt_info_even" exp="{dev_position}">所在位置</td>
					<td class="bt_info_even" exp="{org_name}">所在单位</td>
				</tr>
			</table>
		</div>
		<div id="fenye_box">

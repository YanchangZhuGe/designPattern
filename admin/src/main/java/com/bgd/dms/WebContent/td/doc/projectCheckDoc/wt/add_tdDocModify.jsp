...
function save(){
	...
	form.action = "<%=contextPath%>/td/wt/toSaveProjectCheckDoc.srq?businessType=<%=businessType%>&isSingle="+isSingle;
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if(""==document.getElementById("pk_0110000061100000008").value){
		if (!isTextPropertyNotNull("0110000061100000008", "验收意见书")) return false;	
	}
	if (!isLimitB20("auditor","负责人")) return false;
	if (!isLimitB20("writer","参加人员")) return false; 
	if (!isLimitB100("memo","验收结果")) return false;  
	return true;
}
...
function page_init(){
	...
	if(fileId!='null'){
		var querySql = " select * from(select b.project_info_no,p.project_name,t.file_id,t.ucm_id,t.file_abbr,b.business_type,t.doc_file_type,t.file_name,b.tecnical_id,b.title,b.written_time,b.writer,b.auditor,b.memo,b.test_type from gp_ws_tecnical_basic b left join gp_task_project p on b.project_info_no=p.project_info_no and p.bsflag='0' left join bgp_doc_gms_file t on  b.tecnical_id = t.relation_id and t.bsflag='0')m where m.tecnical_id ='"+fileId+"'";
		...
		if(datas!=null && datas.length>0){
			...
			document.getElementById("test_type").value = datas[0].test_type;
			if(null!=document.getElementById("projectName")){
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4">项目验收类型：</td>
									<td class="inquire_form4">
								...
								<tr>
									...
									<td class="inquire_form4"><input type="text" id="memo" name="memo" value="" class="input_width" /></td>
									<td class="inquire_item4"></td>
								...
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>验收意见书：</td>
									<td colspan="2">

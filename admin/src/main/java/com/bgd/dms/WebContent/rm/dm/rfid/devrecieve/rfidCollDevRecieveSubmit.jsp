      ...
      <table id="table1" width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
         <tr>
			  ...
			  <tr>
				...
				<td class="inquire_form6" colspan="2"><input id="actual_in_time" name="actual_in_time" class="input_width" type="text" readonly="readonly"/>
...
<script type="text/javascript"> 
	...
	function submitInfo(){
		...
		document.getElementById("form1").action = "<%=contextPath%>/rm/dm/rfidCollDevReceive.srq?device_oif_subid="+device_oif_subid+"&devaccId="+devaccId+"&projectInfoNo="+projectInfoNo+"&fk_devaccId="+fk_devaccId+"&outInfoId="+'<%=outInfoId%>';

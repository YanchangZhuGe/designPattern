...
<html>
 ...
 <div id="new_table_box" align="center">
  <div id="new_table_box_content"> 
  	...
  	<input type="hidden" name="target_indicator_id" id="target_indicator_id" value="" />
    ...
    <table  width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
	    ...
	    <tr>
			...
			<td class="inquire_form4" colspan="3"><textarea  name="work_load" id="work_load" class="textarea" ></textarea></td>
		</tr>
		<tr>	
			<td class="inquire_item4">地表条件：</td>
			<td class="inquire_form4" colspan="3"><textarea  name="work_situation" id="work_situation" class="textarea" ></textarea></td>
		</tr>
		<tr>
			<td class="inquire_item4">施工因素：</td>
			<td class="inquire_form4" colspan="3"><textarea  name="work_factor" id="work_factor"  class="textarea" ></textarea></td>
		</tr>
		<tr>	
			<td class="inquire_item4">影响施工效率的主要因素：</td>
			<td class="inquire_form4" colspan="3"><textarea  name="work_reason" id="work_reason" class="textarea" ></textarea></td>
		</tr>
		<tr>
			<td class="inquire_item4">用工人数及工期：</td>
			<td class="inquire_form4" colspan="3"><textarea  name="work_person" id="work_person" class="textarea" ></textarea></td>
		</tr>
		<tr>	
			<td class="inquire_item4">设备投入情况：</td>
			<td class="inquire_form4" colspan="3"><textarea  name="work_device" id="work_device" class="textarea" ></textarea></td>
		</tr>
	    <tr>
		...
		<tr>	
			<td class="inquire_item4"><font color="red">*</font>满覆盖工作量<input type="radio" name="workload" id="workload1" value="1" checked="checked"/></td>
			<td class="inquire_form4"> <input name="tech_005" id="tech_005" value="" class="input_width" type="text"  /> </td>
			<td class="inquire_item4"><font color="red">*</font>实物工作量<input type="radio" name="workload" id="workload2" value="2"/></td>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		//载入技术指标信息
		var querySql="select * from bgp_op_target_project_indicato where bsflag='0' and tartget_basic_id='"+tartget_basic_id+"'";
		...
		if(retObj!=null && retObj.returnCode =='0' && retObj.datas[0]!=null){
			...
			document.getElementById("target_indicator_id").value = map.target_indicator_id;
		}
	...
	function newSubmit() {
		...
		submit = "table_name=bgp_op_target_project_indicato&target_indicator_id="+document.getElementById("target_indicator_id").value;
		for(var name in project_indicato){
			submit += "&"+name + "="+document.getElementById(name).value ;
		}

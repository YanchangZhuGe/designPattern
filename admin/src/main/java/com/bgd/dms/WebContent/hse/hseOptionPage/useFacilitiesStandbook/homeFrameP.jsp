...
<frameset rows="148,*"  cols="*" frameborder="yes" border="0" framespacing="1">
  ...
  <frameset cols="620,620" frameborder="yes" border="0" framespacing="1">   
    <frame  src="<%=contextPath %>/hse/hseOptionPage/useFacilitiesStandbook/testLeftP.jsp?addTypes=<%=addTypes%>&usefacilities_no=<%=usefacilities_no%>" name="leftframe" frameborder="1" scrolling="auto" noresize="noresize" id="leftframe"/> 
 
    <frame src="<%=contextPath %>/hse/hseOptionPage/useFacilitiesStandbook/rightPageP.jsp?addTypes=<%=addTypes%>&optionP=<%=optionP%>&usefacilities_no=<%=usefacilities_no%>" name="rightframe" frameborder="1" scrolling="auto" noresize="noresize" id="rightframe"/>    
  </frameset>

			...
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <td class="ali_cdn_input">
			    	<select id="s_dev_ci_model" name="select"  class="select_width"  id="select" onchange="selectRefreshData()">
...
<script type="text/javascript"><!--
    ...
    function loadDataDetail(obj){
		...
		if(shuaId!=null){
			var querySql="select (select coding_name from comm_coding_sort_detail where coding_code_id=a.OIL_NAME)as OIL_NAME1,";
			querySql+="(select coding_name from comm_coding_sort_detail where coding_code_id=a.OIL_MODEL)as OIL_MODEL1,";
			querySql+="(select coding_name from comm_coding_sort_detail where coding_code_id=OIL_UNIT)as OIL_UNIT1,";
			querySql+=" b.owning_org_name,c.PROJECT_NAME,a.* ";
			querySql+="from BGP_COMM_DEVICE_OIL_INFO a left join GMS_DEVICE_ACCOUNT_DUI b on a.DEVICE_ACCOUNT_ID=b.dev_acc_id ";
			querySql+="left join gp_task_project c on b.PROJECT_INFO_ID=c.project_info_no where DEVICE_ACCOUNT_ID='"+shuaId+"' order by a.fill_date desc";

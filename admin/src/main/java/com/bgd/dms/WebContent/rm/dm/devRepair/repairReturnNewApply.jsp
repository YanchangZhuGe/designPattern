						...
						<div style="overflow: auto">
							<table style="width: 97.9%" border="0" cellspacing="0"
								...
								<tr>
									...
									<td width="13%" class="bt_info_even">实物标识号</td>
...
function refreshData(){
	...
	function submitInfo(){
		...
		****/
		...
		document.getElementById("form1").action = "<%=contextPath%>/rm/dm/devRepair/repairRtnNewApply.srq?count="+count+"&line_infos="+line_infos+"&rosClass="+rosClass+"&lin_id="+lin_id;
	...
	$().ready(function(){
		$("#addProcess").click(function(){
			...
			var vReturnValue = window.showModalDialog("<%=contextPath%>/rm/dm/devRepair/selectDevDetailForBack.jsp?projectinfono=projectInfoNo&backdevtype=backdevtype",paramobj,"dialogWidth=820px;dialogHeight=450px");
			//var vReturnValue = window.showModalDialog('<%=contextPath%>/rm/dm/devRepair/selectDevReturn.jsp?backUrl=/rm/dm/devRepair/DevReturnList.jsp&action=view',"test",'dialogWidth=800px;dialogHeight=450px');
			...
			var condition ="(";
				...
				var str = "SELECT SUB.REPAIRFORM_ID SEND_FORM_ID,REP.REPAIR_FORM_CODE AS REPAIR_FORM_NO,REP.REPAIR_FORM_NAME AS REPAIR_FORM_NAME,ACC.DEV_NAME AS DEV_NAME, ACC.DEV_MODEL AS DEV_MODEL, ACC.DEV_TYPE AS DEV_TYPE,DECODE(SUB.ERROR_TYPE, <%=DevUtil.getDecodeStr(DevConstants.DECODE_KEY_ERRORTYPE)%>) AS ERROR_TYPE\n" +

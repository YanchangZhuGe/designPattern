...
<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      <td class="bt_info_odd" exp="<input type='checkbox' name='rdo_entity_id' value='{project_info_no}-{project_name}' id='rdo_entity_id_{project_info_no}'  />" >选择</td>
			      <td class="bt_info_even" autoOrder="1">序号</td>
			      <td class="bt_info_odd" exp="{project_name}">项目名称</td>
			      <td class="bt_info_even" exp="{project_year}">项目年度</td>
			      <td class="bt_info_odd" exp="{project_type}">项目类型</td>
			    </tr> 
			  </table>
			</div>
...
<script type="text/javascript">
	...
	function refreshData(){
		cruConfig.queryStr = "select distinct pd.org_id,t.project_info_no,t.project_name,t.project_year,c.coding_name as project_type "+
			"from gp_task_project t,comm_coding_sort_detail c,gp_task_project_dynamic pd "+
			"where t.bsflag = '0' and pd.bsflag = '0' and pd.org_subjection_id like '"+orgCode+"%' and t.project_type = c.coding_code_id "+
			"and pd.project_info_no = t.project_info_no and pd.exploration_method = t.exploration_method and pd.bsflag = '0' "+
			"and t.project_name like '%%' and t.project_type like '%%' and t.is_main_project like '%%' and t.project_status like '%%' "+
			"order by t.project_year desc, project_type";
		...
		cruConfig.currentPageUrl = "/td/searchProjectList.jsp";
		queryData(1);	

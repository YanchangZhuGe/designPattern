      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
         <td class="inquire_item4" >申请设备类别:</td>
          <td class="inquire_form4">
          	<select name="mixownership" id="mixownership" class="selected_width" >
          		<option value="S0000">单台</option>
          		<option value="S9997">地震仪器</option>
          		<option value="S14050208">检波器</option>          		
          	</selected>
          </td>

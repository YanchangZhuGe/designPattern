			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="{hse_work_hour}">本周百万工时总数</td>
			    </tr>
			  </table>
			</div>
	...
	function simpleSearch(){
			var accidentName = document.getElementById("accidentName").value;
				if(accidentName!=''&&accidentName!=null){
					cruConfig.cdtType = 'form';
					cruConfig.queryStr = "select t.hse_accident_id,t.second_org,t.third_org,t.accident_name,t.accident_date,t.accident_place,decode(t.accident_type,'1','工业生产安全事故','2','火灾事故','3','交通事故') as accident_type,oi1.org_abbreviation as second_org_name,oi2.org_abbreviation as third_org_name,t.create_date,t.modifi_date from bgp_hse_accident_news t join comm_org_subjection os1 on t.second_org = os1.org_subjection_id and os1.bsflag = '0' join comm_org_information oi1 on oi1.org_id = os1.org_id and oi1.bsflag = '0' join comm_org_subjection os2 on t.third_org = os2.org_subjection_id and os2.bsflag = '0' join comm_org_information oi2 on oi2.org_id = os2.org_id and oi2.bsflag = '0' where t.bsflag = '0' and t.accident_name like '%"+accidentName+"%' order by t.modifi_date desc";
					cruConfig.currentPageUrl = "/hse/accidentNews/accident_list.jsp";
					queryData(1);
				}else{
					refreshData();

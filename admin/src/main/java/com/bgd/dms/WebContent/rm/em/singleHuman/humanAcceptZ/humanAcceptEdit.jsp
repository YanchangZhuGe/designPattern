...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <div id="list_table">
	<div id="table_box" >
	  <table width="99%" border="0" cellspacing="0" cellpadding="0"  id="queryRetTable">		
	     <tr>
	      ...
	      <td class="bt_info_odd" width="6%">用工类型</td>
    ...
    <tr>
	 ...
	 <input type="text" name="fy<%=i%>actualStartDate"  style="width:120px;" id="fy<%=i%>actualStartDate" value="<%=(record.get("actual_start_date") != null && !"".equals(record.get("actual_start_date"))) ? record.get("actual_start_date"):record.get("plan_start_date") != null ? record.get("plan_start_date"):""%>" readonly="readonly"/>
...
function save(){
	if(checkForm()){
		...
		form.action = "<%=contextPath%>/rm/em/toZHumanAcceptEdit.srq";
		form.submit();
		newClose();
	}
}

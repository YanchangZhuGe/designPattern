      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>	
			    ...
			    <td>&nbsp;</td>		
			    <auth:ListButton functionId="" css="tj" event="onclick='toConfirm()'" title="JCDP_btn_confirmEmergency"></auth:ListButton>	    
			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_odd" exp="{emergency_flag}<input type='hidden' name='is_emergency_{emergency_id}' id='is_emergency_{emergency_id}' value='{is_emergency}'/>">应急确认</td>
			    </tr>
			  </table>
			</div>
			    ...
			    <td width="4"><img src="<%=contextPath%>/images/list_17.png" width="4" height="36" /></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="commonInfoTable" class="tab_line_height">
					  ...
					  <tr>
					    ...
					    <td class="inquire_form4"  id="item2_1"><textarea rows="4" id="emergency_reason" name="emergency_reason" readonly="readonly"></textarea></td>
					  </tr>		
					  <tr>
					    <td class="inquire_item4">过程：</td>
					    <td class="inquire_form4" id="item3_0"><textarea rows="4" id="emergency_process" name="emergency_process" readonly="readonly"></textarea></td>
				...
				<div id="tab_box_content3" class="tab_box_content" style="display:none;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="commonInfoTable_1" class="tab_line_height">
					  <tr>
					    ...
					    <textarea rows="4" cols="50" id="emergency_measure" name="emergency_measure"></textarea>
					    </td>
					  </tr>	
					  <tr>
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "getAllRiskEvent";
	...
	function simpleSearch(){
		...
		if(is_risk_confirm == "0"|| is_risk_confirm == "1"){
			cruConfig.submitStr = "emergencyConfirm="+is_risk_confirm;	
			queryData(1);
	...
	function toEdit(){
	    ...
	    var risk_flag = document.getElementById("is_emergency_"+ids).value;
	    if(risk_flag == "1"){
	    	alert("应急已确认，不能修改！");
	    	return;
	    }
	...
	function loadDataDetail(ids){
		...
		document.getElementById("risks").src = "<%=contextPath%>/risk/singleproject/riskEvent/risks_of_event.jsp?relationId="+ids;

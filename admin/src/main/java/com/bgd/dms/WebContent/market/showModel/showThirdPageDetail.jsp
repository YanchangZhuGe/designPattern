...
<%
    ...
    String times=resultMsg.getValue("times");
...
<form name="form1" id="form1" enctype="multipart/form-data" method="post" >
 ...
 <div id="nav">
  ...
  <div id="content_div">
    <div id="content_gl_news_mbx" style="padding-right: 40px;">
      <ul>
        <li class="mleft"></li>
       	<%if(typeName==null){ %>
       	...
       	<%}else{%>
       	<li class="mbg"><span class="mbx_text"><a href="#"><%=typeName==null?"&nbsp;":typeName %></a><a href="javascript:window.history.back()" <%if(typeName.length()==4){ %> style="margin-left: 826px;"<%}else if(typeName.length()==5){ %> style="margin-left: 813px;"<%}else if(typeName.length()==8){ %> style="margin-left: 776px;"<%}else{ %> style="margin-left: 800px;"<%} %>>返回&nbsp;&nbsp;</a></span>
        </li>
       	<%} %>
    ...
    <div id="content_main_content" style="text-align: left;">
      <div id="news_title" style="text-align: center;"><%=(String)map.get("infomationName") %></div>
      <div id="news_titbot" style="text-align: center;">
        <ul>           
         	 <li>来源：<%=(String)map.get("creator") %>&nbsp;&nbsp;&nbsp;</li>
         	 <li>发布时间：<%=(String)map.get("releaseDate") %></li>         	 
         	 <li style="margin-left: 15px;">浏览次数：<%=times %></li>         	 
        </ul>
      </div>
      <div id="news_content" style="width: 930px;">
        <%=content %>
      </div>
  ...
  <div id="content_gl_news_mbx" style="padding-right: 40px;">
      <ul>
        <li class="mleft"></li>
        <%if(typeName==null){ %>
        <li class="mbg"><span class="mbx_text"> <a href="" style="float: right">&nbsp;&nbsp;&nbsp;&nbsp;</a></span>
        <%}else{ %>

...
<div id="list_table">
			...
			<td background="<%=contextPath%>/images/list_15.png">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>&nbsp;</td>
						<auth:ListButton functionId="F_QUA_PLAN_002" css="zj" event="onclick='toAdd()'" title="JCDP_btn_add"></auth:ListButton>
						...
						<%-- <auth:ListButton functionId="F_QUA_PLAN_002" css="dc" event="onclick='exportData()'" title="JCDP_btn_export"></auth:ListButton> --%>
	...
	<div id="table_box">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			<tr>
				<td class="bt_info_odd" exp="<input type='checkbox' name='chk_entity_id' value='{file_id}:{ucm_id}' id='chk_entity_id' onclick=doCheck(this)/>" >
				<input type='checkbox' name='chk_entity_id' value='{file_id}:{ucm_id}' id='chk_entity_id' onclick='check(this)'/></td>
...
<script type="text/javascript">
	...
	function toAdd(){
	  	...
	  	popWindow('<%=contextPath%>/qua/common/upload_file.jsp?relationId=<%=relation_id%>&index=0&file_abbr=KZJH');
	}
	...
	function toDelete(){
		...
		if(window.confirm("您确定要删除?")){
			...
			sql = sql + "update bgp_qua_control t set t.bsflag ='1' where t.project_info_no='<%=project_info_no%>';"
			if(sql!=null && sql!=''){

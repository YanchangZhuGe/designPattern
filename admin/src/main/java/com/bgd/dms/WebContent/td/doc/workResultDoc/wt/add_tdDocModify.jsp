...
function save(){
	...
	form.action = "<%=contextPath%>/td/wt/toSaveWorkResultDoc.srq";
	form.submit();
	newClose();
}

function checkForm(){
	if (!isTextPropertyNotNull("title", "拐点编号")) return false;	
	if (!isLimitB20("title","拐点编号")) return false;  
	if (!isTextPropertyNotNull("north_location", "X坐标")) return false;	
	if (!isTextPropertyNotNull("south_location", "Y坐标")) return false;	
	if (!isValidFloatProperty12_2("north_location","X坐标")) return false;  
	if (!isValidFloatProperty12_2("south_location","Y坐标")) return false;  
	return true;
}
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>拐点编号：</td>
								...
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>X坐标：</td>
									<td class="inquire_form4"><input type="text" id="north_location" name="north_location" value="" class="input_width" /></td>
									<td class="inquire_item4"></td>
									<td class="inquire_form4"></td>
								</tr>
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>Y坐标：</td>

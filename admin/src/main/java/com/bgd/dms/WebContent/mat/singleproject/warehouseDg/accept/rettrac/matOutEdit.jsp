...
<table border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td class="inquire_item6"><input type="text"
			...
			value="<gms:msg msgTag="matInfo" key="invoices_id"/>" />
			</td>
		...
		<td class="inquire_item6">发放单号：</td>
		<td class="inquire_item6"><input type="text" name="procure_no" id="procure_no"
			class="input_width"
			value="<gms:msg msgTag="matInfo" key="procure_no"/>" readonly/></td>
	</tr>
	<tr>
...
<script type="text/javascript">
	...
	function refreshData(value){
		var outInfoId = "<gms:msg msgTag="matInfo" key="out_info_id"/>";
		var sql ='';

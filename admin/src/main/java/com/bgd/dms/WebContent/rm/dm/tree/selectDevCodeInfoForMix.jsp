...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
 ...
 <body style="background:#F1F2F3; overflow:scroll;" onload="refreshData()">
      	<div id="list_table">
...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model,v_dev_ci_code){
		...
		str += "where 1=1 and dev_ci_code like 'S"+dev_ci_code+"%' ";
	...
	function setHeight(){
			...
			var h3=0;
			//分页栏
			if($("#fenye_box_table").length>0){
				h1 = $("#fenye_box_table").height();
			}
			//表格上方工具栏
			if($("#inq_tool_box").length>0){
				 h2 = $("#inq_tool_box").height();
			}
			
			//设置表格大小
			$("#list_table").css("height",($(window).height()-h1-h2));

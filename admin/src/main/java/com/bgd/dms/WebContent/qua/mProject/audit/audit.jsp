...
<div id="list_table">
	...
	<div id="table_box">
		<input id="org_subjection_id" name="org_subjection_id" type="hidden" class="input_width" value=""/>
...
<script type="text/javascript">
	...
	function refreshData(org_subjection_id){
		...
		if((org_subjection_id ==null || org_subjection_id =='') && subjection!=null && subjection!=''){
		...
		cruConfig.queryStr = "select t.file_id,t.file_name,t.file_type,to_char(t.create_date,'yyyy-MM-dd HH24:mi:ss') as create_date,t.ucm_id "+
			" from bgp_doc_gms_file t where t.bsflag='0' and t.is_file='1' "+
			" and t.file_name like '%"+file_name+"%' and t.relation_id like '"+relation_id+"' "+
	...
	function toAdd(){
		...
		var relation_id = 'audit:'+subjection_id;
		popWindow('<%=contextPath%>/qua/common/upload_file.jsp?relationId='+relation_id+'&path=company&file_abbr=XX');
	}

...
<%
	...
	//	response.sendRedirect(contextPath+"/mat/singleproject/matLedger/matItemListDg.jsp?type=1");
...
%>
 <frameset cols="320,*"  frameborder="yes" border="0" framespacing="0">
  ...
  <frame src="<%=contextPath %>/mat/singleproject/matLedger/repItemList.jsp" name="menuFrame" frameborder="no" scrolling="auto"  id="menuFrame" style="border-right: 2px solid #5796DD; cursor: w-resize;"/>
 </frameset>

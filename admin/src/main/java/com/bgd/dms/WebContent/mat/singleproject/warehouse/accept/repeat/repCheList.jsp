			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_odd" exp="{org_abbreviation}">来源</td>
...
<script type="text/javascript"><!--
	...
	function refreshData(){
		var sql ="select t.*,oi.org_abbreviation from gms_mat_teammat_invoices t  left join comm_org_information oi on t.source = oi.org_id and oi.bsflag='0' where t.project_info_no='<%=projectInfoNo%>' and t.invoices_type='2'and t.if_input='1' and t.bsflag='0'";
		cruConfig.cdtType = 'form';
		cruConfig.queryStr = sql;
		cruConfig.currentPageUrl = "/mat/singleproject/warehouse/accept/repeat/repCheList.jsp";
		queryData(1);
	}
	function save(){	
		//if (!checkForm()) return;
		...
		document.getElementById("form1").action="<%=contextPath%>/mat/singleproject/warehouse/accept/repeat/queruRepList.srq?invoices_type=2&laborId="+ids;

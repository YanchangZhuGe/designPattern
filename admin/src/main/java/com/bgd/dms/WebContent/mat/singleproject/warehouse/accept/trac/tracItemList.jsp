			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="{source}">分中心</td>
...
<script type="text/javascript">
	...
	function refreshData(){
		var sql ="select t.invoices_no,t.total_money,t.input_date,t.source,t.note,t.invoices_id from GMS_MAT_TEAMMAT_INVOICES t left join comm_org_information i on t.source=i.org_id and i.bsflag='0' where t.project_info_no='<%=projectInfoNo%>' and (t.invoices_type='0' or t.invoices_type='4')  and t.source is null and t.if_input='0' order by t.input_date desc";
	...
	var showTabBox = document.getElementById("tab_box_content0");
	  function toAdd(){ 
			  ...
			  popWindow("<%=contextPath%>/mat/singleproject/warehouse/accept/trac/tracCheList.jsp",'1024:800');
		...
		function toEdit(){
			...
			popWindow("<%=contextPath%>/mat/singleproject/warehouse/accept/trac/getTracEdit.srq?laborId="+ids,'1024:800');
			}

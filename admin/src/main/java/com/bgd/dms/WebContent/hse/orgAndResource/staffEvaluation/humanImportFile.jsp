...
<body>
<form action="<%=contextPath%>/hse/orgAndResource/staffEvaluation/humanImportFile_ts.jsp" id="fileForm" method="post" enctype="multipart/form-data" target="targetIframe">
...
<table id="buttonTable" border="0" cellpadding="0" cellspacing="0" class="form_info">
	<tr align="right">
	<td>
		<a  href="<%=contextPath%>/rm/em/humanRequest/download.jsp?path=/hse/orgAndResource/staffEvaluation/ImpleOperation.xlsx&filename=员工能力评价模板.xlsx">下载员工能力评价模板</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		<input name="Submit" type="button" class="iButton2" id="confirmButton"  onClick="returnFile()" value="确定" />
		<input name="Submit" type="button" class="iButton2" id="confirmButton"  onClick="returnNull()" value="取消" />
	</td>
	</tr>
</table>

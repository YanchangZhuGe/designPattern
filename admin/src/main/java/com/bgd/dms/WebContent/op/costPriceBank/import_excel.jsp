...
<html>
 ...
 <body> 
 <form name="fileForm" id="fileForm" method="post" enctype="multipart/form-data" action="<%=contextPath%>/op/OPCostSrv/importPrice.srq">
  ...
  <div id="new_table_box_content"> 
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		<tr>
		    ...
		    <td class="inquire_form4" colspan="3"><input type="file" name="price_file" id="price_file" value="" class="input_width" /></td>
		</tr>
	</table>
  </div> 
  <div id="oper_div">
...
<script type="text/javascript">
	...
	function checkValue(){
		var obj = document.getElementById("price_file");
		var value = obj.value ;
		if(obj ==null || value==''){
			alert("请选择上传的文档!");
			return false;

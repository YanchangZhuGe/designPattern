...
<body>
<form name="form1" id="form1" method="post" action="<%=contextPath%>/doc/uploadFileCommon.srq?isMultiProject=1">
...
<script type="text/javascript">
	...
	autoSelectFolder(module_id);
	
	function autoSelectFolder(module_id){
		var querySql1 = "select f.file_id, f.file_name from bgp_doc_folder_module t join bgp_doc_gms_file f on t.folder_id = f.file_id and t.bsflag='0' and t.project_info_no is null and t.module_id = '"+module_id+"'";

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function getFusionChart(){
			...
			$("#country_1").attr("value",1);//设置第二项为当前选中项
		}
		//获取闲置情况
		function getAmountWhlFusionChart(){
			...
			chart1.setXMLUrl("<%=contextPath%>/rm/dm/getDeviceLieOne.srq?country=1");
		...
		function toQuery1(){
			...
			chartReference1.setXMLUrl("<%=contextPath%>/rm/dm/getDeviceLieOne.srq?devTreeId="+devTreeId+"&country="+country);
			parent.mainRightframe.location.href = "<%=contextPath%>/rm/dm/deviceXZAccount/DevAccListUnUse.jsp?devTreeId="+devTreeId+"&country="+country;
		}
		//清除
		function toClear(){
			$('#org_sub_id_1') .val('');
		...
		function popDevList(devTreeId,orgSubId,country){
			parent.mainRightframe.location.href = "<%=contextPath%>/rm/dm/deviceXZAccount/DevAccListUnUse.jsp?devTreeId="+devTreeId+"&orgSubId="+orgSubId+"&country="+country;

      	...
      	<div id="list_table">
			...
			<div id="tag-container_3">
			  <ul id="tags" class="tags">
			    ...
			    <li id="tag3_5"><a href="#" onclick="getTab3(5)">风险应对</a></li>
			  </ul>
			</div>
...
<script type="text/javascript">
	...
	function refreshData(){
		cruConfig.submitStr = "riskConfirm=1&isflow=1";	
		queryData(1);
	}
	...
	function toAdd(){
		popWindow('<%=contextPath %>/risk/singleproject/riskIdentify/edit_risk_identify.jsp?pageAction=Add&addType=flow');		
	}

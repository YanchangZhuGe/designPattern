...
<input type="hidden" id="hse_advertise_id" name="hse_advertise_id" value="<%=(String)map.get("hseAdvertiseId") %>"/>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" style="margin-top: 10px;">
					  ...
					  <tr>
					   ...
					   <td class="inquire_item6"><font color="red">*</font>宣贯人职务：</td>
					    ...
					    <td class="inquire_form6"><input type="text" id="advertise_person" name="advertise_person" class="input_width" value="<%=(String)map.get("advertisePerson") %>"/></td>
					  </tr>	
					  <tr>
					    <td class="inquire_item6">宣贯日期：</td>
					    <td class="inquire_form6">
					    	<input type="text" id="advertise_date" name="advertise_date" class="input_width" readonly="readonly" value="<%=(String)map.get("advertiseDate") %>"/>
					  ...
					  <tr>
					    ...
					    <td class="inquire_form6" colspan="5"><textarea id="content" name="content" class="textarea"><%=(String)map.get("content") %></textarea></td>
					  </tr>
					</table>
				</div>
			<div id="oper_div">
...
document.getElementById("if_plicy").value="<%=(String)map.get("ifPlicy")%>";
...
function submitButton(){
	...
	form.action="<%=contextPath%>/hse/advertise/addAdvertise.srq";
	form.submit();
}

				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box_title"><span class="kb"><a
							href="#"></a></span><a href="#">一线员工学历分析</a>
							<span class="gd"><a href="#"></a></span></div>
						<div class="tongyong_box_content_left"  id="chartContainer1"  style="height: 100%">
...
<script type="text/javascript">
 ...
 function getFusionChart(){
		...
		myChart4.setXMLUrl("<%=contextPath%>/cache/rm/em/getChart21.srq");      
		myChart4.render("chartContainer1"); 

}

 function myJS(orgId){
	 popWindow('<%=contextPath%>/rm/em/humanChart/humanChart21-1.jsp?orgId='+orgId,'800:700');
 }
</script>  
<script type="text/javascript">
	/**/function frameSize() {

...
<!-- 	<fieldSet style="margin-left:2px"><legend >装备基本信息</legend>
 ...
 -->      		
		<fieldset style="margin-left:2px"><legend>装备离场信息</legend>
			 <table id="table1" width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
			   <tr>
				...
				<select id="province" name="province" class="select_width" style="width: 30%;"> 
					<option value="涿州">涿州</option>
					<option value="库尔勒">库尔勒</option>
...
<script type="text/javascript"> 
	...
	function submitInfo(){
		...
		if(confirm("确认提交吗？")){
			document.getElementById("form1").action = "<%=contextPath%>/rm/dm/toSubmitEqStock.srq";

...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		if(duty_name!=''&&duty_name!=null){
			sql = sql+" and t.duty_name like '%"+duty_name+"%'";
		}
		if(out_flag!=''&&out_flag!=null){
			sql = sql+" and t.out_flag = '"+out_flag+"'";
		}
		if(number_die!=''&&number_die!=null){
			sql = sql+" and t.number_die = '"+number_die+"'";
		}
    ...
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
          ...
          <td class="inquire_item6">负责人:</td>
          <td class="inquire_form6"><input id="duty_name" name="duty_name" class="input_width" type="text" /></td>
        </tr>
        <tr>

...
function initPageBody(projectType){	//根据项目类型初始化页面显示内容
	if( !strIsNullOrEmpty(projectType) )
	{
		...
		if( projectType=="5000100004000000001")	 // 陆地项目
		{
			...
			operationName = "getEditProjectPlan" ;
		}
		else if( projectType=="5000100004000000002" )	// 浅海项目
		{ 
			serviceName = "ProjectPlanSrv";
			operationName = "getEditProjectPlan" ;
		}
		...
		else if( projectType=="5000100004000000010")	// 滩浅海地震项目
		{
			serviceName = "ProjectPlanSrv";
			operationName = "getEditProjectPlan" ;
		}
...
function loadData(){	//加载数据
	...
	var retObj = jcdpCallService(serviceName, operationName, "project_info_no="+ids+"&base_plan_id="+basePlanId);
...
function save(){
	...
	if( !strIsNullOrEmpty(projectType) )
	{
		if( projectType=="5000100004000000001" || projectType=="5000100004000000002" || projectType=="5000100004000000010")	 // 陆地项目
		{
	...
	{
		var retObj = jcdpCallService(serviceName, "saveProjectBackUpPlan", str);
	...
	{
		var retObj = jcdpCallService(serviceName, "saveProjectPlan", str);
		if(retObj != null && retObj.message == "success") {
			alert("修改成功");
...
function saveOrgInfo(){
	...
	if( !strIsNullOrEmpty(projectType) )
	{
		...
		{ 
			str += "&team_leader="+document.getElementById("team_leader_qh").value;
			str += "&project_secretary="+document.getElementById("project_secretary_qh").value;
			str += "&product_leader="+document.getElementById("product_leader_qh").value;
			str += "&device_leader="+document.getElementById("device_leader_qh").value;
			str += "&technology_leader="+document.getElementById("technology_leader_qh").value;
			str += "&protection_cable_leader="+document.getElementById("protection_cable_leader_qh").value;
			str += "&geophysical_division="+document.getElementById("geophysical_division_qh").value;
			str += "&survey_monitor="+document.getElementById("survey_monitor_qh").value;
			str += "&technology_monitor="+document.getElementById("technology_monitor_qh").value;
			str += "&surface_monitor="+document.getElementById("surface_monitor_qh").value;
			str += "&instrument_monitor="+document.getElementById("instrument_monitor_qh").value;
			str += "&gas_explosion_monitor="+document.getElementById("gas_explosion_monitor_qh").value;
			str += "&hse_leader="+document.getElementById("hse_leader_qh").value;
			str += "&team_id="+document.getElementById("team_id_qh").value;
			str += "&is_majorteam="+document.getElementById("is_majorteam_qh").value;
		}
		else if( projectType=="5000100004000000003")	// 非地震项目
		{ 
		}
		...
		{
			str += "&team_leader="+document.getElementById("team_leader_tqh").value;
			str += "&project_secretary="+document.getElementById("project_secretary_tqh").value;
			str += "&product_leader="+document.getElementById("product_leader_tqh").value;
			str += "&device_leader="+document.getElementById("device_leader_tqh").value;
			str += "&technology_leader="+document.getElementById("technology_leader_tqh").value;
			str += "&well_drilling_leader="+document.getElementById("well_drilling_leader_tqh").value;
			str += "&geophysical_division="+document.getElementById("geophysical_division_tqh").value;
			str += "&survey_monitor="+document.getElementById("survey_monitor_tqh").value;
			str += "&technology_monitor="+document.getElementById("technology_monitor_tqh").value;
			str += "&surface_monitor="+document.getElementById("surface_monitor_tqh").value;
			str += "&instrument_monitor="+document.getElementById("instrument_monitor_tqh").value;
			str += "&gas_explosion_monitor="+document.getElementById("gas_explosion_monitor_tqh").value;
			str += "&powder_monitor="+document.getElementById("powder_monitor_tqh").value;
			str += "&well_drilling_monitor="+document.getElementById("well_drilling_monitor_tqh").value;
			str += "&hse_leader="+document.getElementById("hse_leader_tqh").value;	
			str += "&team_id="+document.getElementById("team_id_tqh").value;
			str += "&is_majorteam="+document.getElementById("is_majorteam_tqh").value;
		}
...
<body onload="initPageBody('<%=projectType %>')">
...
document.getElementById("addChangePlan").innerHTML = "";
</script>
</body>
</html>
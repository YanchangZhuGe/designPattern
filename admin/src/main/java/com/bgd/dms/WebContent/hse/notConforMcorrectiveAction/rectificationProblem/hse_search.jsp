...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		var rectification_date = document.getElementById("rectification_date").value;  
		var rectification_date2 = document.getElementById("rectification_date2").value;   
		...
		if(rectification_date!=''&&rectification_date!=null){
			sql = sql+" and tr.rectification_date >= to_date('"+rectification_date+"','yyyy-MM-dd')";
		}
		if(rectification_date2!=''&&rectification_date2!=null){
			sql = sql+" and tr.rectification_date <= to_date('"+rectification_date2+"','yyyy-MM-dd')";
		}
    ...
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
		  ...
		  <td class="inquire_form6"><input type="text" id="rectification_date2" name="rectification_date2" class="input_width" readonly="readonly"/>
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton2" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(rectification_date2,tributton2);" />&nbsp;</td>
        </tr>

...
<script type="text/javascript">
	...
	function refreshData(){
		...
		cruConfig.currentPageUrl = "/mat/singleproject/warehouseDg/accept/oil/oilItemList.jsp";
		queryData(1);
	}
	  ...
	  function toAdd(){ 
       ...
       function simpleSearch(){
    	   var sql ='';
			...
			sql+="select * from (select i.coding_code_id,i.wz_id,i.wz_name,i.wz_prickie,d.actual_price,to_char(d.create_date,'yyyy-mm-dd') create_date,sum(d.mat_num) mat_num,sum(d.total_money) total_money from GMS_MAT_TEAMMAT_INFO_DETAIL d inner join gms_mat_infomation i on d.wz_id=i.wz_id and i.bsflag='0' where d.input_type='2'and d.project_info_no='<%=projectInfoNo%>' and d.bsflag='0' group by i.coding_code_id,i.wz_id,i.wz_name,i.wz_prickie,d.actual_price,to_char(d.create_date,'yyyy-mm-dd') order by to_char(d.create_date,'yyyy-mm-dd') desc) ttt where ttt.wz_name like'%"+wz_name+"%'"
			cruConfig.cdtType = 'form';
			cruConfig.queryStr = sql;

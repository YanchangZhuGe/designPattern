...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		var if_build = document.getElementById("if_build").value;  
		var if_library = document.getElementById("if_library").value;   
		...
		var sql = " select tr.explosives_no,decode(tr.if_build,'1','是','2','否') if_build,decode(tr.if_library,'1','是','2','否') if_library,tr.inventory,tr.consumption,tr.accumulated_comsumption,tr.equipment_total ,  tr.second_org,tr.third_org,oi3.org_abbreviation org_name,tr.creator,tr.create_date,tr.bsflag, tr.modifi_date, tr.updator,oi1.org_abbreviation as second_org_name,oi2.org_abbreviation as third_org_name from BGP_EXPLOSIVES_MANAGEMENT tr left join comm_org_subjection os1 on tr.second_org = os1.org_subjection_id  and os1.bsflag = '0' left join comm_org_information oi1  on oi1.org_id = os1.org_id  and oi1.bsflag = '0' left join comm_org_subjection os2  on tr.third_org = os2.org_subjection_id  and os2.bsflag = '0' left join comm_org_information oi2 on oi2.org_id = os2.org_id  and oi2.bsflag = '0' left join comm_org_subjection os3 on tr.org_sub_id=os3.org_subjection_id and os3.bsflag='0' left join comm_org_information oi3  on oi3.org_id = os3.org_id and oi3.bsflag='0'   where tr.bsflag='0'   "+sql;
		...
		if(if_build!=''&&if_build!=null){
			sql = sql+" and tr.if_build = '"+if_build+"'";
		}
		
		if(if_library!=''&&if_library!=null){
			sql = sql+" and tr.if_library = '"+if_library+"'";
		}

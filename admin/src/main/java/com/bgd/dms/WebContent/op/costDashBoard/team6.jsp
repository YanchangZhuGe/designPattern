...
<div id="chart_c640c8b06d7020ece0430a15082c2006" style="width:100%; height:100%; overflow:auto;"></div>   

<script type="text/javascript">
	var myChart6 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/MSColumn3D.swf", "myChartId6", "100%", "100%", "0", "0" );    
	myChart6.setXMLUrl("<%=contextPath%>/cache/op/OpCostSrv/getTeamTargetActualInfo.srq?parentId=S01001002&projectInfoNo=<%=projectInfoNo%>");      
	myChart6.render("chart_c640c8b06d7020ece0430a15082c2006");

...
Ext.onReady(function() {
    ...
    grid.addListener('cellclick', function(grid,colspan, colIndex, rowdata, rowspan,rowIndex,e) {
		...
		var querySql = "select rownum,t.* from bgp_comm_human_cost_act_deta t where t.project_info_no='"+projectInfoNo+"' and t.subject_id='"+codingCodeId+"'  and t.org_subjection_id like '"+orgAffordId+"' ";

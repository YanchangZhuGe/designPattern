...
<%
	...
	/* if(org_subjection_id.startsWith("C105007")){
		request.getRequestDispatcher("tqhDetail.jsp").forward(request, response);
	} */
				...
				<div id="tab_box" class="tab_box">
					...
					<div id="tab_box_content1" class="tab_box_content"  style="display:none;">
						<table width="100%" border="4" style="border: thick;" cellspacing="1" cellpadding="1">
							...
							<tr>
								<td rowspan="4"><p align="center">合同要求指标</p></td>
							...
							<tr>
								...
								<td><p align="center"><%=map.get("content17") == null ? "" : map.get("content17")%>%</p></td>
								<td  id="str17"><%=map.get("str17") == null ? "" : (String)map.get("str17")%>&nbsp;</td>
							</tr>
							<tr>

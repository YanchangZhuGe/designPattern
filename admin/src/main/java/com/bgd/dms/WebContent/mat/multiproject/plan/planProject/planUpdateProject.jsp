			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="<input name='demand_num_{wz_id}'  type='text' value='{demand_num}' onkeyup='loadDataDetail()'/>" >需求数量</td>
			      <td class="bt_info_odd" exp="<input name='demand_money_{wz_id}'  type='text' value='{plan_money}' readonly/>" >金额</td>
...
<script type="text/javascript">
	...
	function refreshData(value){
		...
		cruConfig.queryOp = "";
		var sql ='';
		sql +="select mi.wz_id,mi.coding_code_id,mi.wz_name,mi.wz_prickie,mi.wz_price,t.demand_num,t.plan_money from gms_mat_demand_plan t  join gms_mat_demand_plan_invoice i on t.plan_invoice_id = i.plan_invoice_id and i.bsflag = '0' join gms_mat_demand_rough_detail d on i.plan_invoice_id = d.plan_invoice_id and d.bsflag='0' join gms_mat_infomation mi on mi.wz_id=t.wz_id and mi.bsflag='0'  where d.detail_id='<%=plan_id %>'";
		cruConfig.cdtType = 'form';
	  ...
	  function toSave(){ 
		  ids = getSelIds('rdo_entity_id');
			if (ids == '') {
				...
				document.getElementById("form1").action="<%=contextPath%>/mat/singleproject/plan/updatePlanProject.srq";
				openMask();

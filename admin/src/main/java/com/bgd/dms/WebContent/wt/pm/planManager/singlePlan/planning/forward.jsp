...
location.href="<%=contextPath %>/wt/pm/planManager/singlePlan/planning/workloadList.jsp?taskObjectId=<%=taskObjectId %>&testTaskName="+encodeURI(taskName,'UTF-8')+"&foward=1";

 ...
 <body style="background:#fff" onload="refreshData('')">
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      ...
		      <%} %>
			  	<td class="ali_cdn_name">验收意见书</td>
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <%} %>
			      <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">验收意见书</td>
			      <td class="bt_info_odd" exp="{test_type}" func="getOpValue,test_type1">验收类型</td>
			      <td class="bt_info_odd" exp="{written_time}">验收时间</td>
			      <td class="bt_info_odd" exp="{auditor}">负责人</td>
			      <td class="bt_info_odd" exp="{memo}">验收结果</td>
			     </tr> 			        
			  </table>
			</div>
...
<script type="text/javascript">
var test_type1 = new Array(['1','内部'],['2','甲方']);
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/doc/projectCheckDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'800:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/doc/projectCheckDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&id='+id+'&isSingle='+isSingle,'800:680');
	}

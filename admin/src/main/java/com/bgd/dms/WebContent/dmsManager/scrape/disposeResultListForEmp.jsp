			...
			<div id="tag-container_3">
			 ...
			 <li class="selectTag" id="tag3_0" ><a href="#" onclick="getContentTab(this,0)">基本信息</a></li>
			    <li id="tag3_1"><a href="#" onclick="getContentTab(this,1)">明细信息</a></li>
			     <li id="tag3_1"><a href="#" onclick="getContentTab(this,2)">参与处置人员信息</a></li>
			...
			<div id="tab_box" class="tab_box">
				...
				<div id="tab_box_content2" name="tab_box_content2" class="tab_box_content">
					<table border="0" cellpadding="0" cellspacing="0"  class="tab_line_height" width="100%" style="margin-top:10px;background:#efefef"> 
				        ...
				        <tbody id="menMap" name="menMap" ></tbody>
					</table>
				</div>
...
cruConfig.contextPath =  "<%=contextPath%>";
	...
	cruConfig.queryOp = "queryDisposeResultListForJianduer";
...
function searchDevData(){
 ...
 function refreshData(dispose_method_name, dispose_method_no){
      	var temp = "";
	...
	popWindow('<%=contextPath%>/dmsManager/scrape/disposeResultAddForEmp.jsp?dispose_method_id='+ids);
	}
	...
	function getContentTab(obj,index) { 
		...
		if(index == 2){
			...
			var retObj;
		   retObj = jcdpCallService("ScrapeSrv", "getDisposeMenInfo", "dispose_method_id="+ids);
		   basedatas = retObj.datas;
		  	$(filtermapid).empty();
		   if(basedatas!=undefined && basedatas.length>=1){
					//先清空
					var filtermapid = "#menMap";
					$(filtermapid).empty();

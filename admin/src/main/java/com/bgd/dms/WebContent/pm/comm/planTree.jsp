...
debugger;
if('<%=projectInfoNo %>'==null || '<%=projectInfoNo %>' == 'null'){
	alert("请选择项目");
}
Ext.require([
             'Ext.data.*',
...
Ext.onReady(function() {
    ...
    function cellclick(grid,colspan, colIndex, rowdata, rowspan,rowIndex,e) {
        ...
        if(leaf == true){
  			parent.mainRightframe.location.href = "<%= contextPath%>/pm/plan/"+url+"?projectInfoNo=<%=projectInfoNo%>&action=<%=action %>";
  		}
    }

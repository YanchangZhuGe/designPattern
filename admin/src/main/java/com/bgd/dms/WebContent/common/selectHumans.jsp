...
<HEAD>
	...
	var root = "<%=path%>";
		...
		function onClick(event, treeId, treeNode, clickFlag) {
			alert("treeNode.id==="+treeNode.id+"======treeNode.name==="+treeNode.name);
...
<div class="content_wrap"> 
	...
	<font style="font-size: 14px">
	 <input type="radio" id="name" name="keyType" class="radio first" checked />  用户名： </font><input type="text" id="key" value=""  /><br/>

	...
	<div id="table_box" >
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="right" id="queryRetTable">
			<tr>
				...
				<td class="bt_info_odd" exp="<input type='text' name='actual_price_{wz_id}' id='mat_num_{wz_id}' value='{wz_price}'  style='width:40px'/>">入库单价</td>
				<td class="bt_info_even"	exp="<input type='text' name='mat_num_{wz_id}' id='mat_num_{wz_id}' value=''  style='width:40px' onkeyup='keyup()'/>">入库数量</td>
				<td class="bt_info_odd"exp="<input type='text' name='total_money_{wz_id}' id='mat_num_{wz_id}' value=''  style='width:40px'/>">入库金额</td>
				<td class="bt_info_even"	exp="<input type='text' name='warehouse_number_{wz_id}' id='mat_num_{wz_id}' value=''  style='width:40px'/>">收料库</td>
				<td class="bt_info_odd" exp="<input type='text' name='goods_allocation_{wz_id}' id='mat_num_{wz_id}' value=''  style='width:40px'/>">货位</td>
			</tr>
		</table>
	</div>
...
<script type="text/javascript"><!--
	...
	function refreshData(){
		...
		cruConfig.queryOp = "getAcceptList";
		queryData(1);
	}					
	...
	function save(){	
		...
		openMask();
		document.getElementById("form1").action="<%=contextPath%>/mat/singleproject/warehouse/accept/selfaccept/saveAcceptLedger.srq?id="+ids;

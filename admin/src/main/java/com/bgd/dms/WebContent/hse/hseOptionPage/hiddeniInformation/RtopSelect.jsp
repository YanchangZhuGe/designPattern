...
function clearQueryText(){
	...
	document.getElementsByName("crisk_levels")[0].value="";	 
...
<tr  >
	...
	<td class="inquire_item4">识别人：</td> 
	<td class="inquire_form4">	 
	<input type="text" id="recognition_people" name="recognition_people" class="input_width"  style="width:180px;"  />    
	</td>
	</tr>
	<tr  >
	<td  class="inquire_item4"><font color=red></font>&nbsp;上报日期：</td>
	<td class="inquire_form4">	 
	<input type="text" id="report_date" name="report_date" class="input_width" style="width:180px;"  style="width:180px;"  readonly="readonly"  />
	...
	<td class="inquire_form4">	 
	 <select id="crisk_levels" name="crisk_levels" style="width:180px;"  class="select_width">
       <option value="" >请选择</option>
	  ...
	  <td class="inquire_item4"><font color="red">*</font>整改状态：</td>
	    <td class="inquire_form4">
	    <select id="rectification_state" name="rectification_state" style="width:180px;"  class="select_width">
	       <option value="" >请选择</option>

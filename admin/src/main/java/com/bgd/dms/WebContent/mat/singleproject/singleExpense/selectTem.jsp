			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_odd" exp="{tamplate_name}">模板名称</td>
			      <td class="bt_info_even" exp="{tname}">班组/设备</td>
	...
	function refreshData(){
       ...
       function simpleSearch(){
    	   var sql ='';
			...
			sql+="select  t.tamplate_id,t.tamplate_name,t.create_date,c.coding_name,u.user_name, nvl(c.coding_name,(d.dev_ci_name||d.dev_ci_model))as tname from gms_mat_demand_tamplate t left join gms_device_codeinfo d on t.device_id = d.dev_ci_code left join comm_coding_sort_detail c on t.coding_code_id = c.coding_code_id and c.bsflag='0' inner join p_auth_user u on t.creator_id = u.user_id and u.bsflag='0' where t.bsflag='0'and t.device_id='"+deviceCode+"'and t.tamplate_name like'%"+tamplate_name+"%'"
			cruConfig.cdtType = 'form';
			cruConfig.queryStr = sql;
     ...
     function toSubmit(){
    	 ...
    	 if (ids == '') {
		    	...
		    	window.location.href='<%=contextPath%>/mat/singleproject/singleExpense/selectMatList.jsp?tamplateId='+ids+'&ids='+ids
			}
     }

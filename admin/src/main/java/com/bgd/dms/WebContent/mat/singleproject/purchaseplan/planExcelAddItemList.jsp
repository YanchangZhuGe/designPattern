				...
				<div>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
						  <tr>
						  	...
						  	<td class="inquire_item4">选择班组 </td>
...
<!-- 				      <td class="bt_info_even" exp="" >单元用量</td>      -->
				      <td class="bt_info_even" exp="<input name='demand_num_{wz_id}'  type='text' value='{unit_num}'/>" >需求数量</td>
...
//	    	var applyTeamList=jcdpCallService("HumanCommInfoSrv","queryApplyTeam","");	
	...
	function getPlanNum(){
		...
		document.getElementById("plannum").value="TM2222QX00"+num;
		}	
	var selectIndex = 0;
	...
	function checkText(){
	 ...
	 function AddExcelData(){
		 var obj=window.showModalDialog('<%=contextPath%>/mat/singleproject/plan/planExcelAdd.jsp',"","dialogHeight:500px;dialogWidth:600px");
		...
		obj = decodeURI(obj,'UTF-8');
		 if(obj!="" && obj!=undefined ){
			 ...
			 cruConfig.queryStr = "";
			 cruConfig.queryService = "MatItemSrv";
			 cruConfig.queryOp = "getPlanExclData";
	 ...
	 function downloadModel(modelname,filename){
			...
			if("kq_model"==modelname){
				window.location.href="<%=contextPath%>/rm/dm/xlsmodel/download.jsp?path=/mat/singleproject/plan/"+modelname+".xls&filename="+filename+".xls";
			}else{
				window.location.href="<%=contextPath%>/rm/dm/xlsmodel/download.jsp?path=/mat/singleproject/plan/"+modelname+".xlsx&filename="+filename+".xlsx";
			}

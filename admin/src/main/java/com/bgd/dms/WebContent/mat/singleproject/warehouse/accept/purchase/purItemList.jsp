			...
			<div id="tab_box" class="tab_box">
				<div id="tab_box_content0" class="tab_box_content">
				    ...
				    <tr>
				      ...
				      <td  class="inquire_form6"  ><input id="source" class="input_width_no_color" type="text"  value=""/> &nbsp;</td>
				     </tr>
				     <tr >
				     ...
				     <td  class="inquire_form6"><input id="waybill_no" class="input_width_no_color" type="text"  value=""/> &nbsp;</td>  
				    </tr>
				     <tr >
				     <td  class="inquire_item6">备注：</td>
				     <td  class="inquire_form6"><input id="note" class="input_width_no_color" type="text"  value=""/> &nbsp;</td> 
				     <td  class="inquire_item6">供应商信息：</td>
				     <td  class="inquire_form6"><input id="supplier" class="input_width_no_color" type="text"  value=""/> &nbsp;</td> 
				...
				<div id="tab_box_content2" class="tab_box_content" style="display:none;">
				   <table id="taskTable" width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height"  >
			    	<tr>
			            ...
			            <td  class="bt_info_odd">发票号</td>
			            <td class="bt_info_even">名称及规格</td>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		var sql ="select t.procure_no,t.total_money,t.input_date,t.source,t.note,t.invoices_id from GMS_MAT_TEAMMAT_INVOICES t where t.project_info_no='<%=projectInfoNo%>' and t.invoices_type='1' and t.source is null and t.bsflag='0' order by t.input_date desc,t.create_date desc";
	...
	function loadDataDetail(shuaId){
		...
		document.getElementById("source").value = retObj.matInfo.source;
		...
		document.getElementById("waybill_no").value = retObj.matInfo.waybill_no;
		document.getElementById("note").value = retObj.matInfo.note;
		document.getElementById("supplier").value = retObj.matInfo.supplier;
		taskShow(shuaId);  
	...
	function toOut(){
	  ...
	  function toAdd(){ 
			  ...
			  popWindow("<%=contextPath%>/mat/singleproject/warehouse/accept/purchase/purLedgerAdd.jsp",'1024:800');
     ...
     //验收明细信息
  	 function taskShow(value){
  			...
  			for(var i =0; taskList!=null && i < taskList.length; i++){
  				...
  				var procure_no = taskList[i].procure_no;
      ...
      function toEdit(){
    	  ...
    	  popWindow("<%=contextPath%>/mat/singleproject/warehouse/accept/purchase/queruPurList.srq?laborId="+ids,'1024:800');
          }

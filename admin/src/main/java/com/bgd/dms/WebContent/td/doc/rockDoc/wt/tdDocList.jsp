			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <%} %>
			      <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">岩石物性分析报告</td>
			      <td class="bt_info_odd" exp="{writer}">编写人</td>
			      <td class="bt_info_odd" exp="{auditor}">审核人</td>
			      <td class="bt_info_odd" exp="{test_start_date}">测定开始时间</td>
			      <td class="bt_info_odd" exp="{test_end_date}">测定结束时间</td>
			     </tr> 			        
			  </table>
			</div>
...
<script type="text/javascript">
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/doc/rockDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'800:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/doc/rockDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&id='+id+'&isSingle='+isSingle,'800:680');
	}

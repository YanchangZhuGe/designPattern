...
<body>
<form name="form1" id="form1" method="post" action="<%=contextPath%>/doc/uploadFileCommon.srq">
  ...
  <div id="new_table_box_content">
	...
	<table  border="0" cellpadding="0" cellspacing="0" class="tab_line_height" width="100%">
  	<tr>
    	<td colspan="4" align="center">上传文档
    		<input type="hidden" name="qualityControl" value="<%=quality_control %>"/>
	...
	<tr>
     	<td class="inquire_item4">文档：</td>
      	<td class="inquire_form4"><input type="file" name="doc_content" id="doc_content" onchange="getFileInfo()" class="input_width"/></td>
...
<script type="text/javascript">
	...
	autoSelectFolder(module_id,project_no);
	
	function autoSelectFolder(module_id,project_info_no){
		var querySql1 = "select f.file_id, f.file_name from bgp_doc_folder_module t join bgp_doc_gms_file f on t.folder_id = f.file_id and t.project_info_no ='"+project_info_no+"' and t.module_id = '"+module_id+"'"
		...
		if(queryOrgRet1.datas!=null && queryOrgRet1.datas.length == 1){
			var folder_id = queryOrgRet1.datas[0].file_id;
			//var folder_name = queryOrgRet1.datas[0].file_name;
	...
	function refreshData(){
		if(checkUploadFileEmpty()){
			document.getElementById("form1").submit();
		}
		
	}
	
	function checkUploadFileEmpty(){

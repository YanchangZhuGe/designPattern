...
/**监测系统传递页面参数修改代码 开始**/
	$(function(){
		var _u = "<%=contextPath%>/bpm/common/toProcessDashbordList.srq?isDone=0";
		var p_param = '';
		<%
		if(!("".equals(_p_p))){
		%>
...
<body>
	<div id="tag-container_3">
		<ul id="tags" class="tags">
			<li class="selectTag" id="tag3_0"><a id="0" href="####" onclick="getTab3(0)">待办事宜</a></li>
			<li id="tag3_1"><a id="0" href="####" onclick="getTab3(1)">我的流程</a></li>
	   <!-- <li id="tag3_2"><a id="0" href="#" onclick="getTab3(2)">任务</a></li>
			<li id="tag3_3"><a id="0" href="#" onclick="getTab3(3)">提醒</a></li>
			<li id="tag3_4"><a id="0" href="#" onclick="getTab3(4)">我的问题</a></li> -->
		</ul>
	</div>
	<div id="tab_box" class="tab_box" style="overflow-y:hidden">
		<div id="tab_box_content0" class="tab_box_content" style="overflow-y:hidden">
			<iframe width="100%" height="100%" name="wfPic" id="wfPic" frameborder="0"  marginheight="0" marginwidth="0"  scrolling="no"></iframe>
		</div>
		<div id="tab_box_content1" class="tab_box_content"  style="display:none;overflow-y:hidden">
			<iframe width="100%" height="100%" name="wfOldPic" id="wfOldPic" frameborder="0" src="" marginheight="0" marginwidth="0"  scrolling="no"></iframe>
		</div>
		<div id="tab_box_content2" class="tab_box_content"  style="display:none;overflow-y:hidden"></div>

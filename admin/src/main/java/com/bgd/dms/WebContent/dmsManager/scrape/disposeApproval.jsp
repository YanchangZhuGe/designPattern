...
var dispose_apply_id='<%=dispose_apply_id%>';
	function pass(){
			var form = document.getElementById("CheckForm");
...
<div id="tab_box_content1" class="tab_box_content" style="display:none;height: 530px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/scrape/disposeApplyListForProc.jsp<%=linkParaStr%>'> </iframe>
</div>

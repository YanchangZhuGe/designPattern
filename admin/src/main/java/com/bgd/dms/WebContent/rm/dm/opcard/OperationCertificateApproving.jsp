...
<body style="background: #cdddef; overflow-y: auto" onload="get_time()"> 
	<form name="form" id="form" method="post" enctype="multipart/form-data" action="<%=contextPath%>/rm/dm/opcard/saveOrUdateOp_cardApproving.srq?flag=add">
	<div id="list_content">
						...
						<tr>
							<td>
										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													<span class="kb"><a href="####"></a></span>审验时间： <span id="apply_date1"></span><input type="hidden" id="apply_date" name="apply_date"/>
														&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;审验单位 :<span id="org_name01"><%=org_name %></span>
								...
								<input id="dev_type_id" name="dev_type_id" class="" type="hidden" /></td>
														...
														<td class="bt_info_even" ><input name="train_content"/></td>
...
var noimg='';
	//关闭操作
	function toClose(){
		window.location.href='<%=contextPath %>/rm/dm/opcard/OperationCardApprovingList.jsp';	
	}
	//提交方法
	function toSubmit(){
	if($('#dev_model').val()==''){

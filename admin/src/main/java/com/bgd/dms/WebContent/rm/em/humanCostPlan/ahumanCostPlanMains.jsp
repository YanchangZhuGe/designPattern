...
//	cruConfig.funcCode = "F_HUMAN_003";
	...
	function loadDataDetail(ids){ 
  	  processNecessaryInfo={         
  		...
  		loadProcessHistoryInfo(); 
  	document.getElementById("mainF").src = "<%=contextPath%>/rm/em/singleHuman/humanCostPlan/add_costPlanModify.jsp?buttionN=0&planId="+ids.split("-")[1]; 

...
<table border="0" cellpadding="0" cellspacing="0" id="lineTable" class="form_info" width="100%" style="margin-top:-1px;">
    <tr class="odd">
      ...
      <td class="inquire_form_dynamic1">本月新增<br>(万元)</td>
	...
	String carryovey_dollar01 = "";
   	if(list0!=null){
   		for(int i=0;i<list0.size();i++){
   			...
   			if(i==0){
   				 income_id00 = map.get("incomeId").toString();
   				...
   				new_sign01 = map.get("newSign").toString();
   				 income_id01 = map.get("incomeId").toString();
    ...
    <tr class="even">
      ...
      <td><input name="income_id00" value="<%=income_id00 %>" type="hidden"/>
      <input name="country00" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign00" value="<%=new_sign00 %>" size="8" readonly/></td>
      <td><input name="carryover00" value="<%=carryover00 %>" size="8" readonly/></td> 
      <td><input name="new_get00" value="<%=new_get00 %>" size="8" readonly/></td>
      <td><input name="carryout00" value="<%=carryout00 %>" size="8" readonly/></td> 
      <td><input name="income_id01" value="<%=income_id01 %>" type="hidden"/>
      <input name="country01" value="2" type="hidden"/>国际</td>
            <td><input name="new_sign01" value="<%=new_sign01 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar01" value="<%=carryovey_dollar01 %>"  size="8" readonly/></td> 
      <td><input name="carryover01" value="<%=carryover01 %>"  size="8" readonly/></td> 
      <td><input name="new_get_dollar01" value="<%=new_get_dollar01 %>"  size="8" readonly/></td> 
      <td><input name="new_get01" value="<%=new_get01 %>" size="8" readonly/></td>
      <td><input name="carryout_dollar01" value="<%=carryout_dollar01 %>" size="8"  readonly/></td>
      <td><input name="carryout01" value="<%=carryout01 %>" size="8"  readonly/></td> 
    </tr>	   
   <%		
   String new_sign10 = "";
	String income_id10="";
   ...
   if(list1!=null){
   		for(int i=0;i<list1.size();i++){
   			...
   			if(i==0){
   				income_id10 = map.get("incomeId").toString();
   				...
   				income_id11 = map.get("incomeId").toString();
	...
	<tr class="odd">
      ...
      <td><input name="income_id10" value="<%=income_id10 %>" type="hidden"/><input name="country10" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign10" value="<%=new_sign10 %>" size="8" readonly/></td>
      <td><input name="carryover10"  value="<%=carryover10 %>"  size="8" readonly/></td> 
      <td><input name="new_get10"  value="<%=new_get10 %>"  size="8" readonly/></td>
      <td><input name="carryout10"  value="<%=carryout10 %>"  size="8" readonly/></td> 
      <td><input name="income_id11" value="<%=income_id11 %>" type="hidden"/><input name="country11" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign11" value="<%=new_sign11 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar11" value="<%=carryovey_dollar11 %>"  size="8" readonly/></td>
      <td><input name="carryover11" value="<%=carryover11 %>"  size="8" readonly/></td> 
      <td><input name="new_get_dollar11"  value="<%=new_get_dollar11 %>" size="8" readonly/></td> 
      <td><input name="new_get11"  value="<%=new_get11 %>"  size="8" readonly/></td>
      <td><input name="carryout_dollar11" value="<%=carryout_dollar11 %>" size="8"  readonly/></td>
      <td><input name="carryout11" value="<%=carryout11 %>" size="8"  readonly/></td> 
    </tr>	
    <%	
    String new_sign20 = "";
    String income_id20="";
    ...
    if(list2!=null){
   		for(int i=0;i<list2.size();i++){
   			...
   			if(i==0){
   				income_id20 = map.get("incomeId").toString();
   				...
   				income_id21 = map.get("incomeId").toString();
    ...
    <tr class="even">
      ...
      <td><input name="income_id20" value="<%=income_id20 %>" type="hidden"/><input name="country20" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign20" value="<%=new_sign20 %>" size="8" readonly/></td>
      <td><input name="carryover20"  value="<%=carryover20 %>"  size="8" readonly/></td> 
      <td><input name="new_get20" value="<%=new_get20 %>"  size="8"  readonly/></td>
      <td><input name="carryout20"  value="<%=carryout20 %>"  size="8" readonly/></td> 
      <td><input name="income_id21" value="<%=income_id21 %>" type="hidden"/><input name="country21" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign21" value="<%=new_sign21 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar21" value="<%=carryovey_dollar21 %>"  size="8" readonly/></td>
      <td><input name="carryover21"  value="<%=carryover21 %>" size="8" readonly/></td> 
      <td><input name="new_get_dollar21"  value="<%=new_get_dollar21 %>" size="8" readonly/></td> 
      <td><input name="new_get21" value="<%=new_get21 %>"   size="8" readonly/></td>
      <td><input name="carryout_dollar21" value="<%=carryout_dollar21 %>" size="8"  readonly/></td>
      <td><input name="carryout21" value="<%=carryout21 %>" size="8"  readonly/></td> 
    </tr>	
    <%	
    String new_sign30 = "";
    String income_id30="";
    ...
    if(list3!=null){
   		for(int i=0;i<list3.size();i++){
   			...
   			if(i==0){
   				income_id30 = map.get("incomeId").toString();
   				...
   				income_id31 = map.get("incomeId").toString();
    ...
    <tr class="odd">
      ...
      <td><input name="income_id30" value="<%=income_id30 %>" type="hidden"/><input name="country30" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign30" value="<%=new_sign30 %>" size="8" readonly/></td>
      <td><input name="carryover30"  value="<%=carryover30 %>" size="8"  readonly/></td> 
      <td><input name="new_get30"  value="<%=new_get30 %>"  size="8" readonly/></td>
      <td><input name="carryout30"  value="<%=carryout30 %>"  size="8" readonly/></td> 
      <td><input name="income_id31" value="<%=income_id31 %>" type="hidden"/><input name="country31" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign31" value="<%=new_sign31 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar31" value="<%=carryovey_dollar31 %>"  size="8" readonly/></td>
      <td><input name="carryover31" value="<%=carryover31 %>"  size="8" readonly/></td> 
      <td><input name="new_get_dollar31"  value="<%=new_get_dollar31 %>" size="8" readonly/></td> 
      <td><input name="new_get31" value="<%=new_get31 %>"  size="8"  readonly/></td>
      <td><input name="carryout_dollar31" value="<%=carryout_dollar31 %>" size="8"  readonly/></td>
      <td><input name="carryout31" value="<%=carryout31 %>" size="8"  readonly/></td> 
    </tr>	
    <%	
    String new_sign40 = "";
    String income_id40="";
    ...
    if(list4!=null){
   		for(int i=0;i<list4.size();i++){
   			...
   			if(i==0){
   				income_id40 = map.get("incomeId").toString();
   				...
   				income_id41 = map.get("incomeId").toString();
    ...
    <tr class="even">
      ...
      <td><input name="income_id40" value="<%=income_id40 %>" type="hidden"/><input name="country40" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign40" value="<%=new_sign40 %>" size="8" readonly/></td>
      <td><input name="carryover40"  value="<%=carryover40 %>"  size="8" readonly/></td> 
      <td><input name="new_get40" value="<%=new_get40 %>"  size="8"  readonly/></td>
      <td><input name="carryout40"  value="<%=carryout40 %>"  size="8" readonly/></td> 
      <td><input name="income_id41" value="<%=income_id41 %>" type="hidden"/><input name="country41" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign41" value="<%=new_sign41 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar41" value="<%=carryovey_dollar41 %>"  size="8" readonly/></td>
      <td><input name="carryover41"  value="<%=carryover41 %>" size="8" readonly/></td> 
      <td><input name="new_get_dollar41" value="<%=new_get_dollar41 %>"  size="8" readonly/></td> 
      <td><input name="new_get41" value="<%=new_get41 %>"  size="8"  readonly/></td>
      <td><input name="carryout_dollar41" value="<%=carryout_dollar41 %>" size="8"  readonly/></td>
      <td><input name="carryout41" value="<%=carryout41 %>" size="8"  readonly/></td> 
    </tr>	
    <%	
    String new_sign50 = "";
    String income_id50="";
    ...
    if(list5!=null){
   		for(int i=0;i<list5.size();i++){
   			...
   			if(i==0){
   				income_id50 = map.get("incomeId").toString();
   				...
   				income_id51 = map.get("incomeId").toString();
    ...
    <tr class="odd">
      ...
      <td><input name="income_id50" value="<%=income_id50 %>" type="hidden"/><input name="country50" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign50" value="<%=new_sign50 %>" size="8" readonly/></td>
      <td><input name="carryover50"  value="<%=carryover50 %>"  size="8" readonly/></td> 
      <td><input name="new_get50"  value="<%=new_get50 %>" size="8"  readonly/></td>
      <td><input name="carryout50"  value="<%=carryout50 %>"  size="8" readonly/></td> 
      <td><input name="income_id51" value="<%=income_id51 %>" type="hidden"/><input name="country51" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign51" value="<%=new_sign51 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar51" value="<%=carryovey_dollar51 %>"  size="8" readonly/></td>
      <td><input name="carryover51"  value="<%=carryover51 %>" size="8" readonly/></td> 
      <td><input name="new_get_dollar51" value="<%=new_get_dollar51 %>"  size="8" readonly/></td> 
      <td><input name="new_get51" value="<%=new_get51 %>"  size="8"  readonly/></td>
      <td><input name="carryout_dollar51" value="<%=carryout_dollar51 %>" size="8"  readonly/></td>
      <td><input name="carryout51" value="<%=carryout51 %>" size="8"  readonly/></td> 
    </tr>
    <%	
    String new_sign60 = "";
    String income_id60="";
    ...
    if(list6!=null){
   		for(int i=0;i<list6.size();i++){
   			...
   			if(i==0){
   				income_id60 = map.get("incomeId").toString();
   				...
   				income_id61 = map.get("incomeId").toString();
    ...
    <tr class="even">
      ...
      <td><input name="income_id60" value="<%=income_id60 %>" type="hidden"/><input name="country60" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign60" value="<%=new_sign60 %>" size="8" readonly/></td>
      <td><input name="carryover60"  value="<%=carryover60 %>"  size="8" readonly/></td> 
      <td><input name="new_get60"  value="<%=new_get60 %>" size="8"  readonly/></td>
      <td><input name="carryout60"  value="<%=carryout60 %>" size="8"  readonly/></td> 
      <td><input name="income_id61" value="<%=income_id61 %>" type="hidden"/><input name="country61" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign61" value="<%=new_sign61 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar61" value="<%=carryovey_dollar61 %>"  size="8" readonly/></td>
      <td><input name="carryover61" value="<%=carryover61 %>"  size="8" readonly/></td> 
      <td><input name="new_get_dollar61"  value="<%=new_get_dollar61 %>" size="8" readonly/></td> 
      <td><input name="new_get61"  value="<%=new_get61 %>" size="8"  readonly/></td>
      <td><input name="carryout_dollar61" value="<%=carryout_dollar61 %>" size="8"  readonly/></td>
      <td><input name="carryout61" value="<%=carryout61 %>" size="8"  readonly/></td> 
    </tr>	 
    <%	
    String new_sign70 = "";
    String income_id70="";
    ...
    if(list7!=null){
   		for(int i=0;i<list7.size();i++){
   			...
   			if(i==0){
   				income_id70 = map.get("incomeId").toString();
   				...
   				income_id71 = map.get("incomeId").toString();
      ...
      <td><input name="income_id70" value="<%=income_id70 %>" type="hidden"/><input name="country70" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign70" value="<%=new_sign70 %>" size="8" readonly/></td>
      <td><input name="carryover70" value="<%=carryover70 %>"  size="8"  readonly/></td> 
      <td><input name="new_get70"  value="<%=new_get70 %>"  size="8" readonly/></td>
      <td><input name="carryout70"  value="<%=carryout70 %>" size="8"  readonly/></td> 
      <td><input name="income_id71" value="<%=income_id71 %>" type="hidden"/><input name="country71" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign71" value="<%=new_sign71 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar71" value="<%=carryovey_dollar71 %>"  size="8" readonly/></td>
      <td><input name="carryover71" value="<%=carryover71 %>"  size="8" readonly/></td> 
      <td><input name="new_get_dollar71" value="<%=new_get_dollar71 %>"  size="8" readonly/></td> 
      <td><input name="new_get71" value="<%=new_get71 %>"  size="8"  readonly/></td>
      <td><input name="carryout_dollar71" value="<%=carryout_dollar71 %>" size="8"  readonly/></td>
      <td><input name="carryout71" value="<%=carryout71 %>" size="8"  readonly/></td> 
    </tr>
    <%	
    String new_sign80 = "";
    String income_id80="";
    ...
    if(list8!=null){
   		for(int i=0;i<list8.size();i++){
   			...
   			if(i==0){
   				income_id80 = map.get("incomeId").toString();
   				...
   				income_id81 = map.get("incomeId").toString();
    ...
    <tr class="even">
      ...
      <td><input name="income_id80" value="<%=income_id80 %>" type="hidden"/><input name="country80" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign80" value="<%=new_sign80 %>" size="8" readonly/></td>
      <td><input name="carryover80" value="<%=carryover80 %>" size="8"  readonly/></td> 
      <td><input name="new_get80" value="<%=new_get80 %>"  size="8"  readonly/></td>
      <td><input name="carryout80"  value="<%=carryout80 %>" size="8"  readonly/></td> 
      <td><input name="income_id81" value="<%=income_id81 %>" type="hidden"/><input name="country81" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign81" value="<%=new_sign81 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar81" value="<%=carryovey_dollar81 %>"  size="8" readonly/></td>
      <td><input name="carryover81" value="<%=carryover81 %>"  size="8" readonly/></td> 
      <td><input name="new_get_dollar81" value="<%=new_get_dollar81 %>"  size="8" readonly/></td> 
      <td><input name="new_get81" value="<%=new_get81 %>"  size="8"  readonly/></td>
      <td><input name="carryout_dollar81" value="<%=carryout_dollar81 %>" size="8"  readonly/></td>
      <td><input name="carryout81" value="<%=carryout81 %>" size="8"  readonly/></td> 
    </tr>	
    <%	
    String new_sign90 = "";
    String income_id90="";
    ...
    if(list9!=null){
   		for(int i=0;i<list9.size();i++){
   			...
   			if(i==0){
   				income_id90 = map.get("incomeId").toString();
   				...
   				income_id91 = map.get("incomeId").toString();
    ...
    <tr class="odd">
      ...
      <td><input name="income_id90" value="<%=income_id90 %>" type="hidden"/><input name="country90" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign90" value="<%=new_sign90 %>" size="8" readonly/></td>
      <td><input name="carryover90" value="<%=carryover90 %>"  size="8"  readonly/></td> 
      <td><input name="new_get90"  value="<%=new_get90 %>"  size="8" readonly/></td>
      <td><input name="carryout90"  value="<%=carryout90 %>"  size="8" readonly/></td> 
      <td><input name="income_id91" value="<%=income_id91 %>" type="hidden"/><input name="country91" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign91" value="<%=new_sign91 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar91" value="<%=carryovey_dollar91 %>"  size="8" readonly/></td>
      <td><input name="carryover91" value="<%=carryover91 %>"  size="8" readonly/></td> 
      <td><input name="new_get_dollar91" value="<%=new_get_dollar91 %>"  size="8" readonly/></td> 
      <td><input name="new_get91"  value="<%=new_get91 %>" size="8"  readonly/></td>
      <td><input name="carryout_dollar91" value="<%=carryout_dollar91 %>" size="8"  readonly/></td>
      <td><input name="carryout91" value="<%=carryout91 %>" size="8"  readonly/></td> 
    </tr>
    <%	
    String new_sign100 = "";
    String income_id100="";
    ...
    if(list10!=null){
   		for(int i=0;i<list10.size();i++){
   			...
   			if(i==0){
   				income_id100 = map.get("incomeId").toString();
   				...
   				income_id101 = map.get("incomeId").toString();
    ...
    <tr class="even">
      ...
      <td><input name="income_id100" value="<%=income_id100 %>" type="hidden"/><input name="country100" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign100" value="<%=new_sign100 %>" size="8" readonly/></td>
      <td><input name="carryover100"  value="<%=carryover100 %>"  size="8" readonly/></td> 
      <td><input name="new_get100" value="<%=new_get100 %>"  size="8"  readonly/></td>
      <td><input name="carryout100"  value="<%=carryout100 %>"  size="8" readonly/></td> 
      <td><input name="income_id101" value="<%=income_id101 %>" type="hidden"/><input name="country101" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign101" value="<%=new_sign101 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar101" value="<%=carryovey_dollar101 %>"  size="8" readonly/></td>
      <td><input name="carryover101" value="<%=carryover101 %>"  size="8" readonly/></td> 
      <td><input name="new_get_dollar101"  value="<%=new_get_dollar101 %>" size="8" readonly/></td> 
      <td><input name="new_get101"  value="<%=new_get101 %>" size="8"  readonly/></td>
      <td><input name="carryout_dollar101" value="<%=carryout_dollar101 %>" size="8"  readonly/></td>
      <td><input name="carryout101" value="<%=carryout101 %>" size="8"  readonly/></td> 
    </tr>
    <%	
    String new_sign110 = "";
    String income_id110="";
    ...
    if(list11!=null){
   		for(int i=0;i<list11.size();i++){
   			...
   			if(i==0){
   				income_id110 = map.get("incomeId").toString();
   				...
   				income_id111 = map.get("incomeId").toString();
    ...
    <tr class="odd">
      ...
      <td><input name="income_id110" value="<%=income_id110 %>" type="hidden"/><input name="country110" value="1" type="hidden"/>国内</td>
      <td><input name="new_sign110" value="<%=new_sign110 %>" size="8" readonly/></td>
      <td><input name="carryover110"  value="<%=carryover110 %>"  size="8" readonly/></td> 
      <td><input name="new_get110"  value="<%=new_get110 %>"  size="8" readonly/></td>
      <td><input name="carryout110"  value="<%=carryout110 %>"  size="8" readonly/></td> 
      <td><input name="income_id111" value="<%=income_id111 %>" type="hidden"/><input name="country111" value="2" type="hidden"/>国际</td>
      <td><input name="new_sign111" value="<%=new_sign111 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar111"  value="<%=carryovey_dollar111 %>" size="8" readonly/></td>
      <td><input name="carryover111"  value="<%=carryover111 %>" size="8" readonly/></td> 
      <td><input name="new_get_dollar111" value="<%=new_get_dollar111 %>"  size="8" readonly/></td> 
      <td><input name="new_get111"  value="<%=new_get111 %>"  size="8" readonly/></td>
      <td><input name="carryout_dollar111" value="<%=carryout_dollar111 %>" size="8"  readonly/></td>
      <td><input name="carryout111" value="<%=carryout111 %>" size="8"  readonly/></td> 
    </tr>
     <%	
    String new_sign120 = "";
    String new_get120 = "";
    ...
    <tr class="even">
      ...
      <input name="country120" value="1" type="hidden"/>国内</td>
       <td><input name="new_sign120" value="<%=new_sign120 %>" size="8" readonly/></td>
      <td><input name="carryover120"  value="<%=carryover120 %>"  size="8" readonly/></td> 
      <td><input name="new_get120"  value="<%=new_get120 %>"  size="8" readonly/></td>
      <td><input name="carryout120"  value="<%=carryout120 %>"  size="8" readonly/></td> 
      <td><input name="income_id121" value="" type="hidden"/>
      <input name="country121" value="2" type="hidden"/>国际</td>
       <td><input name="new_sign121" value="<%=new_sign121 %>" size="8" readonly/></td>
      <td><input name="carryovey_dollar121"  value="<%=carryovey_dollar121 %>" size="8" readonly/></td>
      <td><input name="carryover121"  value="<%=carryover121 %>" size="8" readonly/></td> 
      <td><input name="new_get_dollar121" value="<%=new_get_dollar121 %>"  size="8" readonly/></td> 
      <td><input name="new_get121"  value="<%=new_get121 %>"  size="8" readonly/></td>
      <td><input name="carryout_dollar121" value="<%=carryout_dollar121 %>" size="8"  readonly/></td>
      <td><input name="carryout121" value="<%=carryout121 %>" size="8"  readonly/></td> 
    </tr>	
...
function cancel()
{
	window.location="<%=contextPath%>/market/incomeMonth/incomeReport.srq";
}
</script>
</html>

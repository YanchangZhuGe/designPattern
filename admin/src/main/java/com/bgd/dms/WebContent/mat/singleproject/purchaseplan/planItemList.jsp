...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
	<tr>
		<td class="bt_info_odd"
			exp="<input name = 'rdo_entity_id' id='rdo_entity_id' type='checkbox' value='{submite_number}' onclick='chooseOne(this);loadDataDetail();'/>">选择</td>
...
<script type="text/javascript">
	...
	function loadDataDetail(shuaId){
		...
		if(projectType=="5000100004000000008"){
			businessType = "5110000004100001073";
		}else{
			businessType = "5110000004100000047";
		}
		if(shuaId!= undefined){
			showTag(shuaId);
			taskShow(shuaId);
			processNecessaryInfo={
					...
					businessId: shuaId,
					businessInfo:"<%=projectName%>-自采购物资申请",
	...
	function toDelete(){
	 ...
	 function toAdd(){ 
			  ...
			  popWindow("<%=contextPath%>/mat/singleproject/purchaseplan/planAddItemList.jsp?taskObjectId="+taskObjectId+"&projectInfoNo="+projectInfoNo,'1024:800');
...
*/
    		 ...
    		 function AddExcelData(){
    		    	popWindow("<%=contextPath%>/mat/singleproject/purchaseplan/planExcelAddItemList.jsp?taskObjectId="+taskObjectId,'1024:800');
    		        }   

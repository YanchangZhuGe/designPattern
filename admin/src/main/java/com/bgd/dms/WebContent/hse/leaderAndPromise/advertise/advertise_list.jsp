...
<script type="text/javascript">
	...
	function refreshData(){
		...
		cruConfig.currentPageUrl = "/hse/leaderAndPromise/advertise/advertise_list.jsp";
		queryData(1);
	}
	...
	function toAdd(){
		popWindow("<%=contextPath%>/hse/leaderAndPromise/advertise/addAdvertise.jsp?isProject=<%=isProject%>");
	...
	function toEdit(){  
		var hse_advertise_id = document.getElementById("hse_advertise_id").value;
	  	...
	  	popWindow("<%=contextPath%>/hse/advertise/queryAdvertise.srq?isProject=<%=isProject%>&hse_advertise_id="+hse_advertise_id);
	} 
	...
	function toUpdate(){ 
		...
		form.action="<%=contextPath%>/hse/advertise/saveAdvertise.srq";
		form.submit();
	} 
	...
	function toSearch(){
		popWindow("<%=contextPath%>/hse/leaderAndPromise/advertise/advertise_search.jsp?isProject=<%=isProject%>");
	}

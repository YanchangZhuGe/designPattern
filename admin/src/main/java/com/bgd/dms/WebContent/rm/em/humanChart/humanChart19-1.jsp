...
<%
	...
	if(orgId==null || orgId.equals("")) orgId = user.getSubOrgIDofAffordOrg();
%>
...
<script type="text/javascript">
 ...
 function getFusionChart(){
		...
		myChart4.setXMLUrl("<%=contextPath%>/rm/em/getChart20.srq?orgId=<%=orgId%>");      
		//myChart4.setDataXML(url);

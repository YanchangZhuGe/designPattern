...
*/		
	...
	function dbclickRow(ids){
	    ...
	    var ids1 = idss[1];
	    var ids2 = idss[2];
		popWindow('<%=contextPath%>/pm/dailyReport/singleProject/viewDailyReport.jsp?daily_no='+ids1+'&project_info_no='+ids+'&produce_date='+ids2+'&orgSubjectionId=<%=orgSubjectionId%>&orgId=<%=orgId %>','1280:800');
	}

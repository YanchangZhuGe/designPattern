...
<script type="text/javascript">
	...
	function newSubmit() {
		...
		if(target_rent_id!=null && target_rent_id!=''){
			...
			"actual_start_date,actual_end_date,org_id,org_subjection_id,creator,create_date,updator,update_date,bsflag,if_change,dev_acc_id,spare1)"+
			...
			sql += "insert into bgp_op_tartet_device_depre(target_depre_id,project_info_no,dev_name,dev_model,dev_team,device_count,actual_start_date,"+
			"actual_end_date,org_id,org_subjection_id,creator,create_date,updator,update_date,bsflag,if_change,record_type,dev_acc_id,spare1)"+

...
$().ready(function(){
	...
	function addRows(value){
		...
		innerhtml += "<td width='3%'><input name='dev_name"+tr_id+"' id='dev_name"+tr_id+"' style='line-height:15px' value='' size='15' type='text' readonly /><img src='<%=contextPath%>/images/magnifier.gif' width='16' height='16' style='cursor:hand;' onclick='showDevCodePage("+tr_id+")' />";
		innerhtml += "</td>"
		innerhtml += "<td ><input name='dev_model"+tr_id+"' id='dev_model"+tr_id+"' value='' size='14'  type='text' readonly /></td>";
		innerhtml += "<td ><input name='dev_type"+tr_id+"' id='dev_type"+tr_id+"' value='' size='12' type='text' readonly/>";
		innerhtml += "<td ><input name='asset_value"+tr_id+"' id='asset_value"+tr_id+"' value='' size='11' type='text' readonly/></td>";
		innerhtml += "<td ><input name='scrape_date"+tr_id+"' id='scrape_date"+tr_id+"' value='' size='9' type='text' readonly/></td>";
		innerhtml += "<td ><input name='bak"+tr_id+"' id='bak"+tr_id+"' value='' size='9'  type='text' readonly /></td>";
		innerhtml += "</tr>";
...
function refreshData(){
	...
	if('<%=dispose_apply_id%>'!='null'){
		...
		for (var tr_id = 0; tr_id< baseData.datas.length; tr_id++) {
			...
			innerhtml += "</td>"
			innerhtml += "<td width='17%'><input name='dev_model"+tr_id+"' id='dev_model"+tr_id+"' value='"+baseData.datas[tr_id].dev_model+"' size='14'  type='text' readonly /></td>";
			innerhtml += "<td width='17%'><input name='dev_type"+tr_id+"' id='dev_type"+tr_id+"' value='"+baseData.datas[tr_id].dev_type+"' size='12' type='text' readonly/>";
			innerhtml += "<td ><input name='asset_value"+tr_id+"' id='asset_value"+tr_id+"' value='"+baseData.datas[tr_id].asset_value+"' size='11' type='text' readonly/></td>";

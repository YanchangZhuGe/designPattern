...
<script type="text/javascript">
	...
	function getTab3(index) {  
		...
		if(index==0){
			parent.bottomFrame.location.href = "<%=contextPath%>/hse/danCharts/hsePanel11.jsp";
		}else if(index==1){
			parent.bottomFrame.location.href = "<%=contextPath%>/hse/danCharts/hsePanel12.jsp";
		}else if(index==2){
			parent.bottomFrame.location.href = "<%=contextPath%>/hse/danCharts/hsePanel13.jsp";
		}
	}

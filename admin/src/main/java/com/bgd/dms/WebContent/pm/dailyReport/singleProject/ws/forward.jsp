...
location.href="<%=contextPath %>/pm/dailyReport/singleProject/ws/showWsTree.srq?projectInfoNo=<%=projectInfoNo %>&taskBackUrl=<%=taskBackUrl %>&customKey=<%=customKey %>&customValue=<%=customValue %>";
</script>
<body>
</body>
</html>
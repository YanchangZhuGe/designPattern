...
//	String projectInfoNo = user.getProjectInfoNo
	...
	String sql = "select project_name from gp_task_project where bsflag='0' and project_info_no='"+projectInfoNo+"'";
...
<!-- 多项目中计划编制，按钮未定   	    <auth:ListButton functionId="" css="xg" event="onclick='toEdit()'" title="JCDP_btn_edit"></auth:ListButton>
...
<script type="text/javascript">
	...
	function refreshData(){
	 ...
	 function toAdd(){ 
		  popWindow("<%=contextPath%>/mat/multiproject/plan/planAddItemList.jsp?taskObjectId="+tob[0].other1+"&projectInfoNo="+projectInfoNo,'1024:800');
    }  

      ...
      <fieldSet style="margin-left:2px"><legend>报废批复详细信息</legend>
	  	  ...
	  	  <div>
	  	  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  	  		<tr>
	  	  			<!-- <td class="ali_cdn_name">审批分类选择</td>
	  	  			<td class="ali_cdn_input">
	  	  				<select id="scrape_report_type" name="scrape_report_type">
	  	  			...
	  	  			<td>&nbsp;</td> -->
	  	  			<td align="right">
	  	  				<auth:ListButton functionId="" css="zj" event="onclick='toAddDevInfo()'" title="汇总单"></auth:ListButton>
			    	</td>
			    	<%-- <auth:ListButton functionId="" css="sc" event="onclick='toDeleteDevInfo()'" title="删除汇总单"></auth:ListButton> --%>
	  	  		</tr>
	  	  	</table>
	  	  </div>
...
//add by zzb
	...
	function refreshData(){
		...
		if('<%=scrape_report_id%>'!='null'){
			...
			$("#scrape_report_type").val(baseData.deviceappMap.scrape_report_type);
			//汇总附件
...
//删除文件
	...
	function fujian(i){
		...
		/* var sp_bak1=$("#sp_bak1"+i).val(); */
	 	window.showModalDialog("<%=contextPath%>/dmsManager/scrape/selectScrapeFileListCollect.jsp?org_name="+org_name,"","dialogWidth=1240px;dialogHeight=480px");
	}
</script>
</html>

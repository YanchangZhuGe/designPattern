...
String[][] infos = {
		  {"重点项目情况","/pm/wr/weekRaoPPT/weekPPTRunqianReport.jsp?reportFileName=wr/stressProject.raq&reportName=重点项目情况&rptParams="+rptParams},
		  {"本周VSP项目运行动态","/pm/wr/weekRaoPPT/weekPPTRunqianReport.jsp?reportFileName=wr/VspReport.raq&reportName=本周VSP项目运行动态&rptParams="+rptParams}
};
...
<div id="tagContent" style="float: left">
	<iframe name="tabIframe" src="" frameborder="0" width="1000px" height="1500px" scrolling="no" style="overflow-x:no;overflow-y:no;align:left"></iframe>
</div>

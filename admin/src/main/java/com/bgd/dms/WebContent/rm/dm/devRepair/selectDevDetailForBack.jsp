...
<script type="text/javascript" src="<%=contextPath%>/js/rt/rt_base.js"></script>
 ...
 <body style="background:#F1F2F3" onload="refreshData()">
      	...
      	<!-- 
			  ...
			  <table width="98%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			   ...
			   <table style="width: 98.5%" border="0" cellspacing="0"
				...
				<tr id='id_{id}' name='id'
					...
					<td class="bt_info_even" exp="{repair_form_no}">送内维修单号</td>
			...
			<div id="fenye_box"  style="display:block"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="fenye_box_table"></table>
			<!--
			 <table>
			  <tr>
...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model){
		var str = 
			...
			"                        SUB.ID as ID\n" + 
			"                   FROM (select t.*\n" + 
			"                           from GMS_DEVICE_COLL_REPAIR_SUB t\n" + 
			"                          where not exists\n" + 
			"                          (select 1\n" + 
			...
			"                    AND SUB.dev_status > 2 and sub.RETURN_FLG ='0'\n";

...
<script type="text/javascript">
	...
	function toDelete(){
	 ...
	 function toAdd(){ 
			  ...
			  popWindow("<%=contextPath%>/mat/singleproject/plan/planAddItemListDg.jsp?taskObjectId="+taskObjectId+"&projectInfoNo="+projectInfoNo,'1024:800');
...
*/
    		 ...
    		 function AddExcelData(){
    		    	popWindow("<%=contextPath%>/mat/singleproject/plan/planExcelAddItemListDg.jsp?taskObjectId="+taskObjectId,'1024:800');
    		        }   

  ...
  <div id="new_table_box_content">
    <div id="new_table_box_bg">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" style="margin-top: 10px;">
					  ...
					  <tr>
					    <td class="inquire_item6">宣贯次数：</td>
					    <td class="inquire_form6"><input type="text" id="times" name="times" onkeydown='javascript:return checkIfNum(event);' value="<%=(String)map.get("times") %>"  class="input_width" /></td>
					    <td class="inquire_item6">宣贯频次：</td>
					    <td class="inquire_form6">
					    	<select id="rate" name="rate" class="select_width">
...
document.getElementById("rate").value="<%=(String)map.get("rate")%>";

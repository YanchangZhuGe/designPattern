...
<%
	...
	if(("5000100004000000008").equals(projectType)){
		response.sendRedirect(contextPath+"/pm/dailyReport/multiProject/ws/wsReportList.jsp");
	}
	if(("5000100004000000009").equals(projectType)){
		response.sendRedirect(contextPath+"/pm/dailyReport/multiProject/wt/wtReportList.jsp");
	}
	if(("5000100004000000006").equals(projectType)){
		response.sendRedirect(contextPath+"/pm/dailyReport/multiProject/sh/reportList.jsp?projectType="+projectType);
	}
	if(orgSubjectionId!=null && orgSubjectionId.startsWith("C105007")){
...
*/		
	...
	function dbclickRow(ids){
	    ...
	    //改成待审批日报列表形式 reportListAuditDispatch.jsp
	  	popWindow('<%=contextPath%>/pm/dailyReport/multiProject/reportListAudit/reportListAuditDispatch.jsp?daily_no='+ids1+'&project_info_no='+ids+'&produce_date='+ids2+'&projectName='+projectName,'1280:800');

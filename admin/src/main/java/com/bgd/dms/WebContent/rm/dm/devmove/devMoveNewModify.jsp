...
<script type="text/javascript">
	...
	function refreshData(){
		...
		var proSql = "select t.dev_mov_id,t.dev_mov_no,t.out_project_info_id,t.in_project_info_id,t.dev_mov_name,";
			...
			proSql += "t.opertor_id,t.apply_date, case when t.out_project_info_id='"+projectInfoNos+"' then '转出' else '转入' end as mov_state,";
			...
			proSql += "left join common_busi_wf_middle wfmiddle on t.dev_mov_id=wfmiddle.business_id ";
			proSql += "where (t.out_project_info_id='"+projectInfoNos+"' or t.in_project_info_id='"+projectInfoNos+"') and t.bsflag='0' ";
			proSql += "and t.dev_mov_id='"+devMovId+"'";
		...
		if(devMovId!=null && devMovId!=''){
			...
			var devdetSql = "select dui.dev_coding,dui.dev_name,t.dev_acc_id,dui.dev_model,dui.self_num,dui.license_num,dui.dev_sign,dui.asset_coding,dui.actual_in_time,t.actual_out_time as planning_out_time "+
           					"from gms_device_move_detail t left join gms_device_account_dui dui on t.dev_acc_id = dui.dev_acc_id "+

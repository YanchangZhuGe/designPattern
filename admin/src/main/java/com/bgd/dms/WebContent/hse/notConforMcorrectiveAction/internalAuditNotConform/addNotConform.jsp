...
<%
	...
	String inter_no="";
	if(request.getParameter("inter_no") != null){
		inter_no=request.getParameter("inter_no");	
    ...
    <div id="new_table_box_bg">
				    ...
				    <tr>			 				   
					  ...
					  <tr>
					    ...
					    <td class="inquire_form6" colspan="5" align="center" ><textarea  style="width:450px;" id="close_content" name="close_content"   class="textarea" ></textarea>
					  ...
					  <tr>
					    ...
					    <td class="inquire_form6" colspan="5" align="center" ><textarea  style="width:450px;" id="requirements" name="requirements"   class="textarea" ></textarea></td>
					    <td class="inquire_item6"> </td> 
					  </tr>	
					</table>
				</div>
...
function checkText0(){
    ...
    if (!re.test(second_org))
   {
	...
	if(inter_no !=null){
		...
		querySql = "  select  tr.project_no,tr.org_sub_id,tr.inter_no,tr.not_conform_num,tr.completion_date,tr.verify_date,tr.validation_situation,tr.not_content,tr.requirements ,  tr.second_org,tr.third_org,ion.org_abbreviation as org_name,tr.creator,tr.create_date,tr.bsflag, tr.modifi_date, tr.updator,oi1.org_abbreviation as second_org_name,oi2.org_abbreviation as third_org_name from BGP_INTER_NOT_CONFORM tr    join comm_org_subjection os1   on tr.second_org = os1.org_subjection_id  and os1.bsflag = '0'  join comm_org_information oi1  on oi1.org_id = os1.org_id  and oi1.bsflag = '0'  left  join comm_org_subjection os2  on tr.third_org = os2.org_subjection_id  and os2.bsflag = '0' left  join comm_org_information oi2  on oi2.org_id = os2.org_id  and oi2.bsflag = '0'       left join comm_org_subjection ose    on tr.org_sub_id = ose.org_subjection_id   and ose.bsflag = '0'  join comm_org_information ion    on ion.org_id = ose.org_id  where tr.bsflag = '0' and tr.inter_no='"+inter_no+"'";				 	 

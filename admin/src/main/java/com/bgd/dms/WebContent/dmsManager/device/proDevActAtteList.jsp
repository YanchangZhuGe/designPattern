		...
		<div id="table_box">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
				<tr>
					...
					<td class="bt_info_odd" exp="{timesheet_date}">设备实际出勤日期</td>
				</tr>
			</table>
		</div>
		<div id="fenye_box">
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "queryProDevActAtteList";
	...
	function refreshData(){
		var temp = "devAccId="+devAccId+"&startDate="+startDate+"&endDate="+endDate;

    ...
    <div id="new_table_box_bg">
	  ...
	  <tr>
			...
			<td class="inquire_form6">
				...
				<input id="dev_in_time" name="dev_in_time" class="input_width"  type="hidden" readonly/>
			</td>
...
<%-- 			<auth:ListButton functionId="" css="jh" event="onclick='viewBY()'" title="查看详情"></auth:ListButton> --%>
			</td>
...
<script type="text/javascript"> 
	...
	function loadDataDetail(){
	   ...
	   var querySql ="select dui.actual_in_time,dui.dev_name,dui.dev_sign,dui.fk_dev_acc_id,dui.dev_model,dui.self_num,dui.license_num,dui.dev_coding from GMS_DEVICE_ACCOUNT_DUI dui  "
...
// 			$("#modify_date")[0].value=basedatas[0].modify_date;
			...
			$("#dev_in_time")[0].value=basedatas[0].actual_in_time;
	...
	function addrow(obj){
		...
		if(obj==undefined){
			newTd.innerHTML="<input type='text' name='by_date"+optnum+"' id='by_date"+optnum+"' value='' onpropertychange='checkEndDate("+optnum+");' readonly class='input_width' /><img src='<%=contextPath%>/images/calendar.gif' id='tributton"+optnum+"' width='16' height='16' style=cursor: hand ; onmouseover='calDateSelector(by_date"+optnum+",tributton"+optnum+")'; />";
		}else{
	...
	function checkEndDate(index){
		var startTime = $("#dev_in_time").val();
		var returnTime = $("#by_date"+index).val();

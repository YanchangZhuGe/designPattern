...
<div id="tab_box_content1" class="tab_box_content" style="display:none;height: 530px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/zengzhi/zengzhiApplyForProc.jsp<%=linkParaStr%>'> </iframe>
</div>

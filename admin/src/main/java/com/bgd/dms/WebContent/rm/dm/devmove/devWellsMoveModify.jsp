      ...
      <table border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr>
          ...
          <td class="inquire_form4" >
          	<input name="output_name" id="output_name" class="input_width" type="text" value=""  readonly/>
          	<input name="outProjectInfoNo" id="outProjectInfoNo" class="input_width" type="hidden" onpropertychange="clearDevList();" value=""/>
...
<script type="text/javascript">
	...
	function submitInfo(){
		...
		if(confirm("确认提交？")){
			document.getElementById("form1").action = "<%=contextPath%>/rm/dm/devmove/wellsDevMoveNewApply.srq?count="+count+"&idinfos="+idinfos+"&enddateinfo="+enddateinfo;

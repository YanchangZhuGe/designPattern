...
<%
	...
	String illegal_no="";
	if(request.getParameter("illegal_no") != null){
		illegal_no=request.getParameter("illegal_no");	
...
<body  onload="queryOrg();getHazardCenter(); listInfo();exitSelect()" >
    ...
    <div id="new_table_box_bg">
				    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" >					
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" >	
					    ...
					    <td class="inquire_form6"  align="center" ><textarea  style="width:450px;height:60px;" id="lllegal_description" name="lllegal_description"   class="textarea" ></textarea></td>
					    <td class="inquire_form6"> </td> 
					  </tr>	
					  <tr>
					    <td class="inquire_item6">纠正措施：</td> 					   
					    <td class="inquire_form6"  align="center" ><textarea  style="width:450px;height:60px;" id="corrective_measures" name="corrective_measures"   class="textarea" ></textarea></td>
					    <td class="inquire_form6"> </td> 		

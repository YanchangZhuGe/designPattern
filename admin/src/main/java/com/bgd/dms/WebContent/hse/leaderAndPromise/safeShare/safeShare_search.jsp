...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		if(safe_name!=''&&safe_name!=null){
			sql = sql+" and t.safe_name like '%"+safe_name+"%'";
		}
		if(safe_type!=''&&safe_type!=null){
			sql = sql+" and t.safe_type = '"+safe_type+"'";
		}
		if(safe_date!=''&&safe_date!=null){
			sql = sql+" and t.safe_date = to_date('"+safe_date+"','yyyy-MM-dd')";
		}
    ...
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
	          	...
	          	<td class="inquire_form6"><input type="text" id="safe_name" name="safe_name" value=""></input></td>
				<td class="inquire_item6">安全经验类别：</td>
				<td class="inquire_form6">
				...
				<td class="inquire_item6">发表时间：</td>
				<td class="inquire_form6"><input type="text" id="safe_date" name="safe_date" class="input_width" value="" readonly="readonly"/>
					&nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton1" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(safe_date,tributton1);" />&nbsp;</td>
			</tr>
      </table>

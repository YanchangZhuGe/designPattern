...
<%
	...
	String collMixFlag = rb.getString("CollMixFlag");
%>
...
<div id="new_table_box">
  <div id="new_table_box_content">
    <div id="new_table_box_bg">
      ...
      <fieldset style="margin:2px;margin-top:4px;padding:2px;"><legend>调配申请基本信息(采集设备)</legend>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		if('<%=deviceappid%>'!=null){
			//查询基本信息
			var querySql = "select pro.project_name,devapp.device_app_id,devapp.device_allapp_id,devapp.device_app_no,devapp.device_app_name,devapp.project_info_no,allapp.appdate as allappdate,";
				...
				%>
					querySql += "case devapp.state when '0' then '未提交' when '9' then '已提交' else '未知状态' end as state_desc,";
				<% 
					}
				%>
				querySql += "org.org_abbreviation as org_name,emp.employee_name,allapp.device_allapp_name,allapp.device_allapp_no ";
						
				querySql += "from gms_device_collapp devapp ";

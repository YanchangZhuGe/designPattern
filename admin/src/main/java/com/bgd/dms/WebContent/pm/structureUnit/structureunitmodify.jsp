...
var ids = "<%=id%>";
	...
	function loadData(){
		...
		document.getElementById("structUnitName").value = retObj.stuctureUnit.struct_unit_name;
		jsSelectOption("structUnitLevel",retObj.stuctureUnit.struct_unit_level);
		document.getElementById("structUnitParent").value = retObj.stuctureUnit.struct_unit_parent;
		document.getElementById("structUnitNo1").value = retObj.stuctureUnit.struct_unit_parent_no;
		document.getElementById("basin").value = retObj.stuctureUnit.basin;
		
		jsSelectOption("divideDate",retObj.stuctureUnit.divide_date);
		document.getElementById("regionName").value = retObj.stuctureUnit.region_name;
		document.getElementById("notes").value = retObj.stuctureUnit.notes;
		document.getElementById("structUnitId").value = retObj.stuctureUnit.struct_unit_id;
		document.getElementById("structUnitArea").value = retObj.stuctureUnit.struct_unit_area;
		document.getElementById("divideUnit").value = retObj.stuctureUnit.divide_unit;
	}
...
<table  border="0" cellpadding="0" cellspacing="0" class="tab_line_height"  width="100%">
  <tr>
   ...
   <input name="structUnitNo" type="hiddern"　 value="<%=id%>" />
   <input name="structUnitName" type="text"　 value="" class="input_width" /></td>
   <td class="inquire_item4"><font color="red">*</font>&nbsp;构造单元级别：</td>
   <td class="inquire_form4"><select name="structUnitLevel" class="select_width" onchange="cleanupstructParent();">
  ...
  <tr>
    ...
    <td class="inquire_form4">
    	<input type="hidden" name="structUnitNo1" id="structUnitNo1" />
	    <input type="text" name="structUnitParent" class="input_width" id="structUnitParent"  readOnly/>&nbsp;&nbsp;<img src="<%=contextPath%>/images/magnifier.gif" style="cursor:hand;" onclick="choosestructParent();"/>
    </td>
  ...
  <tr>
    ...
    <td class="inquire_form4">
    <select name="divideDate" class="select_width">
	    <%
	    Date date = new Date();
  ...
  <tr>
    ...
    <td class="inquire_form4"><input id="structUnitId" name="structUnitId" type="text" value="" class="input_width" />
    </td>
   	<td class="inquire_item4">构造单元面积：</td>
   	<td class="inquire_form4"><input id="structUnitArea" name="structUnitArea" type="text" value="" class="input_width" /> km&sup2
    </td>
  </tr>
  <tr> 
  	<td class="inquire_item4">划分单位：</td>
   	<td class="inquire_form4"><input id="divideUnit" name="divideUnit" type="text" value="" class="input_width" />
    </td> 
 ...
 <div id="oper_div">
     	<span class="tj_btn"><a href="#" onclick="saveStructureUnit()"></a></span>

      	...
      	<div id="list_table">
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			        <td class="bt_info_odd" exp="<input name = 'rdo_entity_name' id='rdo_entity_id' type='checkbox' value='{submite_number}' onclick='loadDataDetail();chooseOne(this)'/>" >选择</td>
					...
					<td class="bt_info_odd" exp="{create_date}">日期</td>
...
<script type="text/javascript">
	...
	function refreshData(){
		var sql ='';
		sql +="select t.submite_number,t.submite_id,u.user_name,o.org_name,d.coding_name,decode(t.if_submit,'1','已提交') if_submit,t.create_date from gms_mat_demand_plan_bz t inner join comm_org_information o on t.org_id=o.org_id and o.bsflag='0' inner join p_auth_user u on t.creator_id=u.user_id left join comm_coding_sort_detail d on t.s_apply_team=d.coding_code_id and d.bsflag='0'  where t.bsflag='0'and t.project_info_no='<%=projectInfoNo%>' and t.if_submit='1'and t.s_apply_team='"+teamId+"' order by t.create_date desc";

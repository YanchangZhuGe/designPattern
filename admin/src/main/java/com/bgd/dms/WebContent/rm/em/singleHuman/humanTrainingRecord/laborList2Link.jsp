...
function page_init(){
	...
	cdt_init();
	cruConfig.queryStr = "     select lt.list_id,        l.labor_id,        l.employee_name,        l.employee_gender,        decode(l.employee_gender, '1', '男', '0', '女') employee_gender_name,        l.employee_id_code_no   from bgp_comm_human_labor l   left join bgp_comm_human_labor_list lt on l.labor_id = lt.labor_id and lt.bsflag='0'  where l.bsflag='0' and lt.list_id is null     ";
	cruConfig.currentPageUrl = "/rm/em/singleHuman/humanTrainingRecord/laborList2Link.jsp";
	queryData(1);
...
<table border="0"  cellspacing="0"  cellpadding="0"  class="form_info"  width="100%" id="queryRetTable">
	...
	<tr class="bt_info">
	    <td class="tableHeader" 	 exp="<input type='radio' name='chx_entity_id'  value='{employee_id_code_no}-{employee_name}-{employee_gender}' onclick=doCheck(this) />"></td>
		...
		<td class="tableHeader" 	 exp="{labor_id}"  isShow="TextHide" style="display:none">labor_id</td>
	</tr>

...
function save(){
	...
	form.action = "<%=contextPath%>/td/wt/toSaveConsSumDoc.srq?isSingle="+isSingle;
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if(""==document.getElementById("pk_0110000061100000012").value){
		if (!isTextPropertyNotNull("0110000061100000012", "施工总结报告")) return false;	
	}
...
function page_init(){
	...
	var retObj = jcdpCallService("WtProjectSrv", "getProjectOrgNames", "projectInfoNo=<%=projectInfoNo%>");
	if(null!=retObj.orgNameMap){
		document.getElementById("orgId").value =retObj.orgNameMap.org_name;
	}
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4">作业队伍：</td>
									<td class="inquire_form4" colspan="3"><input type="text" id="orgId" name="orgId" value="" class="input_width" readonly="readonly" disabled="disabled"/></td>
								</tr>
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>施工总结报告：</td>
									<td colspan="2">

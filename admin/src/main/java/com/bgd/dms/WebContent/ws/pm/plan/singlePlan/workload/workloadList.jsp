...
<body style="background:#fff">
      	<div id="list_table">
			...
			<div id="table_box">
			<form action="<%=contextPath%>/ws/pm/plan/singlePlan/workload/updateWorkload.srq" method="post"  id="form1">
...
<script type="text/javascript">
	...
	function toAdd(){
		...
		window.showModalDialog('<%=contextPath%>/wt/pm/planManager/singlePlan/planning/selectWorkload.jsp?codingSortId=7000',obj);

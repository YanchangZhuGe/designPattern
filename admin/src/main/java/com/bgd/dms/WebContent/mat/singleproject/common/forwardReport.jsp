...
<%
	...
	response.sendRedirect(contextPath+"/$bireport/dynamic/rpt/showReport?isRefreshCache=true&reportId="+reportId+"&noLogin=admin&tokenId=admin&KeyId="+projectInfoNo);
%>

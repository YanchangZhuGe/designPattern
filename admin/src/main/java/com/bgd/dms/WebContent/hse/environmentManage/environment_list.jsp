			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_odd" exp="{year}">年</td>
			      <td class="bt_info_even" exp="{month}">月</td>
			      <td class="bt_info_odd" exp="{status}">状态</td>
			      <td class="bt_info_even" exp="{submit_person}">提交人</td>
			      <td class="bt_info_odd" exp="{submit_date}">提交日期</td>
			    </tr>
			  </table>
			</div>
...
<script type="text/javascript">
	...
	function toSearch(){
		popWindow("<%=contextPath%>/hse/environmentManage/environment_search.jsp");
	}

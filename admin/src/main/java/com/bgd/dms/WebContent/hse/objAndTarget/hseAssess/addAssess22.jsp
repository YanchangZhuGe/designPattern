					...
					<td colspan="6">
						<table id="" width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="black" class="tab_line_height">
							...
							<tr>
								...
								<td class="inquire_form6" colspan="3"><textarea id="superior_suggest" name="superior_suggest" class="textarea" readonly="readonly"></textarea></td>
							</tr>
						</table>
					</td>
				</tr>		
...
toEdit();
document.getElementById("assess_sign").value="<%=user.getUserName() %>";
...
function submitButton(){
	...
	form.action="<%=contextPath%>/hse/assess/addAssessYuan.srq";
	form.submit();
}

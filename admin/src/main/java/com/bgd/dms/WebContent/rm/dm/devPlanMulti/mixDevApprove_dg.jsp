...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
  ...
  <title>多项目-计划审批-调剂设备申请-审批(大港)</title>
 </head>
...
<script type="text/javascript">
	...
	function refreshData(ids){
	    ...
	    <%
		 ...
		 %>
	    //cruConfig.currentPageUrl = "/bpm/common/toGetSelfProcessListDevDgMix.srq";
	    queryData(ids);
	...
	function loadDataDetail(ids){
        ...
        processNecessaryInfo={        							//流程引擎关键信息
        			...
        			businessInfo:"大港设备调剂配置计划审批列表信息<配置计划单名称:"+deviceAllAppName+">",
	...
	function toAudit(){
		...
		if(isdone==1){//已审批过
			...
			if(nodeLinkType!='1'){//公用审批页面
				...
				nodeLink=nodeLink+"&dgflag="+dgflag+"&deviceallappid="+device_allapp_id+"&taskinstId="+taskinstId+"&businessId="+businessId+"&examineinstID="+entityId+"&procinstID="+procinstId+"&businessType=<%=businessType%>&isDone="+isdone;
				window.showModalDialog(cruConfig.contextPath+nodeLink,window,"dialogWidth=900px;dialogHeight=600px")				
			}
		}		
	}

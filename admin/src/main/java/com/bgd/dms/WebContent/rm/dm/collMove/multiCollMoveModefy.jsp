      ...
      <table border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr>
          ...
          <td class="inquire_form4" >
          	<input name="output_name" id="output_name" class="input_width" type="text" value=""  style="color:#B0B0B0;" onpropertychange="clearDevList();" readonly/>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		var proSql = "select t.dev_mov_id,t.dev_mov_no,t.out_project_info_id,t.in_project_info_id,t.dev_mov_name,";
			...
			proSql += "from gms_device_move t left join gp_task_project outgp on t.out_project_info_id=outgp.project_info_no ";
			...
			proSql += "left join common_busi_wf_middle wfmiddle on t.dev_mov_id=wfmiddle.business_id where t.bsflag='0' and t.dev_mov_id='"+devMovId+"' ";		

...
<script type="text/javascript">
	...
	function refreshData(){
		...
		"t.upload_id,e.employee_name,t.upload_date,t.check_date,t.check_type,decode(t.check_type ,'0','待审核','1','审核通过','2','审核不通过','') check_type_name from bgp_doc_td_file_check t left join gp_task_project p on t.project_info_no=p.project_info_no left join comm_human_employee e on t.upload_id=e.employee_id  where t.bsflag='0' "+str+" and t.check_type is not null "+
		"and t.doc_type between '5110000058000000001' and '5110000058000000007' order by t.upload_date  desc  ) t where 1=1 ";

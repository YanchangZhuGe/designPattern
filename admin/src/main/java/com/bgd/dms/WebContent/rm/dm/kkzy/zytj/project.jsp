...
function getFusionChart(){
	var retObj1 = jcdpCallServiceCache("EarthquakeTeamStatistics","getProjectUse","args=<%=args%>");
...
function exportDataDoc(exportFlag){
	...
	var submitStr="";
    submitStr = "args=<%=args%>"+"&exportFlag="+exportFlag;
	...
	function popBJTYList(args){
		
		popWindow('<%=contextPath %>/rm/dm/kkzy/zytj/wz14TypeList.jsp?args='+args,'800:600');
										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													<span class="kb"><a href="#"></a></span><a href="#">震源消耗统计</a><span
														class="gd"><a href="#"></a></span> <span class="dc"
														style="float: right; margin-top: -4px;"> <a
														href="#" onclick="exportDataDoc('projectuse')" title="导出excel"></a>
													</span>
												</div>

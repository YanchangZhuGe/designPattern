...
function save(){
	...
	form.action = "<%=contextPath%>/td/wt/toSaveRockDoc.srq?businessType=<%=businessType%>&isSingle="+isSingle;
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if(""==document.getElementById("pk_0110000061100000049").value){
		if (!isTextPropertyNotNull("0110000061100000049", "岩石物性分析报告")) return false;	
	}
...
function page_init(){
	...
	if(fileId!='null'){
		var querySql = " select * from(select b.project_info_no,p.project_name,t.file_id,t.ucm_id,t.file_abbr,b.business_type,t.doc_file_type,t.file_name,b.tecnical_id,b.title,b.written_time,b.writer,b.test_start_date,b.test_end_date,b.auditor from gp_ws_tecnical_basic b left join gp_task_project p on b.project_info_no=p.project_info_no and p.bsflag='0' left join bgp_doc_gms_file t on  b.tecnical_id = t.relation_id and t.bsflag='0')m where m.tecnical_id ='"+fileId+"'";
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4">测定开始时间：</td>
									<td class="inquire_form4">
									...
									<td class="inquire_item4">测定结束时间：</td>
									<td class="inquire_form4">
								...
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>岩石物性分析报告：</td>
									<td colspan="2">
										<input type="hidden" id="pk_0110000061100000049" name="pk_0110000061100000049" value=""/>
										<input type="file" name="0110000061100000049" id="0110000061100000049" class="input_width"/>
					    				<div id="down_0110000061100000049"></div>
									</td>

...
<body   onload="queryOrg();queryOrgs();queryOrgss();">
  ...
  <div id="new_table_box_content" style="width:956px; height:565px;">
    <div id="new_table_box_bg"   style="width:937px; height:490px; ">
				    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" >			
				 	  ...
				 	  <tr > 
					    <td   align="center"> <font color=black size="4px">培训</font> 
					    <input type="radio" name="radioType" value="1" id="radioType1" onclick="radioValue()"/>
					    </td>
			 		    <td   align="center"><font color=black size="4px">演练</font> 
					    <input type="radio" name="radioType" value="2" id="radioType2" onclick="radioValue()"/>  		
					    </td>
					    <td   align="center"><font color=black size="4px">培训和演练</font> 
					    <input type="radio"  checked   name="radioType" value="3" id="radioType3" onclick="radioValue()"/>  		
					    </td>
					  </tr>		  
					</table>
					    ...
					    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" >					
						 ...
						 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" >	
						  <tr>
						    ...
						    <td class="inquire_form6" colspan="5" align="center" ><textarea  style="width:730px;" id="training_content" name="training_content"   class="textarea" ></textarea></td>
			 ...
			 <br>
					  ...
					  <tr>	
						  <td class="inquire_item6"><font color="red">*</font>演练时间：</td>
						    ...
						    <td class="inquire_item6">参加人员数量 ：</td>
						    <td class="inquire_form6">
	 ...
	 {  
		 if(l[i].checked)  
		 {
		 	 if(l[i].value =='1'){
		 		 ...
		 		 document.getElementById("oper_div2").style.display="none";
		 	 }
			 if(l[i].value =='2'){
			 ...
			 if(l[i].value =='3'){
		 		 ...
		 		 document.getElementById("oper_div2").style.display="block";
				 document.getElementById("type2").style.display="none";
		 		 document.getElementById("oper_div1").style.display="none";
		 		 document.getElementById("type1").style.display="none";
		 		 document.getElementById("oper_div").style.display="none";

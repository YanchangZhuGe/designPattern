...
<script language="javaScript">
	...
	//	window.location.href="<%= contextPath%>/hse/hseOptionPage/hseHiddenTwo/safeCheckCharts.jsp?second="+second+"&&third="+third+"&&fourth="+fourth+"&&check_date="+check_date+"&&check_dateA="+check_dateA;
		var myChart2 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Column2D.swf", "myChartId", "100%", "350", "0", "0" );  
		myChart2.setXMLUrl("<%=contextPath%>/hse/chart/queryHidden.srq?second_org="+second+"&&third_org="+third+"&&fourth_org="+fourth+"&&check_date="+check_date+"&&check_dateA="+check_dateA);   
		myChart2.render("chartContainer");	
		
		var myChart = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Column2D.swf", "myChartIdA", "100%", "300", "0", "0" );  
		myChart.setXMLUrl("<%=contextPath%>/hse/chart/queryHiddenA.srq?second_org="+second+"&&third_org="+third+"&&fourth_org="+fourth+"&&check_date="+check_date+"&&check_dateA="+check_dateA);   
		myChart.render("chartContainerA");	
		
		var myCharts = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Column2D.swf", "myChartIdC", "100%", "300", "0", "0" );  
		myCharts.setXMLUrl("<%=contextPath%>/hse/chart/queryHiddenC.srq?second_org="+second+"&&third_org="+third+"&&fourth_org="+fourth+"&&check_date="+check_date+"&&check_dateA="+check_dateA);   
		myCharts.render("chartContainerB");	
		
		var myCharts3 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/StackedColumn2D.swf", "myChartIdC", "100%", "350", "0", "0" );  
		myCharts3.setXMLUrl("<%=contextPath%>/hse/chart/queryHiddenD.srq?second_org="+second+"&&third_org="+third+"&&fourth_org="+fourth+"&&check_date="+check_date+"&&check_dateA="+check_dateA);   
		myCharts3.render("chartContainerC");	

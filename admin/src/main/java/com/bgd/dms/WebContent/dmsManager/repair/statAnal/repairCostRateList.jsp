		...
		<div id="table_box">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
				<tr>
					...
					<td class="bt_info_odd" exp="{repair_cost}">维修费用(元)</td>
					<td class="bt_info_even" exp="{asset_value}">设备原值(元)</td>
					<td class="bt_info_odd" exp="{repair_cost_rate}">费用率(%)</td>
				</tr>
			</table>
		</div>
		<div id="fenye_box">
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "queryRepairCostRateList";

										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">采集月度收入同比折线图</a><span class="gd"><a href="#"></a> </span>
												</div>
										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">国际/国内采集收入对比图</a><span class="gd"><a href="#"></a> </span>
												</div>
										...
										<td width="100%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">各物探处总采集收入对比图</a><span class="gd"><a href="#"></a> </span>
												</div>
...
<script type="text/javascript">
 function getFusionChart(){
	...
	myChart1.setXMLUrl("<%=contextPath%>/op/OpCostSrv/getCompanyIncomeInfo.srq");      
	myChart1.render("chartContainer1");  
	
	
	
	var myChart2 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/MSColumn3D.swf", "myChartId9", "100%", "100%", "0", "0" );    
	myChart2.setXMLUrl("<%=contextPath%>/op/OpCostSrv/getCompanyCompareCountryInfo.srq");      
	myChart2.render("chartContainer2");  
	
	
	 
	 var myChart3 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/MSColumn3D.swf", "myChartId4", "100%", "100%", "0", "0" );    
	myChart3.setXMLUrl("<%=contextPath%>/op/OpCostSrv/getCompanyCompareSectionInfo.srq");   
  ...
  function drillgssr(obj){
   ...
   function drillwtsr(obj){
	 	window.showModalDialog("<%=contextPath%>/op/costDashBoard/company4table.jsp",obj,"dialogWidth=800px;dialogHeight=600px");
 		}

    			...
    			<table  border="0" cellpadding="0" cellspacing="0" id='tab_line_height' name='tab_line_height' class="tab_line_height" width="100%">
    					<tr>
					    	...
					    	<td class="inquire_item6">钻井进尺：</td>
					      	<td class="inquire_form6"><input type="text" name="drilling_num" id="drilling_num" class="input_width" value="" readonly/></td>
					    	<td class="inquire_item6">工作小时：</td>
					      	<td class="inquire_form6"><input type="text" name="work_hour" id="work_hour" class="input_width" value="" readonly/></td>
					    </tr>
					    <tr>
 ...
 var ids='<%=ids%>';
	...
	if(ids !=null){
		...
		queryRet = syncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'pageSize=100000&querySql='+encodeURI(encodeURI(querySql)));
			...
			if(datas != null&&datas!=""){	
				document.getElementById("drilling_num").value = datas[0].drilling_num;
				document.getElementById("work_hour").value = datas[0].work_hour;

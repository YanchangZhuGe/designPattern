...
$().ready(function(){
	...
	function submitInfo(state){
		...
		//给调配单号设置成空
		$("#mixinfo_no").val("");
		document.getElementById("form1").action = "<%=contextPath%>/rm/dm/toSaveEQMixFormAllInfo.srq?mixform_type=4&state="+state+"&count="+count+"&line_infos="+line_infos+"&idinfos="+idinfos+"&addedcount="+addedcount+"&addedline_info="+addedline_info;

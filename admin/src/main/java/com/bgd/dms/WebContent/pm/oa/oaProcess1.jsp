				...
				<table id="dev_grid1"  >
						<thead>
							<tr>
							  ...
							  <th nowrap="false" data-options="field:'scrape_apply_no',align:'center',sortable:'true'" width="6%">报废申请单号</th>
						      <th nowrap="false" data-options="field:'scrape_apply_name',align:'center',sortable:'true'" width="6%">报废申请单名称</th>
						      <th nowrap="false" data-options="field:'types',align:'center',sortable:'true'" width="6%">报废类型</th>
						      <th nowrap="false" data-options="field:'employee_name',align:'center',sortable:'true'" width="6%">申请人</th>
						      <th nowrap="false" data-options="field:'apply_date',align:'center',sortable:'true'" width="6%">申请时间</th>
...
//初始化详细信息
	$("#dev_grid1").datagrid({ 
		...
		onDblClickRow  :function(rowIndex,rowData){  
             var editUrl = "${pageContext.request.contextPath}/pm/oa/oaZhuanJia.jsp?expert_leader_id=<%=loginid%>";
			window.open(editUrl,"专家意见填写","scrollbars=yes,resizable=yes"); 
        },
		url:"${pageContext.request.contextPath}/rm/dm/getListDataBySrvAndMethod.srq?JCDP_SRV_NAME=ScrapeSrv&JCDP_OP_NAME=queryScrapeApplyForOAEasyui&expert_leader_id=<%=loginid%>",
		fitColumns:true,pageList:[10,50,100]
	});

...
function loadData(){
	...
	var spData = retObj.airgunData;//气枪数据
	var jpData = retObj.spData;//井炮数据
	...
	if(layoutData != null){
		...
		document.getElementById("td_section_sp").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 气枪激发</font></span>';
    	...
    	document.getElementById("table3").style.display = "none";
 		document.getElementById("td_section_jp").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 井炮激发</font></span>';
 		document.getElementById("td_section_geophone").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">3、组合检波</font></span>';
 		document.getElementById("td_section_instrument").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">4、仪器参数</font></span>';
 		if(jpData != null){
			for(var i=0;i<jpData.length;i++){
				...
				var order_num = record.order_num;
				if(order_num == "1"){
					first_jp_rowid = record.wa3d_no;
					continue;
				}else{
					toAddJP();
					var rowIndex = jpRows - 1;
					setJPData(record, rowIndex);
				}
			}
		}
 	...
 	}else if("5000100003000000005" == buildMethod){
 		///气枪/井炮
 		document.getElementById("table3").style.display = "none";
 		document.getElementById("td_section_sp").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 气枪激发</font></span>';
 		document.getElementById("td_section_jp").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 井炮激发</font></span>';
 	...
 	}else if("5000100003000000006" == buildMethod){
 		//气枪/震源
 		document.getElementById("table6").style.display = "none";
 		document.getElementById("td_section_sp").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 气枪激发</font></span>';
 		document.getElementById("td_section_source").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 震源激发</font></span>';
 		document.getElementById("td_section_geophone").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">3、组合检波</font></span>';
 		document.getElementById("td_section_instrument").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">4、仪器参数</font></span>';
 		//加载气枪段数据
 		if(spData != null){
 	...
 	}else if("5000100003000000007"== buildMethod){
 		document.getElementById("td_section_sp").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 气枪激发</font></span>';
 		document.getElementById("td_section_jp").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 井炮激发</font></span>';
 		document.getElementById("td_section_source").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">2、激发参数: 可控震源激发</font></span>';
 		document.getElementById("td_section_geophone").innerHTML = '<span>&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">3、组合检波</font></span>';
...
function toSave(){
	...
	for(var i=1; i<spRows; i++){
		...
		var air_gun_type =	document.getElementById("air_gun_type" + "_"+lineNum).value;
		if(air_gun_type.length < 1){
			air_gun_type = "";
		}
		var volume_total = document.getElementById("volume_total" + "_"+lineNum).value;
		if(volume_total.length < 1){
			volume_total = "";
		}
		var air_gun_pressure = document.getElementById("air_gun_pressure" + "_"+lineNum).value;
		if(air_gun_pressure.length < 1){
			air_gun_pressure = "";
		}
		var gun_num = document.getElementById("gun_num" + "_"+lineNum).value;
		if(gun_num.length < 1){
			gun_num = "";
		}
		
		var peak_value = document.getElementById("peak_value" + "_"+lineNum).value;
		if(peak_value.length < 1){
			peak_value = "";
		}
		var bubble_ratio = document.getElementById("bubble_ratio" + "_"+lineNum).value;
		if(bubble_ratio.length < 1){
			bubble_ratio = "";
		}
		var bandwidth = document.getElementById("bandwidth" + "_"+lineNum).value;
		if(bandwidth.length < 1){
			bandwidth = "";
		}
		var array_length = document.getElementById("array_length" + "_"+lineNum).value;
		if(array_length.length < 1){
			array_length = "";
		}
		
		var array_separation = document.getElementById("array_separation" + "_"+lineNum).value;
		if(array_separation.length < 1){
			array_separation = "";
		}
		...
		if(i==1){
			...
			mainRow['air_gun_type'] = air_gun_type;
			mainRow['volume_total'] = volume_total;
			mainRow['air_gun_pressure'] = air_gun_pressure;
			mainRow['gun_num'] = gun_num;
			mainRow['peak_value'] = peak_value;
			mainRow['bubble_ratio'] = bubble_ratio;
			mainRow['bandwidth'] = bandwidth;
			mainRow['array_length'] = array_length;
			mainRow['array_separation'] = array_separation;
		}else{
			if(method_no != ""){
				fromRow['wa3d_no'] = method_no;
			}
		}
		fromRow['air_gun_type'] = air_gun_type;
		fromRow['volume_total'] = volume_total;
		fromRow['air_gun_pressure'] = air_gun_pressure;
		fromRow['gun_num'] = gun_num;
		fromRow['peak_value'] = peak_value;
		fromRow['bubble_ratio'] = bubble_ratio;
		fromRow['bandwidth'] = bandwidth;
		fromRow['array_length'] = array_length;
		fromRow['array_separation'] = array_separation;
	...
	for(var i=1; i<jpRows; i++){
		var fromRow = {};
		fromRow['project_info_no'] = project_info_no;
		var lineNum = i;
		var method_no = document.getElementById("method10_no" + "_"+lineNum).value;
		var bsflag = document.getElementById("bsflag10" + "_"+lineNum).value;
		...
		if(i==1){
			if(first_jp_rowid != ""){
				fromRow['wa3d_no'] = first_jp_rowid;
			}
...
function setSPData(record, lineNum){ 
	...
	document.getElementById('array_separation_'+lineNum).value = record.array_separation;
	
}

function setJPData(record, lineNum){
	document.getElementById("method10_no" + "_"+lineNum).value = record.wa3d_no;
	document.getElementById("dynamite_type" + "_"+lineNum).value = record.dynamite_type;
	document.getElementById("well_array_type" + "_"+lineNum).value = record.well_array_type;
	document.getElementById("well_num" + "_"+lineNum).value = record.well_num;
	document.getElementById("well_depth" + "_"+lineNum).value = record.well_depth;
...
function setSourceData(record, lineNum){//显示震源数据
...
function toAddJP(){
	jpIndex++;
	var tr = document.getElementById("trJP_"+jpIndex);
	
	if(tr != null){
		document.getElementById("trJP_hr_"+jpIndex).style.display = "block";
		document.getElementById("trJP_"+jpIndex).style.display = "block";
		return;
	}
	...
	if(rowNum > 1){
		//读取上一行数据
		var preRowNum = parseInt(rowNum) - 1;
		var pre_method2_no = document.getElementById('method10_no_'+preRowNum).value;
		...
		tr.id = "trJP_hr_" + rowNum;
		tr.insertCell().innerHTML = '<table width="100%"><tr><td width="2%" align="right"></td><td width="98%"><hr width="95%"></td></tr></table>';
		var tr = document.getElementById("table6").insertRow();
		tr.id = "trJP_" + rowNum;
		tr.insertCell().innerHTML = '<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height" id="jp_table_'+jpIndex+'">'
					+' <tr class="even"><td class="inquire_item6">炸药类型：</td>'
					+' <td class="inquire_form6"><input id="method10_no' + '_' + rowNum+'" type="hidden" value=""/><input id="bsflag10' + '_' + rowNum+'" type="hidden" value="0"/>'
...
function toAddSP(){
	...
	if(rowNum > 1){
		...
		var array_separation = document.getElementById('array_separation_'+preRowNum).value;
		...
		tr.insertCell().innerHTML = '<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height" id="sp_table_'+spIndex+'">'
				+' <tr class="even"><td class="inquire_item6">气枪震源型号：</td>'
				+' <td class="inquire_form6"><input id="method2_no' + '_' + rowNum+'" type="hidden" value="" class="input_width" /><input id="bsflag2' + '_' + rowNum+'" type="hidden" value="0"/>'
				+' <input type="text" id="air_gun_type' + '_' + rowNum+'" name="air_gun_type' + '_' + rowNum+'" value="'+air_gun_type+'" style="margin-top:4px;" class="input_width" /></td>'
				+' <td class="inquire_item6">气枪容量：</td>'
				+' <td class="inquire_form6"><input id="volume_total' + '_' + rowNum+'" name="volume_total' + '_' + rowNum+'" type="text" value="'+volume_total+'" style="margin-top:4px;" class="input_width" onkeypress="return on_key_press_int(this)"/><div>in3</div></td>'
				+' <td class="inquire_item6">气枪压力:</td>'
					+' <td class="inquire_form6"><input id="air_gun_pressure' + '_' + rowNum+'" name="air_gun_pressure' + '_' + rowNum+'" type="text" value="'+air_gun_pressure+'" style="margin-top:4px;" class="input_width" onkeypress="return on_key_press_int(this)" /><div>psi</div></td>'
				+' </tr>'
				+' <tr class="odd"><td class="inquire_item6">枪数：</td>'
				+' <td class="inquire_form6"><input id="gun_num' + '_' + rowNum+'" name="gun_num' + '_' + rowNum+'" type="text" value="'+gun_num+'" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)" /><div>条</div></td>'
				+' <td class="inquire_item6">峰-峰值：</td>'
				+' <td class="inquire_form6"><input id="peak_value' + '_' + rowNum+'" name="peak_value' + '_' + rowNum+'"  type="text" value="'+peak_value+'" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)" /><div>barm</div></td>'
				+' <td class="inquire_item6">气泡比：</td>'
				+'<td class="inquire_form6"><input id="bubble_ratio' + '_' + rowNum+'" name="bubble_ratio' + '_' + rowNum+'" type="text" value="'+bubble_ratio+'" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)" /><div></div></td>'
				+' </tr>'
				+' <tr class="even"><td class="inquire_item6">频宽：</td>'
				+' <td class="inquire_form6"><input id="bandwidth' + '_' + rowNum+'" name="bandwidth' + '_' + rowNum+'" type="text" value="'+bandwidth+'" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)" /><div>m</div></td>'
				...
				+'<td class="inquire_form6"><input id="array_separation' + '_' + rowNum+'" name="array_separation' + '_' + rowNum+'" type="text" value="'+array_separation+'" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)" /><div>m</div></td>'
				+' </tr></table>';
		...
		tr.insertCell().innerHTML = '<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height" id="sp_table_'+spIndex+'">'
				+' <tr class="even"><td class="inquire_item6">气枪震源型号：</td>'
				+' <td class="inquire_form6"><input id="method2_no' + '_' + rowNum+'" type="hidden" value="" class="input_width" /><input id="bsflag2' + '_' + rowNum+'" type="hidden" value="0"/>'
				+' <input type="text" id="air_gun_type' + '_' + rowNum+'" name="air_gun_type' + '_' + rowNum+'" value="" style="margin-top:4px;" class="input_width" /></td>'
				+' <td class="inquire_item6">气枪容量：</td>'
				+' <td class="inquire_form6"><input id="volume_total' + '_' + rowNum+'" name="volume_total' + '_' + rowNum+'" type="text" value="" style="margin-top:4px;" class="input_width" onkeypress="return on_key_press_int(this)" /><div>in3</div></td>'
				+' <td class="inquire_item6">气枪压力:</td>'
				+' <td class="inquire_form6"><input id="air_gun_pressure' + '_' + rowNum+'" name="air_gun_pressure' + '_' + rowNum+'" type="text" value="" style="margin-top:4px;" class="input_width" onkeypress="return on_key_press_int(this)" /><div>psi</div></td>'
				+' </tr>'
				+' <tr class="odd"><td class="inquire_item6">枪数：</td>'
				+' <td class="inquire_form6"><input id="gun_num' + '_' + rowNum+'" name="gun_num' + '_' + rowNum+'" type="text" value="" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)" /><div>条</div></td>'
				+' <td class="inquire_item6">峰-峰值：</td>'
				+' <td class="inquire_form6"><input id="peak_value' + '_' + rowNum+'" name="peak_value' + '_' + rowNum+'"  type="text" value="" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)"/><div>barm</div></td>'
				+' <td class="inquire_item6">气泡比：</td>'
				+'<td class="inquire_form6"><input id="bubble_ratio' + '_' + rowNum+'" name="bubble_ratio' + '_' + rowNum+'" type="text" value="" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)" /><div></div></td>'
				+' </tr>'
				+' <tr class="even"><td class="inquire_item6">频宽：</td>'
				+' <td class="inquire_form6"><input id="bandwidth' + '_' + rowNum+'" name="bandwidth' + '_' + rowNum+'" type="text" value="" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)"/><div>m</div></td>'
				+' <td class="inquire_item6">阵列长度：</td>'
				...
				+' <td class="inquire_item6">子阵间距：</td>'
				+'<td class="inquire_form6"><input id="array_separation' + '_' + rowNum+'" name="array_separation' + '_' + rowNum+'" type="text" value="" class="input_width" style="margin-top:4px;" onkeypress="return on_key_press_int(this)" /><div>m</div></td>'
				+' </tr></table>';
...
function toAddInstrument(){
	...
	if(rowNum > 1){
		...
		tr.insertCell().innerHTML = '<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height" id="instrument_table_'+instrumentIndex+'">'
					...
					+' <td class="inquire_form6"><input id="preamplifier_gain' + '_' + rowNum+'" type="text" value="'+pre_preamplifier_gain+'" class="input_width" style="margin-top:4px;"  /><div></div></td>'
		...
		tr.insertCell().innerHTML = '<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height" id="instrument_table_'+instrumentIndex+'">'
					...
					+' <td class="inquire_item6">前放增益：</td>'
					+' <td class="inquire_form6"><input id="preamplifier_gain' + '_' + rowNum+'" type="text" value="" class="input_width" style="margin-top:4px;"  /><div></div></td>'
					+' <td class="inquire_item6">低截频率：</td>'
...
function toDeleteJP(){
	...
	var line = document.getElementById("trJP_hr_"+rowNum);
	var dataLine = document.getElementById("trJP_"+rowNum);
	var record_id = document.getElementById("method10_no_"+rowNum).value;
	if(record_id!=""){
		line.style.display = 'none';
		dataLine.style.display = 'none';
		document.getElementsByName("bsflag10_"+rowNum)[0].value = '1';
		jpIndex--;
	}else{
		line.parentNode.removeChild(line);
		dataLine.parentNode.removeChild(dataLine);
			...
			<tr>
				<td>
					<table border="0" cellpadding="0" cellspacing="0" width="100%"
						class="tab_line_height">
						<tr style="background-color: #97cbfd">
							<td align="left" width="90%" id="td_section_jp"></td>
							<td width="10%" align="right">
								<%
									if (action != "view" && !"view".equals(action)) {
								%><table>
									<tr>
										<td><auth:ListButton functionId="" css="zj"
												event="onclick='toAddJP()'" title="JCDP_btn_add"></auth:ListButton>
										</td>
										<td><auth:ListButton functionId="" css="sc"
												event="onclick='toDeleteJP()'" title="JCDP_btn_edit"></auth:ListButton>
										</td>
									</tr>
								</table> <%
 	}

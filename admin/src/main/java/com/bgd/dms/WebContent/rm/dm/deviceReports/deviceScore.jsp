...
//如果是是星期四下午，则增加7天  
   ...
   String rptParams ="startDate="+startDate+";endDate="+endDate+";startMM="+firstDayOfMonth+";endMM="+lastDayOfMonth+";isS="+isS+";weekNum="+nowWeekNum;;
%>
...
<body>
	...
	<div id="table_box"  style="height:510px;" >
		<table id=rpt border="0" cellpadding="0" cellspacing="0" class="ali6">
			...
			reportFileName="device/deviceScore.raq"
			params="<%=rptParams%>"
			width="-1" 
			height="-1"
			needScroll="no"

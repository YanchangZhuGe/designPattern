    ...
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr>
          ...
          <td class="inquire_form4"><input type="hidden" id="project_type" name="project_type" value="5000100004000000008" class="input_width" /><input name="project_name" class="input_width" type="text" /></td>
        ...
        <tr>
          <td class="inquire_item4"><div id="view_type_text">观测类型:</div></td>
          <td class="inquire_form4"><div id="view_type_name"> 

				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box_title"><span class="kb"><a
							href="#"></a></span><a href="#">线别结构分类占比</a><span class="gd"><a
							href="#"></a></span></div>
...
<script type="text/javascript">
 ...
 function getFusionChart(){
	...
	var myChart2 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Pie3D.swf", "myChartId2", "100%", "100%", "0", "0" );    
	myChart2.setXMLUrl("<%=contextPath%>/rm/em/getChart7.srq?orgId=<%=orgId%>");      

      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
          ...
          <td class="inquire_form4">
          	...
          	<input name="mixownership" id="mixownership" type="hidden" value="" />
          	<input name="mixtypename" id="mixtypename" type="hidden" value="" />
          	<input name="mixtypeusername" id="mixtypeusername" type="hidden" value="" />
          </td>
        </tr>
       </table>
      </fieldset>
...
<script type="text/javascript">
	function submitInfo(){
		...
		//计划提交
		document.getElementById("form1").action = "<%=contextPath%>/rm/dm/toSaveMixAppBaseInfo.srq?state=9";
	...
	function refreshData(){
		...
		if('<%=deviceappid%>'!=null){
			//查询基本信息
			var mainSql = "select devapp.project_info_no,pro.project_name,devapp.appdate,devapp.device_app_no,devapp.remark,";
			mainSql += "devapp.device_app_name,devapp.app_org_id,devapp.employee_id,org.org_name as app_org_name,emp.employee_name,";
			mainSql += "devapp.mix_type_id,devapp.mix_type_name,devapp.mix_user_id,devapp.mix_org_id ";
			mainSql += "from gms_device_app devapp ";
			...
			$("#mixownership").val(retObj[0].mix_type_id);
			$("#mixtypename").val(retObj[0].mix_type_name);
			$("#mixtypeusername").val(retObj[0].mix_user_id);
			...
			querySql += "ci.dev_ci_name,ci.dev_ci_model,dad.dev_ci_code,dad.unitinfo, ";
			querySql += "dad.apply_num,dad.teamid,dad.team, ";
			querySql += "dad.purpose,dad.plan_start_date,dad.plan_end_date, ";
			querySql += "devapp.project_info_no,pro.project_name,devapp.appdate,devapp.device_app_no,devapp.remark,";
			querySql += "devapp.device_app_name,devapp.app_org_id,devapp.employee_id,org.org_name as app_org_name,emp.employee_name ";
			
			querySql += "from gms_device_app_detail dad left join gms_device_app devapp on dad.device_app_id=devapp.device_app_id ";
			...
			querySql += "left join gms_device_codeinfo ci on dad.dev_ci_code = ci.dev_ci_code ";

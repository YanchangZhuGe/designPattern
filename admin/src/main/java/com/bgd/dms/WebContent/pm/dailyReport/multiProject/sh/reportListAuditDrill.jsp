			...
			<div id="table_box">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="{total_sp}" >累计采集炮数</td>
			      <td class="bt_info_odd" exp="{total_sp_radio}" >完成采集%</td>		
			      <td class="bt_info_even" exp="{total_drill}">累计钻井炮点数</td>
				  <td class="bt_info_odd"  exp="{total_drill_radio}">完成钻井%</td>	
			      <td class="bt_info_even" exp="{total_survey}" >累计测量公里数</td>
			      <td class="bt_info_odd" exp="{total_survey_radio}" >完成测量%</td>
			      <td class="bt_info_even" exp="{total_measue}" >累计表层点数</td>
			      <td class="bt_info_odd" exp="{total_measue_radio}" >完成表层%</td>
...
*/		
		//document.getElementById("dailyQuestion").src = "<%=contextPath%>/pm/dailyReport/singleProject/dailyQuestionList.jsp?projectInfoNo="+ids+"&produceDate="+ids2;
	}
	...
	function dbclickRow(ids){
		...
		//popWindow('<%=contextPath%>/pm/dailyReport/singleProject/viewDailyReport.jsp?daily_no='+ids1+'&project_info_no='+ids+'&produce_date='+ids2,'1280:800');
	}

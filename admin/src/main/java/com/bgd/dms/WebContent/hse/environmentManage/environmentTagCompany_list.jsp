...
<script type="text/javascript">
	...
	function getTab3(index) {  
		...
		if(index==0){
			parent.assessframe.location.href = "<%=contextPath%>/hse/environmentManage/environmentCompany_list.jsp";
		}else if(index==1){
			parent.assessframe.location.href = "<%=contextPath%>/hse/environmentManage/environmentCompany22_list.jsp";
		}else if(index==2){

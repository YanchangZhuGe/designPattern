...
function save(){
	...
	form.action = "<%=contextPath%>/td/ws/yljcToSaveConsdesignDoc.srq";
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if (!isLimitB20("written_unit","编写单位")) return false;  
	...
	if(fileId!='null'){ 
		if (!isTextPropertyNotNull("pk_0110000061110000010", "压裂监测施工设计报告")) return false;	
	}else{
		if (!isTextPropertyNotNull("0110000061110000010", "压裂监测施工设计报告")) return false;		
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								<tr>
									...
									<input name="tecnical_id" id="tecnical_id" class="input_width" value="" type="hidden" readonly="readonly"/>
								        ...
								        <input name="project_info_no" id="project_info_no" class="input_width" value="<%=projectInfoNo%>" type="hidden" readonly="readonly"/>           
							         	...
							         	<input name="status_type" id="status_type" class="input_width" value="3" type="hidden" readonly="readonly"/>
								...
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>压裂监测施工设计报告：</td>
									<td colspan="2">
										<input type="hidden" id="pk_0110000061110000010" name="pk_0110000061110000010" value=""/>
										<input type="file" name="0110000061110000010" id="0110000061110000010" class="input_width"/>
					    				<div id="down_0110000061110000010"></div>
									</td>
								...
								<tr  style="display:none">
									...
									<td colspan="2">
										<input type="hidden" id="pk_0110000061110000011" name="pk_0110000061110000011" value=""/>
										<input type="file" name="0110000061110000011" id="0110000061110000011" class="input_width"/>
										<div id="down_0110000061110000011"></div>
									</td>
									<td class="inquire_form4"></td>
								</tr>
								<tr  style="display:none" >
									...
									<td colspan="2">
										<input type="hidden" id="pk_0110000061110000008" name="pk_0110000061110000008" value=""/>
										<input type="file" name="0110000061110000008" id="0110000061110000008" class="input_width"/>
					    				<div id="down_0110000061110000008"></div>
									</td>
									<td class="inquire_form4"></td>
								</tr>
								<tr>

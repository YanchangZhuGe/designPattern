...
<tr>
<input type="hidden" id="design_line_num"/>
<input type="hidden" id="design_object_workload"/>
<input type="hidden" id="design_sp_num"/>
<input type="hidden" id="object_id"/>
<td class="inquire_form4" >本次部署工作量：</td>
</tr>
<tr>
<td class="inquire_form4" id="workload_td"></td>
</tr>
</table>
</div>
<div id="oper_div">

...
<script type="text/javascript">
	...
	function refreshData(){
		var sql ='';
			sql +="select b.wz_name,b.wz_id,sum(b.demand_num) demand_num,b.wz_prickie,b.wz_price from (select t.*,m.wz_name,m.wz_prickie,m.wz_price,m.note,c.code_name from gms_mat_demand_plan_detail t inner join gms_mat_demand_plan_bz bz on t.submite_number = bz.submite_number and bz.bsflag='0' and bz.if_purchase='1' inner join (gms_mat_infomation m inner join (gms_mat_coding_code c) on m.coding_code_id= c.coding_code_id  ) on t.wz_id = m.wz_id and m.bsflag='0'  and t.bsflag='0'  and t.project_info_no='"+projectInfoNo+"') b group by b.wz_name,b.wz_prickie,b.wz_price,b.wz_id";
			
		cruConfig.cdtType = 'form';
		cruConfig.queryStr = sql;
		cruConfig.currentPageUrl = "/mat/singleproject/plan/planMatListDg.jsp";
		queryData(1);
	}
	
	function toAdd(){ 
		  popWindow("<%=contextPath%>/mat/singleproject/plan/planItemListDg.jsp?taskObjectId="+taskObjectId+"&projectInfoNo="+projectInfoNo,'1024:800');
    }  

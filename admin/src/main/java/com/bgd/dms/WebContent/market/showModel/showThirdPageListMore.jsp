...
<script type="text/javascript">
	function linkPageList(page){
		window.location.href="<%=contextPath%>/market/show/viewListMore.srq?typeId=<%=typeId%>&&orgId=<%=orgId%>&&typeName=<%=typeName%>&&currentPage="+page;	
	}
 ...
 <div id="nav">
  ...
  <div id="content_div"> 
    <div id="content_gl_news_mbx">
      <ul>
        <li class="mleft"></li>
        <li class="mbg"><span class="mbx_text"><%=typeName %><a href="javascript:window.history.back()" <%if(typeName.length()==4){ %>style="margin-left: 820px;"<%}else{ %>style="margin-left: 800px;"<%} %>>返回&nbsp;&nbsp;</a></span></li>
        <li class="mright"></li>
      </ul>
    </div>

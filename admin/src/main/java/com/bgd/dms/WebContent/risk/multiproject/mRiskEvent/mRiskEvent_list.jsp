      	...
      	<div id="list_table">
			...
			<div id="tag-container_3">
			  <ul id="tags" class="tags">
			    ...
			    <li id="tag3_5"><a href="#" onclick="getTab3(5)">编码</a></li>
	...
	function simpleSearch(){
		...
		if(query_type == "0"|| query_type == "1"){
			...
			if(query_type == "0"){
				...
				if(project_name != ""){
					if(is_risk_confirm == "0"|| is_risk_confirm == "1"){	
						cruConfig.submitStr = "emergencyConfirm="+is_risk_confirm+"&isMulti=1&projectName="+project_name;	
						queryData(1);
			...
			//项目编号
				...
				if(project_number != ""){
					if(is_risk_confirm == "0"|| is_risk_confirm == "1"){	
						cruConfig.submitStr = "emergencyConfirm="+is_risk_confirm+"&isMulti=1&projectNumber="+project_number;	
						queryData(1);
					}else if(is_risk_confirm == "2"){
		...
		//没有选择按项目查询,
			...
			if(is_risk_confirm == "0"|| is_risk_confirm == "1"){		
				cruConfig.submitStr = "emergencyConfirm="+is_risk_confirm+"&isMulti=1";	
				queryData(1);
			}else if(is_risk_confirm == "2"){
				refreshData();
			}

...
function getSubNodes(parentNode) {
	...
	Ext.Ajax.request({
		...
		params : {
			currentPage:"1",
			pageSize:"10000",
			querySql:"select coding_code_id,coding_code, case length(coding_code) when 2 then coding_name when 5 then '--'||coding_name  when 8 then '----'||coding_name  when 11 then '------'||coding_name end as coding_name ,'1' as is_leaf from comm_coding_sort_detail where coding_sort_id='0101600001'  order by coding_code"
		},
		method : 'Post',

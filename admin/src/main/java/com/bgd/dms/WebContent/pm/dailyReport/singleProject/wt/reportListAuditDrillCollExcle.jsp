...
function toDelete(){
   ...
   var procStatusV =  $("#procStatus").val();
   if(procStatusV=="3"){
	   alert("审批通过不可删除");
	   return;
	}
	var retObj = jcdpCallService("WtDailyReportSrv", "deleteDailyReportWt", "daily_report_ids="+ids);
...
<div id="list_table">
	...
	<div id="table_box">
			...
			<tr id="dailyTr">
				<td class="bt_info_odd" exp="<input type='checkbox' name='chk_entity_id' value='{daily_report_id}' id='chk_entity_id' />" >选择</td>

			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="{invoices_id}">单号</td>
			      <td class="bt_info_odd" exp="{total_money}">合计金额</td>
			      <td class="bt_info_even" exp="{org_name}">退货班组</td>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		var sql ="select t.note,t.out_date,t.total_money,t.out_info_id,t.invoices_id,i.coding_name as org_name,decode(t.if_submit,'0','未提交','1','已提交') if_submit from gms_mat_out_info t inner join comm_coding_sort_detail i on t.team_id=i.coding_code_id and t.bsflag='0'and t.out_type='3'and t.project_info_no='<%=projectInfoNo%>'";
	...
	function toOut(){
	  ...
	  function toAdd(){ 
			  ...
			  popWindow("<%=contextPath%>/mat/singleproject/warehouseDg/accept/rettrac/matOut.jsp",'1024:800');
       ...
       function simpleSearch(){
    	   var sql ='';
			...
			sql+="select * from (select t.note,t.out_date,t.total_money,t.out_info_id,t.invoices_id,i.coding_name as org_name,decode(t.if_submit,'0','未提交','1','已提交') if_submit from gms_mat_out_info t inner join comm_coding_sort_detail i on t.team_id=i.coding_code_id and t.bsflag='0'and t.out_type='3'and t.project_info_no='<%=projectInfoNo%>') ttt where ttt.invoices_id like '%"+wz_name+"%'"
			cruConfig.cdtType = 'form';
			cruConfig.queryStr = sql;
    	  ...
    	  if(ids==''){ 
			    alert("请先选中一条记录!");
	     		return;
 	    		 ...
 	    		 popWindow("<%=contextPath%>/mat/singleproject/warehouse/accept/rettrac/queryTracOut.srq?laborId="+ids,'1024:800');
 				}
      }
      function toDelete(){
    	  ids = getSelIds('rdo_entity_id');

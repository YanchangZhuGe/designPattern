...
var cruTitle = "新建--VSP采集项目情况情况CRU";
...
function page_init(){
	...
	if(data_week_date!='null' ){
		...
		var querySql = "select t.* from BGP_WR_ACQ_PROJECT_INFO t where t.org_id = '" + data_org_id + "' and to_char(t.week_date,'yyyy-MM-dd') = '" + data_week_date + "' and t.bsflag='0' and t.project_type = '2' order by country";
...
<table border="0" cellpadding="0" cellspacing="0" id="lineTable"  width="100%" class="tab_line_height">
    ...
    <tr class="odd">
      ...
      <td align="inquire_form4">正在准备</td>
      <td align="inquire_item4">正在施工</td>
      <td align="inquire_form4">项目结束</td> 
    </tr>
    <tr class="even">
      ...
      <td align="inquire_item4"><input type="text" name="construct_num0" id="construct_num0" value=""></td>
    ...
    <tr class="odd">
      ...
      <td align="inquire_item4"><input type="text" name="construct_num1" id="construct_num1" value=""></td>

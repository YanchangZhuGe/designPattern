...
<script type="text/javascript">
	...
	function refreshData(){
		...
		str += "alldet.dev_ci_code,devapp.device_allapp_name, ";
		...
		str += "zd.apply_num as approve_num,";
		...
		str += "where devapp.allapp_type = 'S10002' and devapp.bsflag='0' and alldet.bsflag='0' ";
	...
	function submitInfo(oprinfo){
        ...
        for(var i=2;i<autoOrder.length;i++){
          	...
          	var num=td[5].getElementsByTagName("input")[0].value;
          	var info="";
	    	if(allappType=='S10002'){

...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		var sql = "select t.file_id,t.file_name,t.ucm_id,to_char(t.create_date,'yyyy-MM-dd') create_date,e.user_name,t.project_info_no,p.project_name from bgp_doc_gms_file t left join p_auth_user e on t.creator_id = e.user_id and e.bsflag='0' left join gp_task_project p on t.project_info_no=p.project_info_no and p.bsflag='0'  where t.bsflag='0' and t.org_subjection_id like '%<%=org_subjection_id%>%' and t.parent_file_id='<%=parentFileId%>' ";

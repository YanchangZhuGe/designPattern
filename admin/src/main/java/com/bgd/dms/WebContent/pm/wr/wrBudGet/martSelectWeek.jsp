...
function save(){
	...
	if(subflag=="1"){// 数据已提交
		...
		window.location="<%=contextPath%>/pm/wr/wrBudGet/orgAddMartandprojectInfoModify.jsp?week_date="+week_date+"&week_end_date="+week_end_date+"&org_id=<%=user.getCodeAffordOrgID()%>&isSecond=false&orgId=<%=orgId%>&action="+action;
		}
	}
}

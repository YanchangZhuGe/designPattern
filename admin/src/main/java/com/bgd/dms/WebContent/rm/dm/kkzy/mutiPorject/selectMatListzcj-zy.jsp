		 ...
		 baseData = jcdpCallService("DevInsSrv", "getwxbyMatInfos", "wz_name="+wz_name);
				if(baseData.datas!=null)
				{
					...
					for (var tr_id = 0; tr_id< baseData.datas.length; tr_id++) {
						...
						innerhtml += "<td><input type='checkbox' name='idinfo' id='"+tr_id+"' onclick='chooseOne(this);' value=''/></td>";
						...
						innerhtml += "<td>-</td>";
						innerhtml += "<td><input name='use_num"+tr_id+"' id='use_num"+tr_id+"' value='' size='16' onblur='checkUse_num("+tr_id+")'/></td>";

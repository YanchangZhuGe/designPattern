...
<script type="text/javascript">
	...
	function refreshData(){
		var sql ="select t.invoices_no,t.total_money,t.create_date,t.source,t.note,t.invoices_id,t.input_no from GMS_MAT_TEAMMAT_INVOICES t where t.project_info_no='<%=projectInfoNo%>' and t.invoices_type='3'and t.if_input='0'";

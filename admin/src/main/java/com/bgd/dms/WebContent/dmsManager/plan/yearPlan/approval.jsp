...
<div id="tab_box_content1" class="tab_box_content" style="display:none;">
	<iframe id="businessIframe0" name="businessIframe0" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/plan/yearPlan/require_report_approval.jsp<%=linkParaStr%>&isDone=<%=isDone%>'> </iframe>
</div>
<div id="tab_box_content2" class="tab_box_content" style="display:none;">
	<iframe id="businessIframe1" name="businessIframe1" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/plan/yearPlan/supp_data_approval.jsp<%=linkParaStr%>'> </iframe>
</div>

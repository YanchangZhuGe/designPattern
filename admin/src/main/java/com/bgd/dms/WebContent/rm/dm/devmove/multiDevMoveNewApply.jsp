...
<script type="text/javascript">
	$().ready(function(){
		$("#addProcess").click(function(){	
			...
			var vReturnValue = window.showModalDialog("<%=contextPath%>/rm/dm/devmove/selectAccountForBack.jsp?projectinfono="+outProjectInfoNo+"&backdevtype="+backdevtype,paramobj,"dialogWidth=1200px;dialogHeight=480px");
			...
			var devdetSql = "select account.dev_acc_id,account.asset_coding, ";
				...
				devdetSql += "and account.project_info_id='"+outProjectInfoNo+"' ";

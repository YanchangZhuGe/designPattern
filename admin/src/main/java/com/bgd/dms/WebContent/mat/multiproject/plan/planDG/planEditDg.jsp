...
<%
		...
		String submite_number = request.getParameter("submite_number");
...
<body   onload="getConRatio(),refreshData()" class="odd_odd">
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="<input name='demand_num_{wz_id}'  type='text' value='{demand_num}' onkeyup='loadDataDetail()'/>" >发放数量</td>
			      <td class="bt_info_odd" exp="<input name='demand_money_{wz_id}'  type='text' value='{demand_money}' readonly/>" >金额</td>
			      <td class="bt_info_even" exp="<input name='note_{wz_id}'  type='text' value='{note}'/>" >备注</td>
			    </tr>
			  </table>
			  </div>

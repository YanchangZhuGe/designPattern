...
<%
	...
	System.out.println("____________procinstId_____________"+procinstId);
	...
	System.out.println("____________businessId_____________"+businessId);
	System.out.println("____________linkParaStr_____________"+linkParaStr);
...
var zz_id='<%=zz_id%>';
	function pass(){
			...
			// if(result=="END_NODE"){
				//baseData = jcdpCallService("ScrapeSrv", "checkDisposeInfo","zz_id="+zz_id);
			//}
			var retObj = jcdpCallService("WFCommonSrv", "doWfProcess",$("#CheckForm").serialize());	
...
<div id="tab_box_content1" class="tab_box_content" style="display:none;height: 530px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/zhuanzi/zhuanziApplyForProc.jsp<%=linkParaStr%>'> </iframe>
</div>

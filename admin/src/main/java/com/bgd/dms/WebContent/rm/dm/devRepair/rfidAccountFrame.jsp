...
%>
<frameset cols="200,*" name="list" frameborder="yes" border="0" framespacing="0">
	<frame src="<%=contexPath%>/rm/dm/devRepair/rfidDevTypeTree.jsp<%=paramUrl%>" name="mainleftframe" frameborder="0" scrolling="auto"
		id="mainleftframe" style="border-right: 2px solid #5796DD; cursor: w-resize;" />
	<frame src="<%=contexPath%>/rm/dm/devRepair/rfidDevAccList.jsp?code=" name="mainRightframe" frameborder="0" scrolling="auto"

...
<table border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
    	<td colspan="6" align="center">物资Excel导入</td>
    </tr>
	 <tr>
     	<td class="inquire_item6">Excel：</td>
      	<td class="inquire_form6"><input type="file" id="files" name="doc_excel"  /></td>
...
var type='<%=type%>';
	function save(){	
		openMask();
		document.getElementById("form1").action="<%=contextPath%>/mat/multiproject/matLed/repmat/saveExcelRepMatDg.srq?type="+type;

    ...
    <div id="new_table_box_bg" style="width:95%">
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
          ...
          <td class="inquire_form4">
          	<select name="backdevtype" id="backdevtype" class="selected_width" onchange="showCheckOrg()"></select>
          </td>
          <td class = "inquire_item4" id="check1" style="display: none;">验收单位：
...
var project_type="<%=projectType%>";
	...
	function refreshData(){
		...
		if(proqueryRet!=null && proqueryRet.returnCode =='0'){
			...
			%>
			if(dg_Flag == 'Y'){
				var tmpTJ = "<option id='S9998' value='S9998' userinfo=''>"+'调剂设备'+"</option>";
				innerHTML += tmpTJ;
			}
			...
			//综合物化探隐藏专业化测量及专业化震源选项
			if(project_type == '5000100004000000009'){
				$("select option[value='S0623']").remove();
				$("select option[value='S1404']").remove();
			}
		}

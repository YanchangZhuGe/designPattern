	...
	function getContentTab(obj,index) { 
		...
		if(index == 1){
			...
			if(currentid != undefined && idinfo == currentid){
				...
				//str += "left join gms_device_allapp_detail det on devapp.device_allapp_id = det.device_allapp_id ";
...
<script type="text/javascript">
    ...
    function refreshData(v_device_app_no, v_device_app_name){
		var str = "select pro.project_name,devapp.device_hireapp_id,devapp.device_hireapp_no,devapp.device_hireapp_name,devapp.project_info_no,";
			...
			str += "where devapp.bsflag = '0' and devapp.project_info_no='"+projectInfoNos+"' and allapp.allapp_type='S9999' and wfmiddle.proc_status='3' ";
    ...
    function loadDataDetail(device_hireapp_id){
		...
		var device_allapp_id = retObj.deviceappMap.device_allapp_id;

		var businessTypeDg="5110000004100001032";
        ...
        processNecessaryInfo={        							//流程引擎关键信息
        			...
        			businessInfo:"大港自有设备配置计划审批列表信息<配置计划单名称:"+retObj.deviceappMap.device_allapp_name+">",

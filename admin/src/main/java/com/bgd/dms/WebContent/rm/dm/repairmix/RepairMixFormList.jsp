 ...
 <body style="background:#fff" onload="refreshData()">
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			  	<td class="ali_cdn_name">维修调配单号</td>
			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr id='device_appdet_id_{device_mixinfo_id}' name='device_mixinfo_id'>
					...
					<td class="bt_info_odd" exp="{repair_info_no}">维修调配单号</td>
			...
			<div id="tab_box" class="tab_box">
				<div id="tab_box_content0" name="tab_box_content0" class="tab_box_content">
				    ...
				    <tr >
				     <td  class="inquire_item6">&nbsp;维修调配单号：</td>
...
<script type="text/javascript">
	...
	function refreshData(v_repairmixinfo_no,v_project_name){
		var str = "select rif.device_mixinfo_id,case rif.state when '0' then '未提交' when '9' then '已提交' else '异常状态' end as state_desc,";
			...
			str += "where rif.bsflag='0'  and rif.repairtype='1' ";
		//TODO 补充名称的查询条件
	...
	function toNewPage(){
    	popWindow('<%=contextPath%>/rm/dm/repairmix/repairMixFormNewFill.jsp');
    }

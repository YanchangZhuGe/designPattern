...
<tr  >
	...
	<tr  >
	<td  class="inquire_item4"><font color=red></font>&nbsp;评价日期：</td>
	<td class="inquire_form4">	 
	<input type="text" id="evaluation_date" name="evaluation_date" class="input_width" style="width:180px;"  style="width:180px;"  readonly="readonly"  />
	&nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton2" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(evaluation_date,tributton2);" />&nbsp;</td>

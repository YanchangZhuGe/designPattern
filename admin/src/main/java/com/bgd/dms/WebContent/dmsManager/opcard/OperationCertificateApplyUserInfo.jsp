...
<body style="background: #cdddef; overflow-y: auto;"  onload="loadEmployeeInfo()">
	...
	<div id="list_content">
		...
		<div id="bottomnav0" style="display:none; position:fixed; top:100;right:0;left:0"><img src="<%=contextPath%>/images/shuiyi.png"></img></div>
	<div id="bottomnav1" style="display:none;position:fixed; top:100;right:0;left:0"><img src="<%=contextPath%>/images/shuiyi.png"></img></div>
	<div id="bottomnav6" style="display:none;position:fixed; top:100;right:0;left:0"><img src="<%=contextPath%>/images/shuiyi.png"></img></div>
	<div id="bottomnav16" style="display:none;position:fixed; top:100;right:0;left:0"><img src="<%=contextPath%>/images/shuiyi.png"></img></div>
			<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td align="center"   >
								...
								<table width="30%" border="0" cellspacing="0" cellpadding="0" id="table0" >
									<tr>
										<td width="50%" >
												...
												<div class="tongyong_box_content_left" id="chartContainer1"
													...
													<table width="30%" border="0" cellspacing="0"
														...
														<td class="bt_info_odd">身份证：<span id="employee_id" readonly="readonly"></span></td>
													 	...
													 	<td class="bt_info_even"  id="status_date">下次审验时间：<span readonly="readonly" id="next_modifi_date"></span></td>
													 	</tr>
			...
			<td id="temp" align="center">
		   	<table width="30%" border="0" cellspacing="0" cellpadding="0" id='table1' >
									<tr>
										<td width="70%" >
											<div class="tongyong_box">
												<div class="tongyong_box_title" align="center">
			...
			<td  align="center"> 
			<span class="bc_btn"><a href="#" onclick="printme()"></a></span> 
...
var typecount=0;
	...
	function loadEmployeeInfo( ){
		var baseData = jcdpCallService("DevInsSrv", "getApplyInfoByEmployee_idFY", "employee_id=<%=employee_id%>");
		if (typeof baseData.datas != "undefined"&&baseData.datas.length!=0){
		 	...
		 	$("#next_modifi_date").html(d.getFullYear()+"-"+d.getMonth()+"-"+d.getDate());
		 	...
		 	for(var i=0;i<baseData.datas.length;i++){
		 		if(typecount%5==0&&baseData.datas.length>5&&typecount!=0){
		 			...
		 			$("#table111").append('<tr><td align="center">'
		 				   	+' <table border="0" cellpadding="0" id="table'+(i+1)+'" cellspacing="0" width="30%">'
		 				   +'<tbody><tr>'
		 				  +'<td width="30%">'
		 				 +'<div class="tongyong_box">'
		 				+'	<div class="tongyong_box_title" align="center">'
		 				...
		 				+'					<table class="tab_info" border="0" cellpadding="0" cellspacing="0" width="30%">'
	...
	+' </td></tr>');
		 		...
		 		var baseData1 = jcdpCallService("DevInsSrv", "getTaskinst", "procinst_id="+map.proc_inst_id);
		 		if (typeof baseData1.datas != "undefined"&&baseData1.datas.length!=0){
		 			var map=baseData1.datas[0];
 	...
 	//为每个表格加上水印
	 var  shuiyi11 = new Array('0','1','6','11','16');
	   for(var key in shuiyi11){
			...
			$("#bottomnav"+shuiyi11[key]).css({position: "absolute",'top':X,'left':Y+100,'z-index':999});  
		   	}
       }    
	}11
	function toClose(){

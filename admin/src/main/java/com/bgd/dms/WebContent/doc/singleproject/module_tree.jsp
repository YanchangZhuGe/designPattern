...
function getSubNodes(parentNode) {
	...
	Ext.Ajax.request({
		...
		params : {
			currentPage:"1",
			pageSize:"100",
			querySql:"Select menu_id,menu_c_name FROM P_AUTH_MENU_DMS WHERE parent_menu_id='"+parentNode.id+"' and menu_c_name in ('经营管理','物资管理','风险管理','质量管理','市场信息','生产管理','人力资源','设备管理','HSE管理','技术管理','文档管理') ORDER BY order_num"
		},
		method : 'Post',

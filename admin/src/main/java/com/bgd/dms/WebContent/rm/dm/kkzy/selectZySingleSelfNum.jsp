			...
			<table width="98%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr id='dev_acc_id_{dev_acc_id}' name='dev_acc_id'  idinfo='{dev_acc_id}'>
					<td class="bt_info_odd"
						exp="<input type='checkbox' name='rdo_entity_name'  onclick='chooseOne(this)'  value='{self_num}' id='rdo_entity_name_{dev_acc_id}' { selectflag}/></td>
...
<script type="text/javascript">
  ...
  var checked = false;
	...
	function refreshData(arrObj){
		...
		str += "  where  t.owning_sub_id like 'C105006%'  and t.dev_type like 'S062301%'  ";
		//if(selectWzId!="")
		//{	

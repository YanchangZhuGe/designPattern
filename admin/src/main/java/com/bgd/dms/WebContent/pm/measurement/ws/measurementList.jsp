...
<script type="text/javascript">
	...
	function dbclickRow(ids){
		//测算表
		if(ids=="cs"){
			popWindow('<%=contextPath%>/pm/project/ws/queryMeasureListCs.srq?projectInfoNo=<%=project_info_no%>&measureType=0&viewmeasurement=<%=view_measurement %>','1300:680');
		}
		//确认表
		else if(ids=="qr"){
		  	popWindow('<%=contextPath%>/pm/project/ws/queryMeasureListQr.srq?projectInfoNo=<%=project_info_no%>&measureType=1&viewmeasurement=<%=view_measurement %>','1300:680');
		}
	}

    ...
    <div id="new_table_box_bg">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
          ...
          <td class="inquire_form4">
          	<input name="check_date" id="check_date" class="input_width" type="text" value="<%=nowTime%>" readonly/>
          </td>
        </tr>
        <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		      <tr>
			    ...
			    <td class="inquire_form4">
			    	<input name="dispose_date" id="dispose_date" type="text" class="easyui-datebox input" editable="false"/>
			    </td>
			   </tr>
		       <tr>
		       	<td class="inquire_item4">处置收入入账凭证号:</td>
			    <td class="inquire_form4"><input name="dispose_income_no" id="dispose_income_no" type="text" class="input_width" value="" /></td>
			   	<td class="inquire_item4">备注:</td>
			    <td class="inquire_form4"><input name="remark" id="remark" type="text" class="input_width" value="" /></td>
			   </tr>
	    		<tr>
				...
				<td class="inquire_item4">	<input id="dispose_paimai_num" name="dispose_paimai_num"  type="text" value="" readonly></td>
					<td class="inquire_item4">	<input id="dispose_company_num" name="dispose_company_num"  type="text" value="" readonly></td>
						<td class="inquire_item4">	<input id="dispose_other_num" name="dispose_other_num"  type="text" value="" readonly></td>
							<td class="inquire_item4">	<input id="dispose_sum_num" name="dispose_sum_num"  type="text" value="" readonly></td>
				</tr>
				<tr>
				<td class="inquire_item4">处置金额(元) </td>
				<td class="inquire_item4">	<input id="dispose_paimai_money" name="dispose_paimai_money"  type="text" value=""></td>
				<td class="inquire_item4">	<input id="dispose_company_money" name="dispose_company_money"  type="text" value=""></td>
				<td class="inquire_item4">	<input id="dispose_other_money" name="dispose_other_money"  type="text" value=""></td>
				<td class="inquire_item4">	<input id="dispose_sum_money" name="dispose_sum_money"  type="text" value=""></td>
				</tr>
		</table>
      </fieldSet>
	   <fieldset><legend>监督人员</legend>
	  	...
	  	<table width="97%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
			...
			<table id="file_table6" border="0" cellpadding="0" cellspacing="0" class="tab_line_height" width="100%">
				<tr class='file_tr'>
					<td class='inquire_item5'>处置会议记录<font color="red">*(必填项)</font>：</td>
		  			<td class='inquire_form5'><input type='file' name='doc_content_meet__tmp' id='doc_content_meet__tmp' onchange='getFileInfo(this)' class='input_width'/></td>
					<td class='inquire_item5'>附件名：</td>
					<td class='inquire_form5'>
						<input type='text' readonly='readonly' name='doc_name__tmp' id='doc_name__tmp' class='input_width' />
						<input type='hidden' id='doc_type__tmp' name='doc_type__tmp'/>
					</td>
				</tr>
			</table>
	  </fieldset>
...
$().ready(function(){
	...
	function saveInfo(){
		...
		//if($("#dispose_income_no").val()=="")
		//{
		//	alert("处置收入入账凭证号不能为空!");
		//	return;
		//}
		if($("#dispose_date").datebox('getValue')=="")
		{
			alert("处置日期不能为空!");
			return;
		}
		...
		if('<%=dispose_method_id%>'=='null'){
			if(($("#doc_content_meet__tmp").val()==undefined||$("#doc_content_meet__tmp").val()=='')){
				alert('会议记录附件不允许为空！');
				return;
			}
		}
...
function refreshData(){
	...
	if('<%=dispose_method_id%>'!='null'){
		...
		$("#dispose_income_no").val(baseData.deviceMap.dispose_income_no);
		$("#remark").val(baseData.deviceMap.remark);
		$("#dispose_date").datebox("setValue",baseData.deviceMap.dispose_date);

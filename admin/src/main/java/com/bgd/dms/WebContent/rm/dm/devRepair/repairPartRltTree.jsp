...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.TreeStore', {
        ...
        proxy: {
       	 type : 'ajax',
            method: 'get',
            url: '<%=contextPath%>/rm/dm/devRepair/getRepartPartTreeOnlyUnit.srq',
            reader: {
                type : 'json'
            }
        },
    ...
    function cellclick(grid, colspan, colIndex, rowdata, rowspan, rowIndex, e) {
        ...
        var id = rowdata.data.id.split("~")[0];
  		parent.mainRightframe.location.href = "<%= contextPath%>/rm/dm/devRepair/repairPartRltList.jsp?is_leaf="+is_leaf+"&node_level="+node_level+"&id="+id;
    }
});

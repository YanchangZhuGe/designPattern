...
function searchDevData(){
		...
		refreshData(dispose_method_name, dispose_method_no,'',start_date,end_date);
	}
 ...
 function refreshData(dispose_method_name, dispose_method_no,dispose_method_id,start_date,end_date){
      	var temp = "";

...
function refreshData(){
	...
	cruConfig.queryOp = "getTeamwzList";
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>&nbsp;</td>
										<td class="ali_cdn_name">日期:</td>
								 	    <td class="ali_cdn_input"><input class="input_width" id="date" name="date" type="text" readonly/></td>
						...
						<div class="tongyong_box_title"><span class="kb"><a href="#"></a></span><a href="#">单日物资消耗详情</a></div>

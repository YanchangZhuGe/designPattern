...
/**监测系统传递页面参数修改代码 开始**/
	$(function(){
		var _u = "<%=contextPath%>/ei/sap/device/appendingApprovalForPlan.srq";
		var p_param = '';
		<%
		if(!("".equals(_p_p))){
		%>
...
/**监测系统传递页面参数修改代码 结束**/
	...
	function getTab3(index) {  
		...
		//延迟加载已审批的流程
		if(index==1){
			$("#wfOldPic").attr("src","<%=contextPath%>/ei/sap/device/appendingApprovalForPlan.srq")
		}
	}
...
<body style="overflow-y:hidden;overflow-x:hidden;padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;" >
				<div id="tag-container_3" style="margin-top:2px;margin-left:2px;">
					<ul id="tags" class="tags">
						...
						<li id="tag3_1"><a id="0" href="#" onclick="getTab3(1)">向sap发送审批待办申请</a>
						</li>
				...
				<div id="tab_box" class="tab_box" style="overflow-y:hidden">
					...
					<div id="tab_box_content1" class="tab_box_content"  style="display:none;overflow-y:hidden">
						<iframe width="100%" height="100%" name="wfPic" id="wfOldPic" frameborder="0" src="<%=contextPath%>/pm/toSapPlan/appendingPlanList.jsp" marginheight="0" marginwidth="0"  scrolling="auto"></iframe>
					</div>

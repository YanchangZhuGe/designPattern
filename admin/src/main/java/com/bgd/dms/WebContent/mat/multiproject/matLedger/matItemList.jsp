      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<!--			    <auth:ListButton functionId="" css="fz" event="onclick='toAdd()'" title="添加"></auth:ListButton>
			    <auth:ListButton functionId="" css="zj" event="onclick='toAddNew()'" title="添加新物资"></auth:ListButton>

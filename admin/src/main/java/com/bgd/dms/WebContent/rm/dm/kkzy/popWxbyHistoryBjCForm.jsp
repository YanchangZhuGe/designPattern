					...
					<tr>
						<td width="99%">
							<div class="tongyong_box">
								...
								href="#"></a></span><a href="#">消耗备件历史明细(<%=project_name %>)</a>
								<span class="gd"><a href="#"></a></span>
								<span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('bjxhlsmx')" title="导出excel"></a>
								</span>
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj = jcdpCallService("EarthquakeTeamStatistics","getWxbyHistoryBjCForm","self_num=<%=self_num%>&coding_code_id=<%=coding_code_id%>&project_info_id=<%=project_info_id%>&wz_id=<%=wz_id%>");
	...
	function exportDataDoc(exportFlag){
		...
		var submitStr = "self_num=<%=self_num%>&coding_code_id=<%=coding_code_id%>&project_info_id=<%=project_info_id%>&wz_id=<%=wz_id%>&exportFlag="+exportFlag;

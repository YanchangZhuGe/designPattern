...
<script type="text/javascript">
	...
	function showDevTreePage(){
		...
		var returnValue = window.showModalDialog("<%=contextPath%>/dmsManager/safekeeping/add_devpage.jsp?out_org_id="+out_org_id,"","dialogWidth=1200px;dialogHeight=480px");			
		var strs= new Array(); //定义一数组
		if(!returnValue){
			return;
		}

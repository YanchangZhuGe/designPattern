...
<%
  ...
  String mainFrameUrl = rootPath;
  if(listUrl!=null){
	  mainFrameUrl = listUrl;
  }
...
<script type="text/javascript">
	...
	function redirect(){
		var listUrl = "<%=listUrl%>";
		var mainFrameUrl="<%=mainFrameUrl%>";
		if(listUrl!=null||listUrl!="undifined"){
			getTab('8ad899ae4ed8ec8b014ed90d1d27000d',mainFrameUrl,0);
		}
	}
  ...
  <tr valign="top">
  	...
  	<td > 
  		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
  				<td>
					<iframe id="list" name="list" title="mainFrame" width="100%" height="100%" frameborder="0" src="<%=request.getContextPath()%>"></iframe>
				</td>
			</tr>
		</table>
 </td>

...
<input type='hidden' name='invoices_type' id='invoices_type' value='3'/>
...
<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="<input name='actual_price_{wz_id}'  type='text' value='{wz_price}'/>">调剂单价</td>

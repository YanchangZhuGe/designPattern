...
<div id="list_table2">
	<div id="tag-container2_3">
		<ul id="tags" class="tags">
			<li class="selectTag" id="tag3_0"><a href="#" onclick="getTab3(0)">HSE责任书统计</a></li>
			<li id="tag3_1"><a href="#" onclick="getTab3(1)">签订情况录入</a></li>
		</ul>
	</div>
</div>
<script type="text/javascript">
	...
	function getTab3(index) {  
		...
		if(index==0){
			parent.menuFrame.location.href = "<%=contextPath%>/hse/objAndTarget/hseDutyBook/duty_book.jsp?isProject=<%=isProject%>";
		}else if(index==1){
			parent.menuFrame.location.href = "<%=contextPath%>/hse/objAndTarget/hseDutyBook/duty_book_list.jsp?isProject=<%=isProject%>";
		}
	}

 ...
 <body style="background:#fff" onload="refreshData('');">
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      ...
		      <%} %>
			  	<td class="ali_cdn_name">试验总结文档</td>
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <%} %>
			      <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">试验总结文档</td>
...
<script type="text/javascript">
	...
	var businessType="5110000004100000089";
	...
	function refreshData(str){
		...
		"left join bgp_doc_gms_file f on t.tecnical_id = f.relation_id and f.doc_file_type = '0110000061100000015' and f.bsflag = '0' "+
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/expSumDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'750:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/expSumDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&id='+id+'&isSingle='+isSingle,'750:680');
	}

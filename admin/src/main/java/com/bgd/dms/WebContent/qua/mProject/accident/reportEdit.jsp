  ...
  <div id="new_table_box_content"> 
    ...
    <table  width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
    	...
    	<tr>
	    	...
	    	<td class="inquire_item4"><font color="red">*</font>预计直接经济损失:</td>
	    ...
	    <tr>	    
	    	...
	    	<td class="inquire_form4"><input name="reporter_id" id="reporter_id" type="hidden" class="input_width" value="" />
	    		<input name="reporter_name" id="reporter_name" type="text" class="input_width" value="" disabled="disabled"/>
	    		<img onclick="selectOrgHR('userId','reporter_id','reporter_name')" src="<%=contextPath %>/images/images/tree_12.png" width="16" height="16" style="cursor: hand;" /></td>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		if(retObj.returnCode =='0'){
			...
			if(map !=null ){
				...
				document.getElementById("reporter_name").value = map.reporter_name;
	...
	function newSubmit() {
		...
		form.action = '<%=contextPath%>/qua/sProject/accident/saveAccidentReport.srq';
		form.submit();
	}
	function checkValue(){

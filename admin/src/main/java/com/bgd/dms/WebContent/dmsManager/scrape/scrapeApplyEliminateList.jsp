      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <td class="ali_cdn_name">批复状态</td>
			    <td class="ali_cdn_input" style="width: 110px;">
			    	<select id="report_dev_type">
			...
			<div id="tag-container_3">
			  <ul id="tags" class="tags">
			    ...
			    <li id="tag3_1"><a href="#" onclick="getContentTab(this,1)">技术淘汰信息</a></li>
			    <li id="tag3_1"><a href="#" onclick="getContentTab(this,2)">设备明细</a></li>
			    <li id="tag3_1"><a href="#" onclick="getContentTab(this,3)">附件</a></li>
			    <!-- <li id="tag3_1"><a href="#" onclick="getContentTab(this,14);byjh();">专家信息</a></li> -->
			  </ul>
			</div>
			<div id="tab_box" class="tab_box">
				...
				<div id="tab_box_content1" name="tab_box_content1" idinfo="" class="tab_box_content" style="display:none">
					<iframe width="100%" height="100%" name="pkhsxx" id="pkhsxx" frameborder="0" src="" marginheight="0" marginwidth="0" ></iframe>
				</div>
					  ...
					  <tr>
					    ...
					    <td background="<%=contextPath%>/images/list_15.png">
						    <table width="100%" border="0" cellspacing="0" cellpadding="0">
							    <tr>
								    <td>&nbsp;</td>
								    <auth:ListButton functionId="" css="xz" event="onclick='exportDevData()'" title="导出技术淘汰设备"></auth:ListButton>
							    </tr>
							</table>
						</td>
...
$(function(){
	...
	function getContentTab(obj,index) {
		...
		if(index == 1){
		  ...
		  //技术淘汰信息
		  //popWindow('/DMS/dmsManager/scrape/scrapeApplyDamageShow.jsp?scrape_apply_id='+ids,'','报废评审');
		  $("#pkhsxx").attr("src","<%=contextPath%>/dmsManager/scrape/scrapeApplyEliminateShow.jsp?scrape_apply_id="+ids);
		}
		else if(index == 2){
			var baseData;
			var ids = getSelIds('selectedbox');
		  ...
		  //设备信息显示
			$("#dev_grid").datagrid({
				...
				queryParams:{'scrape_apply_id':ids,'scrape_type':'1'}
			});
		}else if(index == 3){
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "queryScrapeApplyEliminateList";
	...
	function searchDevData(){
		...
		var report_dev_type = document.getElementById("report_dev_type").value;
		
		refreshData(scrape_apply_no, scrape_apply_name,'',report_dev_type);
	}
    ...
    function refreshData(scrape_apply_no, scrape_apply_name, scrape_apply_id,report_dev_type){
      	var temp = "&procStatus=4";
		...
		if(typeof report_dev_type!="undefined" && report_dev_type!=""){
			temp += "&report_dev_type="+report_dev_type;
		}
	...
	function toAddScrapePage(){
		popWindow('<%=contextPath%>/dmsManager/scrape/scrapeApply_add.jsp','','报废申请单');
	}
	function toModifyScrapePage(){
		...
		popWindow('<%=contextPath%>/dmsManager/scrape/scrapeApply_add.jsp?scrape_apply_id='+ids+'&proStatus='+proStatus,'','报废申请');
	}
   ...
   function exportDevData(){
	...
	var submitStr="scrape_apply_id="+ids+"&exportFlag="+exportFlag+"&scrape_type=1";

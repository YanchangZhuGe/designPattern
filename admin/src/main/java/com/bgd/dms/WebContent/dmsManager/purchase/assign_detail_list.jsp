	...
	<div id="list_table">
		<div id="table_box">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
				<tr>
					<td class="bt_info_even" autoOrder="1" exp="<input type='hidden' value='ids_{fp_id}' id='{fp_id}'/>">序号</td> 
					<td class="bt_info_odd" exp="{line_num}">行号</td>
					<td class="bt_info_even" exp="{order_line_desc}">订单行说明</td>
					...
					<td class="bt_info_odd" exp="{name_spec}">名称规格</td>
					<td class="bt_info_even" exp="{amount}">数量</td>
					<td class="bt_info_odd" exp="{meas_unit}">计量单位</td>
					<td class="bt_info_even" exp="{unit_price}">单价</td>
					<td class="bt_info_odd" exp="{currency}">币种</td>
					<td class="bt_info_even" exp="{amount_money}">金额</td>
					<td class="bt_info_odd" exp="{accept_org_name}">资产落户单位</td>
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "queryCgApplyFPList";

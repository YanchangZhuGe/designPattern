...
<%
	...
	System.out.println("The moduleID is:"+moduleID);
%>
...
function getSubNodes(parentNode) {
	...
	Ext.Ajax.request({
		...
		params : {
			currentPage:"1",
			pageSize:"10000",
			querySql:"select f.file_id, f.file_name from bgp_doc_folder_module t join bgp_doc_gms_file f on t.folder_id = f.file_id and t.project_info_no ='"+project_info_no+"' and t.module_id = '<%=moduleID%>'"
		},
		method : 'Post',

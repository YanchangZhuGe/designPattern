		...
		<div id="new_table_box_bg">
			<table  width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
			    ...
			    <tr>
			    	...
			    	<td class="inquire_form4"><select id="company_type" name="company_type" onchange="change();" class="select_width">
		    ...
		    <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tab_line_height" id="team" style="display: none">
	    		<tr>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		if(retObj.returnCode=='0'){
			if(retObj.datas != null && retObj.datas.length>0){
				...
				var company_type = datas.company_type-1;
				document.getElementById("company_type").options[company_type].selected = true;
				if(company_type!=null && company_type=='1'){
	...
	function newSubmit() {
		...
		var equipment_mode = document.getElementById("equipment_mode").value ;
		if(company_id!=null && company_id!=''){
			...
			" t.team_num='"+team_num+"' ,t.equipment='"+equipment+"' ,t.equipment_mode='"+equipment_mode+"'" +
			...
			var sql ="select * from bgp_market_oil_company t where t.bsflag='0' and t.company_name='"+company_name+"'";
			var obj = syncRequest('post',cruConfig.contextPath+appConfig.queryListAction,'querySql='+encodeURI(sql));
			...
			"&company_type="+company_type+"&company_stork="+company_stork+"&key_name="+key_name +"&key_position="+key_position+"&key_telephone="+key_telephone+"&key_email="+key_email+
			"&team_num="+team_num+"&equipment="+equipment+"&equipment_mode="+equipment_mode;
			if(substr!=''){
	...
	function companyType(select ,id ,name){
	    ...
	    if(select !=null && select=='1' ){
	    	if(divisory_type!=null && divisory_type==select){
	    		...
	    		window.showModalDialog('<%=contextPath%>/market/crm/common/company_tree.jsp',company_type,'dialogWidth=300px;dialogHeight=600px');
	    	}
	    	...
	    	if(divisory_type!=null && divisory_type==select){
	    		...
	    		window.showModalDialog('<%=contextPath%>/market/crm/common/section_tree.jsp',company_type,'dialogWidth=300px;dialogHeight=600px');
	    	}

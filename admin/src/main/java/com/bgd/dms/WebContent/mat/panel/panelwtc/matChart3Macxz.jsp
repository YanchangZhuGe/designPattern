			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box_title"><span class="kb"><a href="#"></a></span><a href="#">配件消耗对比</a></div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		...
		myChart1.setXMLUrl("<%=contextPath%>/mat/panel/getChart17.srq?projectInfoNo=<%=projectInfoNo%>");   

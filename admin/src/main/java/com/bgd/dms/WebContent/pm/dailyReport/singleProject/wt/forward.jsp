...
location.href="<%=contextPath %>/pm/dailyReport/singleProject/wt/showTree.srq?projectInfoNo=<%=projectInfoNo %>&taskBackUrl=<%=taskBackUrl %>&customKey=<%=customKey %>&customValue=<%=customValue %>";
</script>
<body>
</body>
</html>
...
function appendEvent(treeNode){
	...
	if(jcdpTreeCfg.clickEvent) treeNode.on("click",clickForderNode);
...
/**
	给节点增加响应事件
*/
function appendDeviceEvent(treeNode){
	if(jcdpTreeCfg.clickEvent) treeNode.on("click",clickDeviceNode);
}	

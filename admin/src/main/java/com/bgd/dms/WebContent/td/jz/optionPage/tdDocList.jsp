...
<script type="text/javascript">
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/ConsdesignDoc/add_tdDocModifyNew.jsp?docType=<%=docType%>&fileAbbr='+fileAbbr+'&parent_file_id=<%=parent_file_id%>');
    }
	function toEdit() {

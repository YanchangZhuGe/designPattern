...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model,license_num,self_num,dev_sign){
		var str = "select account.dev_acc_id,account.asset_coding, "
				+ "account.dev_coding,account.self_num,account.dev_sign, "
				+ "account.license_num,account.actual_in_time,account.planning_out_time, "
				+ "account.dev_name,account.dev_model "
				...
				+ "where account.project_info_id='"+projectInfoNos+"' and account.actual_out_time is null "
		...
		if(zbflag == 'Y'){
			str += "and acc.owning_sub_id like '%"+orgsubId+"%' ";
		}

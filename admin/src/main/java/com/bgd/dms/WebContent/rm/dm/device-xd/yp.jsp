...
<script type="text/javascript"> 
	...
	function loadDataDetail(){
		...
		if(oil_info_id=="null"){
			...
			var querySql="select a.*,b.dev_name,b.dev_model,b.self_num,b.license_num,c.PROJECT_NAME,b.owning_org_name,b.usage_org_name,b.using_stat,b.tech_stat from BGP_COMM_DEVICE_OIL_INFO a left join GMS_DEVICE_ACCOUNT_DUI b on a.DEVICE_ACCOUNT_ID=b.dev_acc_id left join gp_task_project c on b.PROJECT_INFO_ID=c.project_info_no  where a.oil_info_id='"+oil_info_id+"'" ;
			var queryRet = syncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'querySql='+querySql);
			var basedatas = queryRet.datas;
			$("#dev_name")[0].value=basedatas[0].dev_name;
			$("#dev_model")[0].value=basedatas[0].dev_model;

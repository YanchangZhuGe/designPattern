			...
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <td>
			   <input type="button" name="daily_mian" id="daily_mian" value="面积、长度/公里数" onclick="dailyChange();"></input>
			    <input type="button" name="daily_mian" id="daily_mian" value="坐标点" onclick="dailyChange1();"></input>
			   </td>
			    <td>&nbsp;</td>
...
*/		
	...
	function dbclickRow(ids){
	   ...
	   var ids1 = idss[1];
	    ...
	    popWindow('<%=contextPath%>/pm/dailyReport/multiProject/wt/viewDailyReport.jsp?produce_date='+ids+'&status='+ids1+'&build='+ids2+'&weather='+ids3+'&daily_no_wt='+ids5,'1280:800');

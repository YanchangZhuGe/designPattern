...
location.href="<%=contextPath %>/pm/dailyReport/singleProject/ws/queryWsResourceAssignment.srq?projectInfoNo=<%=projectInfoNo %>&produceDate=<%=produceDate %>&taskObjectId=<%=taskObjectId %>&edit_flag=<%=edit_flag %>";
</script>
<body>
</body>
</html>
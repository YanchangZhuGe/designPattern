...
<%
	...
	System.out.println("The project info no is:"+project_info_no);
...
var querySql = "Select b.file_id,b.file_name FROM bgp_doc_gms_file b WHERE b.project_info_no = '"+project_info_no+"' and b.bsflag='0' and b.is_file='0'  and b.file_abbr='HSE'    and b.is_template is null ";
...
function clickNode(selectedNode){
	...
	//显示目录下面的所有文档
	//parent.menuFrame.location.href = "<%=contextPath%>/doc/singleproject/doc_list2.jsp?folderid="+selectedNode.id;
	parent.mainFrame.refreshData(selectedNode.id);
	//parent.mainBottomframe.location.href = "<%=contextPath%>/doc/singleproject/blank.htm";

					...
					<tr>
						<td width="99%">
							<div class="tongyong_box">
								...
								href="#"></a></span><a href="#">震源备件消耗明细</a>
								<span class="gd"><a href="#"></a></span>
								<span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('pzybjuse')" title="导出excel"></a>
								</span>
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj = jcdpCallServiceCache("EarthquakeTeamStatistics","getPopZyBjUse","project_info_id=<%=project_info_id%>&type=<%=type%>&start_date=<%=start_date%>&end_date=<%=end_date%>&coding_code_id=<%=coding_code_id%>");
	...
	function exportDataDoc(exportFlag){
		...
		var submitStr = "project_info_id=<%=project_info_id%>&type=<%=type%>&start_date=<%=start_date%>&end_date=<%=end_date%>&coding_code_id=<%=coding_code_id%>&exportFlag="+exportFlag;

...
<script type="text/javascript"><!--
    ...
    function loadDataDetail(obj){
		...
		if(shuaId!=null){
			var querySql="select  d.employee_name,b.owning_org_name,b.project_info_id,c.PROJECT_NAME,a.* ";
			querySql+="from GMS_DEVICE_EQUIPMENT_OPERATOR a left join GMS_DEVICE_ACCOUNT_DUI b on a.DEVICE_ACCOUNT_ID=b.dev_acc_id ";
			querySql+="left join gp_task_project c on b.PROJECT_INFO_ID=c.project_info_no left join comm_human_employee d on a.OPERATOR_ID=d.employee_id where DEVICE_ACCOUNT_ID='"+shuaId+"'";

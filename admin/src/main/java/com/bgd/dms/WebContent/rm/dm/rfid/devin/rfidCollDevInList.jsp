      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <td class="ali_cdn_name">接收单位名称</td>
			    ...
			    <td>&nbsp;</td>
			    <auth:ListButton functionId="" css="jl" event="onclick='toDetailPage()'" title="JCDP_btn_submit"></auth:ListButton>
			...
			<div id="table_box">
			  <table style="width:98.5%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
					...
					<td class="bt_info_odd"  exp="{device_mixapp_no}">返还调配单号</td>
					<td class="bt_info_even" exp="{backapp_name}">返还申请单名称</td>
					<td class="bt_info_odd" exp="{back_org_name}">返还单位名称</td>
					<td class="bt_info_even" exp="{receive_org_name}">接收单位名称</td>
					<td class="bt_info_odd" exp="{employee_name}">申请人</td>
					<td class="bt_info_even" exp="{backdate}">离场时间</td>
...
<script type="text/javascript">
    ...
    function loadDataDetail(devicebackappid){
		...
		if(devicebackappid!=null){
			...
			var queryRet = encodeAndsyncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'querySql='+querySql);
	...
	function refreshData(v_backmixinfo_no,v_usage_org_name,v_backmixinfo_name){
		...
		if(v_backmixinfo_no!=undefined && v_backmixinfo_no!=''){
			str += "and t.device_mixapp_no like '%"+v_backmixinfo_no+"%' ";
		}
		if(v_usage_org_name!=undefined && v_usage_org_name!=''){
			str += "and org.org_abbreviation like '%"+v_usage_org_name+"%' ";
		}
		if(v_backmixinfo_name!=undefined && v_backmixinfo_name!=''){
			str += "and gp.project_name like '%"+v_backmixinfo_name+"%' ";
		}
	...
	function toDetailPage(){
		...
		window.location.href='<%=contextPath%>/rm/dm/rfid/devin/rfidCollDevInSubList.jsp?id='+shuaId;
    }

...
function save(){
	...
	form.action = "<%=contextPath%>/td/ws/toSaveWorkRangeDoc.srq?businessType=<%=businessType%>";
	form.submit();
	newClose();
}
...
//	if (!isLimitB20("written_unit","踏勘组织单位")) return false;  
	...
	if(fileId!='null'){ 
		if (!isTextPropertyNotNull("pk_0110000061100000018", "踏勘报告")) return false;	
	}else{
		if (!isTextPropertyNotNull("0110000061100000018", "踏勘报告")) return false;	
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>踏勘报告：</td>
									<td colspan="2">

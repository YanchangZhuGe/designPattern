...
<iframe width="100%" id="viewprojectiframe" height="100%" frameborder="0"   style="overflow: scroll;" src="<%=contextPath %>/wt/pm/planManager/singlePlan/progress/viewProject.jsp?projectInfoNo=<%=projectInfoNo%>" ></iframe>

<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
	<tr><td><div class="tongyong_box_title">1.4 施工方法：</div></td></tr>
</table>

<iframe width="100%" id="technicalparameteriframe" height="100%" frameborder="0" src="<%=contextPath %>/wt/tm/parameter/technicalParameter.jsp?projectInfoNo=<%=projectInfoNo%>&action=view"  style="overflow: scroll;"></iframe>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
	<tr>
	<td><div class="tongyong_box_title">自然因素影响时间</div></td></tr>
</table>

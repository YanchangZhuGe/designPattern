...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			    ...
			    <td align="right">
			    <a  href="javascript:downloadModel('燃油消耗导入模板')">下载模板</a>
			    </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
	...
	<tr>
		<td class="bt_info_odd"
			exp="<input name = 'rdo_entity_name' id='rdo_entity_id' type='checkbox' value='{teammat_out_id}' onclick='loadDataDetail()'/>">选择</td>
...
var showTabBox = document.getElementById("tab_box_content0");
	...
	function loadDataDetail(shuaId){
	 ...
	 function toAdd(){
	    popWindow("<%=contextPath%>/mat/singleproject/oilconsumption/addConsumption.jsp",'1024:800');
	 }
	...
	function toEdit(){
	    ...
	    if(ids==''){ alert("请先选中一条记录!");
	    	...
	    	var temp = ids.split(",");
		    	if(temp.length==1){
			    	 popWindow("<%=contextPath%>/mat/singleproject/oilconsumption/editConsumption.srq?teammatOutId="+ids,'1024:800');
		    	}else{
		    		alert("请先选中一条记录!");
			    	return;
		    	}
	...
	//汇总信息
	 function taskShow(value){
			...
			var retObj = jcdpCallService("MatItemSrv", "findConsumptionList", "ids="+value);
		...
		function downloadModel(filename){
			...
			filename = encodeURI(filename);
			window.location.href="<%=contextPath%>/mat/singleproject/mattemplate/download.jsp?path=/mat/singleproject/oilconsumption/oilInport.xlsx&filename="+filename+".xlsx";
		}
</script>

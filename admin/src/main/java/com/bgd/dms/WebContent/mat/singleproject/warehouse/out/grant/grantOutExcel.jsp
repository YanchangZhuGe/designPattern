...
<body onload='refreshData();getApplyTeam();getConRatio()'>
...
<table border="0" cellpadding="0" cellspacing="0" class="tab_line_height" width="100%">
	...
	<tr>
		<td class="inquire_item6">发放类别：</td>
...
<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    <td>&nbsp;</td>
		    <td align="right">
		    <a  href="<%=contextPath%>/mat/singleproject/mattemplate/download.jsp?path=/mat/singleproject/plan/matplan.xlsx&filename=物资出库模板.xlsx">下载物资申请模板</a>
...
<fieldset>
	<div id="table_box" >
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="right" id="queryRetTable">
			<tr>
				<td class="bt_info_even" exp="<input name = 'rdo_entity_id' id = 'rdo_entity_id' type='checkbox'  value='{wz_id}' onclick='loadDataDetail()'/>" >选择</td>
				...
				<td class="bt_info_odd"exp="<input type='text' name='mat_num_{wz_id}' id='mat_num_{wz_id}' value='{demand_num}'  style='width:40px'/>">本次发放数量</td>
				<td class="bt_info_even" exp="<input type='text' name='mat_price_{wz_id}' id='mat_price_{wz_id}' value='{actual_price}'  style='width:40px'/>">实际单价</td>
...
//    	var applyTeamList=jcdpCallService("HumanCommInfoSrv","queryApplyTeam","");
	...
	function loadDataDetail(shuaId){
		...
		for(var i=1;i<row.length;i++){
			...
			var cell_10 = row[i].cells[10].firstChild.value;
			if(cell_9!=undefined && cell_10!=undefined){
				...
				row[i].cells[11].firstChild.value=Math.round((outNum*wzPrice)*1000)/1000;
	...
	function getConRatio(){
	 ...
	 function AddExcelData(){
		 var obj=window.showModalDialog('<%=contextPath%>/mat/singleproject/warehouse/out/grant/planExcelAdd.jsp',"","dialogHeight:500px;dialogWidth:600px");
		obj = decodeURI(obj,'UTF-8');
		obj = decodeURI(obj,'UTF-8');
		alert(obj);
		 if(obj!="" && obj!=undefined ){
			 var retObject;
			 retObject = jcdpCallService("MatItemSrv","getPlanExclData","obj="+obj);
			 ...
			 cruConfig.queryStr = "";
			 cruConfig.queryService = "MatItemSrv";
			 cruConfig.queryOp = "queryExcelDatas";

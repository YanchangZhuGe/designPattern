...
//删除文件
	...
	function fujian(i){
		...
		times = encodeURI(encodeURI(times));
	 	window.showModalDialog("<%=contextPath%>/dmsManager/scrape/selectScrapeFileListCollect.jsp?org_name="+org_name+"&dev_name="+dev_name+"&dev_type="+dev_type+"&times="+times+"&scrape_type="+scrape_type+"&scrape_apply_id1="+scrape_apply_id1,"","dialogWidth=1240px;dialogHeight=480px");
	}
	/*打印评审单*/
	function myprint()
	{

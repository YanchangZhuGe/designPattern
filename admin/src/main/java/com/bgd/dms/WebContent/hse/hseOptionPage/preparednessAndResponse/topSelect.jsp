...
<table border="0" cellpadding="0" cellspacing="0" class="tab_line_height"   id="table1" width="1000px">
    ...
    <div style="display:none"> <img src="<%=contextPath%>/images/calendar.gif" id="tributton1" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(acquisition_time,tributton1);" />&nbsp;</div>
    </td>

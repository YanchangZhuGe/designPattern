			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <%} %>
			      <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">计划书</td>
			      <td class="bt_info_odd" exp="{test_start_date}">计划开始时间</td>
			      <td class="bt_info_odd" exp="{test_end_date}">计划结束时间</td>
...
<script type="text/javascript">
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/doc/projectMoveDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'800:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/doc/projectMoveDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&id='+ids+'&isSingle='+isSingle,'800:680');
	}

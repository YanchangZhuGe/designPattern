...
<script type="text/javascript" src="<%=contextPath%>/js/gms_list.js"></script>
 ...
 <div id="tab_box_content0" class="tab_box_content" style="background:#fff;width:840px;height:500px;overflow-x:hidden; "  > 
      	...
      	<div id="list_table">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
			    <td class="ali_cdn_name" id="bz1" >设置班组</td>
			    <td class="ali_cdn_input" id="bz2" ><select id="s_set_apply_team" name="s_set_apply_team" class="select_width"  onchange="getPost()"></select></td>
			  	<td class="ali_cdn_name" id="gw1" >设置岗位</td>
			    <td class="ali_cdn_input" id="gw2" ><select id="s_set_post" name="s_set_post" class="select_width"></select></td>
...
//alert([rowid,ids]); 
	...
	var tdView='<%=projectType%>';
	if(tdView =='5000100004000000009'){ 
		document.getElementById("bz1").style.display="none";
		document.getElementById("bz2").style.display="none";

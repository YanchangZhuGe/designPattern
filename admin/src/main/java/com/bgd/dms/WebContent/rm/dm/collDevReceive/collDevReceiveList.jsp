...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
  <title>单项目-设备接收-设备接收(采集设备)</title> 
 </head> 
			...
			<div id="table_box">
			  <table style="width:98.5%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr id='device_outinfo_id_{device_outinfo_id}' name='device_outinfo_id'>
			     	<td class="bt_info_even" exp="<input type='checkbox' name='selectedbox' value='{device_outinfo_id}_{device_app_id}' id='selectedbox_{device_outinfo_id}'  onclick='chooseOne(this);'/>" >选择</td>
...
<script type="text/javascript">
	...
	function searchDevData(){
		...
		refreshData(v_device_app_name, v_outinfo_no, v_opr_state_desc);
	}
	...
	function refreshData(v_device_app_name,v_outinfo_no,v_opr_state_desc){
...
// 		+"where cof.project_info_no='"+projectInfoNos+"' and cof.state='9' and cof.bsflag='0' ";
		var str = "select * from(select * from(select devapp.device_app_id,devapp.device_app_name,he.employee_name,pro.project_name,";
			...
			if(projectType == "5000100004000000008" && retFatherNo.length >= 1){//子项目
				...
				str += "where (allapp.allapp_type = 'S1405' or allapp.allapp_type is null) and (allapp.allapp_type = 'S1405' or allapp.allapp_type is null) and cof.bsflag='0' and cof.devouttype!='2' and cof.project_info_no = '" +retFatherNo+"' ";
	        	...
	        	str += "where (allapp.allapp_type = 'S1405' or allapp.allapp_type is null) and (allapp.allapp_type = 'S1405' or allapp.allapp_type is null) and cof.bsflag='0' and cof.devouttype!='2' and cof.project_info_no='"+projectInfoNos+"' ";
	    }else{
	        	str += "left join gp_task_project pro on cof.project_info_no = pro.project_info_no and pro.bsflag = '0' ";
	        	str += "where (allapp.allapp_type = 'S1405' or allapp.allapp_type is null) and cof.bsflag='0' and cof.devouttype!='2' and cof.project_info_no='"+projectInfoNos+"' ";
		  }
			str += "and exists (select 1 from gms_device_coll_outsub sub where sub.device_outinfo_id = cof.device_outinfo_id) ) ";
			...
			{
				str += "left join gp_task_project pro on cof.project_info_no = pro.project_info_no and pro.bsflag = '0' and pro.project_type = '5000100004000000008' ";
				str += "where cof.bsflag='0' and cof.devouttype='2' and cof.project_info_no = '" +retFatherNo+"' ";
			}else if(projectType == "5000100004000000008" && retFatherNo.length <= 0){
	        	str += "left join gp_task_project pro on cof.project_info_no = pro.project_info_no and pro.bsflag = '0' and pro.project_father_no is null and pro.project_type = '5000100004000000008' ";
	        	str += "where cof.bsflag='0' and cof.devouttype='2' and cof.project_info_no='"+projectInfoNos+"' ";
	         }else{
	        	str += "left join gp_task_project pro on cof.project_info_no = pro.project_info_no and pro.bsflag = '0' ";
	        	str += "where cof.bsflag='0' and cof.devouttype='2' and cof.project_info_no='"+projectInfoNos+"' ";
		     }
	...
	function toDetailPage(){
		...
		window.location.href='<%=contextPath%>/rm/dm/collDevReceive/collSubDevReceiveList.jsp?outInfoId='+shuaId+'&sonFlag='+sonFlag;
    }

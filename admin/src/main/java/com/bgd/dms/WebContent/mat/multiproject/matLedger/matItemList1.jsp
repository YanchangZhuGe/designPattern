      	...
      	<div id="list_table">
			...
			<div id="tag-container_3">
			  <ul id="tags" class="tags">
			    ...
			    <li id="tag3_1"><a href="#" onclick="getTab3(1)">消耗详情</a></li>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		if(codeId !=null && codeId != rootId){
		  if(userId == 'C105'){
			sql += "select g.*, c.code_name from gms_mat_infomation g inner join GMS_MAT_CODING_CODE c on g.coding_code_id = c.coding_code_id and g.bsflag='0' and c.bsflag='0' and g.coding_code_id like'"+codeId+"%'";
		  }else{
			sql +="select c.code_name, g.wz_id ,g.coding_code_id,g.wz_name,g.wz_prickie,g.wz_code,g.wz_price from gms_mat_infomation_wtc  w inner join gms_mat_infomation g on g.wz_id = w.wz_id inner join GMS_MAT_CODING_CODE c on g.coding_code_id = c.coding_code_id and g.bsflag='0'and c.bsflag='0' and w.bsflag ='0' and g.coding_code_id like'"+codeId+"%'";
			  }
	}
		else
			{
			...
			sql +="select c.code_name, g.wz_id ,g.coding_code_id,g.wz_name,g.wz_prickie,g.wz_code,g.wz_price from gms_mat_infomation_wtc  w inner join gms_mat_infomation g on g.wz_id = w.wz_id inner join GMS_MAT_CODING_CODE c on g.coding_code_id = c.coding_code_id and g.bsflag='0'and c.bsflag='0' and w.bsflag ='0'";
					}
			}
	  ...
	  function toAdd(){ 
		  ...
		  if(codeId==null){
			confirm("请选择物资分类!");
			  ...
			  popWindow("<%=contextPath%>/mat/multiproject/matLedger/matLedgerMenuWTC.jsp");
			  }

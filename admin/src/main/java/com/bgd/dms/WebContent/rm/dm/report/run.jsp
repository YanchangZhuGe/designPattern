				...
				<tr>
					<td class="ali_cdn_name">统计月份：</td>
			 	    <td class="ali_cdn_input">
			 	    	<input type="text" id="monthDate" name="monthDate" class="input_width" style="width:120px" value="" readonly="readonly"/>
...
<% if(monthDate!=null && !monthDate.equals("")){
    ...
    str.append("monthDate=").append(monthDate).append(";projectInfoNo=").append(projectInfoNo)
    .append(";reportName=").append(reportName); %>
    <div>
...
<script type="text/javascript">
	...
	document.getElementById("monthDate").value = "<%=monthDate%>";
	...
	function simpleSearch(){
		...
		window.location="<%=contextPath%>/rm/dm/report/run.jsp?reportId=<%=reportId%>&projectInfoNo=<%=projectInfoNo%>&monthDate="+monthDate;
	}

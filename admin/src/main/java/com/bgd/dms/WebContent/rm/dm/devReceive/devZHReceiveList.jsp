...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
  ...
  <title>单项目-设备接收-设备接收(自有单台)-综合物化探专用</title> 
 </head> 
...
<script type="text/javascript">
	...
	function refreshData(v_device_app_name,v_mixinfo_no,v_opr_state_desc){
		...
		var str = "select devapp.device_app_name,he.employee_name,pro.project_name,dm.*,inorg.org_abbreviation as in_org_name,outorg.org_abbreviation as out_org_name,";
			...
			str += "where '1'='1' and dm.state='9' and dm.bsflag='0' and (dm.mixform_type='1' or dm.mixform_type='3') and dm.mix_type_id='S0000' and dm.project_info_no='"+projectInfoNos+"'";
    ...
    function toDetailPage(){
		...
		window.location.href='<%=contextPath%>/rm/dm/devReceive/subZHDevReceiveList.jsp?mixId='+shuaId;
    }

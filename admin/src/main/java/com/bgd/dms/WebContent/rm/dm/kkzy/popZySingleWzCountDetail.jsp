						...
						<td width="99%">
							<div class="tongyong_box">
								...
								<span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('dxmbjxhcc')" title="导出excel"></a>
								</span>
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj = jcdpCallServiceCache("EarthquakeTeamStatistics","getZySingleWzC","project_info_id=<%=project_info_id%>&self_num=<%=self_num%>&start_date=<%=start_date%>&end_date=<%=end_date%>&coding_code_id=<%=coding_code_id%>");

      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <td class="ali_cdn_input"><input id="s_employee_name" name="s_employee_name" type="text" class="input_width"  /></td>
			    <td class="ali_cdn_name">岗位</td>
			    <td class="ali_cdn_input"><input id="s_employee_cd" name="s_employee_cd" type="text" class="input_width"  /></td>
			    <td class="ali_query">
			...
			<div id="table_box">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
				 ...
				 <tr>
			      ...
			      <td class="bt_info_odd" exp="{start_date}">进入项目时间</td>
			      <td class="bt_info_even" exp="{end_date}">离开项目时间</td> 
			     </tr> 					        
...
<script type="text/javascript">
	...
	function simpleSearch(){ 
		...
		if(s_employee_coid !=''){
			str = str + " and d4.post_name like '"+q_file_name+"%' ";
		}
		if(s_employee_coid !=''){
			str = str + " and d3.apply_team_name like like '"+s_employee_coid+"%' ";
		}
	...
	function refreshData(taskId,projectInfoNo){
		...
		if(projectInfoNo==undefined){
     	...
     	cruConfig.queryStr = "select distinct t.labor_deploy_id,        t.labor_id,        l.employee_name,        l.employee_id_code_no,        t.project_info_no,        t.start_date,        t.end_date,  d2.deploy_detail_id,        d2.apply_team,        d2.post,        d3.coding_name apply_team_name,        d4.coding_name post_name,        round( case when nvl(t.end_date, sysdate) - t.start_date > 0 then nvl(t.end_date, sysdate) - t.start_date  -(-1) else 0 end ) days   from bgp_comm_human_labor_deploy t   left join bgp_comm_human_deploy_detail d2 on t.labor_deploy_id = d2.labor_deploy_id and d2.bsflag='0'  left join bgp_comm_human_labor l on t.labor_id = l.labor_id   left join comm_coding_sort_detail d3 on d2.apply_team = d3.coding_code_id   left join comm_coding_sort_detail d4 on d2.post = d4.coding_code_id   where t.bsflag = '0' and t.project_info_no =  '"+projectInfoNos+"' and l.if_engineer='<%=laborCategory%>' and t.start_date is not null and  t.end_date is null ";
		cruConfig.currentPageUrl = "/rm/em/singleHuman/humanLedger/rootPlanLaborList.jsp";
		queryData(1); 

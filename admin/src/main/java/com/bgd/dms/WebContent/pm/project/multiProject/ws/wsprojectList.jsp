				...
				<div id="tab_box_content0" class="tab_box_content">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					  ...
					  <tr>
					    ...
					    <td class="inquire_item6">指标金额：</td>
...
<script type="text/javascript">
	...
	function refreshData(){
		cruConfig.submitStr = "projectType="+projectType+"&orgSubjectionId="+orgSubjectionId;
		queryData(1);
	}
	...
	function toUpdateQualification(){
		...
		form.action="<%=contextPath%>/pm/project/ws/saveQualification1.srq?project_info_no="+proj_no+"&action=edit&orgSubjectionId="+orgSubjectionId+"&orgId="+orgId+"&projectType="+projectType;
		form.submit();
	}
	...
	function toSon(){
		...
		if(""!=ids){
	    	if(ids.indexOf(",")==-1){
	    		...
	    		popWindow('<%=contextPath%>/pm/project/multiProject/ws/subProjectList.jsp?projectFatherName='+projectFatherName+'&projectFatherNo='+ids.split("-")[0]+'&orgSubjectionId='+orgSubjectionId+'&projectType='+projectType+'&orgId='+org_id_v+'&projectYear='+projectYear_v,'1300:900');
	    	}else{
	    		alert("只能选择一条项目信息！")
		    }
	 	}else{
 	...
 	function toAdd(){
		popWindowAuto('<%=contextPath%>/pm/project/singleProject/ws/insertProject.jsp?projectType=5000100004000000008','750:700');
	}

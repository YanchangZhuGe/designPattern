...
function toEdit(){
		var checkSql="select level, t.* from bgp_hse_environment_detail t where t.hse_environment_id = '' start with t.father_id = '101' connect by prior t.hse_detail_id = t.father_id ";

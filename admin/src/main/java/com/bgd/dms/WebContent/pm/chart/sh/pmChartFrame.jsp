...
function getFusionChart(){
	...
	var retObj5 = jcdpCallService("DailyReportAnalysisSrv","getDailyActivitySh","type=colldailylist&project_info_no="+projectInfoNo);
	...
	var retObj2 = jcdpCallServiceCache("DailyReportAnalysisSrv","getDaysCumulative","type=colldailylist&projectInfoNo="+projectInfoNo);
	...
	var retObj6 = jcdpCallService("DailyReportAnalysisSrv","getDaysCumulativeSh","type=colldailylist&exploration_method="+expMethod+"&projectInfoNo="+projectInfoNo);

...
<%
	...
	//System.out.println("nodeLink=========="+nodeLink);
%>
...
<div>
	  <ul id="tags" class="tags">
	    <li class="selectTag" id="tag3_0"><a href="#" onclick="getTab3(0)">流程轨迹</a></li>
	    <li id="tag3_1"><a href="#" onclick="getTab3(1)">业务信息</a></li>
	  </ul>
</div>

<div id="tab_box_content0" class="tab_box_content" style="height: 800px" >
...
<div id="tab_box_content1" class="tab_box_content" style="display:none;height: 800px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath + nodeLink%>'> </iframe>
</div>
</body>
</html>
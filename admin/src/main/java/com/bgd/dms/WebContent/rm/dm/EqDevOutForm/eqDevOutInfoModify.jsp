...
<div id="new_table_box" style="width:98%">
  <div id="new_table_box_content" style="width:100%">
    <div id="new_table_box_bg" style="width:95%;overflow-x:hidden;overflow-y:auto">
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
          ...
          <td class="inquire_item4" >出库时间:</td>
          <td class="inquire_form4" >
      ...
      <fieldset style="margin-left:2px"><legend>调配出库信息</legend>
	   <fieldset style="margin-left:2px"><legend>出库数量明细</legend>
	      ...
	      <fieldset style="margin-left:2px"><legend>出库台账明细</legend>
	  ...
	  <fieldset style="margin-left:2px"><legend>补充出库数量</legend>
		  <div style="height:90px;overflow:auto">
			  <table style="width:97.9%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		       <tr>
					<td class="bt_info_even" width="5%">选择</td>
...
<script type="text/javascript"> 
		...
		$("input[type='checkbox'][name='detinfo']").each(function(i){
			if(this.checked){
				...
				for(var j = 0;j<parseInt(outnum);j++){
					...
					innerhtml += "<td width='11%'><input name='asset_coding"+seqinfo+"' id='asset_coding"+seqinfo+"' style='line-height:18px;width:98%' value='' readonly/></td>";
					...
					innerhtml += "<td width='10%'><input name='license_num"+seqinfo+"' id='license_num"+seqinfo+"' value='' style='line-height:18px;' size='8' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='dev_sign"+seqinfo+"' id='dev_sign"+seqinfo+"' style='line-height:18px;' type='text' size='8' readonly/></td>";
	...
	function toAddAddedDetailInfos(){
		...
		innerhtml += "<td width='4%'><input type='checkbox' name='addedseq' id='addedseq"+addedseqinfo+"' style='background-color:#909090'/></td>";
		innerhtml += "<td width='13%'><input name='addeddevicename"+addedseqinfo+"' id='addeddevicename"+addedseqinfo+"' value='' style='line-height:18px;width:98%' size='10' type='text' readonly/></td>";
		innerhtml += "<td width='13%'><input name='addeddevicetype"+addedseqinfo+"' id='addeddevicetype"+addedseqinfo+"' value='' style='line-height:18px;' size='10' type='text' readonly/><img src='<%=contextPath%>/images/magnifier.gif' width='16' height='16' style='cursor:hand;' onclick=showAddedDevPage("+addedseqinfo+") /></td>";
		...
		innerhtml += "<input name='addedself_num"+addedseqinfo+"' id='addedself_num"+addedseqinfo+"' style='line-height:18px;' size='9' type='text' readonly/></td>";
		innerhtml += "<td width='10%'><input name='addedlicense_num"+addedseqinfo+"' id='addedlicense_num"+addedseqinfo+"' value='' style='line-height:18px;' size='9' type='text' readonly/></td>";
		innerhtml += "<td width='10%'><input name='addeddev_sign"+addedseqinfo+"' id='addeddev_sign"+addedseqinfo+"' style='line-height:18px;' type='text' size='9' readonly/></td>";
		innerhtml += "<td width='10%'><input name='addedasset_coding"+addedseqinfo+"' id='addedasset_coding"+addedseqinfo+"' style='line-height:18px;' size='9' value='' readonly/></td>";
		innerhtml += "<td width='11%'><input name='addedplanstartdate"+addedseqinfo+"' id='addedplanstartdate"+addedseqinfo+"' value='"+planstartdate+"' size='11' type='text' readonly/>";
		innerhtml += "<td width='11%'><input name='addedplanenddate"+addedseqinfo+"' id='addedplanenddate"+addedseqinfo+"' value='"+planenddate+"' size='11' type='text' readonly/></td>";
		innerhtml += "<td width='10%'><input name='addedremark"+addedseqinfo+"' id='addedremark"+addedseqinfo+"' value='' size='9' type='text' /></td>";
		innerhtml += "</tr>";
		...
		$("input[type='checkbox'][name='mixdetinfo']").each(function(i){
			if(this.checked == true){
				...
				for(var j = 0;j<parseInt(outnum);j++){
					...
					innerhtml += "<td width='12%'><input name='mixdetdevicetype"+mixseqinfo+"' id='mixdetdevicetype"+mixseqinfo+"' value='"+devicemodel+"' style='line-height:18px;' size='10' type='text' readonly/><img src='<%=contextPath%>/images/magnifier.gif' width='16' height='16' style='cursor:hand;' onclick=showMixDevPage("+mixseqinfo+",'"+devicename+"','"+devicemodel+"') /></td>";
					...
					innerhtml += "<input name='mixdetself_num"+mixseqinfo+"' id='mixdetself_num"+mixseqinfo+"' style='line-height:18px;' size='9' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='mixdetdev_sign"+mixseqinfo+"' id='mixdetdev_sign"+mixseqinfo+"' style='line-height:18px;' type='text' size='9' readonly/></td>";
					innerhtml += "<td width='10%'><input name='mixdetlicense_num"+mixseqinfo+"' id='mixdetlicense_num"+mixseqinfo+"' value='' style='line-height:18px;' size='9' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='mixdetasset_coding"+mixseqinfo+"' id='mixdetasset_coding"+mixseqinfo+"' style='line-height:18px;' size='9' value='' readonly/></td>";
					innerhtml += "<td width='11%'><input name='mixdetdevstartdate"+mixseqinfo+"' id='mixdetdevstartdate"+mixseqinfo+"' style='line-height:18px;' size='11' value='"+startdate+"' type='text' readonly/></td>";
					innerhtml += "<td width='11%'><input name='mixdetdevenddate"+mixseqinfo+"' id='mixdetdevenddate"+mixseqinfo+"' style='line-height:18px;' size='11' value='"+enddate+"' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='mixdetdevremark"+mixseqinfo+"' id='mixdetdevremark"+mixseqinfo+"' value='' size='9' type='text' /></td>";
					innerhtml += "</tr>";
					$("#addeddetailtable").append(innerhtml);
				}
			}
	...
	function showAddedDevPage(seqinfo){
		var obj = new Object();
		var vReturnValue = window.showModalDialog("<%=contextPath%>/rm/dm/tree/selectAccountForAdded.jsp" , obj ,"dialogWidth=820px;dialogHeight=380px");
		if(vReturnValue!=undefined){
			var returnvalues = vReturnValue.split('~');
			//返回信息是 队级台账id + 设备编码 + 设备名称 + 规格型号 + 自编号 + 实物标识号 + 牌照号
	...
	function showDevPage(trid,devcicode,isdevicecode,devicename){
		...
		//回头加上转出单位
		var out_org_id = $("#out_org_id").val();
		var dialogurl = "<%=contextPath%>/rm/dm/tree/selectAccountForMix.jsp?isdevicecode="+isdevicecode;
		dialogurl += "&dev_ci_code="+devcicode+"&out_org_id="+out_org_id+"&devicename="+devicename;
		dialogurl = encodeURI(dialogurl);
		dialogurl = encodeURI(dialogurl);
		var vReturnValue = window.showModalDialog(dialogurl , obj ,"dialogWidth=820px;dialogHeight=380px");
		if(vReturnValue!=undefined){
			var returnvalues = vReturnValue.split('~');
			//返回信息是 队级台账id + 设备编码 + 设备名称 + 规格型号 + 自编号 + 实物标识号 + 牌照号
	...
	function refreshData(){
		...
		if('<%=mixInfoId%>'!=null){
			//回填基本信息
			var mainsql = "select mix.device_mixinfo_id,mix.mixinfo_no,pro.project_name,mix.create_date,mix.in_org_id,mix.out_org_id,mix.project_info_no, "+
			"inorg.org_abbreviation as in_org_name,outorg.org_abbreviation as out_org_name,equform.out_date,equform.outinfo_no,"+
			"he.employee_name,equform.device_outinfo_id,equform.receive_state,mix.mix_type_id "+
			"from gms_device_equ_outform equform "+
			"left join gms_device_mixinfo_form mix on mix.device_mixinfo_id=equform.device_mixinfo_id "+
			"left join gp_task_project pro on equform.project_info_no=pro.project_info_no "+
			...
			mainsql += "where mix.device_mixinfo_id='<%=mixInfoId%>' and equform.device_outinfo_id='<%=outInfoId%>'";
			...
			var prosql = "select amm.device_mix_subid,amm.dev_ci_code,amm.assign_num,amm.isdevicecode,";
				...
				prosql += "nvl(temp.outednum,0) outednum,unitsd.coding_name as unit_name,appdet.unitinfo,outsub.out_num, ";
				prosql += "appdet.plan_start_date,appdet.plan_end_date,outsub.device_oif_subid ";
				prosql += "from gms_device_appmix_main amm ";
				prosql += "left join (select device_mix_subid,dev_ci_code,sum(out_num) as outednum from gms_device_equ_outsub group by device_mix_subid,dev_ci_code) temp on temp.device_mix_subid=amm.device_mix_subid ";
				prosql += "left join gms_device_equ_outsub outsub on outsub.device_mix_subid=amm.device_mix_subid ";
				prosql += "left join gms_device_codeinfo ci on amm.dev_ci_code=ci.dev_ci_code  ";
				...
				prosql += "where amm.bsflag='0' and amm.device_mixinfo_id='<%=mixInfoId%>' and outsub.device_outinfo_id='<%=outInfoId%>'";
		...
		if(retObj!=undefined){
			for(var index=0;index<retObj.length;index++){
				...
				innerhtml += "<td width='5%'><input type='checkbox' name='detinfo' id='"+index+"' value='"+retObj[index].device_mix_subid+"' ";
				if(retObj[index].out_num!=''){
					innerhtml +="checked ";
				}
				innerhtml +="/></td>";
				innerhtml += "<td width='20%'><input name='devicename"+index+"' id='devicename"+index+"' style='line-height:15px' value='"+retObj[index].dev_ci_name+"' size='20' type='text' readonly/>";
				innerhtml += "<input name='isdevicecode"+index+"' id='isdevicecode"+index+"' style='line-height:15px' value='"+retObj[index].isdevicecode+"' type='hidden' />";
				innerhtml += "<input name='devcicode"+index+"' id='devcicode"+index+"' style='line-height:15px' value='"+retObj[index].dev_ci_code+"' type='hidden' /></td>";
				innerhtml += "<td width='15%'><input name='devicemodel"+index+"' id='devicemodel"+index+"' value='"+retObj[index].dev_ci_model+"' size='20' type='text' readonly/></td>";
				innerhtml += "<td width='10%'><input name='unitname"+index+"' id='unitname"+index+"' value='"+retObj[index].unit_name+"' size='10' type='text' readonly/>";
				...
				if(retObj[index].device_oif_subid!=''){
					innerhtml +="<input name='deviceoifsubid"+index+"' id='deviceoifsubid"+index+"' value='"+retObj[index].device_oif_subid+"' type='hidden' />";
				}
				innerhtml += "<td width='10%'><input name='mixnum"+index+"' id='mixnum"+index+"' style='line-height:15px' value='"+retObj[index].assign_num+"' size='10' type='text' /></td>";
				innerhtml += "<td width='10%'><input name='outednum"+index+"' id='outednum"+index+"' value='"+retObj[index].outednum+"' size='10'  type='text' readonly/>";
				innerhtml += "<input name='checkoutednum"+index+"' id='checkoutednum"+index+"' value='"+(parseInt(retObj[index].outednum)-parseInt(retObj[index].out_num))+"' type='hidden'/></td>";
				innerhtml += "<td width='10%'><input name='outnum"+index+"' id='outnum"+index+"' value='"+retObj[index].out_num+"' size='10' type='text' detindex='"+index+"' onkeyup='checkAssignNum(this)'></td>";
			...
			// 给台账信息查询出来
			var prosql = "select device_oif_detid,equod.dev_ci_code,dev_acc_id,asset_coding,self_num,dev_sign,license_num,equod.devremark,'N' as isdevicecode,";
				prosql += "dev_plan_start_date,dev_plan_end_date,outsub.device_oif_subid,outsub.device_mix_subid,ci.dev_ci_name,ci.dev_ci_model ";
				prosql += "from gms_device_equ_outdetail equod ";
				prosql += "left join gms_device_equ_outsub outsub on outsub.device_oif_subid=equod.device_oif_subid ";
				prosql += "left join gms_device_codeinfo ci on equod.dev_ci_code=ci.dev_ci_code  ";
				prosql += "where outsub.device_outinfo_id='<%=outInfoId%>'";
				prosql += "order by equod.dev_ci_code ";
			var proqueryRet = syncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'querySql='+prosql);
			retObj = proqueryRet.datas;
			if(retObj!=undefined){
				var seqinfo=0;
				if(retObj.length>0){
					for(var index=0;index<retObj.length;index++){
						...
						innerhtml += "<td width='12%'><input name='detdevicename"+seqinfo+"' id='detdevicename"+seqinfo+"' value='"+retObj[index].dev_ci_name+"' style='line-height:18px' size='10' type='text' readonly/></td>";
						innerhtml += "<td width='14%'><input name='detdevicetype"+seqinfo+"' id='detdevicetype"+seqinfo+"' value='"+retObj[index].dev_ci_model+"' style='line-height:18px;' size='10' type='text' readonly/><img src='<%=contextPath%>/images/magnifier.gif' width='16' height='16' style='cursor:hand;' onclick=showDevPage("+seqinfo+",'"+retObj[index].dev_ci_code+"','"+retObj[index].isdevicecode+"','"+retObj[index].dev_ci_name+"') /></td>";
						innerhtml += "<td width='11%'><input name='asset_coding"+seqinfo+"' id='asset_coding"+seqinfo+"' style='line-height:18px' size='10' value='"+retObj[index].asset_coding+"' readonly/></td>";
						innerhtml += "<td width='11%'><input name='dev_acc_id"+seqinfo+"' id='dev_acc_id"+seqinfo+"' value='"+retObj[index].dev_acc_id+"' type='hidden'/>";
						innerhtml += "<input name='device_mix_subid"+seqinfo+"' id='device_mix_subid"+seqinfo+"' value='"+retObj[index].device_mix_subid+"' type='hidden'/>";
						innerhtml += "<input name='device_oif_subid"+seqinfo+"' id='device_oif_subid"+seqinfo+"' value='"+retObj[index].device_oif_subid+"' type='hidden'/>";
						innerhtml += "<input name='device_oif_detid"+seqinfo+"' id='device_oif_detid"+seqinfo+"' value='"+retObj[index].device_oif_detid+"' type='hidden'/>";
						innerhtml += "<input name='detdevcicode"+seqinfo+"' id='detdevcicode"+seqinfo+"' value='"+retObj[index].dev_ci_code+"' type='hidden'/>";
						innerhtml += "<input name='self_num"+seqinfo+"' id='self_num"+seqinfo+"' style='line-height:18px;' value='"+retObj[index].self_num+"' size='8' type='text' readonly/></td>";
						innerhtml += "<td width='10%'><input name='dev_sign"+seqinfo+"' id='dev_sign"+seqinfo+"' value='"+retObj[index].dev_sign+"' style='line-height:18px;' type='text' size='8' readonly/></td>";
						innerhtml += "<td width='10%'><input name='license_num"+seqinfo+"' id='license_num"+seqinfo+"' value='"+retObj[index].license_num+"' style='line-height:18px;' size='8' type='text' readonly/></td>";
						innerhtml += "<td width='11%'><input name='devstartdate"+seqinfo+"' id='devstartdate"+seqinfo+"' value='"+retObj[index].dev_plan_start_date+"' style='line-height:18px' size='10' type='text' readonly/></td>";
						innerhtml += "<td width='11%'><input name='devenddate"+seqinfo+"' id='devenddate"+seqinfo+"' value='"+retObj[index].dev_plan_end_date+"' style='line-height:18px' size='10' type='text' readonly/></td>";
			...
			var mixprosql = "select amm.device_mix_subid,amm.assign_num,amm.dev_name as dev_ci_name,amm.dev_model as dev_ci_model,";
				mixprosql += "nvl(temp.outednum,0) outednum,amm.dev_unit as unit_name,added.out_num ";
				...
				mixprosql += "left join gms_device_equ_outform frm on added.device_outinfo_id=frm.device_outinfo_id ";
				mixprosql += "where frm.bsflag='0' and added.device_mix_subid is not null group by device_mix_subid) temp on temp.device_mix_subid=amm.device_mix_subid ";
				mixprosql += "left join gms_device_equ_outsub_added added on added.device_mix_subid=amm.device_mix_subid and added.device_outinfo_id='<%=outInfoId%>' ";
			...
			if(retObj!=undefined){
				for(var index=0;index<retObj.length;index++){
					...
					innerhtml += "<td width='10%'><input name='mixunitname"+index+"' id='mixunitname"+index+"' value='"+retObj[index].unit_name+"' size='10' type='text' readonly/></td>";
					...
					innerhtml += "<td width='10%'><input name='mixoutednum"+index+"' id='mixoutednum"+index+"' value='"+retObj[index].outednum+"' size='10'  type='text' readonly/>";
					innerhtml += "<input name='checkmixoutednum"+index+"' id='checkmixoutednum"+index+"' value='"+(parseInt(retObj[index].outednum)-parseInt(retObj[index].out_num))+"' size='10'  type='hidden'/></td>";
					innerhtml += "<td width='10%'><input name='mixoutnum"+index+"' id='mixoutnum"+index+"' value='"+retObj[index].out_num+"' size='10' type='text' detindex='"+index+"' onkeyup='checkMixAssignNum(this)'></td>";
			...
			// 先增加补充出库数量的单条明细
			var mixdetprosql = "select added.device_oif_detid,added.device_oif_subid,amm.device_mix_subid,";
				mixdetprosql += "added.dev_ci_code,added.dev_acc_id,added.asset_coding,added.self_num,added.dev_sign,added.license_num, ";
				mixdetprosql += "ci.dev_ci_name,ci.dev_ci_model,added.dev_plan_start_date,added.dev_plan_end_date,added.devremark as mixdetdevremark ";
				mixdetprosql += "from gms_device_equ_outdetail_added added ";
				mixdetprosql += "left join gms_device_equ_outsub_added amm on added.device_oif_subid=amm.device_oif_subid ";
				mixdetprosql += "left join gms_device_codeinfo ci on added.dev_ci_code=ci.dev_ci_code ";
				mixdetprosql += "where added.device_outinfo_id='<%=outInfoId%>' and amm.device_outinfo_id='<%=outInfoId%>' ";
				mixdetprosql += "and added.device_oif_subid is not null ";
			var mixdetproqueryRet = syncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'querySql='+mixdetprosql);
			retObj = mixdetproqueryRet.datas;
			var mixseqinfo = 0;
			if(retObj!=undefined){
				for(var j = 0;j<retObj.length;j++){
					mixseqinfo++;
					var innerhtml = "<tr id='mixdettr"+mixseqinfo+"' name='mixdettr"+mixseqinfo+"' seq='"+mixseqinfo+"' is_added='false'>";
					innerhtml += "<td width='4%'>&nbsp;</td>";
					innerhtml += "<td width='12%'><input name='mixdetdevicename"+mixseqinfo+"' id='mixdetdevicename"+mixseqinfo+"' value='"+retObj[j].dev_ci_name+"' style='line-height:18px;width:98%' size='10' type='text' readonly/></td>";
					innerhtml += "<td width='12%'><input name='mixdetdevicetype"+mixseqinfo+"' id='mixdetdevicetype"+mixseqinfo+"' value='"+retObj[j].dev_ci_model+"' style='line-height:18px;' size='10' type='text' readonly/><img src='<%=contextPath%>/images/magnifier.gif' width='16' height='16' style='cursor:hand;' onclick=showMixDevPage("+mixseqinfo+",'"+retObj[j].dev_ci_name+"','"+retObj[j].dev_ci_model+"') /></td>";
					innerhtml += "<td width='10%'><input name='mixdetdevice_mix_subid"+mixseqinfo+"' id='mixdetdevice_mix_subid"+mixseqinfo+"' value='"+retObj[j].device_mix_subid+"' type='hidden'/>";
					innerhtml += "<input name='mixdetdev_acc_id"+mixseqinfo+"' id='mixdetdev_acc_id"+mixseqinfo+"' seq='"+mixseqinfo+"' value='"+retObj[j].dev_acc_id+"' type='hidden'/>";
					innerhtml += "<input name='mixdetdevcicode"+mixseqinfo+"' id='mixdetdevcicode"+mixseqinfo+"' value='"+retObj[j].dev_ci_code+"' type='hidden'/>";
					innerhtml += "<input name='mixdetself_num"+mixseqinfo+"' id='mixdetself_num"+mixseqinfo+"' style='line-height:18px;' value='"+retObj[j].self_num+"' size='9' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='mixdetdev_sign"+mixseqinfo+"' id='mixdetdev_sign"+mixseqinfo+"' style='line-height:18px;' type='text' value='"+retObj[j].dev_sign+"' size='9' readonly/></td>";
					innerhtml += "<td width='10%'><input name='mixdetlicense_num"+mixseqinfo+"' id='mixdetlicense_num"+mixseqinfo+"' style='line-height:18px;' value='"+retObj[j].license_num+"' size='9' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='mixdetasset_coding"+mixseqinfo+"' id='mixdetasset_coding"+mixseqinfo+"' style='line-height:18px;' size='9' value='"+retObj[j].asset_coding+"'  readonly/></td>";
					innerhtml += "<td width='11%'><input name='mixdetdevstartdate"+mixseqinfo+"' id='mixdetdevstartdate"+mixseqinfo+"' style='line-height:18px;' size='11' value='"+retObj[j].dev_plan_start_date+"' type='text' readonly/></td>";
					innerhtml += "<td width='11%'><input name='mixdetdevenddate"+mixseqinfo+"' id='mixdetdevenddate"+mixseqinfo+"' style='line-height:18px;' size='11' value='"+retObj[j].dev_plan_end_date+"' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='mixdetdevremark"+mixseqinfo+"' id='mixdetdevremark"+mixseqinfo+"' value='"+retObj[j].mixdetdevremark+"' size='9' type='text' /></td>";
					innerhtml += "</tr>";
					$("#addeddetailtable").append(innerhtml);
					if(j==(retObj.length-1)){
						$("input[type='text'][name^='mixoutnum']").attr("readonly","readonly");
						$("#mixtab_box").show();
					}
				}
			}
			// 给补充出库台账信息查询出来
			var addedprosql = "select device_oif_detid,equod.dev_ci_code,dev_acc_id,asset_coding,self_num,dev_sign,license_num,equod.devremark,'N' as isdevicecode,";
				addedprosql += "equod.dev_plan_start_date,equod.dev_plan_end_date,equod.device_outinfo_id,ci.dev_ci_name,ci.dev_ci_model ";
				addedprosql += "from gms_device_equ_outdetail_added equod ";
				addedprosql += "left join gms_device_codeinfo ci on equod.dev_ci_code=ci.dev_ci_code  ";
				addedprosql += "where equod.device_outinfo_id='<%=outInfoId%>' and equod.device_oif_subid is null ";
				addedprosql += "order by equod.dev_ci_code ";
			...
			if(retObj!=undefined){
				for(var index=0;index<retObj.length;index++){
					...
					var innerhtml = "<tr id='tr"+seqinfo+"' name='tr"+seqinfo+"' seq='"+seqinfo+"' is_added='false'>";
					innerhtml += "<td width='4%'><input type='checkbox' name='addedseq' id='addedseq"+seqinfo+"' style='background-color:#909090'/></td>";
					innerhtml += "<td width='12%'><input name='addeddevicename"+seqinfo+"' id='addeddevicename"+seqinfo+"' value='"+retObj[index].dev_ci_name+"' style='line-height:18px;width:98%' size='10' type='text' readonly/></td>";
					innerhtml += "<td width='12%'><input name='addeddevicetype"+seqinfo+"' id='addeddevicetype"+seqinfo+"' value='"+retObj[index].dev_ci_model+"' style='line-height:18px;' size='10' type='text' readonly/><img src='<%=contextPath%>/images/magnifier.gif' width='16' height='16' style='cursor:hand;' onclick=showAddedDevPage("+seqinfo+") /></td>";
					innerhtml += "<td width='10%'><input name='addeddev_acc_id"+seqinfo+"' id='addeddev_acc_id"+seqinfo+"' seq='"+seqinfo+"' value='"+retObj[index].dev_acc_id+"' type='hidden'/>";
					innerhtml += "<input name='addeddevcicode"+seqinfo+"' id='addeddevcicode"+seqinfo+"' value='"+retObj[index].dev_ci_code+"' type='hidden'/>";
					innerhtml += "<input name='addedself_num"+seqinfo+"' id='addedself_num"+seqinfo+"' style='line-height:18px;' value='"+retObj[index].self_num+"' size='9' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='addeddev_sign"+seqinfo+"' id='addeddev_sign"+seqinfo+"' style='line-height:18px;' value='"+retObj[index].dev_sign+"' type='text' size='9' readonly/></td>";
					innerhtml += "<td width='10%'><input name='addedlicense_num"+seqinfo+"' id='addedlicense_num"+seqinfo+"' value='"+retObj[index].license_num+"' style='line-height:18px;' size='9' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='addedasset_coding"+seqinfo+"' id='addedasset_coding"+seqinfo+"' style='line-height:18px;' value='"+retObj[index].asset_coding+"' size='9' type='text' readonly/></td>";
					innerhtml += "<td width='11%'><input name='devstartdate"+seqinfo+"' id='devstartdate"+seqinfo+"' style='line-height:18px;' size='11' value='"+retObj[index].dev_plan_start_date+"' type='text' readonly/></td>";
					innerhtml += "<td width='11%'><input name='devenddate"+seqinfo+"' id='devenddate"+seqinfo+"' style='line-height:18px;' size='11' value='"+retObj[index].dev_plan_end_date+"' type='text' readonly/></td>";
					innerhtml += "<td width='10%'><input name='addedremark"+seqinfo+"' id='addedremark"+seqinfo+"' value='"+retObj[index].devremark+"' size='9' type='text' /></td>";
					innerhtml += "</tr>";
					$("#addeddetailtable").append(innerhtml);
					$("#mixtab_box").show();
				}
	...
	function checkAssignNum(obj){
		...
		var outednumVal = parseInt($("#checkoutednum"+index).val(),10);
		if(obj.value == ''){
			return;
		}
		var objValue = obj.value;

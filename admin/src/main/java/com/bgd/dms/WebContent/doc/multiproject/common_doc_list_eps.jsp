...
<script type="text/javascript">
	...
	function simpleSearchCommonEps(){
		var q_file_name = document.getElementById("file_name").value;
		refreshData(q_file_name);
	}
	...
	function toAdd(){
	  	popWindow('<%=contextPath%>/doc/multiproject/upload_file_common_eps.jsp?relationId=<%=relation_id%>');
	}
	...
	function toEdit(){
		...
		popWindow('<%=contextPath%>/doc/multiproject/edit_attach_eps.jsp?fileId='+file_id);
	...
	function toSearch(){
		popWindow('<%=contextPath%>/doc/multiproject/common_doc_search_eps.jsp?relationId=<%=relation_id%>');
	}

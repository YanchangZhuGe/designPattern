...
<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    <td>&nbsp;</td>
			     <auth:ListButton functionId="" css="jl" event="onclick='showMatPage()'" title="模板"></auth:ListButton>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="right" id="queryRetTable" >
			<tr>
				<td class="bt_info_odd" exp="<input name = 'rdo_entity_id'  type='checkbox' checked='true' value='{wz_id}' onclick='loadDataDetail()'/>" ><input type='checkbox' name='rdo_entity_id' value='' onclick='check()'/></td>
			      ...
			      <td class="bt_info_even" exp="<input name ='unit_num{wz_id}' type='text' value='{unit_num}'/>">单元用量</td>
...
<script type="text/javascript">
	...
	function addTemData(value){
		var sql ='';
		sql +="select i.*,t.unit_num from gms_mat_demand_tamplate_detail t inner join gms_mat_infomation i on t.wz_id=i.wz_id and i.bsflag='0' where t.tamplate_detail_id='"+value+"' and t.bsflag='0'";
		cruConfig.cdtType = 'form';
		cruConfig.queryStr = sql;
		cruConfig.currentPageUrl = "/mat/singleproject/mattemplate/matAddTemList.jsp";
		queryData(1);

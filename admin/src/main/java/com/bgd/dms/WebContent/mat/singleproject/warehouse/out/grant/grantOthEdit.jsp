...
<script type="text/javascript"><!--
	...
	function refreshData(){
		...
		debugger;
		document.getElementById("wz_type").value = "<gms:msg msgTag="map" key="wzType"/>";
		...
		cruConfig.queryOp = "getOutDetail";
		queryData(1);
...
//    	var applyTeamList=jcdpCallService("HumanCommInfoSrv","queryApplyTeam","");	
	...
	function openMatHave(){
		...
		var selected = window.showModalDialog("<%=contextPath%>/mat/singleproject/warehouse/out/grant/selectGrantList.jsp?wz_type="+wz_type+"&selectWzId="+selectWzId+"&teamOutId="+teamOutId,"","dialogWidth=1240px;dialogHeight=480px");
		debugger;
...
*/		
		...
		cruConfig.submitStr ="wz_ids="+wz_id+"&teamOutId="+teamOutId;

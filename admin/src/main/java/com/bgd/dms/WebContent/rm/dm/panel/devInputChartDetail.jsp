...
<%
	...
	//钻取的类别信息--其中地震仪器S140501、检波器S14050301、震源S0623、钻机S0601、运输设备S08、推土机S070301、
	String deviceType = request.getParameter("deviceType");
	String project_info_no = request.getParameter("project_id");
%>
					...
					<tr>
						<td width="99%">
							<div class="tongyong_box">
								...
								href="#"></a></span><a href="#">地震队机械设备统计钻取信息</a>
								<span class="gd"><a href="#"></a></span>
								<!-- <span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('dzdjxsbxx')" title="导出excel"></a>
								</span> -->
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj = jcdpCallService("EarthquakeTeamStatistics","getDevInputChartDetail","project_info_no=<%=project_info_no%>&deviceType=<%=deviceType%>");
	...
	function exportDataDoc(exportFlag){
		...
		var submitStr = "code=<%=deviceType%>&exportFlag="+exportFlag;

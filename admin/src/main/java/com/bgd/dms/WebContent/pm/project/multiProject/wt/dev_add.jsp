    ...
    <div id="oper_div">
   		 <span class="bc_btn"><a href="#" onclick="submitInfo()"></a>
     		<input name="projectInfoNo" id="projectInfoNo" type="hidden" value="<%=projectInfoNo%>" />
          	...
          	<input name="teamtype" id="teamtype" type="hidden" value="<%=teamtype%>" /></span>
	...
	function addRows(value){
		...
		if(value!="" && value !=undefined){
			var trData = value.split(",");
				...
				innerhtml += "<td width='13%'><input name='startdate"+i+"' id='startdate"+i+"' style='line-height:15px' size='10' type='text' value=''/><img src='"+"<%=contextPath%>"+"/images/calendar.gif' id='tributton2"+i+"' width='16' height='16' style='cursor: hand;'"+"onmouseover='calDateSelector(startdate"+i+",tributton2"+i+");'/></td>";
				innerhtml += "<td width='13%'><input name='enddate"+i+"' id='enddate"+i+"' style='line-height:15px' size='10' type='text' value=''/><img src='"+"<%=contextPath%>"+"/images/calendar.gif' id='tributton3"+i+"' width='16' height='16' style='cursor: hand;'"+"onmouseover='calDateSelector(enddate"+i+",tributton3"+i+");'/></td>";

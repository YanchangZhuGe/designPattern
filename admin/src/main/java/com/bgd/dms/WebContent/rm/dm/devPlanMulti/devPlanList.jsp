...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
  ...
  <title>多项目-计划管理-配置计划-设备配置计划</title> 
 </head> 
...
<script type="text/javascript">
    ...
    function refreshData(v_project_name,v_org_name){
		...
		str += "order by state_desc desc, devapp.appdate desc ";
    ...
    function loadDataDetail(device_allapp_id){
    	...
    	processNecessaryInfo={        							//流程引擎关键信息
			...
			businessType:"5110000004100000095",    //业务类型 即为之前设置的业务大类

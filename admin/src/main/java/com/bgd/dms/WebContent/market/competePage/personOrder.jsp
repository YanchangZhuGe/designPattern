...
<script type="text/javascript">
	...
	function parentInfo(){
		window.dialogArguments.location.href="<%=contextPath%>/market/competePage/competeList.lpmd?corpId=<%=map.get("corpId")%>";
	}
</script>
</head>
...
<form name="form1" id="form1"  method="post" action="<%=contextPath%>/market/wtPersonOrderSave.srq" target="hiddenIframe">
	<table>

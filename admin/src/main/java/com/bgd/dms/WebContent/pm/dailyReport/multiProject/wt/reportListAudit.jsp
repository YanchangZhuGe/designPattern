      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 <!--  <td>
			   ...
			   <input type="button" name="daily_mian" id="daily_mian" value="面积、长度/公里数" onclick="dailyChange();"></input></td> -->
			    <td>&nbsp;</td>
			...
			<div id="table_box">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_odd" exp="{date1}<input type='hidden' name='audit_status_{daily_no}' id='audit_status_{daily_no}' value='{audit_status}'/>" >施工日期</td>

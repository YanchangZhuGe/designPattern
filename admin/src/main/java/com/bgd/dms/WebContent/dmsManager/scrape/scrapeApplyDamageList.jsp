      	...
      	<div id="list_table">
			...
			<div id="tag-container_3">
			  <ul id="tags" class="tags">
			    ...
			    <li id="tag3_1"><a href="#" onclick="getContentTab(this,1)">盘亏毁损信息</a></li>
					  ...
					  <tr>
					    ...
					    <td background="<%=contextPath%>/images/list_15.png">
						    <table width="100%" border="0" cellspacing="0" cellpadding="0">
							    <tr>
								    <td>&nbsp;</td>
								    <auth:ListButton functionId="" css="xz" event="onclick='exportDevData()'" title="导出盘亏毁损设备"></auth:ListButton>
							    </tr>
							</table>
						</td>
...
$(function(){
	...
	function getContentTab(obj,index) {
		...
		if(index == 1){
		  ...
		  $("#pkhsxx").attr("src","<%=contextPath%>/dmsManager/scrape/scrapeApplyDamageShow.jsp?scrape_apply_id="+ids);
		}
		else if(index == 2){
			var baseData;
			var ids = getSelIds('selectedbox');
		  ...
		  //设备信息显示
			$("#dev_grid").datagrid({
				...
				queryParams:{'scrape_apply_id':ids,'scrape_type':'2'}
			});
		}else if(index == 3){
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "queryScrapeApplyDamageList";
   ...
   function exportDevData(){
	...
	var submitStr="scrape_apply_id="+ids+"&exportFlag="+exportFlag+"&scrape_type=2";

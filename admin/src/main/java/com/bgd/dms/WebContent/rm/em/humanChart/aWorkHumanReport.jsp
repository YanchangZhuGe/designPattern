...
<%
	...
	String reportId = "234"; 
	String reportFileName = "human_works_m.raq"; 
	String title = "一线用工项目情况报表"; 
	...
	if(curDateSpt==null || curDateSpt.trim().equals("")){ 
		  ...
		  org_sub_id =  "C105001004";// orgSubjectionId;
	}
    ...
    var end_date="";
		...
		if(ifBuild!=''&& ifBuild!=null){ 
		    ...
		    if(org_name!=''&& org_name!=null){ 
		    	 ...
		    	 window.location.href='<%=contextPath%>/rm/em/humanChart/aWorkHumanReport.jsp?reportFileName=human_works_m.raq&year_date='+ifBuild+'&end_date='+end_Date+'&start_date='+start_date+'&org_sub_id='+org_name;
		    	 	
		    }else{
		    	 window.location.href='<%=contextPath%>/rm/em/humanChart/aWorkHumanReport.jsp?reportFileName=human_works_m.raq&year_date='+ifBuild+'&end_date='+end_Date+'&start_date='+start_date+'&org_sub_id=<%=orgSubjectionId%>';
		    	 	
		    }
			}else{
				if(org_name!=''&& org_name!=null){  
					 window.location.href='<%=contextPath%>/rm/em/humanChart/aWorkHumanReport.jsp?reportFileName=human_works_m.raq&year_date='+nianSb+'&end_date='+nianSubDates+'&start_date='+nianSb+'0101&org_sub_id='+org_name;

...
<%
	...
	System.out.print(request.getParameter("projectType"));
...
function page_init(){
	...
	cruConfig.submitStr = "isSingle=<%=isSingle %>&orgSubjectionId=<%=orgSubjectionId %>&projectType=<%=projectType %>";
...
function openChart(projectInfoNo){
	popWindow('<%=contextPath%>/pm/dailyReport/multiProject/ws/pmChartFrame.jsp?projectInfoNo='+projectInfoNo,'1280:800');
}

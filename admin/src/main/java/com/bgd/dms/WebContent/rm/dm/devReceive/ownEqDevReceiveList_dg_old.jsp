...
<script type="text/javascript">
	...
	function refreshData(v_device_app_name,v_mixinfo_no,v_opr_state,v_allapp_type){
		...
		var str = "select case mix_type_id when 'S0000' then '单台' when 'S14050208' then '检波器' when 'S9997' then '批量' when 'S9996' then '仪器附属' end as allapp_type_name, t.* ";
			str += "from (select dm.mixinfo_no as outinfo_no,dm.mixinfo_no,dm.create_date,dm.mix_type_id,dm.device_mixinfo_id,'' as device_outinfo_id,dm.modifi_date,devapp.device_app_name,devapp.device_app_id,he.employee_name,pro.project_name,inorg.org_abbreviation as in_org_name,outorg.org_abbreviation as out_org_name,";
			...
			str += "from gms_device_coll_outform cof left join gms_device_collmix_form mif on cof.device_mixinfo_id = mif.device_mixinfo_id left join gms_device_collapp devapp on devapp.device_app_id = mif.device_app_id ";

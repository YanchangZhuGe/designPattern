 ...
 <input id="export_name" name="export_name" value="设备台账(单台)" type='hidden' />
      	<div id="list_table">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	...
		 	<div id="table_box" style="height:400px;">
			  <table  id="queryRetTable">	
			  	...
			  	<thead data-options="frozen:true">
			     	<tr>
								...
								<th data-options="field:'dev_model',align:'center',sortable:'true'" width="100">设备型号</th>
								<th data-options="field:'self_num',align:'center',sortable:'true'" width="80">自编号</th>
								...
								<th data-options="field:'asset_value',align:'center',sortable:'true'" width="120">固定资产原值</th>
								<th data-options="field:'net_value',align:'center',sortable:'true'" width="120">固定资产净值</th>
					</tr>
					</thead>
					<thead>
					<tr>
								<th data-options="field:'owning_org_name_desc',align:'center',sortable:'true'" width="135">所属单位</th>
								<th data-options="field:'usage_org_name_desc',align:'center',sortable:'true'" width="135" >所在单位</th>
								<th data-options="field:'using_stat_desc',align:'center',sortable:'true'" width="80" >使用情况</th>
								<th data-options="field:'tech_stat_desc',align:'center',sortable:'true',hidden:true,dc:false" width="80">技术状况</th>
								<th data-options="field:'project_name_desc',align:'center',sortable:'true'"  width="135">项目名称</th>
								<th data-options="field:'dev_position1',align:'center',sortable:'true'" formatter='orgNameFormater' width="120">所在位置</th>
								<th data-options="field:'ifcountry_tmp',align:'center',sortable:'true'" width="100">国内/国外</th>
								<th data-options="field:'asset_coding',align:'center',sortable:'true'" width="100">AMIS资产编号</th>
								<th data-options="field:'cont_num',align:'center',sortable:'true'" width="135">合同编号</th>
								<th data-options="field:'turn_num',align:'center',sortable:'true'" width="135">转资单号</th>
								<th data-options="field:'erp_id',align:'center',sortable:'true'" width="100">ERP设备编号</th>
								<th data-options="field:'dev_sign',align:'center',sortable:'true'" width="100">实物标识号</th>
...
$(function(){
	...
	$("#queryRetTable").datagrid({ 
		...
		queryParams:{projectInfoNo:'<%=projectInfoNo%>',code:'<%=code%>',isDeviceCode:'<%=is_devicecode%>'},
		...
		},url:"${pageContext.request.contextPath}/dmsManager/safekeeping/queryKeepingConfInfoList.srq?JCDP_SRV_NAME=DevCommInfoSrv&JCDP_OP_NAME=queryDevAssetsList",
		onLoadSuccess : function(data1) {
			for(var i = 0; i < data1.rows.length; i++){
				debugger;
                if(data1.rows[i].dev_position!= undefined&&data1.rows[i].dev_position!='undefined'){
                    var orgname = data1.rows[i].dev_position;
...
<script type="text/javascript">
	...
	exportDatForEasyUI('queryRetTable','单台设备',1,2000,'<%=contextPath%>')
	}
	function searchDevData(){
		...
		params["query_owning_org_id"] = owning_org_id;
		params["code"] = '<%=code%>';

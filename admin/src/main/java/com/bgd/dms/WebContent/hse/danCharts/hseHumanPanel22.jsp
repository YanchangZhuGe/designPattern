...
<%
	...
	if(listOrg.size()>0){
		...
		second_org_id = (String)mapOrg.get("orgId");
	}
...
<body style="overflow-y: auto; background: #c0e2fb;">
		<table cellpadding="0" cellspacing="0" id="lineTable" class="tab_info" width="100%">
			...
			String sql = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[0]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";
			...
			String sql2 = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[1]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";
			...
			String sql3 = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[2]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";
			...
			String sql4 = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[3]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";
			...
			String sql5 = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[4]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";
			...
			String sql6 = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[5]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";
			...
			String sql7 = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[6]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";
			...
			String sql8 = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[7]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";
			...
			String sql9 = "select count(hp.employee_id) num,cc.employee_gz type from (select hr.employee_id,hr.employee_gz from comm_human_employee_hr hr where hr.second_org = '"+second_org_id+"' union select la.labor_id,la.if_engineer from bgp_comm_human_labor la where la.owning_subjection_org_id like '"+second_org+"%') cc join "+types[8]+" hp on cc.employee_id=hp.employee_id where hp.bsflag='0' group by cc.employee_gz ";

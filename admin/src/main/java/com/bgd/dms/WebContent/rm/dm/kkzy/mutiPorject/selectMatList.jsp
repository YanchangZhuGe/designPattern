      	...
      	<div id="list_table">
			  ...
			  <tr>
			  	<td class="ali_cdn_name">开始时间:</td>
							<td class="ali_cdn_input">
								<input id="v_start_date" name="v_start_date" class="input_width" type="text" readonly/>
						<td ><img src="/gms4/images/calendar.gif" id="tributton1" width="16" height="16" style="cursor: hand;"
					onmouseover="calDateSelector(v_start_date,tributton1);" /></td>

							</td>
							<td class="ali_cdn_name">结束时间:</td>
							<td class="ali_cdn_input">
								<input id="v_end_date" name="v_end_date"  class="input_width" type="text" readonly/>
									<td ><img src="/gms4/images/calendar.gif" id="tributton2" width="16" height="16" style="cursor: hand;"
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			        <td class="bt_info_odd" exp="<input name = 'rdo_entity_name' id='rdo_entity_id' type='checkbox'  value='{wz_id},{wz_prickie}' {disabled} onclick='loadDataDetail();chooseOne(this)'/>"</td>
...
<script type="text/javascript">
	...
	var ids = getQueryString("ids");
       ...
       function simpleSearch(){
			...
			var v_start_date = document.getElementById("v_start_date").value;
			var v_end_date = document.getElementById("v_end_date").value;
			var str = "";
			
			str+="  select t.*,c.code_name from gms_mat_infomation t inner join gms_mat_coding_code c on t.coding_code_id = c.coding_code_id and t.bsflag='0'and c.bsflag='0'";
			str+="  and t.wz_id in(select distinct t.wz_id from gms_device_zy_wxbymat t right join gms_device_zy_bywx wx on t.usemat_id=wx.usemat_id and  wx.bsflag='0'  and wx.org_subjection_id like '<%=userId%>%' and wx.project_info_id is null ";
			if(v_start_date!=undefined && v_start_date!=''){
				str += "  and wx.bywx_date >=to_date('"+v_start_date+"','yyyy-MM-dd') ";
			}
			if(v_end_date!=undefined && v_end_date!=''){
				str += "  and wx.bywx_date <=to_date('"+v_end_date+"','yyyy-MM-dd') ";
			}
			str+=") ";
			if(tamplate_name!=undefined && tamplate_name!=''){
				str += " and t.wz_name like '%"+tamplate_name+"%' ";
			}
			
			if(wz_id!=undefined && wz_id!=''){
				str += " and t.wz_id like '%"+wz_id+"%' ";
			}
     ...
     function saveBake(){
    		...
    		//返回信息是物资名称+物资编码
    		selectedids = ""+columnsObj[2].innerText+"~"+columnsObj[4].innerText;
 	...
 	function clearQueryText(){
 		...
 		document.getElementById("wz_id").value = "";
 		document.getElementById("v_start_date").value = "";
 		document.getElementById("v_end_date").value = "";
 	 	}

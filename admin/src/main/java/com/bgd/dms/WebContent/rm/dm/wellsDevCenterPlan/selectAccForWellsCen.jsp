...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model,license_num,self_num,dev_sign){
		...
		var str = "select account.dev_acc_id,account.asset_coding, ";
			...
			str += "from gms_device_account_wells account ";
			str += "where account.actual_out_time is null ";
		if(obj.selectStr != null){
			str += "and account.dev_acc_id not in ("+obj.selectStr+")";
		}
		str += "and account.account_stat!='0110000013000000005' and account.using_stat!='0110000007000000001' ";
		str += "and account.transfer_state = '0' and account.bsflag='0' and account.is_leaving='0' ";

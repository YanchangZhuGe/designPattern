...
<html>
    ...
    String orgId=(String)map.get("corpId");
	%>
<head>
...
<body>
<form name="form1" id="form1" method="post" action="<%=contextPath%>/market/updateTeamDynamic.srq">
<table border="0" cellpadding="0" cellspacing="0" class="form_info">
		<input type="hidden" name="orgId" value="<%=orgId%>"></input>
		<input type="hidden" name="teamDynamicId" value="<%=(String)map.get("teamDynamicId")%>"></input>
    <tr class="odd">
    	<td class="inquire_item"><font color=red>*</font>&nbsp;作业队号：</td>
    	<td class="inquire_form">
    		<input name="teamNo" id="teamNo" type="text" class="input_width" value="<%=(String)map.get("teamNo")%>"/>
		</td>
    ...
    <tr class="odd">
    	...
    	<td class="inquire_form" colspan="3">
			<textarea name="workPlace" id="workPlace" max=50 msg="作业地点不超过50个汉字"><%=(String)map.get("workPlace") %></textarea>
     	</td>
    </tr>   
	<tr class="odd">
...
<script type="text/javascript">
	document.getElementById("teamStatus").value="<%=(String)map.get("teamStatus")%>";

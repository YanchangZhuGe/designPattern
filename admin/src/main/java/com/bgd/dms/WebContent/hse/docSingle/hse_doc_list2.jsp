      	...
      	<div id="list_table">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <auth:ListButton functionId="F_DOC_009" css="xg" event="onclick='toEdit()'" title="JCDP_btn_edit"></auth:ListButton>
			    <auth:ListButton functionId="F_DOC_010" css="sc" event="onclick='toDelete()'" title="JCDP_btn_delete"></auth:ListButton>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="commonInfoTable" class="tab_line_height">
					  <tr>
					    ...
					    <td class="inquire_item6">文件名称：</td>
...
<script type="text/javascript">
	...
	var project_no = '<%=projectNo%>' == "null"?"":'<%=projectNo%>';
	...
	function loadDataDetail(ids){
		var theFileID = ids.split(":")[0];
 	    processNecessaryInfo={         
  	    		...
  	    		businessInfo:"单项目文档审批",        //用于待审批界面展示业务信息
		...
		document.getElementById("attachement").src = "<%=contextPath%>/doc/common/common_doc_list.jsp?relationId="+theFileID;

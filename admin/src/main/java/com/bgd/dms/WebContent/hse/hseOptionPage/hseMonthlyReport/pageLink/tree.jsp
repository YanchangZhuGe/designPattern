...
Ext.onReady(function() {
    ...
    function cellclick(grid,colspan, colIndex, rowdata, rowspan,rowIndex,e) {
        ...
        if(leaf == true){
        	...
        	parent.mainRightframe.location.href = "<%= contextPath%>/hse/hseOptionPage/hseMonthlyReport/pageLink/"+url+"?month_no=<%=month_no %>&org_sub_id=<%=org_sub_id %>&record_id=<%=record_id %>&action=<%=action%>&org_name=<%=org_name%>&subflag=<%=subflag%>";

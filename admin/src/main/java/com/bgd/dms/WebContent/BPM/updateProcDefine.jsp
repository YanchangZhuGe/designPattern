...
<%
	...
	String userName = user.getOrgSubjectionId();//request.getParameter("userName");
...
<body>
	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
         ...
         <param name="movie" value="UpdateWorkFlowDesigner.swf" />
         <param name="quality" value="high" />
         <param name="bgcolor" value="#869ca7" />
         <param name="allowScriptAccess" value="sameDomain" />
         <embed src="UpdateWorkFlowDesigner.swf" quality="high" bgcolor="#869ca7"

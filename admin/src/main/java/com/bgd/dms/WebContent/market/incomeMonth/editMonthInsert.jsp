...
<body>
<form name="form1" id="form1"  action="<%=contextPath%>/market/month/saveValueReport.srq">
   ...
   if(list1!=null){
    ...
    if(list12!=null){
   		for(int i=0;i<list12.size();i++){
   			...
   			if(i==0){
   				 income_id120 = map.get("incomeId").toString();
   				...
   				new_sign121 = map.get("newSign").toString();
   				 income_id121 = map.get("incomeId").toString();
    ...
    <tr class="even">
      ...
      <td><input name="income_id120" value="<%=income_id120%>" type="hidden"/>
      ...
      <td><input name="income_id121" value="<%=income_id121%>" type="hidden"/>
    ...
    if(list13!=null){
   		for(int i=0;i<list13.size();i++){
   			...
   			if(i==0){
   				 income_id130 = map.get("incomeId").toString();
   				...
   				new_sign131 = map.get("newSign").toString();
   				 income_id131 = map.get("incomeId").toString();
    ...
    <tr class="odd">
      ...
      <td><input name="income_id130" value="<%=income_id130 %>" type="hidden"/>
      ...
      <td><input name="income_id131" value="<%=income_id131 %>" type="hidden"/>
    ...
    if(list14!=null){
   		for(int i=0;i<list14.size();i++){
   			...
   			if(i==0){
   			 	 income_id140 = map.get("incomeId").toString();
   				...
   				new_sign141 = map.get("newSign").toString();
   				 income_id141 = map.get("incomeId").toString();
    ...
    <tr class="even">
      ...
      <td><input name="income_id140" value="<%=income_id140 %>" type="hidden"/>
      ...
      <td><input name="income_id141" value="<%=income_id141 %>" type="hidden"/>

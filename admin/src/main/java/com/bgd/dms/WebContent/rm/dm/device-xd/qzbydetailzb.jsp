    ...
    <div id="new_table_box_bg" style="width: 95%">
	  ...
	  <table width="97%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		  ...
		  <tr>
			...
			<td class="inquire_form6">
				<input id="repair_type" name="repair_type"  class="input_width" type="text" value ='维修'readonly/>
			</td>
			<td class="inquire_item6" ><font color=red>*</font>&nbsp;修理项目</td>
			<td class="inquire_form6">
			<input id="repairItem" name="repairItem"  class="input_width" type="text" value ='强制保养'readonly/>
			</td>
		  </tr>
...
<script type="text/javascript"> 
	...
	function searchRepairItem(){
		...
		if(retObjList != null&&retObjList!=""){		
			for(var index=0;index<retObjList.length;index++){
				...
				td.innerHTML = retObjList[index].check_append;
				td.className =tdClass+'_even'
				   if(autoOrder%2==0){
					td.style.background = "#FFFFFF";
				}else{
				...
				td.innerHTML = retObjList[index].bak;
				td.className =tdClass+'_even'
				   if(autoOrder%2==0){
					td.style.background = "#FFFFFF";
				}else{
	...
	function add(){
		...
		var vReturnValue = window.showModalDialog('<%=contextPath%>/rm/dm/device-xd/wzSelect.jsp',param,"dialogWidth=800px;dialogHeight=620px");
		...
		querySql += " ORDER BY MAIN.CREATE_DATE DESC ";
		var queryRet = syncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'querySql='+querySql+"&pageSize=1000");
		basedatas = queryRet.datas;
		var rindex;
		...
		for(var i=0;i<basedatas.length;i++){
			...
			newTr.insertCell().innerHTML="<font color=red>*</font>&nbsp;<input type='text' readonly='readonly' id='asign_num"+rownum+"' name='asign_num"+rownum+"' out_num='"+basedatas[i].use_num+"' value='"+basedatas[i].use_num+"' size='5' onkeyup='AutoCal(this,"+rownum+")'>";//消耗数量
	...
	function edit(basedatas){
		...
		for(var i=0;i<basedatas.length;i++){
			...
			newTr.insertCell().innerHTML="<input type='text' readonly='readonly' id='asign_num"+rownum+"' name='asign_num"+rownum+"' out_num='"+basedatas[i].out_num+"' size='5' value='"+basedatas[i].material_amout+"' onkeyup='AutoCal(this,"+rownum+")'>";//消耗数量

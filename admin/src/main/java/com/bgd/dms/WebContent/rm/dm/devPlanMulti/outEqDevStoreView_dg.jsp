...
<script type="text/javascript">
	...
	function refreshData(){
		var str = "select d.device_app_detid,d.dev_name,";
			...
			str += "nvl(tmp.mixed_num, 0) mixed_num,u.user_name, ";
			str += "case d.dev_out_org_id when 'C6000052795280' then '小车/运输设备服务中心' else org.org_abbreviation end as out_org_name ";

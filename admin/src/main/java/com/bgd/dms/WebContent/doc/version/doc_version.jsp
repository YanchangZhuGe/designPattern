			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="{file_version}">文件版本</td>			      
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "getDocVersionList";
	...
	function dbclickRow(ids){
		...
		if(ucm_id != ""){
			...
			window.open('<%=contextPath %>/doc/onlineview/view_doc.jsp?ucmId='+ucm_id+'&fileExt='+fileExtension+'&docVersion=docversion');
		}else{
	    	alert("该条记录没有文档");
	    	return;
		}

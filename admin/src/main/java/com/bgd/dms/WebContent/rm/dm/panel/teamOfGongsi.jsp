...
<div ><!-- style="overflow-y: auto; overflow-x: hidden;" -->
	...
	function refreshData(){
		...
		var myChart = new FusionCharts("${applicationScope.fusionChartsURL}/Charts/MSColumn3D.swf", "myChartId", "100%", "300", "0", "1");
	 	var substr = "device_name="+device_name+"&parent_id="+parent_id+"&num_type="+num_type+"&org_subjection_id="+org_subjection_id;
	 	var retObj = jcdpCallService("DevCommInfoSrv", "teamLevel", substr);
	...
	function fusionChart(device_name,parent_id,num_type){
		...
		var obj = {};
		window.showModalDialog('<%=contextPath %>/rm/dm/panel/teamOfGongsi.jsp?parent_id='+parent_id+'&num_type='+num_type+'&device_name='+device_name,obj,'dialogWidth:1024px;dialogHeight:600px');
	}

			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
					...
					<td class="bt_info_odd" exp="{actual_price}">物资单价</td>
					<td class="bt_info_odd" exp="{stock_num}">库存</td>
...
<script type="text/javascript">
	...
	function refreshData(value){
		...
		cruConfig.queryOp = "getRepTemLeafWZXZ";
		cruConfig.submitStr ="ids="+ids+"&value="+value+"&orgSubjectionId="+orgSubjectionId;
		queryData(1);
	}
       ...
       function simpleSearch(){
	    	...
	    	cruConfig.queryService = "MatItemSrv";
			cruConfig.queryOp = "getRepTemLeafWZXZ";
			cruConfig.submitStr ="tamplate_name="+tamplate_name+"&wz_id="+wz_id+"&coding_code_id="+coding_code_id+"&ids="+ids+"&orgSubjectionId="+orgSubjectionId;
			queryData(1);

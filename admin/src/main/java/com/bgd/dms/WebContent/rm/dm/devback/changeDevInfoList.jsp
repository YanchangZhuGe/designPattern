...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
  <title>单项目-设备返还-设备返还(更换设备)</title> 
 </head>
			...
			<div id="table_box">
			  <table style="width:98.5%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
					...
					<td class="bt_info_odd" exp="{device_backapp_no}">更换申请单号</td>
					<td class="bt_info_even" exp="{backapp_name}">更换申请单名称</td>
...
<script type="text/javascript">
    ...
    function refreshData(v_device_backapp_no, v_backapp_name){
		...
		str += " and backapp.backapptype = '3' order by backapp.state nulls first,backapp.backdate desc  ";
	...
	function toAddBackPlanPage(){
		popWindow('<%=contextPath%>/rm/dm/devback/changedev_new_apply.jsp?projectInfoNo=<%=projectInfoNo%>','950:680');
	}
	//修改

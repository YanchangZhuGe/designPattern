...
<!-- <td><input name="new_sign00" value="<%=new_sign00 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign10" value="<%=new_sign10 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign20" value="<%=new_sign20 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign30" value="<%=new_sign30 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign40" value="<%=new_sign40 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign50" value="<%=new_sign50 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign60" value="<%=new_sign60 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign70" value="<%=new_sign70 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign80" value="<%=new_sign80 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign90" value="<%=new_sign90 %>" size="10"/></td>  -->
...
<!--        <td><input name="new_sign100" value="<%=new_sign100 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign110" value="<%=new_sign110 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign120" value="<%=new_sign120 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign130" value="<%=new_sign130 %>" size="10"/></td> -->
...
<!--        <td><input name="new_sign140" value="<%=new_sign140 %>" size="10"/></td> -->
    ...
    <tr class="odd">
      <td>合计</td>
<!--        <td><input name="totalSign" value="<%=totalSign %>" size="10"/></td> -->
      <td>国内</td>
...
<script type="text/javascript">
	...
	function save(){
		...
		var querySql = "select t.* from bgp_wr_income_money t where t.week_date = to_date('" + week_date + "','yyyy-MM-dd') and t.bsflag='0' and t.org_type='1' and t.type='2' order by org_id,country";
		...
		if(datas != null && queryRet.datas.length){
			var flag=false;
			if(confirm("月报开始日期已存在,修改该记录请点确定,否则取消!")){
				flag=true;
				var datas = queryRet.datas;

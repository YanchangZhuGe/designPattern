...
<script type="text/javascript">
	...
	function refreshData(){
		var sql ='';
		sql +="select  t.tamplate_id,t.tamplate_name,t.create_date,c.coding_name,u.user_name, c.coding_name tname from gms_mat_demand_tamplate t  left join comm_coding_sort_detail c on t.coding_code_id = c.coding_code_id and c.bsflag='0' inner join p_auth_user u on t.creator_id = u.user_id and u.bsflag='0' where t.bsflag='0'and t.device_id is null order by t.create_date desc";

...
<body style="background:#fff" onload="simpleRefreshData()">
      	<div id="list_table">
			...
			<div id="table_box">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      <td class="bt_info_odd"  exp="<input type='checkbox' name='rdo_entity_id' value='{project_info_no}-{project_type}-{project_year}-{org_subjection_id}-{org_id}-{project_name}' id='rdo_entity_id_{project_info_no}'  ondbclick='selectProjectInfo(this)'/>" >全选<input  type='checkbox'  onclick="checkAll(this.checked)"></td>
...
<script type="text/javascript">
	...
	function refreshData(q_projectName, q_projectYear,q_projectType, q_isMainProject, q_projectStatus, q_orgName, q_orgSubjectionId){
		cruConfig.submitStr = "orgSubjectionId="+q_orgSubjectionId+"&projectName="+q_projectName+"&projectYear="+q_projectYear+"&isMainProject="+q_isMainProject+"&projectStatus="+q_projectStatus+"&orgName="+q_orgName+"&isSingle=<%=isSingle %>";
		queryData(1);
	...
	function simpleRefreshData(){
		...
		var q_projectStatus = $("#projectStatus").val();
	...
	function toSubProjects(){
	    ...
	    location.href="<%=contextPath %>/pm/project/multiProject/noTagSubProjectsList.jsp?projectName="+projectName+"&projectType="+project_type+"&projectFatherNo="+project_info_no+"&orgSubjectionId="+org_subjection_id+"&projectYear="+project_year+"&orgId="+org_id;
	}

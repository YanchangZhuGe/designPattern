			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box">
						<div class="tongyong_box_title"  ><span class="kb"><a
							href="#"></a></span><a href="#">物探处线级分类对比</a>
...
<script type="text/javascript">
 ...
 function getFusionChart(){
	...
	myChart1.setXMLUrl("<%=contextPath%>/rm/em/getChart5.srq?orgId=<%=orgId%>");      
	myChart1.render("chartContainer1");  
	
	var myChart2 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/StackedColumn3D.swf", "myChartId2", "100%", "100%", "0", "0" );    
	myChart2.setXMLUrl("<%=contextPath%>/rm/em/getChart6.srq");      
 ...
 function changeOrg(){
     ...
     chartReference.setXMLUrl("<%=contextPath%>/rm/em/getChart5.srq?orgId="+s_org_id);
 }

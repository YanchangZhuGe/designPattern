			...
			<div id="tab_box" class="tab_box">
				<div id="tab_box_content0" name="tab_box_content0" class="tab_box_content">
					...
					<tr>
				      ...
				      <td  class="inquire_form6"><input id="team_name" class="input_width" type="text"  value="" disabled/> &nbsp;</td>
...
$().ready(function(){
	...
	if((basedatas.length>=1 && (basedatas[0].proc_status == '1'||basedatas[0].proc_status == '3'))||sonFlag_tmp == 'Y'){
		$(".zj").hide();
		$(".xg").hide();
		$(".sc").hide();
	}
...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model){
		...
		str += "p6.name as jobname,devapp.device_app_name,appdet.dev_name as dev_ci_name, ";
...
<script type="text/javascript">	
	...
	function toAddPage(){
		if(projectType=='5000100004000000009'){
			popWindow('<%=contextPath%>/rm/dm/devmixPlan/zhmixdetail_new_apply.jsp?projectInfoNo=<%=projectInfoNo%>&deviceappid=<%=deviceappid%>','1050:680');
		}else{
	...
	function toModifyPage(){
		...
		if(projectType=='5000100004000000009'){
			popWindow('<%=contextPath%>/rm/dm/devmixPlan/zhmixdetail_modify_apply.jsp?projectInfoNo=<%=projectInfoNo%>&deviceappid=<%=deviceappid%>&deviceappdetid='+selectedid,'950:680');
		}else{
    ...
    function loadDataDetail(device_app_detid){
    	...
    	var str = "select sd.coding_name as unitname,teamsd.coding_name as teamname, ";
		str += "appdet.dev_name as dev_ci_name,appdet.dev_type as dev_ci_model,devapp.device_app_name, ";
		str += "appdet.apply_num,appdet.purpose,appdet.employee_id,emp.employee_name, ";
		...
		$("#team_name","#detailMap").val(retObj[0].teamname);

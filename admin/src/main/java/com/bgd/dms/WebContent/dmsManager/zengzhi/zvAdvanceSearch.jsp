		  ...
		  <div id="new_table_box_content" style="background-color: rgb(241, 242, 243)">
		    ...
		    <tr>
		   	...
		   	<tr>
			    ...
			    <td class="inquire_item4">增值状态：</td>
			    <td class="inquire_form4">
			    	<select id="valuestate" name="valuestate" class="select_width easyui-combobox querystate" data-options="editable:false,panelHeight:'auto'" style="width:210px;" >

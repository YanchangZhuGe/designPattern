...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function getAmountWhlFusionChart(){
			...
			var chart1 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Column3D.swf", "chart1", "95%", "200", "0", "0" );    
			chart1.setXMLUrl("<%=contextPath%>/rm/dm/colljbqgetDeviceLieOne.srq?country="+country);
			chart1.render("chartContainer1");
		
			parent.mainRightframe.location.href = "<%=contextPath%>/rm/dm/deviceXZAccount/colljbqDevAccListUnUse.jsp";
		...
		function toQuery1(){
			...
			chartReference1.setXMLUrl("<%=contextPath%>/rm/dm/colljbqgetDeviceLieOne.srq?devTreeId="+devTreeId+"&country="+country);
			parent.mainRightframe.location.href = "<%=contextPath%>/rm/dm/deviceXZAccount/colljbqDevAccListUnUse.jsp?devTreeId="+devTreeId+"&country="+country;
		}
		//清除
		function toClear(){
			$('#org_sub_id_1') .val('');
			...
			chart1.render("chartContainer1");
			parent.mainRightframe.location.href = "<%=contextPath%>/rm/dm/deviceXZAccount/DevAccListUnUse.jsp";
			}
		//弹出设备信息
		function popDevList(devTreeId,orgSubId,country){
			parent.mainRightframe.location.href = "<%=contextPath%>/rm/dm/deviceXZAccount/colljbqDevAccListUnUse.jsp?devTreeId="+devTreeId+"&orgSubId="+orgSubId+"&country="+country;

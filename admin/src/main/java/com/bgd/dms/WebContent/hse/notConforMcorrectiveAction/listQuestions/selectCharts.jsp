...
<script language="javaScript">
	function submit(){
		...
		window.location.href="<%= contextPath%>/hse/notConforMcorrectiveAction/listQuestions/safeCheckCharts.jsp?second="+second+"&&third="+third+"&&fourth="+fourth+"&&check_date="+check_date+"&&check_dateA="+check_dateA;
	}

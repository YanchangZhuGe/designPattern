	...
	**/
	...
	function submitInfo(){
		...
		if(datas==""||datas==null){
			...
			var id = document.getElementById("devaccid").value;
			if(id==datas[0].dev_acc_id){
				document.getElementById("form1").action = "<%=contextPath%>/rm/dm/saveRFIDDevAccount.srq";
				document.getElementById("form1").submit();
			}else{

...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
 ...
 <body style="bgColor_f3f3f3;" onload="refreshData()">
			...
			<div id="table_box">
				...
				<tr>
			       <td class="inquire_item4" >申请单位名称:</td>
			        <td class="inquire_form4" >
			          	<input name="in_org_name" id="in_org_name" class="input_width" type="text"  value="<%=user.getOrgName() %>" readonly/>
			          	<input name="in_org_id" id="in_org_id" class="input_width" type="hidden"  value="" />
			        </td>
			        <td class="inquire_item4" >申请人:</td>
			        <td class="inquire_form4" >
			          	<input name="out_org_name" id="out_org_name" class="input_width" type="text"  value="<%=user.getUserName()%>" readonly/>
			        </td>
				</tr>
			       </table>
			      </fieldset>
			      <div id="table_box">
					  <fieldset>
					      <table style="width:95.5%;" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					        <tr align="right">
					  		  <td>&nbsp;</td>

					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
						  <tr>
						  	<td class="inquire_item4">申请单位</td>
						   	<td class="inquire_form4"><input name="org_name" id="org_name" type="text" class="input_width" value="<%=orgName%>" readonly="readonly"/>
						   	</td>
	...
	function del() {
	  ...
	  function toSave(){ 
       ...
       function toAdd(){
	   		...
	   		var sql ='';
	   		sql +="select '' wz_name,'' wz_prickie,'' apply_num,'' submit_num,'' wz_price,'' total_price,'' status from dual";
	   		cruConfig.cdtType = 'form';

...
<frameset cols="200,*" frameborder="yes" border="0" framespacing="0">
	<frame src="<%=contexPath%>/rm/dm/devRepair/repairPartRltTree.jsp<%=paramUrl%>" name="mainleftframe" frameborder="0" scrolling="auto"
		id="mainleftframe" style="border-right: 2px solid #5796DD; cursor: w-resize;" />
	<frame src="<%=contexPath%>/rm/dm/devRepair/repairPartRltList.jsp?id=INIT_REPAIR_012345678900000" name="mainRightframe" frameborder="0" scrolling="auto"

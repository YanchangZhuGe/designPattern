...
function save(){
	...
	// 检查是否已存在
	var checkSql="select * from bgp_wr_income_money where to_char(week_date,'yyyy-MM-dd')='" + week_date + "' and bsflag='0' and org_type='1' and type='1'";
	...
	if(datas && datas[0] && datas[0].income_id){
		...
		window.location="<%=contextPath%>/market/week/addValueReport.srq?week_date="+week_date+"&week_end_date="+week_end_date+"&action=add";
	}
}

...
<html>
 ...
 <body> 
 <form name="fileForm" id="fileForm" method="post" enctype="multipart/form-data" action="<%=contextPath%><%=path%>">
 <div id="new_table_box" align="center">
  ...
  <div id="oper_div">
	<span class="bc_btn"><a id="saveB" href="#" onclick="newSubmit()" ></a></span>

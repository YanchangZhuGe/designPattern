...
function getFusionChart(){
	...
	var retObj1 = jcdpCallServiceCache("EarthquakeTeamStatistics","getZyMStatistics","projectInfoNo="+project_info_id+"&start_date="+begin_date+"&end_date="+end_date);
...
function simpleSearch(){
	...
	var retObj1 = jcdpCallServiceCache("EarthquakeTeamStatistics","getZyMStatistics","change=<%=change%>"+"&start_date="+startDate+"&end_date="+endDate+"&dev_coding="+dev_coding+"&project_info_id="+project_info_id);
	var dataXml1 = retObj1.dataXML;
	var myChart1 = new FusionCharts("${applicationScope.fusionChartsURL}/Charts/MSColumn3D.swf", "myChartId1", "100%", "250", "0", "0" );    
	myChart1.setXMLData(dataXml1);
	myChart1.render("chartContainer1");
									...
									<div class="tongyong_box_title">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td class="ali_cdn_input" align="right"><input on
												...
												<td >
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr >
															<td align="left"><input id="s_dev_coding" name="s_dev_coding"
																type="text" readonly="readonly"  size="25"/></td>
															<td align="left"><img src="<%=contextPath%>/images/magnifier.gif"
												...
												<td  align="right" class="ali_cdn_input"><select id="dev_project_name"
													name="dev_project_name">
														<option value=""></option>
												</select> </td>
												<td align="left"><img src="<%=contextPath%>/images/magnifier.gif"
													width="16" height="16" style="cursor: hand;"
													onclick="toChoseProject()" /><input type="hidden" id="project_info_id" /></td>
											...
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													<span class="kb"><a href="#"></a></span><a href="#">震源备件消耗金额统计</a><span
														...
														href="#" onclick="exportDataDoc('aptm')" title="导出excel"></a>
													</span>
												</div>

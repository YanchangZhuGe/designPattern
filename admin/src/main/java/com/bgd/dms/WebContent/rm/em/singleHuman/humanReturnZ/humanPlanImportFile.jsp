...
<body>
<form action="<%=contextPath%>/rm/em/toSaveZHumanReturnExcle.srq" id="fileForm" method="post" enctype="multipart/form-data" target="list">
...
<tr align="right">
	...
	<input name="Submit" type="button"   class="iButton2" id="confirmButton"  onClick="newClose()" value="取消" />
	</td>
</tr>
</table>

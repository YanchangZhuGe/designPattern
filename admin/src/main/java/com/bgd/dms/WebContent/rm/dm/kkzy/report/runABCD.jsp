...
<%
	...
	if (monthDate == null)
		monthDate = ""
				+ new SimpleDateFormat("yyyy-MM").format(c1.getTime());
	String projectInfoNo = user.getProjectInfoNo();
	String reptParams = "id=" + projectInfoNo + ";month=" + monthDate
			+ ";uid=" + userOrgId + ";id2=" + projectInfoNo;
%>
...
<body style="overflow-x: scroll; overflow-y: scroll;">
					...
					<td background="<%=contextPath%>/images/list_15.png">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="ali_cdn_input"><input type="text" id="monthDate"
									name="monthDate" class="input_width" style="width: 120px"
									value="<%=monthDate%>" readonly="readonly" /> &nbsp;&nbsp;<img
									src="<%=contextPath%>/images/calendar.gif" id="tributton1"
									width="16" height="16" style="cursor: hand;"
									onmouseover="yymmSelector(monthDate,tributton1);" />&nbsp;</td>
	...
	<%
		if (monthDate != null && !monthDate.equals("")) {
			...
			str.append("id=").append(projectInfoNo).append(";month=")
					.append(monthDate);
	%>
	...
	<div  style="height: 400px">
		<table align="center" id="90">
			<tr align="center">
				<td align="center"><report:html name="report1"
						reportFileName="/device-abcd.raq" params="<%=reptParams%>"
						width="-1" height="-1" needScroll="no" needPageMark="no"
						saveAsName="可控震源ABCD检查维护保养表" excelPageStyle="0" /></td>
			</tr>
		</table>
	</div>
	<%
...
<script type="text/javascript">
	...
	function simpleSearch(){
		...
		window.location="<%=contextPath%>/rm/dm/kkzy/report/runABCD.jsp?monthDate="
				+ monthDate;
	}

...
<%
	...
	String hse_event_id = resultMsg.getValue("hse_event_id");
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" style="margin-top: 10px;">
					 ...
					 <tr>
				    	<td class="inquire_item6"><font color="red">*</font>事件名称：</td>
				      	<td class="inquire_form6"><input type="text" id="event_name" name="event_name" class="input_width"  value="<%=map.get("eventName")%>"/></td>
				    	...
				    	<td class="inquire_item6"><font color="red">*</font>事件时间：</td>
				      	<td class="inquire_form6"><input type="text" id="event_date" name="event_date" class="input_width"   value="<%=map.get("eventDate") %>" readonly="readonly"/>
				     ...
				     <tr>
					    ...
					    <td class="inquire_form6"><input type="text" id="event_place" name="event_place" class="input_width" value="<%=map.get("eventPlace") %>"/></td>
					    <td class="inquire_item6"><font color="red">*</font>填报日期：</td>
					    <td class="inquire_form6"><input type="text" id="write_date" name="write_date" class="input_width" value="<%=map.get("writeDate") %>" readonly="readonly"/>
					  ...
					  <tr>
					   ...
					   <td class="inquire_item6">报告人：</td>
					    <td class="inquire_form6"><input type="text" id="report_name" name="report_name" class="input_width" value="<%=map.get("reportName") %>"/></td>
					  </tr>
					  <tr>
					    <td class="inquire_item6">报告时间：</td>
					    <td class="inquire_form6"><input type="text" id="report_date" name="report_date" class="input_width" value="<%=map.get("reportDate") %>" readonly="readonly"/>
...
document.getElementById("event_type").value='<%=map.get("eventType")%>';
document.getElementById("event_property").value='<%=map.get("eventProperty")%>';

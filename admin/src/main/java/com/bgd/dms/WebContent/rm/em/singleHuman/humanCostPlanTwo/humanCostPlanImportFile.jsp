...
<body>
<form action="<%=contextPath%>/rm/em/toSaveHumanCostExcleTwo.srq" id="fileForm" method="post" enctype="multipart/form-data" target="list">
<table width="96%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" >
	<tr>
		...
		<input type="hidden" id="planIds" name="planIds" value="<%=planIds%>" class="input_width">
		<input type="hidden" id="projectInfoNo" name="projectInfoNo" value="<%=projectInfoNo%>" class="input_width"></td>

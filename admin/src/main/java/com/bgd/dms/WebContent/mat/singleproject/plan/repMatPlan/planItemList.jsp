...
<script type="text/javascript">
	...
	function toDelete(){
	 	     	...
	 	     	return;
		 	    	...
		 	    	if(submiteIf =='3'){ alert("申请单已被审批!");
		 	     	return;
						...
						popWindow('<%=contextPath%>/mat/singleproject/plan/repMatPlan/queryPlan.srq?laborId='+ids,'1024:800');
			}
			}
		    }
	 }
	 function toAdd(){ 
			  ...
			  popWindow("<%=contextPath%>/mat/singleproject/plan/repMatPlan/planAddItemList.jsp?taskObjectId="+taskObjectId+"&projectInfoNo="+projectInfoNo,'1024:800');

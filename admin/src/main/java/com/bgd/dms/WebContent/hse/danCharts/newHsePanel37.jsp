...
<%
	...
	String wrong_no = "0";
	String fix_no = "0";
	String sql = "select g.use_no,g.week_use_no,g.normal_no,g.wrong_no,g.fix_no from bgp_hse_common c join bgp_hse_week_gps g on c.hse_common_id = g.hse_common_id where c.bsflag = '0' and c.subflag = '1' and c.project_info_no = '"+project_info_no+"' and c.week_end_date = to_date('"+week_end_date+"','yyyy-MM-dd')";

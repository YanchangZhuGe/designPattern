			...
			<form action="" id="form0" name="form0" method="post" target="record">
				<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		    		<tr>
				    	...
				    	<td class="inquire_form8"><input name="org_id" id="org_id" type="text" class="input_width" value="" /></td>
				    	...
				    	<td class="inquire_form8"><input name="leader_id" id="leader_id" type="text" class="input_width" value="" /></td>
				    	<td class="inquire_item8"><font color="red">*</font>分管领导姓名:</td>
				    	<td class="inquire_form8"><input name="super_id" id="super_id" type="text" class="input_width" value="" /></td>
				     </tr>
				    <tr>
				    	...
				    	<td class="inquire_form8"><input name="depart_id" id="depart_id" type="text" class="input_width" value="" /></td>
				    	<td class="inquire_item8"><font color="red">*</font>负责人姓名:</td>
				    	<td class="inquire_form8"><input name="charge_id" id="charge_id" type="text" class="input_width" value="" /></td>
...
<script type="text/javascript">
	...
	function refreshData(orgId){
		org_id = orgId;
		cruConfig.submitStr = "org_subjection_id=<%=org_subjection_id%>";
		setTabBoxHeight();
		queryData(1);
	}
	refreshData('');

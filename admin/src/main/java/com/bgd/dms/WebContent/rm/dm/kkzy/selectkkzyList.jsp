			...
			<div id="table_box">
			  <table width="98%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			      <tr id='dev_acc_id_{dev_acc_id}' name='dev_acc_id' idinfo='{dev_acc_id}'>
			     	<td class="bt_info_odd" exp="<input type='checkbox' name='rdo_entity_name' value='{dev_acc_id}' id='rdo_entity_name_{dev_acc_id}' {selectflag}/>" >全选<input  onclick="checkAll(this.checked)"  type='checkbox'  id='allCheck' ></td>
...
<script type="text/javascript">
  ...
  var checked = false;
	...
	function searchDevData(){
		...
		var obj = new Array();
		obj.push({"label":"self_num","value":v_self_num},{"label":"dev_model","value":v_dev_model});
		refreshData(obj);
	}
	 //清空查询条件
	...
	function refreshData(arrObj){
		...
		str+="  where  t.owning_sub_id like '"+userid+"%'  and t.dev_type like 'S062301%' and project_info_id='"+projectInfoNo+"' ";
		//if(selectWzId!="")
			//{	

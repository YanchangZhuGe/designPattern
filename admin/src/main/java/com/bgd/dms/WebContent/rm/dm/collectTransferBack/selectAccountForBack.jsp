...
<%
	...
	String reporgid = request.getParameter("reporgid");
%>
...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
 ...
 <body style="background:#F1F2F3" onload="refreshData()" style="overflow-x:hidden;overflow-y:visible; background:#fff ;">
      	<div id="list_table">
...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model){
		var str = "select account.dev_acc_id,account.dev_name,account.dev_model,";
		str += " account.unuse_num,org.org_abbreviation as org_name,unitsd.coding_name ";
		str +="  as unit_name from gms_device_coll_account account join comm_org_information";
		str +=" org on account.usage_org_id = org.org_id join comm_coding_sort_detail unitsd";
		str +=" on account.dev_unit = unitsd.coding_code_id where account.usage_org_id = '<%=reporgid%>'";
		str +=" and account.unuse_num > 0 ";
			...
			str += "order by account.usage_org_id ";
		...
		for(var index=0;index<retObj.length;index++){
			...
			innerhtml += "<td>"+retObj[index].org_name+"</td>" ;

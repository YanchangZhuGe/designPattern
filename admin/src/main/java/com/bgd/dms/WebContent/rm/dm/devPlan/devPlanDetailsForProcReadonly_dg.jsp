...
<script type="text/javascript">
	...
	function refreshData(){
		...
		str += "where devapp.project_info_no = '"+projectInfoNos+"' and devapp.bsflag='0' and alldet.bsflag='0' and (alldet.device_addapp_id='"+deviceallappid+"' or alldet.device_allapp_id ='"+deviceallappid+"') ";

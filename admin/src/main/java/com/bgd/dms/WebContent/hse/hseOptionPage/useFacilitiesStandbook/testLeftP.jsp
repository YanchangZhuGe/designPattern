...
<script type="text/javascript"> 
	...
	function refreshData(arrObj){
	   ...
	   function add(){ 
        ...
        self.parent.frames["rightframe"].location="<%=contextPath %>/hse/hseOptionPage/useFacilitiesStandbook/rightPageP.jsp?addTypes=<%=addTypes%>&pk_id="+certificate_no+"&usefacilities_no="+usefacilities_no;

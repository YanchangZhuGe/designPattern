...
<body style="background: #fff; overflow-y: auto"  onload="getFusionChart()">
											...
											<div class="tongyong_box" style="width:96%; height: 100%; margin: 10px;">
												<div class="tongyong_box_title">
													</span><a href="#">公司周利润同比分析</a><span class="gd"><a href="#"></a> </span>
												</div>
...
<script type="text/javascript">
 function getFusionChart(){
	...
	myChart2.setXMLUrl("<%=contextPath%>/op/OpCostSrv/getCompanyWeekProfitInfo.srq?d_month=<%=d_month%>&orgSubjectionId=<%=orgId%>");      

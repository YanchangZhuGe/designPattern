    	 ...
    	 parA.style.display='block';
    		...
    		if(queryRet.returnCode=='0'){
    			if(datas != null && datas != ''  ){	 
    				  ...
    				  document.getElementById("loadFile").innerText="无上传文档";
...
<tr style="display:none;">
	<td class="inquire_item4">上传文件： </td>
	<td class="inquire_form4" > 
...
<table width="1300" border="0" cellspacing="0"  align="center" cellpadding="0" class="scrolltable">
  <thead>
	<tr class="scrollColThead td_head"> 
	    <td class="scrollCR scrollRowThead" width="2%">选择</td>
		...
		<td width="3%">已申请人数 </td> 
		<td width="3%">尚需人数 </td> 
		<td width="4%"><font color="red">*</font>本次申请人数</td> 
		<td width="4%"><font color="red">*</font>其中临时季节性人数</td>
		<td width="3%" >专业化人员<input type="hidden" id="equipmentSize" name="equipmentSize" value="<%=beanList.size()%>" /></td>
	</tr>
		 <%

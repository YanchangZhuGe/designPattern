...
<input type='hidden' name='invoices_type' id='invoices_type' value='2'/>
	<table  border="0" cellpadding="0" cellspacing="0" class="tab_line_height" width="100%">

  	<tr>
    	<td colspan="4" align="center">可重复利用物资调剂</td>
    </tr>
    <tr>
    	
    	<td class="inquire_item6">申请单号：</td>
      	<td class="inquire_form6"><input type="text" name="submite_number" id="submite_number" class="input_width" value="<gms:msg msgTag="matInfo" key="submite_number" />" readonly/>
      	<input type="hidden" name="plan_invoice_id" id="plan_invoice_id" class="input_width" value="<gms:msg msgTag="matInfo" key="plan_invoice_id" />"/></td>
...
<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      <td class="bt_info_odd" exp="<input name = 'plan_id_{wz_id}' id='rdo_entity_id' type='checkbox' checked='checked' value='{wz_id},{plan_id}' onclick='loadDataDetail()'/>"><input type='checkbox' name='task_entity_id' value='' onclick='check()'/></td>
			      ...
			      <td class="bt_info_even" exp="<input name='regulate_num_{plan_id}'  type='text' value='{regulate_num}'/>">调剂数量</td>
			      <td class="bt_info_odd" exp="<input name='actual_price_{plan_id}'  type='text' value='{wz_price}'/>">调剂单价</td>
			      <td class="bt_info_even" exp="<input name='total_money_{plan_id}'  type='text' value=''/><input type='hidden' name='org_subjection_id_{plan_id}' value='{org_subjection_id}'/><input type='hidden' name='org_id_{plan_id}' value='{org_id}'/>">金额</td>
			    </tr>
			  </table>
			</div>

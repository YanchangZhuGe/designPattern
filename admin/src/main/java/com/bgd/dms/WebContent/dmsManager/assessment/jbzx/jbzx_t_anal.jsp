...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function getFusionChart(){
			...
			chart1.setXMLUrl("<%=contextPath%>/dms/assess/jbzx/getTotalJbzxChartData.srq?item_id=<%=item_id%>&item_name=<%=item_name%>&org_sub_id=<%=org_sub_id%>");
			chart1.render("chartContainer1");
		}
		//指标分析
		function popJbzxChart(item_id,item_name,org_sub_id){
			popWindow('<%=contextPath%>/dmsManager/assessment/jbzx/jbzx_anal.jsp?item_id='+item_id+'&item_name='+item_name+'&org_sub_id='+org_sub_id+'&isDisplay=yes','1050:770');		
		}
	</script>
</html>

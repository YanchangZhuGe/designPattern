...
<script type="text/javascript">
    ...
    function loadDataDetail(ids){
  	  ...
  	  processNecessaryInfo={         
	    		...
	    		businessType:"5110000004100000052",        //业务类型 即为之前设置的业务大类
	    		businessId: ids.split("-")[0],         //业务主表主键值
	    		businessInfo:"试验设计文档审核",        //用于待审批界面展示业务信息
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/ConsdesignDoc/add_tdDocModifyNew.jsp?docType=0110000061100000003&fileAbbr='+fileAbbr+'&parent_file_id=<%=parent_file_id%>');
    }
	function toEdit() {

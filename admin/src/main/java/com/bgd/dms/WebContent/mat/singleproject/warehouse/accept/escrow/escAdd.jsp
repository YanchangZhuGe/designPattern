...
<table border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td class="inquire_item6"><input type="text" name="input_no" id="input_no" class="input_width" value="<gms:msg msgTag="matInfo" key="input_no"/>"  readonly="readonly"/></td>
	...
	<div id="table_box" >
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="right" id="queryRetTable">
			<tr>
				...
				<td class="bt_info_even" exp="{wz_name}">名称及规格</td>
				<td class="bt_info_odd" exp="{wz_prickie}">单位</td>
				<td class="bt_info_even" exp="{mat_num}">数量</td>
				<td class="bt_info_odd" exp="{actual_price}">入库单价</td>
...
<script type="text/javascript"><!--
	...
	function refreshData(){
		...
		cruConfig.currentPageUrl = "/mat/singleproject/warehouse/accept/escrow/escAdd.jsp";
		queryData(1);
	}							
	function save(){	
		//if (!checkForm()) return;
		...
		document.getElementById("form1").action="<%=contextPath%>/mat/singleproject/warehouse/accept/trac/saveTracLedger.srq?laborId="+ids+"&invoicesId="+invoicesId;

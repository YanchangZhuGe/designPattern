...
<html>
	...
	<script type="text/javascript">
		...
		function showDevAccountPage(){
			var obj = new Object();
			var dialogurl = "<%=contextPath%>/dmsManager/safekeeping/deviceIns/selectRcjcAccount.jsp";
			...
			if(vReturnValue!=undefined){
				...
				if("1"==rcjcType){
					$("#load_checked_Items").load("<%=contextPath%>/dmsManager/safekeeping/deviceIns/kkzy_rcjc.jsp");
				}
				if("2"==rcjcType){
					$("#load_checked_Items").load("<%=contextPath%>/dmsManager/safekeeping/deviceIns/qbzj_rcjc.jsp");			
				}
				if("3"==rcjcType){
					$("#load_checked_Items").load("<%=contextPath%>/dmsManager/safekeeping/deviceIns/yscl_rcjc.jsp?dev_acc_id="+content[0]);
				}
				if("4"==rcjcType){
					$("#load_checked_Items").load("<%=contextPath%>/dmsManager/safekeeping/deviceIns/czzj_rcjc.jsp");
				}

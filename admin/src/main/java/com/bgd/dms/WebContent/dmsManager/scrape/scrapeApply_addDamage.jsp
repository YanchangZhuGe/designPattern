  ...
  <div id="new_table_box_content">
    <div id="new_table_box_bg">
      ...
      <fieldSet style="margin-left:2px"><legend>添加附件</legend>
       ...
       <fieldSet style="margin-left:2px"><legend>盘亏</legend>
	      <div border="0" cellpadding="0" cellspacing="0"  id="FilterLayer" width="100%" style="height:300px">
			 <iframe id="devMenuZcbf" width="99%" cellSpacing=5 cellPadding=0 width=570 style="height:300px" border=0 src="<%=contextPath %>/dmsManager/scrape/devMenu.jsp?bussId=<%=bussId%>&scrapeType=2&scrape_apply_id=<%=scrape_apply_id %>"></iframe>
		  </div>
      </fieldSet>
       <fieldSet style="margin-left:2px"><legend>毁损</legend>
	      <div border="0" cellpadding="0" cellspacing="0"  id="FilterLayer" width="100%" style="height:300px">
			 <iframe id="devMenuJstt" width="99%" cellSpacing=5 cellPadding=0 width=570 style="height:300px" border=0 src="<%=contextPath %>/dmsManager/scrape/devMenu.jsp?bussId=<%=bussId%>&scrapeType=3&scrape_apply_id=<%=scrape_apply_id %>"></iframe>
		  </div>
      </fieldSet>
      ...
      <tr>
      	<td class="inquire_form2">
      		<table>
		      	<tr>
		            <td class="inquire_item4">专业化服务设备:<font color="red">*</font></td>
				...
				<tr>
				   <td class="inquire_item4" >其他单位设备:<font color="red">*</font></td>
		           <td class="inquire_item4" align="left"> 是 

    ...
    <div id="new_table_box_bg">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
         ...
         <!-- <td class="inquire_item4">资产现状描述:<font color="red">*</font></td>
		...
		<tr style="display:none;">
		 ...
		 <td class="inquire_item4">报废原因:<font color="red">*</font></td>
          <td class="inquire_form4" colspan="1">
	  ...
	  <fieldSet style="margin-left:2px"><legend>关联报废设备技术资料</legend>
	  	  ...
	  	  <div>
	  	  	<table width="97.9%" border="0" cellspacing="0" cellpadding="0">
	  	  		<tr>
	  	  			<td>&nbsp;</td>
	  	  			<td><font color="red">*注：附件中应包括证明材料 、处罚文件、 设备毁损技术鉴定表</font></td>
...
function refreshData(){
	...
	if('<%=scrape_apply_id%>'!='null'){
		baseData = jcdpCallService("ScrapeSrvNew", "getScrapeDamageInfoNew", "scrape_apply_id="+$("#scrape_apply_id").val()+"&scrape_detailed_id="+$("#scrape_detailed_id").val()+"&selectAllFlag="+$("#selectAllFlag").val()+"&wz_name="+decodeURI($("#wz_name").val())+"&wz_id="+$("#wz_id").val()+"&wz_scrape_type="+$("#wz_scrape_type").val()+"&wz_dutyUnit="+decodeURI($("#wz_dutyUnit").val()));
		//报废申请表
...
function saveInfo(){
	...
	$("#idinfos").val(idinfos);//文件name
		...
		Ext.Ajax.request({
			url : "<%=contextPath%>/dmsManager/scrape/devLinkEmpAndFileNew.srq?scrape_type=23",
			method : 'Post',
			isUpload : true,  
			form : "form1",

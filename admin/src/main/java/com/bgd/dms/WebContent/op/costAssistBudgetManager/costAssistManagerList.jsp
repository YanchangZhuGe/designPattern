			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			     <tr>
			      ...
			      <td class="bt_info_even" exp="{record_time}">年份</td>
...
<script type="text/javascript">
	...
	function refreshData(){
		cruConfig.queryStr = "SELECT t.* FROM bgp_op_target_assist_info t where t.bsflag='0' and t.assist_type='"+assistType+"' order by t.record_time desc";
		cruConfig.currentPageUrl = "/op/costAssistBudgetManager/costAssistManagerList.jsp";
		queryData(1);
	}
	function toView(){
		...
		popWindow('<%=contextPath%>/op/costAssistBudgetManager/costAssistManagerEdit.upmd?pagerAction=edit2View&id='+ids);
	}
	function toAdd(){
		popWindow('<%=contextPath%>/op/costAssistBudgetManager/costAssistManagerEdit.upmd?pagerAction=edit2Add&userName=<%=userName%>&orgName=<%=orgName%>&assistType='+assistType);
	}
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/op/costAssistBudgetManager/costAssistManagerEdit.upmd?pagerAction=edit2Edit&userName=<%=userName%>&orgName=<%=orgName%>&assistType='+assistType+'&id='+ids);
	}
	function toDelete(){
		...
		var sql = "update bgp_op_target_assist_info t set t.bsflag='1' where t.assist_info_id ='"+ids+"'";
	...
	function toViewMoney(){
		...
		popWindow('<%=contextPath%>/op/costAssistBudgetManager/costAssistMoneyManager.jsp?assistInfoId='+ids+'&assistType='+assistType);
	}

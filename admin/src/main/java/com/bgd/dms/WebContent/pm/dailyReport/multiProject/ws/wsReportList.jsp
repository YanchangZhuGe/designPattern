      	...
      	<div id="list_table">
			...
			<div id="table_box">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      <td class="bt_info_odd" exp="<input type='checkbox' name='rdo_entity_id' value='{project_info_no},{daily_no_ws},{produce_date},{project_name}' id='rdo_entity_id_{project_info_no}' onclick=doCheck(this)/>" >选择</td>
			      ...
			      <td class="bt_info_odd" exp="<a href='#'  onclick=openProcess('{project_info_no}','{produce_date}','{gp_start_time}','{gp_end_time}','{report_org_id}','{gp_project_type}','{gp_exploration_method}')>查看</a>" >生产进度</td>
			     -->
...
*/		
	...
	function dbclickRow(ids){
	    ...
	    //改成待审批日报列表形式 reportListAuditDispatch.jsp
	  	//popWindow('<%=contextPath%>/ws/pm/dailyReport/multiProject/reportListAudit/reportListAuditDispatch.jsp?daily_no='+ids1+'&project_info_no='+ids+'&produce_date='+ids2+'&projectName='+projectName,'1280:800');
	  	//popWindow('<%=contextPath%>/ws/pm/dailyReport/multiProject/viewDailyReport.jsp?daily_no='+ids1+'&project_info_no='+ids+'&produce_date='+ids2,'1280:800');
	}
	...
	function openChart(projectInfoNo){
		popWindow('<%=contextPath%>/ws/pm/chart/pmChartFrame.jsp?projectInfoNo='+projectInfoNo,'1280:800');
	}
	...
	function openGis(projectInfoNo,dailyNo,produceDate){
		...
		popWindow('<%=contextPath%>/pm/dailyReport/multiProject/ws/reportListAuditDispatch.jsp?daily_no='+dailyNo+'&project_info_no='+projectInfoNo+'&produce_date='+produceDate,'1280:740');
	}
	function openProcess(projectInfoNo,produceTime,startTime,endTime,orgId,projectType,explorationMethod){
		window.open('<%=contextPath%>/pm/dailyReport/queryDailyReportProcess.srq?projectInfoNo='+projectInfoNo+'&produceTime='+produceTime+'&startTime='+startTime+'&endTime='+endTime+'&orgId='+orgId+'&projectType='+projectType+'&explorationMethod='+explorationMethod);
	}
</script>

...
<%
	...
	String sqlAcc = "select sum(t.number_die) number_die, sum(t.number_harm) number_harm,sum(t.number_injure) number_injure from bgp_hse_accident_news t where t.bsflag = '0' and t.second_org='"+second_org+"'";
	...
	String not_event = "0";
	String sqlEvent = "select sum(nvl(t.number_owner,0)+nvl(t.number_out,0)+nvl(t.number_stock,0)+nvl(t.number_group,0)) event_num,t.event_property from bgp_hse_event t where t.bsflag='0' and t.second_org = '"+second_org+"' group by t.event_property";

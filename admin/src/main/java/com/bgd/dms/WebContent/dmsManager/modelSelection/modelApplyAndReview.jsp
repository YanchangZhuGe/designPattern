			...
			<td background="<%=contextPath%>/images/list_15.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		          ...
		          <td class="ali_cdn_name">&nbsp;产品名称:</td>
				   ...
				   <!-- <auth:ListButton functionId="" css="tj" event="onclick='toReview()'" title="提交评审"></auth:ListButton> -->
     ...
     <div id="table_box">
			  <table style="width:98.5%;table-layout: fixed;" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
					...
					<td class="bt_info_even" width="10%" style="white-space:nowrap;overflow:hidden;text-overflow: ellipsis;" exp="{opi_name}">产品名称</td>
					<td class="bt_info_even" style="white-space:nowrap;overflow:hidden;text-overflow: ellipsis;"  width="16%" exp="{production}">生产单位</td>
					<td class="bt_info_odd" style="white-space:nowrap;overflow:hidden;text-overflow: ellipsis;" width="16%" exp="{apply_unit}">申请单位</td>
					<td class="bt_info_even" style="white-space:nowrap;overflow:hidden;text-overflow: ellipsis;" width="16%" exp="{apply_state}" func= "getOpValue,applyState" >申请状态</td>
					<td class="bt_info_odd" style="white-space:nowrap;overflow:hidden;text-overflow: ellipsis;" width="16%" exp="{apply_date}">申请时间</td>
					<td class="bt_info_even" style="white-space:nowrap;overflow:hidden;text-overflow: ellipsis;" width="16%" exp="{review_state}">评审状态</td>
				</tr>
		</table>
		</div>
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "queryModelApplyList";
	function frameSize(){
		setTabBoxHeight();
	}
	frameSize();
	...
	/* 产品基本信息*/
	function loadDataDetail1(opi_id){  
    	var retObj;
    	var flag_public =0;
		if(opi_id != null){
	...
	// 新增一个产品
	function toAdd(){
		popWindow("<%=contextPath%>/dmsManager/modelSelection/equipmentSelectionApplyNew.jsp");
	}
	...
	function toEdit(){      
		...
		//	return;
		//}
		popWindowAuto('<%=contextPath%>/dmsManager/modelSelection/equipmentSelectionApplyNew.jsp?select_model_id='+ids,'840:650','');
	...
	function toDelete(){
		...
		//}
		if(confirm('确定要删除吗?')){  
			var retObj = jcdpCallService("EquipmentSelectionApply", "deleteUpdate", "updateids="+ids);

...
<script type="text/javascript">
	...
	cruConfig.queryStr = "";
       ...
       function simpleSearch(){
			...
			str+="  and t.wz_id in(select distinct t.wz_id from gms_device_zy_wxbymat t right join gms_device_zy_bywx wx on t.usemat_id=wx.usemat_id and  wx.bsflag='0'  and wx.project_info_id='<%=projectInfoId%>'";

  ...
  <div id="new_table_box_content"> 
    ...
    <table  width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
	    ...
	    <tr>	
	    	...
	    	<td class="inquire_form4"><input name="daily_small_oil" id="daily_small_oil" type="text" class="input_width" value="" onkeydown="return checkIfDouble()"/></td>
	    	<td class="inquire_item4">单井消耗油料（公斤）:</td>
	    	<td class="inquire_form4"><input name="single_well_oil" id="single_well_oil" type="text" class="input_width" value="" onkeydown="return checkIfDouble()"/></td>
	    </tr>
	    <tr>
	    	<td class="inquire_item4">油料单价(元/公斤):</td>
	    	<td class="inquire_form4"><input name="oil_unit_price" id="oil_unit_price" type="text" class="input_width" value="" onkeydown="return checkIfDouble()"/></td>
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		var querySql = "select * from bgp_op_tartet_device_oil where bsflag='0' and if_change != '2' and cost_device_id = '"+id+"'";
		var retObj = syncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'querySql='+querySql);
	...
	function newSubmit() {
		...
		if(cost_device_id!=null && cost_device_id!=''){
			var dev_acc_id = "";
			var querySql = "select t.dev_acc_id key_id from bgp_op_tartet_device_oil t where t.bsflag ='0' and t.cost_device_id ='"+cost_device_id+"'";
			...
			if(if_change!=null && if_change !='0'){
				...
				sql = insertDatas();
				sql += "update bgp_op_tartet_device_oil t set t.if_delete_change='1' where t.cost_device_id='"+cost_device_id+"';";
				
				sql += "update bgp_op_tartet_device_depre t set t.if_delete_change='1' where t.dev_acc_id='"+dev_acc_id+"';";
				
				sql += "update bgp_op_tartet_device_material t set t.if_delete_change='1' where t.dev_acc_id='"+dev_acc_id+"';";
	...
	function updateDatas(dev_acc_id){
		...
		" t.change_date = sysdate where t.cost_device_id='"+cost_device_id+"';";
	...
	function insertDatas(){
		...
		sql += "insert into bgp_op_tartet_device_material(target_material_id,project_info_no,dev_name,dev_model,dev_team,device_count,plan_start_date,"+

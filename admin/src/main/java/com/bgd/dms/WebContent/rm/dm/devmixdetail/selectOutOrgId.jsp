...
function getSubNodes(parentNode) {
	...
	Ext.Ajax.request({
		...
		params : {
			currentPage:"1",
			pageSize:"10000",
			querySql:"select distinct amm.out_org_id,org.org_name,'1' as is_leaf from gms_device_appmix_main amm left join gms_device_app_detail ad on amm.device_app_detid = ad.device_app_detid left join comm_org_information org on amm.out_org_id=org.org_id where amm.state = '9' and amm.is_add_detail = 'Y' and ad.device_app_id='<%=devappid%>' order by out_org_id"
		},
		method : 'Post',

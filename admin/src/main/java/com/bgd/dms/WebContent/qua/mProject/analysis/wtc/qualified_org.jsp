...
<div style="overflow-y: hidden; overflow-x: hidden;">
	...
	function getTotal(){  //and p.project_status='3'  正在施工
		var querySql = " select tt.eps_id ,tt.eps_name ,tt.org_id ,tt.org_subjection_id ,case when tt.waster is null then 0 else tt.waster end waster ,"+
			...
			" join gp_ops_daily_report r on r.org_subjection_id like concat(sub.org_subjection_id,'%') and r.bsflag='0'" +
			" join gp_task_project p on r.project_info_no = p.project_info_no and p.bsflag='0'" +
	...
	function projectFirst(org_subjection_id,org_name){
		...
		window.open('<%=contextPath%>/qua/mProject/analysis/wtc/qualified_project.jsp?org_subjection_id='+org_subjection_id+'&org_name='+encodeURI(org_name));
	}
	</script>
    </body>
</html>
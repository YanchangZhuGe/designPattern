			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr id='device_appdet_id_{device_app_detid}' name='device_app_detid'>
					...
					<td class="bt_info_odd" exp="{apply_num}">审批数量</td>
...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model){
		...
		str += "p6.name as jobname,pro.project_name,appdet.state,case appdet.state when '1' then '已验收' when '2' then '验收中'  else '未验收' end as statedesc, ";
		...
		str += "where appdet.project_info_no = '"+projectInfoNos+"' ";
...
<script type="text/javascript">	
	...
	function toBack(){
	 	window.location.href='hireReceiveList_dg.jsp';
	 }
	function dbclickRow(shuaId){
		...
		popWindow('<%=contextPath%>/rm/dm/hireReceive/hiredetail_fill.jsp?deviceappdetid='+shuaId+"&projectInfoNo=<%=projectInfoNo%>","900:680");
	}
</script>
</html>
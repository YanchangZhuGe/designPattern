...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function popNextLevelUseRate(level,devTreeId,orgSubId,country,startDate,endDate,ifproduction){
			popWindow('<%=contextPath%>/dmsManager/device/thirdLevelInsUseRate.jsp?level='+level+'&devTreeId='+devTreeId+'&orgSubId='+orgSubId+'&country='+country+'&startDate='+startDate+'&endDate='+endDate+'&ifproduction='+ifproduction,'800:572');
		}
		//弹出设备信息

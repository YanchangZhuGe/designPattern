...
<script type="text/javascript">
    ...
    function loadDataDetail(ids){
  	  ...
  	  processNecessaryInfo={         
	    		...
	    		businessType:"5110000004100000054",        //业务类型 即为之前设置的业务大类
	    		businessId: ids.split("-")[0],         //业务主表主键值
	    		businessInfo:"技术支持申请文档审核",        //用于待审批界面展示业务信息
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/ConsdesignDoc/add_tdDocModifyNew.jsp?docType=0110000061100000005&fileAbbr='+fileAbbr+'&parent_file_id=<%=parent_file_id%>');
	...
	function toDownload(){
		...
		elemIF.src = "<%=contextPath%>/rm/em/humanRequest/download.jsp?path=/td/TechnicalSupport.doc&filename=TechnicalSupport.doc";

...
Ext.onReady(function() {
    ...
    function cellclick(grid,colspan, colIndex, rowdata, rowspan,rowIndex,e) {
        ...
        if(leaf == true){
        	parent.mainRightframe.location.href = "<%= contextPath%>"+url+"?project=<%=project%>";
  		}
    }
...
<script type="text/javascript">
	...
	function onLoadMenth() {
    	parent.mainRightframe.location.href = "<%= contextPath%>/hse/humanResource/hseProfessional/professional_list.jsp?project=<%=project %>";
		}
</script>

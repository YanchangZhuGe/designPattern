					...
					<tr>
						<td width="99%">
							<div class="tongyong_box">
								...
								href="#"></a></span><a onclick="exportDataDoc('dzdzysbpbxx')" href="#">地震队机动设备配备统计钻取信息</a>
								<span class="gd"><a href="#"></a></span>
								<span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('dzdzysbpbxx')" title="导出excel"></a>
								</span>
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj = jcdpCallService("EarthquakeTeamStatistics","getTeamDevInfoDrillDownForTableForPop","projectInfoNo=<%=projectInfoNo%>&code=<%=code%>");

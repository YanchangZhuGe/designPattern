...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model,v_dev_sign,v_self_num,v_license_num,v_dev_type){
		...
		str += "  left join comm_org_information f on f.org_id=account.owning_org_id where account.bsflag='0' and saveflag='0'  and account.OWNING_SUB_ID like '<%=suborgid%>%'";
		...
		if(flag=='0')
			{
			str += " and (account.tech_stat like '%0110000006000000006%' or account.tech_stat like '%0110000006000000007%' )  and account.account_stat != '0110000013000000002' ";
			}

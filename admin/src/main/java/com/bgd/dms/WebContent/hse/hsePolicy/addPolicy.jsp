...
<input type="hidden" id="hse_advertise_id" name="hse_advertise_id" value=""/>
    	...
    	<div id="new_table_box_bg">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" style="margin-top: 10px;">
			  ...
			  <tr>
			    ...
			    <td class="inquire_form6"><input type="text" id="times" name="times" onkeydown='javascript:return checkIfNum(event);' class="input_width" /></td>

...
<title>单项目-设备返还-井中设备送修-新增按钮子页面</title>
</head>
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
          ...
          <td class="inquire_item4" colspan="3">
          	<input name="backappname" id="backappname" class="input_width" style="width:92%" type="text" value="" />
          </td>
        </tr>
        <tr>
...
<script type="text/javascript">
	$().ready(function(){
		$("#addProcess").click(function(){
			...
			var vReturnValue = window.showModalDialog("<%=contextPath%>/rm/dm/tree/selectWellsAccountForBack.jsp?projectinfono="+projectInfoNo+"&backdevtype="+backdevtype,paramobj,"dialogWidth=1200px;dialogHeight=480px");
	...
	function submitInfo(){
		...
		var backappname = document.getElementById("backappname").value;
		var device_backapp_no = "井中维修返还申请"+backdate.replace(/\-/g,'')+'0'+Math.round(Math.random()*1000);
		...
		if(devicebackappid==null || devicebackappid==''){
			...
			" bsflag,create_date,creator_id,modifi_date,updator_id,org_id,org_subjection_id,state,search_backapp_id,backapp_name,backdevtype,backapptype,receive_org_id) "+
	...
	function refreshData(){
		...
		if(proqueryRet!=null && proqueryRet.returnCode =='0'){
			...
			//默认值
			document.getElementById("receive_org_name").value ='设备支持中心';
			document.getElementById("receive_org_id").value ='C6000000007250';//sub_id:C105005001035
		}

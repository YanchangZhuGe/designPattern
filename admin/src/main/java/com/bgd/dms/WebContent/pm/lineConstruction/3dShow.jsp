...
function initData(){
	...
	if(retObj.datas != null){
		...
		for(var i=0;i<retObj.datas.length;i++){
			...
			tr.insertCell().innerHTML = record.layout+'<input type="hidden" name="layout_'+rowNum+'" value="'+record.layout+'">';
			tr.insertCell().innerHTML = record.fold+'<input type="hidden" name="fold_'+rowNum+'" value="'+record.fold+'">';
			tr.insertCell().innerHTML = record.binning_size+'<input type="hidden" name="binning_size_'+rowNum+'" value="'+record.binning_size+'" >';
			tr.insertCell().innerHTML = record.track_interval+'<input type="hidden" name="track_interval_'+rowNum+'" value="'+record.track_interval+'">';
			tr.insertCell().innerHTML = record.receiving_line_distance+'<input type="hidden" name="receiving_line_distance_'+rowNum+'" value="'+record.receiving_line_distance+'">';
			tr.insertCell().innerHTML = record.shot_interval+'<input type="hidden" name="shot_interval_'+rowNum+'" value="'+record.shot_interval+'">';
			tr.insertCell().innerHTML = record.sp_line_interval+'<input type="hidden" name="sp_line_interval_'+rowNum+'" value="'+record.sp_line_interval+'">';
			tr.insertCell().innerHTML = record.vertical_array_mode+'<input type="hidden" name="vertical_array_mode_'+rowNum+'" value="'+record.vertical_array_mode+'">';
			...
			tr.insertCell().innerHTML = record.rolling_mode+'<input type="hidden" name="rolling_mode_'+rowNum+'" value="'+record.rolling_mode+'">';
			...
			tr.insertCell().innerHTML = record.geophone_comp_graph+'<input type="hidden" name="geophone_comp_graph_'+rowNum+'" value="'+record.geophone_comp_graph+'">';
			...
			tr.insertCell().innerHTML = record.drive_range+'<input type="hidden" name="drive_range_'+rowNum+'" value="'+record.drive_range+'">';
			...
			exportRow["24"] = record.instrument_model;
			exportRow["25"] = record.preamplifier_gain;
			exportRow["26"] = record.sample_ratio;
			exportRow["27"] = record.record_len;
...
function activeInput(){
	...
	window.location.href="<%=contextPath%>/pm/lineConstruction/3dEdit.jsp";
    bActive = true;
}

...
<script type="text/javascript">
	...
	function refreshData(v_device_app_name,v_mixinfo_no,v_opr_state_desc){
		...
		var str = "select devapp.device_app_name,he.employee_name,dm.*,inorg.org_abbreviation as in_org_name,outorg.org_abbreviation as out_org_name,";
			...
			str += "where '1'='1' and dm.state='9' and dm.bsflag='0' and dm.mixform_type='1' and dm.mix_type_id='S10002' ";
    ...
    function toDetailPage(){
		...
		window.location.href='<%=contextPath%>/rm/dm/wellsDevCenterPlan/wellsSubDevRevList.jsp?mixId='+shuaId;
    }

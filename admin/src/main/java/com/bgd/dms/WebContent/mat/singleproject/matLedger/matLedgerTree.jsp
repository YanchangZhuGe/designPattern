...
Ext.onReady(function() {
    ...
    function cellclick(grid,colspan, colIndex, rowdata, rowspan,rowIndex,e) {
        ...
        if(selectId!=null&&selectId=="3"){
        	parent.menuFrame.location = "<%=contextPath%>/mat/singleproject/matLedger/purItemList.jsp?codeId="+selectParentIdData+"&codeName="+selectText;
        }else{
        	parent.menuFrame.location = "<%=contextPath%>/mat/singleproject/matLedger/matItemList.jsp?codeId="+selectParentIdData+"&codeName="+selectText;
        }
    }
});
...
<table border="0" cellpadding="0" cellspacing="0"  id="FilterLayer" width="100%">
	<tr>
		<td align="left">
			<div id="menuTree" style="width:100%;height:100%;overflow:auto;z-index: 0"></div>
		</td>
	</tr>
</table>

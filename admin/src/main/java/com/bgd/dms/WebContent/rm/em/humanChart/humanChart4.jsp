			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box_content_left"  id="chartContainer1" style="height: 200px;" >
...
<script type="text/javascript">
 ...
 function getFusionChart(){
		...
		var myChart3 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/MSStackedColumn2D.swf", "myChartId3", "100%", "100%", "0", "0" );    

      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <td class="ali_cdn_name">转出单位名称</td>
	...
	function getContentTab(obj,index) { 
		...
		if(index == 1){
			...
			if(currentid != undefined && idinfo == currentid){
				...
				str += "account.dev_unit,unitsd.coding_name as unit_name,account.total_num,account.unuse_num,account.use_num,account.actual_in_time ";
...
<script type="text/javascript">
	...
	function searchDevData(){
		...
		refreshData(v_backmixinfo_no, v_usage_org_name,v_backmixinfo_name);
	}
	
	function refreshData(v_backmixinfo_no,v_usage_org_name,v_backmixinfo_name){
		var str = "select colback.device_backapp_id,colback.device_backapp_no,colback.backapp_name,pro.project_name,"
			...
			+"left join comm_human_employee emp on colback.back_employee_id = emp.employee_id ";
			//加机构权限
			str += "left join comm_org_subjection orgsub on colback.receive_org_id=orgsub.org_id and orgsub.bsflag='0' ";
			str += "where colback.bsflag = '0' and colback.state='9' and colback.backapptype='2' ";
		//加机构权限
		...
		if(v_backmixinfo_name!=undefined && v_backmixinfo_name!=''){
			str += "and bif.org_name like '%"+v_backmixinfo_name+"%' ";
		}
		str += "order by colback.opr_state desc,colback.backdate desc ";
	...
	function toDetailPage(){
		...
		window.location.href='<%=contextPath%>/rm/dm/collectStoreBad/subStockin.jsp?id='+shuaId;
    }

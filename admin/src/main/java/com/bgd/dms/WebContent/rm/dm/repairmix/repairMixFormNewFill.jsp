...
<script type="text/javascript">
	...
	$().ready(function(){
		...
		$("#addProcess").click(function(){
			...
			var vReturnValue = window.showModalDialog("<%=contextPath%>/rm/dm/tree/selectAccountForRepairMixForm.jsp?own_org_id="+own_org_id,paramobj,"dialogWidth=950px;dialogHeight=480px");
			var returnvalues;
			if(vReturnValue!=undefined){
				...
				innerhtml += "<td>"+showseqinfo+"<input type='hidden' id='backdetid'"+maxseqinfo+" seqinfo='"+maxseqinfo+"' name='backdetid' value='"+returnvalues[0]+"'></td>";

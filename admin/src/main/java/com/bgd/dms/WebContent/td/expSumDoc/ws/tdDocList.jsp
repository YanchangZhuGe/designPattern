			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <td class="bt_info_even" exp="{test_project}">试验项目</td>
			      <td class="bt_info_odd" exp="{test_start_date}">试验开始时间</td>
			      <td class="bt_info_even" exp="{test_end_date}">试验结束时间</td>
...
<script type="text/javascript">
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/expSumDoc/ws/add_tdDocModify.jsp?docType=0110000061100000006&businessType='+businessType+'&fileAbbr='+fileAbbr,'750:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/expSumDoc/ws/add_tdDocModify.jsp?id='+ids.split("-")[0],'750:680');
	}

...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		var nonumber = document.getElementById("nonumber").value;   
		...
		var validating_date = document.getElementById("validating_date").value;  
		var validating_date2 = document.getElementById("validating_date2").value;   
		...
		if(nonumber!=''&&nonumber!=null){
			sql = sql+" and tr.nonumber like '%"+nonumber+"%'";
		}
		...
		if(validating_date!=''&&validating_date!=null){
			sql = sql+" and tr.validating_date >= to_date('"+validating_date+"','yyyy-MM-dd')";
		}
		if(validating_date2!=''&&validating_date2!=null){
			sql = sql+" and tr.validating_date <= to_date('"+validating_date2+"','yyyy-MM-dd')";
		}
  ...
  <div id="new_table_box_content">
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
        <td class="inquire_item6">不符合条款号：</td>
	    <td class="inquire_form6">
	    <input type="text" id="nonumber" name="nonumber" class="input_width"    />    	
	    </td>	 
		  ...
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton2" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(completion_date2,tributton2);" />&nbsp;</td>
        </tr>
        <tr> 
		  ...
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton3" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(validating_date,tributton3);" />&nbsp;</td>
		  <td class="inquire_item6">至</td>
		  <td class="inquire_form6"><input type="text" id="validating_date2" name="validating_date2" class="input_width" readonly="readonly"/>
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton4" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(validating_date2,tributton4);" />&nbsp;</td>
        </tr>
      </table>

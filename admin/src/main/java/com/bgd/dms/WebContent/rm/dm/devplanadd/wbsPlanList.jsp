...
<script type="text/javascript">
	...
	//打开新增界面
	function toAddPage(){
		popWindow('<%=contextPath%>/rm/dm/devPlan/devdetail_new_apply.jsp?projectInfoNo=<%=projectInfoNo%>&taskId=<%=taskId%>&deviceallappid=<%=idinfo%>','815:680');
	}
   ...
   function loadDataDetail(device_allapp_detid){
		...
		str += "pro.project_name,alldet.dev_name as dev_ci_name,alldet.dev_type as dev_ci_model, ";

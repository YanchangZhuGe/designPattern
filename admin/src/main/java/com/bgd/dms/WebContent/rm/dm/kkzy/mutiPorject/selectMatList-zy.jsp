		...
		<div id="new_table_box_bg_new" style="width: 95%">
			...
			<div id="new_table_box_bg_new_next" style="width: 95%">
				<fieldset style="margin-left: 2px">
					...
					<td align="center"  class="bt_info_odd" style="width:3%">序号</td>
...
function queryData()
{
	...
	var wz_name=$("#s_wz_name").val();
	 baseData = jcdpCallService("DevInsSrv", "getwxbyMatInfos", "wz_name="+wz_name);
		 ...
		 baseData = jcdpCallService("DevInsSrv", "getwxbyMatInfos", "wz_name="+wz_name);
				if(baseData.datas!=null)
				{
					...
					for (var tr_id = 0; tr_id< baseData.datas.length; tr_id++) {
						...
						innerhtml2 += "<td><input matId='"+matId+"' name='postion2"+tr_id+"' id='postion2"+tr_id+"' value='"+baseData.datas[tr_id].postion+"' size='16' onblur='wzOrder("+tr_id+","+matId+")'/></td>";
		 ...
		 if (!re.test(orderNo))   
		  	{   
		       ...
		       document.getElementById("postion2"+tr_id).focus();   
		  		...
		  		jcdpCallService("DevInsSrv", "zyWzOrder", "wz_id="+wz_id+"&postion="+orderNo);
		  		queryData();
		  	 }
	 }

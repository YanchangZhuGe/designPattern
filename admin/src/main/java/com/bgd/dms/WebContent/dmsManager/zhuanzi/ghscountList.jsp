			...
			<tr align="center" >
		    	<td align="center" >
			  		<report:html name="report1"
	        			reportFileName="/device/ghslist.raq"
						params="<%=queryStr%>"
		   				needScroll="yes"
		   				scrollWidth="100%"
		   				scrollHeight="100%"/>
...
<script type="text/javascript">
	...
	function simpleSearch(){
	    ...
	    window.location="<%=contextPath%>/dmsManager/zhuanzi/ghscountList.jsp?year="+q_year;
	}
	//选择年份
	...
	function popgetinfo(year,lifnr_name){
		window.location='<%=contextPath %>/dmsManager/zhuanzi/deviceList.jsp?year='+year+'&lifnr_name='+encodeURI(encodeURI(lifnr_name));
	}
</script>
</html>
			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="{no_modify_dan}">未整改隐患</td>
			      <td class="bt_info_odd" exp="{first_big_dan}">特大</td>
			      <td class="bt_info_even" exp="{second_big_dan}">重大</td>
			      <td class="bt_info_odd" exp="{third_big_dan}">较大</td>
			      <td class="bt_info_even" exp="{usual_dan}">一般</td>
			      <td class="bt_info_odd" exp="{total_dan}">合计</td>
			    </tr>
			  </table>
			</div>

        ...
        Ext.apply(this, {
            ...
            tooltipTpl : new Ext.XTemplate(
                ...
                '<table class="taskTip">', 
                    ...
                    '<tr><td>目标开始:</td> <td align="right">{[Ext.Date.format(values.BaselineStartDate, "Y-m-d")]}</td></tr>',
                    '<tr><td>目标结束:</td> <td align="right">{[Ext.Date.format(Ext.Date.add(values.BaselineEndDate, Ext.Date.MILLI, -1), "Y-m-d")]}</td></tr>',
                '</table>'
            ).compile(),

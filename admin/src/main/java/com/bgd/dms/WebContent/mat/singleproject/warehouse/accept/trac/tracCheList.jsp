			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_odd" exp="{invoices_no}">料单编号</td>
			      <td class="bt_info_even" exp="{source}">分中心</td>
			      <td class="bt_info_odd" exp="{input_date}">日期</td>
			      <td class="bt_info_even" exp="{operator}">经办</td>
			    </tr>
			  </table>
			</div>
...
<script type="text/javascript"><!--
	...
	function refreshData(){
		var sql ="select t.* from gms_mat_teammat_invoices t where t.project_info_no='<%=projectInfoNo%>' and (t.invoices_type='0' or t.invoices_type='4')and t.if_input='1'";
		cruConfig.cdtType = 'form';
		cruConfig.queryStr = sql;
		cruConfig.currentPageUrl = "/mat/singleproject/warehouse/accept/trac/tracCheList.jsp";
		queryData(1);
	}
	function save(){	
		//if (!checkForm()) return;
		...
		document.getElementById("form1").action="<%=contextPath%>/mat/singleproject/warehouse/accept/trac/queruTracList.srq?laborId="+ids;

  ...
  <div id="new_table_box_content"> 
    ...
    <table  width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
    	...
    	<tr>	
	    	...
	    	<td class="inquire_form4"><input name="report_date" id="report_date" type="text" class="input_width" value="<%=nowDate %>" readonly="readonly" />
	    		<!--<img width="16" height="16" id="cal_button7" style="cursor: hand;" 
	    		onmouseover="calDateSelector(report_date,cal_button7);" 
	    ...
	    <tr>
	    	...
	    	<td class="inquire_form4"><input name="small_num" id="small_num" type="text" class="input_width" value="" 
	    		onkeydown="javascript:return checkIfNum(event);"/></td>
	    	<td class="inquire_item4">累计直接经济损失（万元）:</td>
	    	<td class="inquire_form4"><input name="small_loss" id="small_loss" type="text" class="input_width" value="" 
	    ...
	    <tr>
	    	...
	    	<td class="inquire_form4"><input name="large_num" id="large_num" type="text" class="input_width" value="" 
	    		onkeydown="javascript:return checkIfNum(event);"/></td>
	    	<td class="inquire_item4">累计直接经济损失（万元）:</td>
	    	<td class="inquire_form4"><input name="large_loss" id="large_loss" type="text" class="input_width" value="" 
				onblur="checkFormat();" onkeydown="javascript:return checkIfDouble(event);"/></td>
	    </tr>
	    <tr>
	    	<td class="inquire_item4"><font color="red">*</font>重大质量事故次数:</td>
	    	<td class="inquire_form4"><input name="great_num" id="great_num" type="text" class="input_width" value="" 
	    		onkeydown="javascript:return checkIfNum(event);"/></td>
	    	<td class="inquire_item4">累计直接经济损失（万元）:</td>
	    	<td class="inquire_form4"><input name="great_loss" id="great_loss" type="text" class="input_width" value="" 
	    		onblur="checkFormat();" onkeydown="javascript:return checkIfDouble(event);"/></td>
	    </tr>
	    <tr>
	    	<td class="inquire_item4"><font color="red">*</font>特大质量事故次数:</td>
	    	<td class="inquire_form4"><input name="super_num" id="super_num" type="text" class="input_width" value="" 
	    		onkeydown="javascript:return checkIfNum(event);"/></td>
	    	<td class="inquire_item4">累计直接经济损失（万元）:</td>
	    	<td class="inquire_form4"><input name="super_loss" id="super_loss" type="text" class="input_width" value="" 
	    		onblur="checkFormat();" onkeydown="javascript:return checkIfDouble(event);"/></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	    	...
	    	<td class="inquire_form4"><input name="spare1" id="spare1" type="text" class="input_width" value="" /></td>
	    </tr>
    </table> 
  </div> 
  <div id="oper_div">
...
<script type="text/javascript">
	...
	function newSubmit() {
		...
		var retObj = jcdpCallService("QualityItemsSrv","checkAccidentExist", "report_date=" +report_date + "&project_info_no="+project_info_no+"&org_id="+org_id+"&accident_id="+accident_id);

...
<script type="text/javascript">
 function getFusionChart(){
	...
	myChart1.setXMLUrl("<%=contextPath%>/rm/em/chart/queryBanPost.srq?projectInfoNo=<%=projectInfoNo%>&team=<%=team%>");      
 ...
 function changeTeam(){ 
     ...
     chartReference.setXMLUrl("<%=contextPath%>/rm/em/chart/queryBanPost.srq?projectInfoNo=<%=projectInfoNo%>&team="+s_team);
 }

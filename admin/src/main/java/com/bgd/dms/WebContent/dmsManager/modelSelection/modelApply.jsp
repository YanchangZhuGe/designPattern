...
<script type="text/javascript">
	...
	// 新增一个产品
	function toAdd(){
		popWindow("<%=contextPath%>/dmsManager/modelSelection/equipmentSelectionApply.jsp");
	}
	...
	function toEdit(){      
		...
		popWindowAuto('<%=contextPath%>/dmsManager/modelSelection/equipmentSelectionApply.jsp?select_model_id='+ids,'840:650','');

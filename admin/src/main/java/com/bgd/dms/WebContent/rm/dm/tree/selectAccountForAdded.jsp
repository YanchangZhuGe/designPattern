...
<script type="text/javascript">
	...
	function refreshData(v_dev_ci_name,v_dev_ci_model,v_dev_sign,v_self_num,v_license_num,v_dev_type){
		...
		str += "from gms_device_account account where account.bsflag='0' and account.saveflag='0' ";
		...
		if(obj.pageselectedstr == null){
			str += "and account.owning_sub_id like '"+usersubid+"%' and using_stat='0110000007000000002' and account.tech_stat = '0110000006000000001' ";
		}else{
			str += "and account.owning_sub_id like '"+usersubid+"%' and using_stat='0110000007000000002' and account.tech_stat = '0110000006000000001' and account.dev_acc_id not in ("+obj.pageselectedstr+")";
		}

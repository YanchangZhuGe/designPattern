			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box">
						<div class="tongyong_box_title"><span class="kb"><a
							href="#"></a></span><a href="#">存量资源统计</a>
							<code:codeSelect name='s_team' option="teamOps" addAll="true" cssClass="select_height"   selectedValue='' onchange="changeTeam()"/>
							<span class="gd"><a
							href="#"></a></span></div>
...
<script type="text/javascript">
 ...
 function getFusionChart(){
	...
	var myChart1 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/StackedColumn3DLineDY.swf", "myChartId1", "100%", "250", "0", "0" );    
	myChart1.setXMLUrl("<%=contextPath%>/rm/em/getChart9.srq?orgId=<%=orgId%>");      
	...
	myChart3.setXMLUrl("<%=contextPath%>/rm/em/getChart15.srq?orgId=<%=orgId%>");      
 ...
 function changeTeam(){
     ...
     chartReference.setXMLUrl("<%=contextPath%>/rm/em/getChart15.srq?orgId=<%=orgId%>&setTeam="+s_team);
 }

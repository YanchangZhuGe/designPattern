 ...
 <body style="background:#fff" onload="refreshData('');">
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      ...
		      <%} %>
			  	<td class="ali_cdn_name">施工总结报告</td>
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <%} %>
			      <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">施工总结报告</td>
...
<script type="text/javascript">
	...
	var businessType="5110000004100000090";
	...
	function refreshData(str){
		...
		cruConfig.queryStr = " select t.* from (select t.project_info_no,t.tecnical_id,t.title,t.written_unit,t.written_time,t.writer,t.auditor,t.leader,p.project_name,f.ucm_id,f.file_name "+
		"from gp_ws_tecnical_basic t  left join bgp_doc_gms_file f on t.tecnical_id = f.relation_id and f.bsflag = '0' "+
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/ConsSumDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'750:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/ConsSumDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&id='+id+'&isSingle='+isSingle,'750:680');
	}

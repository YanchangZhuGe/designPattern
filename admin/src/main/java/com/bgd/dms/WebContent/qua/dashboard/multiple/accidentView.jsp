  ...
  <div id="new_table_box_content"> 
    ...
    <table  width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
    	<tr>
	    	...
	    	<td class="inquire_form4"><input name="org_id" id="org_id" type="hidden" class="input_width" value="" />
	    		<input name="org_name" id="org_name" type="text" class="input_width" value="" readonly="readonly"/></td>
    	...
    	<tr>
	    	...
	    	<td class="inquire_form4"><input name="leader_id" id="leader_id" type="hidden" class="input_width" value="" />
	    	<input name="leader_name" id="leader_name" type="text" class="input_width" value="" readonly="readonly"/></td>
	    	<td class="inquire_item4"><font color="red">*</font>分管领导姓名:</td>
	    	<td class="inquire_form4"><input name="super_id" id="super_id" type="hidden" class="input_width" value="" />
	    		<input name="super_name" id="super_name" type="text" class="input_width" value="" readonly="readonly"/></td>
	    </tr>
	    <tr>
	    	...
	    	<td class="inquire_form4"><input name="depart_id" id="depart_id" type="hidden" class="input_width" value="" />
	    		<input name="depart_name" id="depart_name" type="text" class="input_width" value="" readonly="readonly"/></td>
	    </tr>
	    <tr>	
	    	<td class="inquire_item4"><font color="red">*</font>负责人姓名:</td>
	    	<td class="inquire_form4"><input name="charge_id" id="charge_id" type="hidden" class="input_width" value="" readonly="readonly"/>
	    		<input name="charge_name" id="charge_name" type="text" class="input_width" value="" readonly="readonly"/></td>

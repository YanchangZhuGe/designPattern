...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.TreeStore', {
        ...
        proxy: {
       	 type : 'ajax',
            method: 'get',
            url: '<%=contextPath%>/rm/dm/collectTree/getColljbqDeviceTreeAjax.srq',
            reader: {
                type : 'json'
            }
        },
    ...
    //debugger;
    grid.addListener('itemdblclick', itemdblclick);
    function itemdblclick(grid, rowdata, item, index, e, options) {
        ...
        if(is_leaf == '1'){
        	returnobj.name = name;
        	returnobj.code = code;
        	returnobj.is_leaf = is_leaf;
        	returnobj.node_level = node_level;
        	returnobj.id = id;
	    	window.close();
    	}
    }

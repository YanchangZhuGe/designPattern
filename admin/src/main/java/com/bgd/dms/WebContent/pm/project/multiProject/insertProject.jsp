						...
						<div id="tab_box_content0" class="tab_box_content">
							...
							<!-- 
							 ...
							 -->
								...
								<tr>
											<td class="inquire_item4"><span class="red_star">*</span>甲方项目名称：</td>
									<td class="inquire_form4" id="item0_20">
											<input type="hidden" id="pro_id" name="pro_id" value="" class="input_width" />
										<input type="text" id="pro_name" name="pro_name" value="" class="input_width" readonly="readonly"/>
...
function selectPrctr(){
	...
	function checkForm(){ 	
		...
		if (!isTextPropertyNotNull("pro_name", "甲方项目名称")) {		

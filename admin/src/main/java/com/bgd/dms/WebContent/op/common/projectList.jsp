			...
			<div id="tab_box" class="tab_box">
				...
				<div id="tab_box_content0" class="tab_box_content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                <tr align="right" height="30">
		                  <td>&nbsp;</td>
		                  <td width="30" id="buttonDis1" ><span class="tj"  onclick="toUpdateProject()"><a href="#"></a></span></td>
		                  <td width="5"></td>
		                </tr>
		              </table>
				...
				<div id="tab_box_content3" class="tab_box_content" style="display:none;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                <tr align="right" height="30">
		                  <td>&nbsp;</td>
		                  <td width="30" id="buttonDis1" ><span class="tj"  onclick="toUpdateWorkarea()"><a href="#"></a></span></td>
		                  <td width="5"></td>
		                </tr>
		              </table>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
				...
				<div id="tab_box_content2" class="tab_box_content" style="display:none;">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                <tr align="right" height="30">
		                  <td>&nbsp;</td>
		                  <td width="30" id="buttonDis1" ><span class="tj"  onclick="toUpdateQuality()"><a href="#"></a></span></td>
		                  <td width="5"></td>
...
//debugger;
		...
		//document.getElementById("surface_type").value = retWorkArea.workarea.surface_type;
		//document.getElementById("second_surface_type").value = retWorkArea.workarea.second_surface_type;
		//document.getElementById("struct_unit_first_name").value = retWorkArea.workarea.struct_unit_first_name;
		//document.getElementById("struct_unit_second_name").value = retWorkArea.workarea.struct_unit_second_name;
		...
		//document.getElementById("surface_condition").value = retWorkArea.workarea.surface_condition;
		document.getElementById("block").value = retWorkArea.workarea.block;
		//document.getElementById("crop_area_type").value = retWorkArea.workarea.crop_area_type;
	...
	function dbclickRow(ids){
		...
		debugger;
		top.frames("topFrame").setProject(longName, name);//.document.getElementById('projectName').innerHTML='<a href="#"  onclick="selectProject();" title="'+longName+'">'+name+'</a>';
 		top.frames("list").location="<%=contextPath+forwardJsp%>";
	}

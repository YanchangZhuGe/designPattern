      	...
      	<div id="list_table">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <auth:ListButton functionId="jbq_add" css="zj" event="onclick='toAdd()'" title="JCDP_btn_add"></auth:ListButton>
			    <auth:ListButton functionId="jbq_upd" css="xg" event="onclick='toEdit()'" title="JCDP_btn_edit"></auth:ListButton>
			    <auth:ListButton functionId="jbq_del" css="sc" event="onclick='toDelete()'" title="JCDP_btn_delete"></auth:ListButton>
...
<script >
	...
	//		"where acc.bsflag='0' and ci.is_leaf = '1' and ci.dev_code not like '04%' and acc.usage_sub_id like '<%=subOrgId%>%' "+
		...
		if(orgLength==4){
			...
			sql +=	")tmp where 1=1 and (tmp.dev_code like '04%' or tmp.dev_code like '06%' ) ";
		}

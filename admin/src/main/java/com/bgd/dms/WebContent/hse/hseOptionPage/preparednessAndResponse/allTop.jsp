...
<fieldSet style="margin-left:2px"><legend>选择录入信息</legend>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height"  >
	 <tr > 
	  <td   align="center"> <font color=black size="2px">保管人</font> 
	  <input type="checkbox" name="checkbox" value="1" id="checkbox1" onclick="add()"/>
	  </td>
	  <td   align="center"> <font color=black size="2px">物资类别</font> 
	  <input type="checkbox" name="checkbox" value="2" id="checkbox2" onclick="add()"/>
	  </td>
	   <td   align="center"><font color=black size="2px">型号/规格</font> 
	  <input type="checkbox" name="checkbox" value="3" id="checkbox3" onclick="add()"/>  		
	  </td>
	  <td   align="center"><font color=black size="2px">购置时间</font> 
	  <input type="checkbox" name="checkbox" value="4" id="checkbox4" onclick="add()"/>  		
	  </td>

	</tr>	
	 <tr > 
	  <td   align="center"> <font color=black size="2px">有效期截止至</font> 
	  <input type="checkbox" name="checkbox" value="5" id="checkbox5" onclick="add()"/>
	  </td>
	   <td   align="center"><font color=black size="2px">校验期截止至</font> 
	  <input type="checkbox" name="checkbox" value="6" id="checkbox6" onclick="add()"/>  		
	  </td>
	  <td   align="center"><font color=black size="2px">存放位置</font> 
...
<td  class="inquire_item4"><font color=red></font>&nbsp;计量单位：</td>
<td class="inquire_form4">	 

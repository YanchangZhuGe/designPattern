...
<%
	...
	String projet_info_id = request.getParameter("projet_info_id");
%>
<html>
<head>
...
<script language="javascript" type="text/javascript">
	var projet_info_id='<%=projet_info_id%>';
...
function getSubNodes(parentNode) {
	...
	Ext.Ajax.request({
		...
		params : {
			currentPage:"1",
			pageSize:"10000",
						querySql:"select 1 as is_leaf, t.employee_id as out_org_id, e.employee_name as org_name from bgp_human_prepare_human_detail t left join bgp_human_prepare p on t.prepare_no = p.prepare_no and p.bsflag = '0' left join comm_coding_sort_detail d1 on t.team = d1.coding_code_id  and d1.bsflag = '0'  left join comm_coding_sort_detail d2 on t.work_post = d2.coding_code_id and d2.bsflag = '0'  left join comm_human_employee e on t.employee_id = e.employee_id  and e.bsflag = '0' where t.bsflag = '0' and t.actual_start_date is not null and p.project_info_no='"+projet_info_id+"' order by e.employee_name "
		},
		method : 'Post',

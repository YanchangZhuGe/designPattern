...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		//调整页面高度
		function frameSize() {
			var height=$(window).height()-$("#tongyong_box_title").height()-$("#lineTable").height()-130;
		...
		function getFieldCaptialFusionChart(){
			...
			chart1.setXMLUrl("<%=contextPath%>/dms/plan/devDistribute/getDeviceCapitalConfig.srq");
		...
		function getList(){	
			var retObj = jcdpCallServiceY("DeviceDistributeSrv","getDeviceCapitalConfig","");
			var j=0;
			var t = document.getElementById('lineTable');
			alert(retObj);
			if(retObj.list != null){	

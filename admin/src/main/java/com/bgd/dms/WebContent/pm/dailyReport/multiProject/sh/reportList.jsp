...
<script type="text/javascript">
	...
	function refreshData(q_projectName, q_orgName, q_projectStatus, q_auditStatus, q_projectType, q_orgSubjectionId){
		...
		document.getElementById("projectType").value = q_projectType;
...
*/		
	...
	function dbclickRow(ids){
	    ...
	    //改成待审批日报列表形式 reportListAuditDispatch.jsp
	  	popWindow('<%=contextPath%>/pm/dailyReport/multiProject/sh/reportListAuditDispatch.jsp?daily_no='+ids1+'&project_info_no='+ids+'&produce_date='+ids2+'&projectName='+projectName,'1280:800');
	  	//popWindow('<%=contextPath%>/pm/dailyReport/multiProject/sh/viewDailyReport.jsp?daily_no='+ids1+'&project_info_no='+ids+'&produce_date='+ids2,'1280:800');
	}

						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td class="inquire_form6"><input id="dev_name"
									name="dev_name" class="input_width" type="text" readonly /></td>
								<td class="inquire_item6">规格型号</td>
								<td class="inquire_form6"><input id="dev_model"
									name="dev_model" class="input_width" type="text" readonly /></td>
							</tr>
							<tr>
								<td class="inquire_item6">自编号</td>
								<td class="inquire_form6"><input id="self_num"
									name="self_num" class="input_width" type="text" readonly /></td>
								<td class="inquire_item6">牌照号</td>
								<td class="inquire_form6"><input name="license_num"
									id="license_num" class="input_width" type="text" readonly /></td>
							</tr>
							<tr>
								<td class="inquire_item6">实物标识号</td>
								<td class="inquire_form6"><input id="dev_sign"
									name="dev_sign" class="input_width" type="text" readonly /></td>
								<td class="inquire_item6">ERP设备编号</td>
								<td class="inquire_form6"><input id="dev_coding"
									name="dev_coding" class="input_width" type="text" readonly /></td>
							</tr>
						</table>
					</fieldset>
					<fieldset>
						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td class="inquire_form6"><input id="LastByTime"
									name="LastByTime" class="input_width" type="text" readonly /></td>
								<td class="inquire_item6">累计里程(公里)</td>
								<td class="inquire_form6"><input id="mileage"
									name="mileage" class="input_width" type="text" readonly /></td>
								<td class="inquire_item6">累计钻井进尺(米)</td>
								<td class="inquire_form6"><input id="drilling_footage"
									name="drilling_footage" class="input_width" type="text"
									readonly /> <input id="fk_dev_acc_id" name="fk_dev_acc_id"
									type="hidden" /> <input id="repair_info" name="repair_info"
									type="hidden" /></td>
							</tr>
							<tr>
								<td class="inquire_item6">累计工作小时(小时)</td>
								<td class="inquire_form6"><input id="work_hour"
									name="work_hour" class="input_width" type="text" readonly /> <%-- 			<auth:ListButton functionId="" css="jh" event="onclick='viewBY()'" title="查看详情"></auth:ListButton> --%>
								</td>
								<td align="left"><a style="color: blue"
									href="javascript:viewBY()" />查看明细</td>
							</tr>
						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="right">
								...
								<auth:ListButton functionId="" css="zj"
									event="onclick='addrow()'" title="增加"></auth:ListButton>
								<auth:ListButton functionId="" css="sc"
									event="onclick='removrow()'" title="删除"></auth:ListButton>
							</tr>
						</table>
					</div>
					<fieldset>
						<legend>计划保养日期</legend>
						<table width="97%" border="0" cellspacing="0" cellpadding="0"
							class="tab_line_height">
							<tbody id="OPERATOR_body">
								<tr>
									<td class="inquire_item6">第1次</td>
									<td class="inquire_form6"><input
										onpropertychange='changeValue(this)' type="text"
										name="by_date1" id="by_date1" value="" readonly="readonly"
										class="input_width" /> <img
										src="<%=contextPath%>/images/calendar.gif" id="tributton1"
										width="16" height="16" style="cursor: hand;"
										onmouseover="calDateSelector(by_date1,tributton1);" /> <input
										id="maintenance_id1" name="maintenance_id1" type="hidden" />
									</td>
								</tr>
							</tbody>
						</table>
	...
	function submitInfo(){
	   ...
	   if(noticeMsg!=""){
		...
		if(confirm("提交后数据不能修改，确认提交？")){
			//调配数量提交
			document.getElementById("form1").action = "<%=contextPath%>/rm/dm/saveDeviceAccMaintenancePlan.srq?ids="+dev_appdet_id+"&count="+optnum;
...
// 			$("#modify_date")[0].value=basedatas[0].modify_date;
	...
	function addrow(obj){
		...
		if(obj==undefined){
			newTd.innerHTML="<input  onpropertychange='changeValue(this)'   type='text' name='by_date"+optnum+"' id='by_date"+optnum+"' value='' readonly class='input_width' /><img src='<%=contextPath%>/images/calendar.gif' id='tributton"
					+ optnum
					+ "' width='16' height='16' style=cursor: hand ; onmouseover='calDateSelector(by_date"
					+ optnum + ",tributton" + optnum + ")'; />";
		} else {

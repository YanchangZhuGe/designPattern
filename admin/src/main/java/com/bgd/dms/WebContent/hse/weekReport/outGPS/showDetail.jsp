    ...
    <div id="new_table_box_bg">
    	<fieldSet style="margin-left:2px"><legend><span id="org_name"></span>GPS使用信息</legend>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" style="margin-top: 10px;">
				<tr>
			     	<td class="inquire_item4">租用车辆台数：</td>
			      	<td class="inquire_form4">
			      	<input type="text" id="use_no" name="use_no" class="input_width" readonly="readonly"/>
			      	</td>
			     	<td class="inquire_item4">GPS安装台数：</td>
			      	<td class="inquire_form4">
			      	<input type="text" id="install_no" name="install_no" class="input_width" readonly="readonly"/>
			      	</td>
		     	</tr>
			  	<tr>
		     	...
		     	<tr>
				    <td class="inquire_item4">未安装原因：</td>
				    <td class="inquire_form4" colspan="3"><textarea id="no_install_reason" name="no_install_reason" class="textarea"  readonly="readonly"></textarea></td>
			  	</tr>	
		     	<tr>
...
function queryOrg(){
	...
	if(datas!=null&&datas!=""){
		...
		document.getElementById("install_no").value = datas[0].install_no;
		document.getElementById("normal_no").value = datas[0].normal_no;
		document.getElementById("wrong_no").value = datas[0].wrong_no;
		document.getElementById("no_install_reason").value = datas[0].no_install_reason;

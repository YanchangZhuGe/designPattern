...
<div id="qua_c640c21612a1d08ae0430a15082cd08c"  style="width:100%; height:100%; overflow:auto;"></div>
<script type="text/javascript">
    ...
    substr = "name=miss&project_info_no="+project_info_no;
 	retObj = jcdpCallServiceCache("QualityChartSrv", "qualityChart", substr);
 	var miss = "";
    ...
    myChart.render("qua_c640c21612a1d08ae0430a15082cd08c");
</script>

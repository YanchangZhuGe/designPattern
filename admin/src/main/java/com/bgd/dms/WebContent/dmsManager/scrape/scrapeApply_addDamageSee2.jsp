...
<div id="new_table_box">
  ...
  <div id="new_table_box_bg">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
       ...
       <fieldSet style="margin-left:2px"><legend>盘亏及毁损设备详细信息</legend>
	      <div border="0" cellpadding="0" cellspacing="0"  id="FilterLayer" width="100%" style="height:300px">
			 <iframe id="devMenuZcbf" width="99%" cellSpacing=5 cellPadding=0 width=570 style="height:300px" border=0 src="<%=contextPath %>/dmsManager/scrape/devListSee2.jsp?scrapeType=23&bussId=<%=bussId%>&scrape_apply_id=<%=scrape_apply_id %>"></iframe>
		  </div>
      </fieldSet>
    ...
    <div id="oper_div">
        <span style="display: none;" class="xyb_btn"><a href="#" onclick="saveInfo()"></a></span>

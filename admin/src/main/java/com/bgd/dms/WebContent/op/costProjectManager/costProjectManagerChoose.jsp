      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <td class="ali_cdn_input"><input id="manageOrg" name="manageOrg" type="text" value="" class="input_width"/></td>
...
$(function(){
	...
	function refreshData(){
		...
		cruConfig.queryStr = "select * from  bgp_op_cost_project_basic pv   where bsflag='0' and org_subjection_id like'<%=org_subjection_id%>%'";
		if(manageOrg!=null&&manageOrg!=''&&manageOrg!=undefined){
			cruConfig.queryStr+=" and manage_org like  '%"+manageOrg+"%'";
		}

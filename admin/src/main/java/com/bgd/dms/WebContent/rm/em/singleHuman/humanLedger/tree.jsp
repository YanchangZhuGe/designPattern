...
parent.mainRightframe.location.href = "<%= contextPath%><%=rootBackUrl %>?taskObjectId=&taskId=&projectInfoNo=<%=projectInfoNo %>&taskName="+encodeURI(encodeURI("",'UTF-8'),'UTF-8')+"<%=customString %>";
}

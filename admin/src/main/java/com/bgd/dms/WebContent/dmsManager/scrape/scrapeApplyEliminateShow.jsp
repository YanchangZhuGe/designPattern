...
<form name="form1" id="form1" method="post" enctype="multipart/form-data" action="">
    <div id="new_table_box_bg">
    	...
    	<div><p align="center"><font style="FONT-SIZE: 24px">固定资产报废审批表</font></p><br/></div>
...
function refreshData(){
	...
	if('<%=scrape_apply_id%>'!='null'){
		baseData = jcdpCallService("ScrapeSrv", "getScrapeEliminateMessage", "scrape_apply_id="+'<%=scrape_apply_id%>');

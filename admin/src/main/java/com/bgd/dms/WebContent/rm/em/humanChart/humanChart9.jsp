...
<script type="text/javascript">
 ...
 function getFusionChart(){
		...
		var myChart4 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/StackedColumn3DLineDY.swf", "myChartId4", "100%", "100%", "0", "0" );    
		myChart4.setXMLUrl("<%=contextPath%>/cache/rm/em/getChart9.srq?orgId=<%=orgId%>");     
 ...
 function changeOrg(){
     ...
     chartReference.setXMLUrl("<%=contextPath%>/cache/rm/em/getChart9.srq?orgId="+s_org_id);
 }
</script>  
<script type="text/javascript">
	/**/function frameSize() {

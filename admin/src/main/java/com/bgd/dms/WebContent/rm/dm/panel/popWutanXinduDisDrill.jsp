						...
						<td width="99%">
							<div class="tongyong_box">
								<div class="tongyong_box_title"><span class="kb"><a
									href="#"></a></span><a href="#">物探处主要设备新度系数钻取情况</a><span class="gd"><a
									href="#"></a></span>
									<span class="dc" style="float:right;margin-top:-4px;">
										<a href="#" onclick="exportDataDoc('wtczysbxuxszqqk')" title="导出excel"></a>
									</span>
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		...
		var retObj = jcdpCallService("DevCommInfoSrv","getComXinduByType","code=<%=code%>&orgsubId=<%=orgsubId%>&drillLevel=1");
	...
	function exportDataDoc(exportFlag){
		...
		var submitStr="code=<%=code%>&orgsubId=<%=orgsubId%>&exportFlag="+exportFlag;

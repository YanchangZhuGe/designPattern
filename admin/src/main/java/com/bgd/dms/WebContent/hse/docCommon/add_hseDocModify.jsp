...
function save(){
	if(checkForm()){
		...
		form.action = "<%=contextPath%>/hse/doc/saveHseCommonDoc.srq";
		form.submit();
//		newClose();
	}
}
 	...
 	<table width="99%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
 	 <tr>
           ...
           <input name="ucmId" id="ucmId" class="input_width" value="" type="hidden" readonly="readonly"/>
              <input name=relation_id id="relation_id" class="input_width" value="<%=relation_id%>" type="hidden" readonly="readonly"/>
           </td>

...
<div id="new_table_box">
  <div id="new_table_box_content">
    ...
    <td>
    	<input type="radio" name="wz_type" value="2" >自采购物资
    </td>
	</tr>
</table>
</div>
		...
		for(var i=0;i<obj.length;i++){
				if(obj[i].checked ==true){
					var wz_type = obj[i].value;
						document.getElementById("form1").action="<%=contextPath%>/mat/singleproject/warehouse/out/matremove/matRemoveEdit.jsp?wz_type="+wz_type;
					}
			}

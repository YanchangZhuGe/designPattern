...
Ext.onReady(function() {
    ...
    function cellclick(grid,colspan, colIndex, rowdata, rowspan,rowIndex,e) {
        ...
        if(eps!=null && eps=='false'){
        	//org_subjection_id = rowdata.data.project_info_no;
        }
        //var objectId = rowdata.parentNode.data.name;
       // if('<%=org_subjection_id%>'=='C105' || org_subjection_id!='C105'){
        	parent.menuFrame.refreshData(name,org_subjection_id);
       // }

...
<input type="hidden" id="hse_safeshare_id" name="hse_safeshare_id" value=""/>
    ...
    <div id="new_table_box_bg">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" style="margin-top: 10px;">
			...
			<tr>
				...
				<td class="inquire_form6"><input type="text" id="safe_date" name="safe_date" class="input_width" value="<%=today %>" readonly="readonly"/>
			...
			<tr>
				...
				<td class="inquire_form6"><input type="text" id="upload_person" name="upload_person" value="<%=user.getUserName() %>" class="input_width"></input></td>
			</tr>	
			<tr>

...
function toAdd(){
	...
	if(rowNum == 0){
		...
		var td = tr.insertCell();
		td.className = "scrollRowThead";
		td.innerHTML = '<input type="text" name="line_group_id_'+rowNum+'" size="8">';
		tr.insertCell().innerHTML = '<input type="text" name="layout_'+rowNum+'" size="20">';
		tr.insertCell().innerHTML = '<input type="text" name="fold_'+rowNum+'" size="20">';
		tr.insertCell().innerHTML = '<input type="text" name="binning_size_'+rowNum+'" size="20">';
		tr.insertCell().innerHTML = '<input type="text" name="track_interval_'+rowNum+'" size="8" onkeypress="return key_press_check(this)">';
		tr.insertCell().innerHTML = '<input type="text" name="receiving_line_distance_'+rowNum+'" size="8" onkeypress="return key_press_check(this)">';
		tr.insertCell().innerHTML = '<input type="text" name="shot_interval_'+rowNum+'" size="8" onkeypress="return key_press_check(this)">';
		tr.insertCell().innerHTML = '<input type="text" name="sp_line_interval_'+rowNum+'" size="8" onkeypress="return key_press_check(this)">';
		tr.insertCell().innerHTML = '<input type="text" name="vertical_array_mode_'+rowNum+'" size="20">';
		
		tr.insertCell().innerHTML = '<input type="text" name="receiving_track_num_'+rowNum+'" size="8" onkeypress="return key_press_check(this)">';
		tr.insertCell().innerHTML = '<input type="text" name="rolling_mode_'+rowNum+'" size="12">';
		...
		tr.insertCell().innerHTML = '<input type="text" name="geophone_comp_graph_'+rowNum+'" size="20">';
		tr.insertCell().innerHTML = '<input type="text" name="well_depth_'+rowNum+'" size="8">';
		...
		tr.insertCell().innerHTML = '<input type="text" name="drive_range_'+rowNum+'" size="8">';
		//tr.insertCell().innerHTML = '<input type="text" name="shock_combination_graph_'+rowNum+'" size="8">';
		//新加 气枪字段列
...
function initData(){
	...
	if(retObj.datas != null){
		for(var i=0;i<retObj.datas.length;i++){
			...
			var td = tr.insertCell();
			td.className = "scrollRowThead";
			td.innerHTML = '<input type="text" name="line_group_id_'+rowNum+'" value="'+record.line_group_id+'" size="8" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="layout_'+rowNum+'" value="'+record.layout+'" size="20" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="fold_'+rowNum+'" value="'+record.fold+'" size="20" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="binning_size_'+rowNum+'" value="'+record.binning_size+'" size="20" readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="receiving_line_distance_'+rowNum+'" value="'+record.receiving_line_distance+'" size="8" onkeypress="return key_press_check(this)" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="shot_interval_'+rowNum+'" value="'+record.shot_interval+'" size="8" onkeypress="return key_press_check(this)" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="sp_line_interval_'+rowNum+'" value="'+record.sp_line_interval+'" size="8" onkeypress="return key_press_check(this)" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="vertical_array_mode_'+rowNum+'" value="'+record.vertical_array_mode+'" size="20" readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="rolling_mode_'+rowNum+'" value="'+record.rolling_mode+'" size="12" readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="geophone_comp_graph_'+rowNum+'" value="'+record.geophone_comp_graph+'" size="20" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="well_depth_'+rowNum+'" value="'+record.well_depth+'" size="8" readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="drive_range_'+rowNum+'" value="'+record.drive_range+'" size="8" readonly>';
			...
			exportRow["7"] = record.receiving_line_distance;
			exportRow["8"] = record.shot_interval;
			exportRow["9"] = record.sp_line_interval;
			exportRow["10"] = record.vertical_array_mode;
			exportRow["11"] = record.receiving_track_num;
			exportRow["12"] = record.rolling_mode;
			exportRow["13"] = record.element_interval;
			exportRow["14"] = record.pat_distance;
			exportRow["15"] = record.geophone_comp_graph;
			exportRow["16"] = record.well_depth;
			exportRow["17"] = record.well_num;
			exportRow["18"] = record.explosive_qty;
			exportRow["19"] = record.source_comp_graph;
			exportRow["20"] = record.source_num;
			exportRow["21"] = record.scanning_len;
			exportRow["22"] = record.scan_frequency;
			exportRow["23"] = record.drive_range;
 
			exportRow["24"] = record.airgun_capacity;
			exportRow["25"] = record.airgun_pressure;
			exportRow["26"] = record.airgun_intro;
			exportRow["27"] = record.airgun_num;
			exportRow["28"] = record.airgun_length;
			exportRow["29"] = record.airgun_spacing;
			
			
			exportRow["30"] = record.instrument_model;
			exportRow["31"] = record.preamplifier_gain;
			exportRow["32"] = record.sample_ratio;
			exportRow["33"] = record.record_len;
			exportRow["34"] = record.notes;
...
function toSave(){
	...
	for(var i=0;i<orders.length;i++){
		...
		//
		var binning_size = document.getElementsByName("binning_size"+"_"+rowNum)[0].value;
		if(binning_size.length > 0){
			rowParam['binning_size'] = binning_size;
		}
		...
		//
		var receiving_line_distance  = document.getElementsByName("receiving_line_distance"+"_"+rowNum)[0].value;
		if(receiving_line_distance.length > 0){
			rowParam['receiving_line_distance'] = receiving_line_distance;
		}
		//
		...
		//
		var geophone_comp_graph = document.getElementsByName("geophone_comp_graph"+"_"+rowNum)[0].value;
		if(geophone_comp_graph.length > 0){
			rowParam['geophone_comp_graph'] = geophone_comp_graph;
		}
		//
		...
		//
		var drive_range = document.getElementsByName("drive_range"+"_"+rowNum)[0].value;
		if(drive_range.length > 0){
			rowParam['drive_range'] = drive_range;
		}
		//
		...
		//
		var sp_line_interval = document.getElementsByName("sp_line_interval"+"_"+rowNum)[0].value;
		if(sp_line_interval.length > 0){
			rowParam['sp_line_interval'] = sp_line_interval;
		}
		//
		...
		//
		var rolling_mode  = document.getElementsByName("rolling_mode"+"_"+rowNum)[0].value;
		if(rolling_mode.length > 0){
			rowParam['rolling_mode'] = rolling_mode;
		}
		//
		var vertical_array_mode = document.getElementsByName("vertical_array_mode"+"_"+rowNum)[0].value;
		if(vertical_array_mode.length > 0){
			rowParam['vertical_array_mode'] = vertical_array_mode;
		}
...
function copyLastLine(){
	...
	var pre_line_group_id = document.getElementsByName('line_group_id_'+preRowNum)[0].value;
	var pre_layout = document.getElementsByName('layout_'+preRowNum)[0].value;
	var pre_fold = document.getElementsByName('fold_'+preRowNum)[0].value;
	var pre_track_interval = document.getElementsByName('track_interval'+'_'+preRowNum)[0].value;
	var pre_binning_size = document.getElementsByName('binning_size'+'_'+preRowNum)[0].value;
	var pre_vertical_array_mode = document.getElementsByName('vertical_array_mode'+'_'+preRowNum)[0].value;		
	var pre_receiving_line_distance = document.getElementsByName('receiving_line_distance'+'_'+preRowNum)[0].value;
	var pre_shot_interval = document.getElementsByName('shot_interval'+'_'+preRowNum)[0].value;
	var pre_sp_line_interval = document.getElementsByName('sp_line_interval'+'_'+preRowNum)[0].value;
	...
	var pre_geophone_comp_graph = document.getElementsByName('geophone_comp_graph'+'_'+preRowNum)[0].value;
	...
	var pre_drive_range = document.getElementsByName('drive_range'+'_'+preRowNum)[0].value;
	...
	var pre_rolling_mode = document.getElementsByName('rolling_mode'+'_'+preRowNum)[0].value;
	...
	var td = tr.insertCell();
	td.className = "scrollRowThead";
	td.innerHTML = '<input type="text" name="line_group_id_'+rowNum+'" value="'+pre_line_group_id+'" size="8">';
	tr.insertCell().innerHTML = '<input type="text" name="layout_'+rowNum+'" value="'+pre_layout+'" size="20">';
	tr.insertCell().innerHTML = '<input type="text" name="fold_'+rowNum+'" value="'+pre_fold+'" size="20">';
	tr.insertCell().innerHTML = '<input type="text" name="binning_size_'+rowNum+'" value="'+pre_binning_size+'" size="20">';
	...
	tr.insertCell().innerHTML = '<input type="text" name="receiving_line_distance_'+rowNum+'" value="'+pre_receiving_line_distance+'" size="8" onkeypress="return key_press_check(this)">';
	tr.insertCell().innerHTML = '<input type="text" name="shot_interval_'+rowNum+'" size="8" value="'+pre_shot_interval+'" onkeypress="return key_press_check(this)">';
	tr.insertCell().innerHTML = '<input type="text" name="sp_line_interval_'+rowNum+'" size="8" value="'+pre_sp_line_interval+'" onkeypress="return key_press_check(this)">';
	tr.insertCell().innerHTML = '<input type="text" name="vertical_array_mode_'+rowNum+'" value="'+pre_vertical_array_mode+'" size="20">';
	...
	tr.insertCell().innerHTML = '<input type="text" name="rolling_mode_'+rowNum+'" value="'+pre_rolling_mode+'" size="12">';
	...
	tr.insertCell().innerHTML = '<input type="text" name="geophone_comp_graph_'+rowNum+'" value="'+pre_geophone_comp_graph+'" size="20">';
	tr.insertCell().innerHTML = '<input type="text" name="well_depth_'+rowNum+'" value="'+pre_well_depth+'" size="8">';
	...
	tr.insertCell().innerHTML = '<input type="text" name="drive_range_'+rowNum+'" value="'+pre_drive_range+'" size="8">';
...
function copyLastLine1(){
	if(loadDataRows > 0){
		...
		var binning_size = document.getElementsByName('binning_size'+'_'+index)[0].value;
		var vertical_array_mode = document.getElementsByName('vertical_array_mode'+'_'+index)[0].value;		
		var receiving_line_distance = document.getElementsByName('receiving_line_distance'+'_'+index)[0].value;
		var shot_interval = document.getElementsByName('shot_interval'+'_'+index)[0].value;
		var sp_line_interval = document.getElementsByName('sp_line_interval'+'_'+index)[0].value;
		...
		var geophone_comp_graph = document.getElementsByName('geophone_comp_graph'+'_'+index)[0].value;
		...
		var drive_range = document.getElementsByName('drive_range'+'_'+index)[0].value;
		...
		var rolling_mode = document.getElementsByName('rolling_mode'+'_'+index)[0].value;
		...
		//for(var j=loadDataRows; j<allRows; j++){
			...
			document.getElementsByName('binning_size'+'_'+j)[0].value = binning_size;
			document.getElementsByName('vertical_array_mode'+'_'+j)[0].value = vertical_array_mode;			
			document.getElementsByName('receiving_line_distance'+'_'+j)[0].value = receiving_line_distance;
			document.getElementsByName('shot_interval'+'_'+j)[0].value = shot_interval;
			document.getElementsByName('sp_line_interval'+'_'+j)[0].value = sp_line_interval;
			...
			document.getElementsByName('geophone_comp_graph'+'_'+j)[0].value = geophone_comp_graph;
			...
			document.getElementsByName('drive_range'+'_'+j)[0].value = drive_range;
			...
			document.getElementsByName('rolling_mode'+'_'+j)[0].value = rolling_mode;
		//}
	}
}
...
function exportExcel(){
	...
	var fromPage = "3dlineConsruction";
...
function importData(){
	...
	if(checkFile(filename)){
		document.getElementById("fileForm").action = "<%=contextPath%>/pm/gpe/importLineConstruction.srq?workMethod=3&teamName="+team_name;
...
function downloadTemplate(){
	window.location.href="<%=contextPath%>/pm/dailyReport/singleProject/download.jsp?path=/pm/lineConstruction/3dLineConsructionTemp.xls&filename=3dLineConsruction_template.xls";
}
...
<table id="lineTable" width="100%" border="0" cellspacing="0"  align="center" cellpadding="0" class="scrolltable">
   ...
   <tr class="scrollColThead td_head">
      ...
      <td class="scrollCR scrollRowThead">线束号</td>
      <td>观测系统类型</td>
      <td>覆盖次数</td>
      <td>面元尺寸</td>
      <td >道距m</td>

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function getSecondLieFusionChart(){
			...
			chart1.setXMLUrl("<%=contextPath%>/dms/device/getSecondJBQLie.srq?orgSubId="+orgSubId+"&country="+country+"");
			chart1.render("chartContainer1");
		}
		//弹出子层级检波器闲置情况
		function popNextLevelLie(level,devTreeId,orgSubId,country){
			popWindow('<%=contextPath%>/dmsManager/use/deviceLie/thirdLevelJBQLie.jsp?level='+level+'&devTreeId='+devTreeId+'&orgSubId='+orgSubId+'&country='+country,'800:572');
		}
		//弹出设备信息

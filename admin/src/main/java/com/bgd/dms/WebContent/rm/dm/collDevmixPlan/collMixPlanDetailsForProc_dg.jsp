...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
 ...
 <body style="background:#cdddef;overflow:auto" onload="refreshData()">
 	<form name="form1" id="form1" method="post" action="" target="target_id">
      	<div id="list_table" style="height:700px;overflow:auto">
			<div id="table_box">
...
$().ready(function(){
	...
	function toMixDetailInfos(){
		...
		if(size==1){
			...
			//containhtml += "<tr class='bt_info'><td class='bt_info_odd'><input type='checkbox' id='devbackinfo' name='devbackinfo'/></td><td class='bt_info_even'>序号</td><td class='bt_info_odd'>设备名称</td><td class='bt_info_even'>规格名称</td>";
			containhtml += "<tr class='bt_info'><td class='bt_info_odd' width='4%'>选择</td><td class='bt_info_even' width='4%'>序号</td><td class='bt_info_odd' width='11'>设备名称</td><td class='bt_info_even' width='11%'>规格名称</td>";
			containhtml += "<td class='bt_info_odd' width='11%'>计量单位</td><td class='bt_info_even' width='9%'>道数</td><td class='bt_info_odd' width='10%'>需求数量</td><td class='bt_info_even' width='10%'>总道数</td></tr>";

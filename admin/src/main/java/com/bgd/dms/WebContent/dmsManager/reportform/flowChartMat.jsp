			...
			<tr align="center" >
		    	<td align="center" >
			  		<report:html name="report1"
	        			reportFileName="/flowChart/demanFlowChartmat.raq"
	        			params="<%=str%>"
		   				needScroll="yes"
		   				scrollWidth="100%"
		   				scrollHeight="100%"
...
<script type="text/javascript">
		...
		window.location="<%=contextPath%>/dmsManager/reportform/flowChartMat.jsp?start_date="+start_date+"&end_date="+end_date+"&sub_id="+sub_id+"&flag="+new Date();
	}

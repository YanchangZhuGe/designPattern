	...
	function submitInfo(str){
		...
		if(str=='1')
		{
			if(confirm("提交后不能修改删除,是否提交?")){
				document.getElementById("form1").action = "<%=contextPath%>/rm/dm/saveXZTJInfo.srq?count="+count+"&line_infos="+line_infos+"&flag=1";
				document.getElementById("form1").submit();
		}
		else
			{
				document.getElementById("form1").action = "<%=contextPath%>/rm/dm/saveXZTJInfo.srq?count="+count+"&line_infos="+line_infos;
				document.getElementById("form1").submit();
			}
				...
				if(baseData.devMap!=null)
					{
						...
						document.getElementById("back_employee_id").value=baseData.devMap.creator_id;
					}

...
<table border="0" cellpadding="0" cellspacing="0" width="95%" height="800" class="form_info">
	...
	<tr class="odd">
  	...
  	<tr class="odd">
    	...
    	<td class="inquire_form">
    		<input type="text" name="birthday" id="birthday" value="" class="input_width" readonly/>
    ...
    <tr class="odd">
    	...
    	<td class="inquire_form">
    		 <input type="text" name="duty" id="duty" value="" class="input_width"/>
      </td>
    </tr>   
    <tr class="odd">
  		<td class="inquire_item">&nbsp;手机号码：</td>
    	<td class="inquire_form">
    		 <input type="text" name="mobilePhone" id="mobilePhone" value="" class="input_width"/>
     </td>
    	<td class="inquire_item">&nbsp;办公电话：</td>
    	<td class="inquire_form">
    		<input type="text" name="officePhone" id="officePhone" value="" class="input_width"/>
      </td>
    </tr>   
    <tr class="odd">
  		<td class="inquire_item">&nbsp;家庭电话：</td>
    	<td class="inquire_form">
    		<input type="text" name="homePhone" id="homePhone" value="" class="input_width"/>
     </td>
    	<td class="inquire_item">&nbsp;传真：</td>
    	<td class="inquire_form">
    		<input type="text" name="fax" id="fax" value="" class="input_width"/>
      </td>
    </tr>   
    <tr class="odd">
  		<td class="inquire_item">&nbsp;电子邮箱：</td>
    	<td class="inquire_form">
    		<input type="text" name="email" id="email" value="" class="input_width"/>
     </td>
    	<td class="inquire_item">&nbsp;主管业务：</td>
    	<td class="inquire_form">
    		<input type="text" name="inChargeOf" id="inChargeOf" value="" class="input_width"/>
      </td>
    </tr>   
    <tr class="odd">
  		<td class="inquire_item">&nbsp;所学专业：</td>
    	<td class="inquire_form">
    		<input type="text" name="majorSubject" id="majorSubject" value="" class="input_width"/>
     </td>
    	<td class="inquire_item">&nbsp;最高学位：</td>
    	<td class="inquire_form">
    		<input type="text" name="educationLevel" id="educationLevel" value="" class="input_width"/>
      </td>
    </tr>   
    <tr class="odd">
  		<td class="inquire_item">&nbsp;籍贯：</td>
    	<td class="inquire_form">
    		<input type="text" name="birthPlace" id="birthPlace" value="" class="input_width"/>
     </td>
    	<td class="inquire_item">&nbsp;个人爱好：</td>
    	<td class="inquire_form">
    		<input type="text" name="hobby" id="hobby" value="" class="input_width"/>
      </td>
    </tr>   
    <tr class="odd">
  		<td class="inquire_item">&nbsp;家庭住址：</td>
    	<td class="inquire_form">
    		<input type="text" name="homeAddress" id="homeAddress" value="" class="input_width"/>
     </td>
    	<td class="inquire_item">&nbsp;工作地点：</td>
    	<td class="inquire_form">
    		<input type="text" name="workPlace" id="workPlace" value="" class="input_width"/>
      </td>
    </tr>   
    <tr class="odd">
  		<td class="inquire_item">&nbsp;与公司关系：</td>
    	<td class="inquire_form">
    		<input type="text" name="relationship" id="relationship" value="" class="input_width"/>
     </td>
    	<td class="inquire_item">&nbsp;毕业院校：</td>
    	<td class="inquire_form">
    		<input type="text" name="graduateFrom" id="graduateFrom" value="" class="input_width"/>
      </td>
    </tr>   
    <tr class="odd">
  		<td class="inquire_item">&nbsp;毕业日期：</td>
    	<td class="inquire_form">
    		<input type="text" name="graduateDate" id="graduateDate" value="" class="input_width" readonly/>
    	...
    	<td class="inquire_form">
    		<input type="text" name="goodAt" id="goodAt" value="" class="input_width"/>
      </td>
    </tr>   
    ...
    <tr class="odd" height="300">
	    ...
	    <td colspan="3"  class="inquire_form">
         	 <textarea name="studyExperience" id="studyExperience" max=2000 msg="学习经历不超过2000个汉字"></textarea>
	    </td>
	</tr>
	 <tr class="odd" height="300">
	  	<td class="inquire_item">&nbsp;家庭成员情况：</td>
	    <td colspan="3"  class="inquire_form">
         	  <textarea name="homeMemo" id="homeMemo" max=2000 msg="家庭成员情况不超过2000个汉字"></textarea>
	    </td>
	</tr>
	 <tr class="odd" height="300">
	  	<td class="inquire_item">&nbsp;个人简介：</td>
	    <td colspan="3"  class="inquire_form">
         	<textarea name="memo" id="memo" max=500 msg="个人简历不超过500个汉字"></textarea>
	    </td>
	</tr>
       <tr class="odd">
 ...
 <script type="text/javascript">
 function toBack(){
		window.location="<%=contextPath%>/market/departmentPage/selectPerson.jsp?id=<%=deptId%>&corpId=<%=corpId%>";
	}
 </script>
</html>

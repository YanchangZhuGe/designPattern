...
<script type="text/javascript">
	...
	function refreshData(){
		...
		var querySql = "select * from bgp_op_target_device_mataxi where bsflag='0' and if_change = '0' and mataxi_type ='4' and target_mataxi_id = '"+id+"'";
	...
	function newSubmit() {
		...
		if(target_mataxi_id!=null && target_mataxi_id!=''){
			...
			"where t.target_mataxi_id='"+target_mataxi_id+"';";
		}else{
			...
			"update_date,bsflag,if_change,mataxi_type) values((lower(sys_guid())),'<%=project_info_no%>','"+dev_name+"',"+
			...
			"'<%=user_id%>',sysdate,'<%=user_id%>',sysdate,'0','0','4');";
		}

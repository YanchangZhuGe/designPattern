...
function toSubmit(){
    ...
    processNecessaryInfo={         
    		...
    		businessInfo:"单项目人工成本补充计划流程",        //用于待审批界面展示业务信息
	...
	jcdpCallService("HumanCommInfoSrv","updateHumanPlanNoT","planId=<%=planId%>");	
...
function page_init(){
	...
	if(planId!='null' ){
		var querySql = "select t.* from bgp_comm_human_cost_plan t left join bgp_comm_human_plan_cost c on t.plan_id=c.plan_id and c.bsflag='0' and c.spare5='1' where c.plan_id='"+planId+"' and t.spare5='1'  and t.bsflag='0' and t.project_info_no='"+projectInfoNo+"' ";		
	...
	if(planId!='null'){
		var querySql = "select t.*,d.coding_name employee_gz_name from bgp_comm_human_cost_plan_deta t left join comm_coding_sort_detail d on t.employee_gz=d.coding_code_id left join bgp_comm_human_plan_cost c on t.plan_id=c.plan_id and c.bsflag='0' and c.spare5='1' where c.plan_id='"+planId+"'  and t.bsflag='0' and t.project_info_no='"+projectInfoNo+"' and t.spare5='1' order by t.show_order  ";
...
<% 
String buttionN = request.getParameter("buttionN");
  if("1".equals(buttionN)){
%>
<div id="oper_div">

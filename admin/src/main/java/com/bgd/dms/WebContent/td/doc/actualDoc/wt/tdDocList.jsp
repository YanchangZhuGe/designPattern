...
<script type="text/javascript">
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/doc/actualDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'800:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/doc/actualDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&id='+id+'&isSingle='+isSingle,'800:680');
	}

...
<body>
<form action="<%=contextPath%>/rm/em/singleHuman/humanTrainingPlan/humanImportFile_t.jsp" id="fileForm" method="post" enctype="multipart/form-data" target="targetIframe">

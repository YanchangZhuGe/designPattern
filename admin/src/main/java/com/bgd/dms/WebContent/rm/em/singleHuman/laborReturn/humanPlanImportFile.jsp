...
<body>
<form action="<%=contextPath%>/rm/em/toSaveHumanLaborReturnExcle.srq" id="fileForm" method="post" enctype="multipart/form-data" target="list">
<table width="96%" border="0" cellspacing="0" cellpadding="0" class="form_info" >
	<tr class="even">
		...
		<input type="hidden" id="laborCategory" name="laborCategory" value="<%=laborCategory%>" class="input_width"> </td>
	</tr>
</table>

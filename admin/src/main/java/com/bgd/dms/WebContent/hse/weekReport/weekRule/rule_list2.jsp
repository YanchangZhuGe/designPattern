      	...
      	<div id="list_table" >
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      <td class="bt_info_even" autoOrder="1" exp="<input type='hidden' name='qwe' value='{work_hour_id}' id='' />">序号</td> 
			      <td class="bt_info_odd" exp="{org_name}">基层单位</td>
			      <td class="bt_info_even" exp="{no_modify_rule}">未整改违章</td>
			      <td class="bt_info_odd" exp="{first_big_rule}">特大</td>
			      <td class="bt_info_even" exp="{second_big_rule}">重大</td>
			      <td class="bt_info_odd" exp="{third_big_rule}">较大</td>
			      <td class="bt_info_even" exp="{usual_rule}">一般</td>
			      <td class="bt_info_odd" exp="{total_rule}">合计</td>
			    </tr>
			  </table>
			</div>

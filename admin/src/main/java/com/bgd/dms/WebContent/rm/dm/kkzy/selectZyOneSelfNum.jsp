...
function saveBake(){
	var self_nums="";
	$("input[type='radio'][name='rdo_entity_name']").each(function(i){
		if($(this).attr("checked")){
			self_nums+=$(this).val()+",";
		}
		
	});
	window.returnValue = self_nums.split(",")[0];
			...
			<table width="98%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr id='dev_acc_id_{dev_acc_id}' name='dev_acc_id'  idinfo='{dev_acc_id}'>
					<td class="bt_info_odd"
						exp="<input type='radio' name='rdo_entity_name'   value='{self_num}-{dev_acc_id}' id='rdo_entity_name_{dev_acc_id}' { selectflag}/></td>
					<td class="bt_info_odd" exp="{self_num}">选择</td>
...
<script type="text/javascript">
  ...
  var checked = false;
	...
	function refreshData(arrObj){
		...
		str += "  where  t.owning_sub_id like 'C105006%'  and t.dev_type like 'S062301%'  and t.bsflag='0'";
		//if(selectWzId!="")
		//{	

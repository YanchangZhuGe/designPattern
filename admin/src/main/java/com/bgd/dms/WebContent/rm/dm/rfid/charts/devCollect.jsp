...
<div>
	<div id="chart4">
		<div>设备类型：
		<devselect:typelist style="height: 20px;" id="chart6type" name="chart6type" cssClass="" selectonchange="chart4Refresh(this);"></devselect:typelist></div>

...
function save(){
	...
	form.action = "<%=contextPath%>/td/ws/toSavestartAcceptanceDoc.srq?businessType=<%=businessType%>";
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if(fileId!='null'){ 
		...
		if (!isTextPropertyNotNull("pk_0110000061000000052", "开工验收检查表")) return false;
	}else{

...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		var sql = "select t.hse_advertise_id,t.second_org,t.third_org,t.times,case when length(t.content)>10 then concat(substr(t.content, 1, 10), '...') else t.content end content,decode(t.rate,'1','一年一次','2','半年一次') as rate,decode(t.duty,'1','处长','2','副处长','3','队经理','4','队副经理') as duty,oi1.org_abbreviation as second_org_name,oi2.org_abbreviation as third_org_name,oi3.org_abbreviation as fourth_org_name,t.create_date,t.modifi_date from bgp_hse_advertise t left join comm_org_subjection os1 on t.second_org = os1.org_subjection_id and os1.bsflag = '0' left join comm_org_information oi1 on oi1.org_id = os1.org_id and oi1.bsflag = '0' left join comm_org_subjection os2 on t.third_org = os2.org_subjection_id and os2.bsflag = '0' left join comm_org_information oi2 on oi2.org_id = os2.org_id and oi2.bsflag = '0' left join comm_org_subjection os3 on t.fourth_org = os3.org_subjection_id and os3.bsflag = '0' left join comm_org_information oi3 on oi3.org_id = os3.org_id and oi3.bsflag = '0' where t.bsflag = '0' and t.if_plicy='0' "+querySqlAdd;
  ...
  <div id="new_table_box_content">
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
          <td class="inquire_item6">宣贯人职务:</td>
          <td class="inquire_form6">

    ...
    <div style="border:1px #aebccb solid;background:#f1f2f3;padding:10px;width:98%">
 	<table width="99%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
 	 ...
 	 <tr>
           ...
           <td class="inquire_form4">
           <input name="cont_cost" id="cont_cost" class="input_width" value="" type="text" />          
           </td>
	  </tr>
	  <tr>
 	       <td class="inquire_item4">市场化用工：</td>
           <td class="inquire_form4">
           <input name="mark_cost" id="mark_cost" class="input_width" value="" type="text" />
           </td>
           <td class="inquire_item4">临时季节工：</td>
           <td class="inquire_form4">
           <input name="temp_cost" id="temp_cost" class="input_width" value="" type="text" />          
           </td>
	  </tr>  
	  <tr>
 	       <td class="inquire_item4">再就业人员：</td>
           <td class="inquire_form4">
           <input name="reem_cost" id="reem_cost" class="input_width" value="" type="text"/>
           </td>
           <td class="inquire_item4">劳务派遣：</td>
           <td class="inquire_form4">
           <input name="serv_cost" id="serv_cost" class="input_width" value="" type="text" />          
           </td>
	  </tr>         
 	</table>
</div>  

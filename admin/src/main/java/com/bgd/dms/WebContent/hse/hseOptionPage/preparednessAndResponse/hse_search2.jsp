...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		var acceptance_numbers = document.getElementById("acceptance_numbers").value;   
		var acceptance_time = document.getElementById("acceptance_time").value;  
		var acceptance_time2 = document.getElementById("acceptance_time2").value;   
		...
		if(acceptance_numbers!=''&&acceptance_numbers!=null){
			sql = sql+" and tr.acceptance_numbers like '%"+acceptance_numbers+"%'";
		}
 
 
		if(acceptance_time!=''&&acceptance_time!=null){
			sql = sql+" and tr.acceptance_time >= to_date('"+acceptance_time+"','yyyy-MM-dd')";
		}
		if(acceptance_time2!=''&&acceptance_time2!=null){
			sql = sql+" and tr.acceptance_time <= to_date('"+acceptance_time2+"','yyyy-MM-dd')";
		}
  ...
  <div id="new_table_box_content">
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
	    ...
	    <td class="inquire_form6">
	    <input type="text" id="acceptance_numbers" name="acceptance_numbers" class="input_width"    />    					    
	    </td>	
		  ...
		  <td class="inquire_form6"><input type="text" id="acceptance_time2" name="acceptance_time2" class="input_width" readonly="readonly"/>
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton2" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(acceptance_time2,tributton2);" />&nbsp;</td>
        </tr>

    ...
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
		  ...
		  <input type="text" id="check_start_time2" name="check_start_time2"  style="width:100px;"   readonly="readonly"/>
        ...
        <td class="">检查结束时间：</td>
		  ...
		  <td class=""  colspan="4" >  &nbsp;&nbsp; 至：&nbsp;&nbsp; 
		  <input type="text" id="check_end_time2" name="check_end_time2"  style="width:100px;"   readonly="readonly"/>

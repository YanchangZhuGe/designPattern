...
function toAdd(){
	...
	document.form1.action="<%=contextPath%>/pm/dailyReport/singleProject/ws/saveOrUpdateWsResourceAssignment.srq";
...
function toSubmit(){
	if(window.confirm("确定提交吗？该操作会提交所有作业的当天的反馈！")) {
		...
		debugger;
		var retObj = jcdpCallService("WsDailyReportSrv", "submitDailyReport", "projectInfoNo=<%=projectInfoNo %>&produceDate=<%=produceDate %>");

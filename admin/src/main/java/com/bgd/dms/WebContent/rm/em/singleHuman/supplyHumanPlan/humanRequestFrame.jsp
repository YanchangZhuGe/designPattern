...
<%
	...
	String splanId = request.getParameter("splan_id");
...
String wbsBackUrl = "/rm/em/singleHuman/supplyHumanPlan/wbsPlanList.jsp";
String taskBackUrl = "/rm/em/singleHuman/supplyHumanPlan/taskPlanList.jsp";
String rootBackUrl = "/rm/em/singleHuman/supplyHumanPlan/rootPlanList.jsp";
...
<frameset cols="300,*" frameborder="yes" border="0" framespacing="0">
  <frame src="<%=contextPath %>/rm/em/singleHuman/supplyHumanPlan/tree.jsp?projectInfoNo=<%=projectInfoNo %>&wbsBackUrl=<%=wbsBackUrl%>&taskBackUrl=<%=taskBackUrl%>&rootBackUrl=<%=rootBackUrl%>&splanId=<%=splanId%>&show_p=<%=show_p%>" name="mainTopframe" frameborder="no" scrolling="no"  style="border-right: 2px solid #5796DD; cursor: w-resize;" id="mainTopframe"/>
...
<%	
		...
		<frame src="<%=contextPath %>/rm/em/singleHuman/supplyHumanPlan/tree.jsp?projectInfoNo=<%=projectInfoNo %>&wbsBackUrl=/rm/em/singleHuman/supplyHumanPlan/jzs_planningList.jsp&taskBackUrl=/rm/em/singleHuman/supplyHumanPlan/jzs_planningList.jsp&rootBackUrl=/rm/em/singleHuman/supplyHumanPlan/jzs_planningList.jsp&splanId=<%=splanId%>&show_p=<%=show_p%>" name="mainTopframe" frameborder="no" scrolling="no"  style="border-right: 2px solid #5796DD; cursor: w-resize;" id="mainTopframe"/>
		<frame src="" name="mainRightframe" frameborder="no" scrolling="auto" style="border-left: 2px solid #5796DD; cursor: w-resize;" id="mainRightframe"/>
		</frameset>

...
function getSubNodes(parentNode) {
	...
	var parentNodeSel = parentNode.id.substring(15);
	if(isSelect==1){
	    parentNodeSel = "C105008";
	}
	Ext.Ajax.request({

...
var jcdp_codes = new Array(
	...
	function viewLink(project_dynamic_id){
	    	editUrl = "/market/viewProjectDynamic.srq?button=view&orgId=<%=orgId%>&projectDynamicId="+project_dynamic_id;
...
<table border="0"  cellspacing="0"  cellpadding="0"  class="form_info"  width="100%" id="queryRetTable">
	...
	<tr class="bt_info">
		...
		<td class="tableHeader" 	 exp="{value_workload}">落实价值工<br>作量(万元)</td>

...
<body>
<form name="form1" id="form1" enctype="multipart/form-data" method="post" action="<%=contextPath%>/market/updateYtgs.srq">
<table border="0" cellpadding="0" cellspacing="0" width="95%" height="800" class="form_info">
	...
	<tr class="odd">
  	...
  	<tr class="odd">
      	<td class="inquire_item"><font color=red>*</font>&nbsp;一级类别：</td>
    	<td class="inquire_form">
    	<%
    ...
    <tr class="odd">
      	<td class="inquire_item"><font color=red>*</font>&nbsp;二级类别：</td>

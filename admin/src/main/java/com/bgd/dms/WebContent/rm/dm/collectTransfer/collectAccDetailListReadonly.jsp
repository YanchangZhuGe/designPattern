...
<div id="new_table_box" style="width:98%">
  <div id="new_table_box_content" style="width:100%">
    <div id="new_table_box_bg" style="width:95%">
		<fieldSet style="margin-left:0px"><legend >内部送修基本信息</legend>
		  ...
		  <fieldSet style="margin-left:0px"><legend >内部送修明细信息</legend>
				<div >
...
<script type="text/javascript">
    ...
    function submitInfo(oprinfo){
		...
		document.getElementById("form1").action = "<%=contextPath%>/rm/dm/toSaveCollAccRepairInfowfpa.srq?oprstate="+oprstate;;

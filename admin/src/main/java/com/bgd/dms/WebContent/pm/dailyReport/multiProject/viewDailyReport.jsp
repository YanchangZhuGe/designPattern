			...
			<div id="tab_box_content0" class="tab_box_content">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					<tr style="background-color: #97cbfd">
						...
						<auth:ListButton tdid="tj" display="none" functionId="F_PM_M_004" css="tj" event="onclick='audit(3)'" title="JCDP_btn_audit"></auth:ListButton>
		    			<auth:ListButton tdid="gb" display="none" functionId="F_PM_M_004" css="gb" event="onclick='audit(4)'" title="JCDP_btn_audit"></auth:ListButton>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					<tr style="background-color: #97cbfd">
						...
						<td class="inquire_form8" id="survey_process_status"></td>
						<td colspan="6">&nbsp;</td>
					</tr>
				</table>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					...
					<tr class="odd">
						...
						<td class="inquire_item8">测量点完成%：</td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					<tr style="background-color: #97cbfd">
						...
						<td class="inquire_form8" id="surface_process_status"></td>
						<td colspan="6">&nbsp;</td>
					</tr>
				</table>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" id="drill_tab" >
					<tr style="background-color: #97cbfd">
						...
						<td class="inquire_form8" id="drill_process_status"></td>
						<td colspan="6">&nbsp;</td>
					</tr>
				</table>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					<tr style="background-color: #97cbfd">
						...
						<td class="inquire_form8" id="collect_process_status"></td>
						<td colspan="6">&nbsp;</td>
					</tr>
				</table>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
...
<!-- 						<td class="inquire_form6" id="DAILY_JP_ACQUIRE_WORKLOAD" style="display:none;"></td> -->
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info"  id="collect">
					  
					  		 <tr> 
					   	<td class="bt_info_odd" >线束（测线）号</td>
	                	<td  class="bt_info_even" >起止桩号</td>
		                <td  class="bt_info_odd" >气枪炮点数</td>
		                <td  class="bt_info_even" >井炮炮点数</td>
		                <td  class="bt_info_odd" >震源炮点数</td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					<tr class="even">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
					<tr style="background-color: #97cbfd">
						<td class="inquire_item8">日生产时效(24小时):</td>
						<td colspan="7">&nbsp;</td>
					</tr>
				</table>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
			  	...
			  	<td class="inquire_form8" id="FIRST_SHOT_TIME"> </td>
				<td class="inquire_item8">末炮时间:</td>
				<td class="inquire_form8" id="LAST_SHOT_TIME">  </td>
			...
			<!-- 	<td class="inquire_item8">实际放炮时间:</td>
				<td class="inquire_form8"><input name="ACTUAL_SHOT"  type="text" /></td> -->
...
function page_init(){
	...
	//alert(prodceDate);
	var retObj = jcdpCallService("DailyReportSrv", "getDgDailyReportInfo", "dailyNo=<%=daily_no %>&projectInfoNo=<%=project_info_no %>&produceDate="+produceDate);
	...
	//debugger;
	var tj_btn = document.getElementById("tj");
	var gb_btn = document.getElementById("gb");
	var cx_btn = document.getElementById("cx");
	
	
	if(audit_status == "" || audit_status == null) {
		document.getElementById("audit_status").innerHTML = '日报未录入!';
		if(tj_btn!=null){
			tj_btn.style.display="none";
		}
		if(gb_btn!=null){
			gb_btn.style.display="none";
		}
		if(cx_btn!=null){
			cx_btn.colSpan="3";
		}
		...
		if(tj_btn!=null){
			tj_btn.style.display="inline";
		}
		if(gb_btn!=null){
			gb_btn.style.display="inline";
		}
		if(cx_btn!=null){
			cx_btn.colSpan="1";
		}
	...
	//时间	
	debugger;
		var retTimeMap = jcdpCallService("DailyReportSrv", "getDgTime","dailyNo="+retObj.dailyMap.DAILY_NO);
		 if(retTimeMap!=null&& retTimeMap!=""){
				document.getElementById("PATH").innerHTML = retTimeMap.dailyMap.path;
				document.getElementById("TIDE_DELAY").innerHTML = retTimeMap.dailyMap.tideDelay;
				//document.getElementById("ACTUAL_SHOT").innerHTML = dailyMap.actualShot;
				document.getElementById("ARRAY_TROUBLE").innerHTML = retTimeMap.dailyMap.arrayTrouble;
				document.getElementById("WEATHER_DELAY").innerHTML = retTimeMap.dailyMap.weatherDelay;
				document.getElementById("MACHINE_DELAY").innerHTML = retTimeMap.dailyMap.machineDelay;
				document.getElementById("MEASURE_DELAY").innerHTML = retTimeMap.dailyMap.measureDelay;
				document.getElementById("CLEARUP_DELAY").innerHTML = retTimeMap.dailyMap.clearupDelay;
				document.getElementById("TRANSIT_DELAY").innerHTML = retTimeMap.dailyMap.transitDelay;
				document.getElementById("LINE_LAY").innerHTML = retTimeMap.dailyMap.lineLay;
				document.getElementById("ARRAY_CHECK").innerHTML = retTimeMap.dailyMap.arrayCheck;
				document.getElementById("HSE_DELAY").innerHTML = retTimeMap.dailyMap.hseDelay;
				document.getElementById("FIRST_SHOT_TIME").innerHTML = retTimeMap.dailyMap.firstShotTime;
				document.getElementById("LAST_SHOT_TIME").innerHTML = retTimeMap.dailyMap.lastShotTime;
				document.getElementById("AIR_GUN_USE_TIME").innerHTML = retTimeMap.dailyMap.airGunUseTime;

		 
				document.getElementById("RELATION_DELAY").innerHTML = retTimeMap.dailyMap.relationDelay;
				document.getElementById("FOCUS_DELAY").innerHTML= retTimeMap.dailyMap.focusDelay;
	...
	var collectList = retObj.collectList;

	var status = retObj.dailyMap.SURVEY_PROCESS_STATUS;
	if(status == "1"){
		document.getElementById("survey_process_status").innerHTML = "未开始";
	} else if(status == "2"){
		document.getElementById("survey_process_status").innerHTML = "正在施工";
	} else if(status == "3"){
		document.getElementById("survey_process_status").innerHTML = "结束";
	}
	
	status = retObj.dailyMap.SURFACE_PROCESS_STATUS;
	if(status == "1"){
		document.getElementById("surface_process_status").innerHTML = "未开始";
	} else if(status == "2"){
		document.getElementById("surface_process_status").innerHTML = "正在施工";
	} else if(status == "3"){
		document.getElementById("surface_process_status").innerHTML = "结束";
	}
	
	status = retObj.dailyMap.DRILL_PROCESS_STATUS;
	if(status == "1"){
		document.getElementById("drill_process_status").innerHTML = "未开始";
	} else if(status == "2"){
		document.getElementById("drill_process_status").innerHTML = "正在施工";
	} else if(status == "3"){
		document.getElementById("drill_process_status").innerHTML = "结束";
	}
	
	status = retObj.dailyMap.COLLECT_PROCESS_STATUS;
	if(status == "1"){
		document.getElementById("collect_process_status").innerHTML = "未开始";
	} else if(status == "2"){
		document.getElementById("collect_process_status").innerHTML = "正在施工";
	} else if(status == "3"){
		document.getElementById("collect_process_status").innerHTML = "结束";
	}
	...
	if(collectList != null){
		...
		for(var i = 0 ; i<collectList.length; i++){
			var tr = document.getElementById("collect").insertRow();
			if ( i % 2 == 0) {
		        tr.className = "even";
		    } else {
		        tr.className = "odd";
		    }
			var obj = retObj.collectList[i];
			
			
			tr.insertCell().innerHTML = obj.LINE_NUM!=null? obj.LINE_NUM:"";
			 
			 
			tr.insertCell().innerHTML = obj.START_END!=null?obj.START_END:"";
			tr.insertCell().innerHTML = obj.QQ_SHOT_NUM!=null?obj.QQ_SHOT_NUM:"";
			tr.insertCell().innerHTML = obj.JP_SHOT_NUM!=null?obj.JP_SHOT_NUM:"";
			tr.insertCell().innerHTML = obj.ZY_SHOT_NUM!=null?ZY_SHOT_NUM:"";
...
function query_data(){
	...
	//alert(prodceDate);
	var retObj = jcdpCallService("DailyReportSrv", "getDailyReportInfo", "projectInfoNo=<%=project_info_no %>&produceDate="+produceDate);
	var no_record = retObj.dailyMap.noRecord;
	if(no_record == "1"){
		alert("该日期没有记录");
		$("#alltables").hide();
		$("#audit_status").html("");
		...
		if(acquireList != null){
			for(var i = 0 ; i<acquireList.length; i++){
				...
				tr.insertCell().innerHTML = obj.DAILY_FINISH_SP;
				tr.insertCell().innerHTML = obj.DAILY_FINISH_WORKLOAD;
			}
		}
	}
	if(collectList != null){

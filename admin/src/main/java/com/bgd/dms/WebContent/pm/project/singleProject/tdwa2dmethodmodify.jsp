...
function toAddLayout(){
	...
	if(rowNum > 1){
		...
		tr.insertCell().innerHTML = '<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height" id="layout_table_'+layoutIndex+'">'
					+' <tr class="odd"><td class="inquire_item6"><font color="red">*</font>观测系统类型：</td>'
					+' <td class="inquire_form6"><input id="method1_no' + '_' + rowNum+'" value="" type="hidden" value=""/><input id="creator1' + '_' + rowNum+'" type="hidden" value=""/><input id="create_date1' + '_' + rowNum+'" type="hidden" value=""/><input id="bsflag1' + '_' + rowNum+'" type="hidden" value="0"/>'
					...
					+' <td class="inquire_form6"><input id="vertical_array' + '_' + rowNum+'" type="text"  value="'+pre_vertical_array+'" class="input_width" style="margin-top:4px;"/><div></div></td>'
					+' <td class="inquire_item6">单线覆盖次数(宽线)：</td>'
					+' <td class="inquire_form6"><input id="single_line_fold' + '_' + rowNum+'" type="text"  value="'+pre_single_line_fold+'" class="input_width" style="margin-top:4px;"/><div>次</div></td>'
					+' </tr>'
					+' <tr class="even"><td class="inquire_item6">CMP线满覆盖(宽线)：</td>'
	    			+' <td class="inquire_form6"><input id="cmp_line_fold' + '_' + rowNum+'" type="text"  value="'+pre_cmp_line_fold+'" class="input_width" style="margin-top:4px;" /><div>次</div></td>'
					...
					+' <td class="inquire_form6"><input id="max_offset_distance' + '_' + rowNum+'" type="text"  value="'+pre_max_offset_distance+'" class="input_width" style="margin-top:4px;" /><div>m</div></td>'
					+' </tr>'
		...
		tr.insertCell().innerHTML = '<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height" id="layout_table_'+layoutIndex+'">'
					...
					+' <td class="inquire_item6">纵向排列方式：</td>'
					+' <td class="inquire_form6"><input id="vertical_array' + '_' + rowNum+'" type="text" value="" class="input_width" style="margin-top:4px;"/><div></div></td>'
					+' <td class="inquire_item6">单线覆盖次数(宽线)：</td>'
					+' <td class="inquire_form6"><input id="single_line_fold' + '_' + rowNum+'" type="text" value="" class="input_width" style="margin-top:4px;"/><div>次</div></td>'
					+' </tr>'
					+' <tr class="even"><td class="inquire_item6">CMP线满覆盖(宽线)：</td>'
					+' <td class="inquire_form6"><input id="cmp_line_fold' + '_' + rowNum+'" type="text" value=""  class="input_width" style="margin-top:4px;" /><div>次</div></td>'
					+' <td class="inquire_item6">测线号:</td>'
					+' <td class="inquire_form6"><input id="line_no' + '_' + rowNum+'" type="text"  value="" class="input_width" style="margin-top:4px;" /></td>'
					+' <td class="inquire_item6">最大炮检距:</td>'
					+' <td class="inquire_form6"><input id="max_offset_distance' + '_' + rowNum+'" type="text"  value=""  class="input_width" style="margin-top:4px;" /><div>m</div></td>'
					+' </tr>'
					+' <tr class="odd"><td class="inquire_item6">观测方式:</td>'
...
function toAddSP(){
	...
	if(rowNum > 1){
		...
		tr.insertCell().innerHTML = '<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height" id="sp_table_'+spIndex+'">'
					...
					+' <td class="inquire_item6">井数：</td>'
	   				+' <td class="inquire_form6"><input id="well_num' + '_' + rowNum+'" type="text" value="" onblur="onkeyupF(this)" style="margin-top:4px;" class="input_width"/><div>口</div></td>'
					+' </tr>'
					+' <tr class="odd"><td class="inquire_item6">井深：</td>'

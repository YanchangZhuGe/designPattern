...
function setLayoutData(record, lineNum){
	...
	if(record.binning != null && record.binning != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
	...
	if(record.shot_interval != null && record.shot_interval != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
			...
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.shot_interval+"&nbsp;m";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "道距：";
	...
	if(record.sp_line_interval != null && record.sp_line_interval != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
			...
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.sp_line_interval+"&nbsp;m";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "接收线距：";
	...
	if(record.max_cross_spread != null && record.max_cross_spread != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
			...
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.max_cross_spread+"&nbsp;m";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "最大非纵距：";
	...
	if(record.largest_minimum_offset != null && record.largest_minimum_offset != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
			...
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "最大最小炮检距：";
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.largest_minimum_offset+"&nbsp;m";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "最大最小炮检距：";
	...
	if(record.max_offset_distance != null && record.max_offset_distance != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
			...
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.max_offset_distance+"&nbsp;m";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "最大炮检距：";
	...
	if(record.maximum_offset != null && record.maximum_offset != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
			...
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "纵向最大炮检距：";
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.maximum_offset+"&nbsp;m";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "纵向最大炮检距：";
	...
	if(record.aspect_ratio != null && record.aspect_ratio != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
			...
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.aspect_ratio;
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "横纵比：";
	...
	if(record.group_roll_distance != null && record.group_roll_distance != ""){
		cells++;
		if(cells%3 == 1){
			tr = document.getElementById("table1").insertRow();
			rows++;
			...
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "束线横向滚动距离：";
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.group_roll_distance+"&nbsp;m";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "束线横向滚动距离：";
...
function setSPData(record, lineNum){
	...
	if(record.well_depth != null && record.well_depth != ""){
		...
		if(cells%3 == 1){
			...
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.well_depth+"&nbsp;";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "井深：";
...
function setGeophoneData(record, lineNum){
	...
	if(record.geophone_comb_num != null && record.geophone_comb_num != ""){
		...
		if(cells%3 == 1){
			...
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.geophone_comb_num+"&nbsp;";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "组合个数：";
	...
	if(record.geophone_comb_height != null && record.geophone_comb_height != ""){
		...
		if(cells%3 == 1){
			...
			td = tr.insertCell();
			td.className = "inquire_form6";
			td.innerHTML = record.geophone_comb_height+"&nbsp;m";
		} else {
			var td = tr.insertCell();
			td.className = "inquire_item6";
			td.innerHTML = "组合高差：";
...
<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height">
 ...
 <table  border="0" cellpadding="0" cellspacing="0" width="100%" id="table5">
	...
	<td colspan="6">
		<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="tab_line_height">
  			<tr style="background-color: #97cbfd">
			<td align="left" width="100%" id="td_section_instrument"></td>
  			</tr>
 		</table>
 	<td>
 	</tr>

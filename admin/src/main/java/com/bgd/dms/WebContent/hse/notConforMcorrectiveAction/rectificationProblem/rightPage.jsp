...
<table border="0"  width="100%"  cellspacing="0" cellpadding="0" class="tab_info"  id="equipmentTableInfo">
	<tr  >  
		...
		<TD  class="bt_info_even" width="18%" >单位</TD>
		<TD  class="bt_info_odd"  width="18%"><font color=black>基层单位</font></TD>
		<TD class="bt_info_even"  width="18%"><font color=black>下属单位</font></TD>
		<TD  class="bt_info_odd"   width="18%"><font color=black>检查日期</font></TD>
		<TD class="bt_info_even"  width="18%" >整改期限
...
cruConfig.contextPath='<%=contextPath %>';
 ...
 var checked = false;
 function check(){
 	var chk = document.getElementsByName("questions_no");
 ...
 if(questions_no !=null  || questions_no !="'null'"){		 
		
		var tempIds = questions_no.split(",");
		var id = "";
 ...
 function deleteLine(lineId){		
		...
		var bsflag = document.getElementsByName("bsflag_"+rowNum)[0].value;
		 document.getElementsByName("questions_no")[rowNum].checked=false;
		if(bsflag!=""){

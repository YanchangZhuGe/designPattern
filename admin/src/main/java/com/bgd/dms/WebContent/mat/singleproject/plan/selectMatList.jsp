      	...
      	<div id="list_table">
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			        <td class="bt_info_odd" exp="<input name = 'rdo_entity_id' id='rdo_entity_id' type='checkbox'  value='{wz_id}' {disabled} onclick='loadDataDetail();'/>"> <input type='checkbox' name='rdo_entity_id' value='' onclick='check()'/></td>

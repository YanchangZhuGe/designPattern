		...
		<tr align="center" >
		    <td align="center" >
		      <report:html name="report1"
			               reportFileName="/zcjwx.raq"
						   params="<%=str.toString()%>"
						width="-1" 
			height="-1"
			needScroll="no"
			needPageMark="no"	   
			saveAsName="主要总成件维修记录"
			excelPageStyle="0"
			  />
...
<script type="text/javascript">
	...
	function simpleSearch(){
		...
		//	}else{
			...
			//}
			//window.location="<%=contextPath%>/rm/dm/kkzy/zytj/zcjwx.jsp?self_num="+self_num+"&bywx_date_begin="+bywx_date_begin+"&bywx_date_end="+bywx_date_end+"&showSelfNum="+showSelfNum+"&selfSeleHtml="+selfSeleHtml+"&zcj_type="+zcj_type;
		window.location="<%=contextPath%>/rm/dm/kkzy/zytj/zcjwx.jsp?bywx_date_begin="+bywx_date_begin+"&bywx_date_end="+bywx_date_end+"&zcj_type="+zcj_type;
}

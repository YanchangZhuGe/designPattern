 ...
 <body style="background:#fff" onload="refreshData('')">
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      ...
		      <%} %>
			  	<td class="ali_cdn_name">开工验收意见</td>
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <%} %>
			       <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">开工验收意见</td>
			       <td class="bt_info_odd" exp="{written_time}" width="200">验收时间</td>	
			      <td class="bt_info_odd" exp="{auditor}">负责人</td>
			     </tr> 			        
			  </table>
			</div>
...
<script type="text/javascript">
	...
	function refreshData(str){
		...
		cruConfig.queryStr = "select t.* from (select f.ucm_id,f.file_name,t.project_info_no,t.tecnical_id,t.title,t.written_time,t.test_start_date,t.writer,t.auditor,t.memo,p.project_name "+
		...
		"where t.bsflag = '0' "+projStr+" and t.business_type = '<%=businessType%>' "+str+" order by t.modifi_date desc) t";
		queryData(1);
	}
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/doc/startAcceptanceSuggestDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'800:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/doc/startAcceptanceSuggestDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&id='+id+'&isSingle='+isSingle+'&fileAbbr='+fileAbbr,'800:680');
	}

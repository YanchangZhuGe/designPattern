    ...
    <div id="new_table_box_bg" style="width: 95%">
	  ...
	  <table width="97%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		  ...
		  <tr>
			...
			<td class="inquire_form6"><input id="MILEAGE_TOTAL" name="MILEAGE_TOTAL" class="input_width" type="text" readonly /></td>
			<td class="inquire_item6" >累计钻井进尺(米)</td>
			<td class="inquire_form6"><input name="DRILLING_FOOTAGE_TOTAL" id="DRILLING_FOOTAGE_TOTAL" class="input_width" type="text" readonly /></td>
			<td class="inquire_item6" >累计工作小时(小时)</td>
			<td class="inquire_form6"><input id="WORK_HOUR_TOTAL" name="WORK_HOUR_TOTAL" class="input_width" type="text" readonly/></td>
		  </tr>
		   <tr>

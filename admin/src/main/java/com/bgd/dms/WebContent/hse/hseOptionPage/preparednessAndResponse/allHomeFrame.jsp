...
<frameset rows="205,*"  cols="*" frameborder="yes" border="0" framespacing="1">
  ...
  <frameset cols="620,620" frameborder="yes" border="0" framespacing="1">   
    <frame  src="<%=contextPath %>/hse/hseOptionPage/preparednessAndResponse/allLeft.jsp" name="leftframe" frameborder="1" scrolling="auto" noresize="noresize" id="leftframe"/> 

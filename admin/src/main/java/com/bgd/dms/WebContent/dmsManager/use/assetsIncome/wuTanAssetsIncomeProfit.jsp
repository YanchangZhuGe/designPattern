...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function getWuTanCostRateFusionChart(){
			...
			chart1.setXMLUrl("<%=contextPath%>/dms/use/getWutanAssetsIncomeOrProfitData.srq?amountYear=<%=amountYear%>&analType=<%=analType%>&orgSubId=<%=orgSubId%>");

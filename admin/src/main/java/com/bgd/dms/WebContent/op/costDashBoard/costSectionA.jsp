										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													</span><a href="#">物探处收入情况</a><span class="gd"><a href="#"></a> </span>
												</div>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													</span><a href="#">物探处支出情况<span class="gd"><a href="#"></a> </span>
												</div>
										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">项目支出对比图<span class="gd"><a href="#"></a> </span>
												</div>
										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">物探处利润情况<span class="gd"><a href="#"></a> </span>
												</div>
										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">项目利润对比图</a><span class="gd"><a href="#"></a> </span>
												</div>
...
<script type="text/javascript">
 function getFusionChart(){
	...
	myChart1.setXMLUrl("<%=contextPath%>/cache/op/OpCostSrv/getCompanyIncomeInfo.srq?orgSubjectionId=<%=orgSubjectionId%>");      
	myChart1.render("chartContainer1");  
	
	var myChart2 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Pie3D.swf", "myChartId4", "100%", "100%", "0", "0" );    
	myChart2.setXMLUrl("<%=contextPath%>/cache/op/OpCostSrv/getIncomeCompareTwoTreePieInfo.srq?orgSubjectionId=<%=orgSubjectionId%>");   
	myChart2.render("chartContainer2"); 
	
	
	var myChart3 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/MSLine.swf", "myChartId3", "100%", "100%", "0", "0" );    
	myChart3.setXMLUrl("<%=contextPath%>/cache/op/OpCostSrv/getOutcomeCompareYearInfo.srq?orgSubjectionId=<%=orgSubjectionId%>");   
	myChart3.render("chartContainer3"); 
	
	var myChart4 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Pie3D.swf", "myChartId5", "100%", "100%", "0", "0" );    
	myChart4.setXMLUrl("<%=contextPath%>/cache/op/OpCostSrv/getOutcomeCompareTwoTreePieInfo.srq?orgSubjectionId=<%=orgSubjectionId%>");   
	...
	myChart5.setXMLUrl("<%=contextPath%>/cache/op/OpCostSrv/getCompanyProfitInfo.srq?orgSubjectionId=<%=orgSubjectionId%>");   
	myChart5.render("chartContainer5"); 
	
	var myChart6 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Pie3D.swf", "myChartId8", "100%", "100%", "0", "0" );    
	myChart6.setXMLUrl("<%=contextPath%>/cache/op/OpCostSrv/getCompareTwoTreeLirunPieInfo.srq?orgSubjectionId=<%=orgSubjectionId%>");      
	myChart6.render("chartContainer6");  
	
}
 function drillgssr(obj){
	 window.showModalDialog("<%=contextPath%>/op/costDashBoard/costCompanyZQ.jsp?d_month="+obj+"&orgId=<%=orgSubjectionId%>",obj,"dialogWidth=800px;dialogHeight=600px");
 }

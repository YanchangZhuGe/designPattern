    ...
    <div id="new_table_box_bg" style="width:95%">
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr> 
          ...
          <td class="inquire_form4" >
  				   <input name="a_project_info_no" id="a_project_info_no" class="input_width" value="" type="hidden" readonly="readonly"/>
	  		    	<input name="a_project_name" id="a_project_name" class="input_width" value="" type="text"  readonly="readonly" />   
...
var deviceCount =0;
	...
	function refreshDatas(){
		...
		if(datas1 != null){	  
		     for (var i = 0; i< queryRet1.datas.length; i++) {  
					addEmployee(datas1[i].pk_ids,datas1[i].xz_type,datas1[i].employee_id,datas1[i].employee_cd,datas1[i].employee_name,datas1[i].team_name,datas1[i].work_post_name,datas1[i].employee_gz_name,datas1[i].zy_type);
	...
	function openSearch(){
		...
		popWindow('<%=contextPath%>/rm/em/projectTransfer/selectHuman.jsp?projectInfoNo='+zcP,'880:725'); 	
	}
	...
	function submitInfo(){ 
        ...
        if(zy_id == "null"){   
    		...
    		var submitStr = 'JCDP_TABLE_NAME=BGP_COMM_HUMAN_PTRANSFER&JCDP_TABLE_ID=&transfer_name='+zy_name+'&aproject_info_no='+zcP+'&bproject_info_no='+zrP+'&back_hname='+back_employee_name+'&back_hid='+back_employee_id
			...
			if(deviceCount>0){
				...
				for(var i=0;i<checkStr.length; i++){
					...
					if(newCheck.indexOf(","+i+",") == -1){
						...
						addEmployee(pk_ids,xz_type,employee_id,employee_cd,employee_name,team_name,work_post_name,employee_gz_name,zy_type);	
					}					
				}	
	...
	function   addLines(checkStr){
		...
		//加一行人员需求
		function addEmployee(pk_ids,xz_type,employee_id,employee_cd,employee_name,team_name,work_post_name,employee_gz_name,zy_type){
			...
			tr.insertCell().innerHTML = '<input type="text" maxlength="32" id="em'+deviceCount+'employee_gz_name" name="em'+deviceCount+'employee_gz_name"  value="'+employee_gz_name+'" class="input_width" readonly="readonly"/>'+ '<input type="hidden" id="em'+deviceCount+'xz_type" name="em'+deviceCount+'xz_type"  value="'+xz_type+'"/>'+'<input type="hidden" id="em'+deviceCount+'employee_id" name="em'+deviceCount+'employee_id"  value="'+employee_id+'"/>';

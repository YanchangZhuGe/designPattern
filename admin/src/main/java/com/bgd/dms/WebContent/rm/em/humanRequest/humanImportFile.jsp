...
cruConfig.contextPath='<%=contextPath %>';
	...
	function returnFile(){
		...
		if(content != ""){
			...
			var humanList = jcdpCallService("HumanRequiredSrv","queryImportHumanList",str);		
...
<body>
<form action="<%=contextPath%>/rm/em/humanRequest/humanImportFile_t.jsp" id="fileForm" method="post" enctype="multipart/form-data" target="targetIframe">

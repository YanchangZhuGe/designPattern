...
<script type="text/javascript">
 ...
 function getFusionChart(){
	...
	myChart1.setXMLUrl("<%=contextPath%>/rm/em/getChart24.srq?projectInfoNo=<%=projectInfoNo%>&team=<%=team%>");      
 ...
 function getHumanList(team){
	 popWindow('<%=contextPath%>/rm/em/humanChart/humanChart18-3.jsp?projectInfoNo=<%=projectInfoNo%>&team='+team,'800:700');

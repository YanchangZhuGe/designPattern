...
debugger;
	...
	document.getElementById("survey_process_status").value = retObj.dailySit.surveyProcessStatus;
	document.getElementById("surface_process_status").value = retObj.dailySit.surfaceProcessStatus;
	document.getElementById("drill_process_status").value = retObj.dailySit.drillProcessStatus;
	document.getElementById("collect_process_status").value = retObj.dailySit.collectProcessStatus;
	...
	var auditStatus=retObj.build.auditStatus;

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function popNextLevelLie(level,devTreeId,orgSubId,country){
			popWindow('<%=contextPath%>/dmsManager/use/deviceLie/thirdLevelLie.jsp?level='+level+'&devTreeId='+devTreeId+'&orgSubId='+orgSubId+'&country='+country+'','800:572');
		}
		//弹出设备信息
		function popDevList(devTreeId,orgSubId,country){
			popWindow('<%=contextPath%>/dmsManager/use/deviceLie/devList.jsp?devTreeId='+devTreeId+'&orgSubId='+orgSubId+'&country='+country+'','800:572','设备闲置情况');
		}
	</script>
</html>

      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
          ...
          <td class="inquire_form4">
          	...
          	<input type="hidden" name="mixownership" value="S0000"/>
          </td>
        </tr>
      </table>
      </fieldset>
      <fieldset style="margin:2px;margin-top:4px;padding:2px;"><legend>调剂申请基本信息</legend>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr>
...
<script type="text/javascript">
	function saveInfo(){
		//调配计划修改
		document.getElementById("form1").action = "<%=contextPath%>/rm/dm/toSaveDisAppBaseInfo.srq?state=0";
	...
	function refreshData(){
		...
		if('<%=deviceappid%>'!=null){
			...
			var querySql = "select pro.project_name,devapp.device_allapp_id,devapp.device_app_id,devapp.device_app_no,devapp.device_app_name,devapp.project_info_no,allapp.appdate as allappdate,";
				...
				querySql += "from gms_device_disapp devapp ";

...
function getCheckedNode(scope) {   
    ...
    for (var i = 0; i < nodes.length; i++) {
        ...
        if(nodes[i].isLeaf()){
        	...
        	index[i] = nodes[i].id.substr(0,14) + "," + nodes[i].text;
        }else{
...
<table border="0" cellpadding="0" cellspacing="0"  id="FilterLayer" width="100%">
	<tr>
		<td align="left" style="padding-left:100px;padding-top:5px;padding-bottom:5px;">

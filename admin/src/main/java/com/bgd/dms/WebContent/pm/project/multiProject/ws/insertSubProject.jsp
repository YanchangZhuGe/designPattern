					...
					<div id="tab_box_content0" class="tab_box_content">
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td class="inquire_form4" id="item0_0"><input type="hidden"
									id="project_father_no" name="project_father_no"
									value="<%=projectFatherNo%>" class="input_width" /> <input
									type="text" id="project_name" name="project_name" value=""
							...
							<tr>
								...
								<td class="inquire_form4" id="item0_3"><select
									name="project_status" id="project_status" class="select_width">
							...
							<tr>
								...
								<td class="inquire_form4" id="item0_4"><input
									id="market_classify" name="market_classify" value=""
							...
							<tr>
								...
								<td class="inquire_form4" id="item0_6"><input type="text"
									id="acquire_start_time" name="acquire_start_time" value=""
									...
									onmouseover="calDateSelector(acquire_start_time,tributton1);" />
								</td>
								<td class="inquire_item4"><span class="red_star">*</span>计划采集结束时间：</td>
								<td class="inquire_form4" id="item0_7"><input type="text"
									id="acquire_end_time" name="acquire_end_time" value=""
									class="input_width" readonly="readonly" /> &nbsp;&nbsp;<img
									src="<%=contextPath%>/images/calendar.gif" id="tributton2"
									width="16" height="16" style="cursor: hand;"
									onmouseover="calDateSelector(acquire_end_time,tributton2);" />
								</td>
							</tr>
							<tr>
								<td class="inquire_item4"><span class="red_star">*</span>合同开始时间：</td>
								<td class="inquire_form4" id="item0_9"><input type="text"
									id="design_start_date" name="design_start_date" value=""
									class="input_width" readonly="readonly" /> &nbsp;&nbsp;<img
									src="<%=contextPath%>/images/calendar.gif" id="tributton3"
									width="16" height="16" style="cursor: hand;"
									onmouseover="calDateSelector(design_start_date,tributton3);" />
								</td>
								<td class="inquire_item4"><span class="red_star">*</span>合同结束时间：</td>
								<td class="inquire_form4" id="item0_10"><input type="text"
									id="design_end_date" name="design_end_date" value=""
									class="input_width" readonly="readonly" /> &nbsp;&nbsp;<img
									src="<%=contextPath%>/images/calendar.gif" id="tributton4"
									width="16" height="16" style="cursor: hand;"
									onmouseover="calDateSelector(design_end_date,tributton4);" />
								</td>
							</tr>
							<tr>
								<td class="inquire_item4"><span class="red_star">*</span>合同金额：</td>
								<td class="inquire_form4" id="item0_9"><input type="text"
									id="contract_amount" name="contract_amount" value=""
									class="input_width" />万元</td>
								<td class="inquire_item4">&nbsp;</td>
								<td class="inquire_form4" id="item0_10">&nbsp;</td>
							</tr>
							<tr>
								<td class="inquire_item4"><span class="red_star">*</span>项目重要程度：</td>
								<td class="inquire_form4" id="item0_8"><code:codeSelect
										cssClass="select_width" name='is_main_project'
										option="isMainProject" selectedValue="" addAll="true" /></td>
								<td class="inquire_item4"><span class="red_star">*</span>勘探方法：</td>
								<td class="inquire_form4" id="item0_11"><select
									class=select_width name=exploration_method
							...
							<tr>
								...
								<td class="inquire_form4" id="item0_14"><select
									class=select_width name=explore_type>
							...
							<tr>
								...
								<img src="<%=contextPath%>/images/magnifier.gif" style="cursor: hand;" border="0" onclick="selectPrctr()" /></td>
							...
							<tr>
								...
								<td colspan="3">
									...
									<input type="checkbox" name="view_type_name" value="5110000053000000010">井地联合勘探&nbsp;&nbsp;</input>
								</td>
							</tr>
							<tr>
								<td class="inquire_item4"><span class="red_star">*</span>常规项目：</td>
								<td>
								    <input type="radio" disabled="disabled" />常规项目&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio"  disabled="disabled" checked="checked"/>非常规项目
								    <input type="hidden" name = "project_common" id="project_common" value="0" />
								</td>
								<td class="inquire_item6"><span class="red_star">*</span>协作队伍：</td>
								<td class="inquire_form6" id="item0_19">
									<input id="other_org_id" name="other_org_id" value="" type="hidden" class="input_width" />
									<input id="other_org_name" name="other_org_name" value="" type="text" class="input_width" />
							...
							<tr>
								...
								<td class="inquire_form4"><input type="text"
									id="project_cost" name="project_cost" value=""
									class="input_width" /></td>
							...
							<tr>
								...
								<td class="inquire_form4"><input type="text" id="unit_one"
									name="unit_one" value="" class="input_width" /></td>
								<td class="inquire_item4">二级构造单元：</td>
								<td class="inquire_form4"><input type="text" id="unit_two"
									name="unit_two" value="" class="input_width" /></td>
							</tr>
							<tr>
								<td class="inquire_item4">项目来源：</td>
								<td class="inquire_form4"><select class=select_width
									name="project_source" id="project_source">
							...
							<tr>
								...
								<td class="inquire_form4"><input type="text"
									id="instrument_num" name="instrument_num" value=""
									class="input_width" /></td>
								<td class="inquire_item4">井下仪器间距：</td>
								<td class="inquire_form4">
								<input type="text"
									id="instrument_space" name="instrument_space" value=""
									class="input_width" />
								<input type="hidden"
									id="docopy" name="docopy" value="true"
									class="input_width" />
								</td>
							</tr>
						</table>
...
function selectPrctr(){
	...
	function save() {
		...
		var retObj = jcdpCallService("WsProjectSrv", "addSubProject",params);
		if(""==projectFatherNo){
			parent.list.frames[1].location.reload();
			newClose();
		}else{
			var projFName=encodeURI(encodeURI(projectFatherName));
			window.location ='<%=contextPath%>/pm/project/multiProject/ws/wssubProjectList.jsp?projectFatherName='+projFName+'&projectFatherNo=<%=projectFatherNo%>&orgSubjectionId=<%=orgSubjectionId%>&projectType='+projectType;
		}
	...
	function checkForm(){ 	
		...
		{		
			document.form1.contract_amount.focus();
			return false;	
		}

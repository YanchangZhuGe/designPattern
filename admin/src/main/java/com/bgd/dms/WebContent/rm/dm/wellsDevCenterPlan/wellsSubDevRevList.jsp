...
<script type="text/javascript" src="<%=contextPath%>/js/dialog_open1.js"></script>
  ...
  <title>多项目-井中设备分中心-设备接收-接收子页面</title> 
 </head> 
			...
			<div id="table_box">
			  <table style="width:98.5%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr id='device_mix_detid_{device_mix_detid}' name='device_mix_detid'>
			     	<td class="bt_info_odd" exp="<input type='checkbox' name='rdo_entity_id' value='{device_mix_detid}' id='rdo_entity_id_{device_mix_detid}' />" >选择</td>
...
<script type="text/javascript">
    ...
    function loadDataDetail(shuaId){
	    ...
	    */ 
		...
		document.getElementById("dev_dev_unit").value =retObj.devicerecMap.dev_unit;
...
// 				td.innerHTML = '<input type="checkbox" name="task_id" value="'+datas[i].id+'">';
    ...
    function deleteTableTr(tableID){
	 ...
	 function toAdd(){ 
	 	...
	 	editUrl2 = "<%=contextPath%>/rm/dm/wellsDevCenterPlan/wellsDevRevSubmit.jsp?id={id}&mixId="+mixId+"&mixTypeId="+mixTypeId;
	 ...
	 function toModify(){
	 	...
	 	editUrl2 = "<%=contextPath%>/rm/dm/wellsDevCenterPlan/wellsDevRevSubmit.jsp?id={id}&mixId="+mixId;
	 	editUrl2 = editUrl2.replace('{id}',selId); 
	 	popWindow(editUrl2,'900:680'); 
	 }
</script>

...
<%
	...
	String dtbywx_id=request.getParameter("dtbywx_id");
	if(dtbywx_id==null){
	dtbywx_id="";
	}
%>
...
<div id="new_table_box">
  <div id="new_table_box_content">
    ...
    <fieldset><legend>维保信息&nbsp;&nbsp;  </legend> 
      <table id="table1" width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
         <tr>
				<td class="inquire_item6"><font color=red>*</font>&nbsp;维保人员</td>
				<td class="inquire_form6">
					<input id="dev_acc_id" name="dev_acc_id" class="easyui-textbox" value="<%=dev_acc_id%>" type="hidden" />		
					<input id="dev_acc_id" name="dtbywx_id" class="easyui-textbox" value="<%=dtbywx_id%>" type="hidden" />					 			 
					<input id="bywx_person" name="bywx_person"  class="input_width" type="text" />
				</td>
				<td class="inquire_item6"><font color=red>*</font>&nbsp;维保日期</td>
				<td class="inquire_form6">
				  <input type="text" name="bywx_date" id="bywx_date"  class="input_width easyui-datebox" style="width:130px" editable="false" required/>
				</td>
				<td class="inquire_item6"><font color=red>*</font>&nbsp;维保公司</td>
				<td class="inquire_form6"><input id="bywx_company" name="bywx_company" class="input_width" type="text"  /></td>
			  </tr>
				<tr>
				 
				<td class="inquire_item6"><font color=red>*</font>&nbsp;是否发现问题</td>
				<td class="inquire_form6"><select id="bywx_result" name="bywx_result">
									<option value="否">否</option>
									<option value="是">是</option>
				</select></td>
				<td class="inquire_item6">发现问题</td>
				<td class="inquire_form6"><input id="bywx_question" name="bywx_question" class="input_width" type="text" /></td>				
			 
				 
				   
			<td class="inquire_item6">&nbsp;维保附件：</td>
...
<script type="text/javascript"> 
	...
	function pageInit(){
		var dtbywx_id='<%=dtbywx_id%>';
	 
		if(dtbywx_id!=''){
		var querySql="select * from GMS_DEVICE_DTBYWX where dtbywx_id='"+dtbywx_id+"'";
		var queryRet = syncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'querySql='+querySql);
		datas = queryRet.datas;
		document.getElementById("bywx_person").value=datas[0].bywx_person;
		document.getElementById("bywx_company").value=datas[0].bywx_company;
		document.getElementById("bywx_result").value=datas[0].bywx_result;
		document.getElementById("bywx_question").value=datas[0].bywx_question;
 		$("#bywx_date").datebox('setValue',datas[0].bywx_date);
	...
	function submitInfo(){
		...
		var querySql;
			...
			document.getElementById("form1").action = "<%=contextPath%>/rm/dm/toSubmitdtbywx.srq";

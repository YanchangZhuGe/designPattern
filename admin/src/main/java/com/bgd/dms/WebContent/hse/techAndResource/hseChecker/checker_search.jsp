...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		if(assessor_type!=''&&assessor_type!=null){
			sql = sql+" and assessor_type like '%"+assessor_type+"%'";
		}
		if(days!=''&&days!=null){
		if(!re.test(days)){

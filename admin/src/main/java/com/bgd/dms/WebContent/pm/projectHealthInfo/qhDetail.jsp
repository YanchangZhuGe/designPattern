...
<script language="javaScript">
	...
	function getTab3(index) {  
		...
		if(index!=null && index =='0'){//选择的是生产选项卡
			var querySql = "select t.build_method from gp_task_project t where t.bsflag ='0' and t.project_info_no ='<%=project_info_no%>'";
			...
			if(retObj!=null && retObj.returnCode =='0' && retObj.datas[0]!=null){
				var buildMethod = retObj.datas[0].build_method == null?"5000100003000000007":retObj.datas[0].build_method;
				//在激发方式仅仅只有气枪，或震源的情况下，不显示“钻井”字段。
				if(buildMethod == "5000100003000000001" || buildMethod == "5000100003000000004" || buildMethod == "5000100003000000005" || buildMethod == "5000100003000000007"){
					document.getElementById("jz_type").style.display = 'block';
					document.getElementById("type1").rowSpan = '4';
					document.getElementById("type2").rowSpan = '3';
					document.getElementById("type3").rowSpan = '3';
				}else{
					document.getElementById("jz_type").style.display = 'none';
					document.getElementById("type1").rowSpan = '3';
					document.getElementById("type2").rowSpan = '2';
					document.getElementById("type3").rowSpan = '2';
				}
			}
		}
	}
				...
				<div id="tab_box" class="tab_box">
					<div id="tab_box_content0" class="tab_box_content">
						<table id="mytable" width="100%" >
							...
							<tr>
								<td rowspan="4" id="type1"><p align="center">进度</p>
								</td>
								<td rowspan="3" id="type2"><p align="center">计划偏离度</p>
								</td>
								<td><p align="center">测量</p></td>
								<td rowspan="3" id="type3"><p align="center"><%=map.get("content1") == null ? "" : map.get("content1")%>&nbsp;</p></td>
								<td id="str1">
							...
							-->
							<tr>
								<td colspan="2" style="border-top: solid 1px;"><p align="center">里程碑时间节点</p>
								</td>

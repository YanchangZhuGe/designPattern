...
<form name="form1" id="form1" method="post" action="<%=contextPath%>/market/startProjectDynamic.srq?orgId=<%=orgId %>">
<table  border="0" cellpadding="0" cellspacing="0" class="form_info" id="queryCdtTable" enctype="multipart/form-data">
<tr class="even">
		<td class="rtCRUFdName" >记录年度：</td>
		<td class="rtCRUFdValue" style="background: #f9f9f9;">
  ...
  <tr class="ali4">
    <td colspan="4" style="background: #f9f9f9;"><input style="margin-right: 15px;" type="submit" onclick="classicQuery()" name="search" value="查询"  class="iButton2"/>  </td>
  </tr>  
</table>
</form>
</div>

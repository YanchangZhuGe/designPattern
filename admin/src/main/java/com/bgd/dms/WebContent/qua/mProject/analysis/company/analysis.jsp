...
<div id="list_content">
								...
								<tr>
									<td width="49%">
										<div class="tongyong_box" >
											...
											<div class="tongyong_box_content_left" style="height: 185px;width: 100%">
												<div>
	...
	function company_1(){
		...
		" where t.bsflag='0' and t.audit_status ='3' and t.org_subjection_id like 'C105%'" ; //and p.project_status='3'  正在施工
	...
	function company(){
		...
		if(retObj!=null && retObj.returnCode=='0'){
			...
			for(var i=0;i<retObj.datas.length && retObj.datas[i]!=null;i++){
				...
				debugger;
				var tr_2 = company_2.insertRow(k);
				...
				var tr_3 = company_3.insertRow(k);
			...
			changeTable("company_2",0);
			changeTable("company_3",0);
		}
		var org_subjection_id = '<%=org_subjection_id%>';
	...
	function getDetail(company ,org_subjection_id){
		if(company!=null && company =='company_1'){
			popWindow(cruConfig.contextPath + "/qua/mProject/analysis/company/qualified.jsp?org_subjection_id="+org_subjection_id);
		}else if(company!=null && company =='company_2'){
			popWindow(cruConfig.contextPath + "/qua/mProject/audit/audit.jsp?org_subjection_id="+org_subjection_id,null,'内审计划');
		}else if(company!=null && company =='company_3'){
			popWindow(cruConfig.contextPath + "/qua/mProject/accident/accident.jsp?org_subjection_id="+org_subjection_id,'1024:720','质量事故上报');
		}
	}
	function orgDetail(name){
		if(name!=null && name=='1'){
			popWindow(cruConfig.contextPath + "/qua/mProject/analysis/company/qualified_org.jsp",'800:600');
		}else if(name!=null && name=='2'){
			popWindow(cruConfig.contextPath + "/qua/mProject/analysis/company/first_org.jsp",'800:600');
		}
	}
	</script>
    </body>

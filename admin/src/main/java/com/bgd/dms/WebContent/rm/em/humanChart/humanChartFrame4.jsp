				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box_title"><span class="kb"><a
							...
							href="#"></a></span></div>
						<div class="tongyong_box_content_left" id="chartContainer3" style="height: 450px;">
...
<script type="text/javascript">
 ...
 function getFusionChart(){
	...
	var myChart1 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/StackedColumn3DLineDY.swf", "myChartId1", "100%", "100%", "0", "0" );    
	myChart1.setXMLUrl("<%=contextPath%>/rm/em/getChart9.srq?orgId=<%=orgId%>");      
	myChart1.render("chartContainer1");  
	
	var myChart3 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/StackedColumn3DLineDY.swf", "myChartId3", "100%", "100%", "0", "0" );    
	myChart3.setXMLUrl("<%=contextPath%>/rm/em/getChart10.srq");      
 ...
 function changeOrg(){
     ...
     chartReference.setXMLUrl("<%=contextPath%>/rm/em/getChart9.srq?orgId="+s_org_id);
 }

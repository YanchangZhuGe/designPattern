...
<script type="text/javascript"><!--
	...
	//打开新增界面
	 function toAdd(){   
		...
		var obj=$("#queryRetTable :checked")[0];
		
		var columnsObj = obj.parentNode.parentNode.cells;
		
	 	popWindow("<%=contextPath%>/rm/dm/device-xd/kq.jsp?ids="+ids); 
	...
	for(var i=0;i<vall.length;i++){
    	...
    	var querySql="select to_char(a.timesheet_date,'yyyy') as Year,to_char(a.timesheet_date,'mm') as month,to_char(a.timesheet_date,'dd') as day,a.* from BGP_COMM_DEVICE_TIMESHEET a where a.device_account_id='"+dev_appdet_id+"' and to_char(a.timesheet_date,'yyyy')='"+ye+"' and to_char(a.timesheet_date,'mm')='"+me+"'";

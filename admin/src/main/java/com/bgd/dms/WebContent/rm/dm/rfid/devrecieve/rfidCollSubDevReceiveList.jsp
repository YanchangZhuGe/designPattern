...
<script type="text/javascript" src="<%=contextPath%>/js/gms_list.js"></script>
  ...
  <title>单项目-设备接收-设备接收(采集站)-接收页面</title> 
 </head> 
...
<script type="text/javascript">
	...
	function toAdd(){ 
		...
		popWindow('<%=contextPath%>/rm/dm/rfid/devrecieve/rfidCollDevRecieveSubmit.jsp?id='+ids+'&outInfoId=<%=outInfoId%>&receiveType='+'<%=receiveType%>'); 
	 } 
	 function toBack(){
	 	window.location.href='<%=contextPath%>/rm/dm/rfid/devrecieve/rfidCollDevReceiveList.jsp';
	 }
</script>
</html>
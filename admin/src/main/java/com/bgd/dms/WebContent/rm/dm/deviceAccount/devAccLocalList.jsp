			...
			<div id="table_box">
			  <table style="width:98.5%" border="0" cellspacing="0" class="tab_info" id="queryRetTable">
			     <tr >
					...
					<td class="bt_info_odd" exp="{cont_num}">合同编号</td>
			     </tr> 
			  </table>
			</div>
...
<script type="text/javascript">
	...
	function refreshData(arrObj,content,dateobj){
		...
		str += " where t.bsflag='0' and t.spare4 = '1' and t.owning_sub_id like '"+userid+"%' ";
	...
	//打开查询条件页面
    function newSearch(){
    	popWindow('<%=contextPath%>/rm/dm/deviceAccount/devquery_local.jsp');
    }
	function newClose(){
		window.close();
	}

...
function save(){
	...
	form.action = "<%=contextPath%>/td/wt/toSaveStartAcceptanceDoc.srq?businessType=<%=businessType%>&isSingle="+isSingle;
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if(""==document.getElementById("pk_0110000061000000052").value){
		if (!isTextPropertyNotNull("0110000061000000052", "开工验收报告")) return false;	
	}
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>开工验收报告：</td>
									<td colspan="2">

...
function getSubNodes(parentNode) {
	...
	if("C105"==parentNode.id){
		querySql= "select wtc.org_id||'_'|| wtc.org_subjection_id id,wtc.org_abbreviation name from dms_comm_org_wtc wtc where wtc.bsflag='0' order by wtc.order_num desc";
	}else{

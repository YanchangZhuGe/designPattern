...
var scrape_apply_id='<%=scrape_apply_id%>';
	function pass(){
			...
			if(result=="END_NODE"){
				baseData = jcdpCallService("ScrapeSrv", "updateScrapeApplyInfo", "scrapeApplyId="+scrape_apply_id);
			}
			form.submit();	 
			window.close();
...
<div id="tab_box_content1" class="tab_box_content" style="display:none;height: 730px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/scrape/scrapeApplyListForProc.jsp<%=linkParaStr%>'> </iframe>
</div>

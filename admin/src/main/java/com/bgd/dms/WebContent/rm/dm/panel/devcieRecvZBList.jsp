				...
				<div data-options="region:'center',border:false,split:false" > 
					<table id="dev_grid">
						<thead>
							...
							<%if("C105".equals(subOrgId)||"C105006".equals(subOrgId)){ %>
								<th data-options="field:'sub_org_name',align:'center',sortable:'true'" width="30">项目所属单位</th>
							<%}else{ %>
								<th data-options="field:'dui_org_name',align:'center',sortable:'true'" width="30">项目所属单位</th>
							<%} %>
...
$(function(){
	...
	$("#dev_grid").datagrid({ 
		...
		url:"${pageContext.request.contextPath}/rm/dm/getListDataBySrvAndMethod.srq?JCDP_SRV_NAME=DevCommRemind&JCDP_OP_NAME=queryZBNotRecvProInfo"
	});
});
</script>
</html>
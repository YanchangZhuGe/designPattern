...
<script type="text/javascript"> 
	...
	function edit(basedatas){
		...
		for(var i=0;i<basedatas.length;i++){
			...
			newTr.insertCell().innerHTML="<font color=red>*</font>&nbsp;<input type=text id=asign_num"+rownum+" name=asign_num"+rownum+" out_num="+basedatas[i].out_num+" value='"+basedatas[i].material_amout+"' onkeyup='AutoCal(this,"+rownum+")'>";//消耗数量

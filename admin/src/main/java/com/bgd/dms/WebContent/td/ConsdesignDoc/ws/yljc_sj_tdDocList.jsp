 ...
 <body style="background:#fff" onload="refreshData('');">
      	<div id="list_table">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4">压裂监测施工设计报告：</td>
									<td colspan="2">
...
<script type="text/javascript">
	...
	var businessType="5110000004100001040";//5110000004100000170
...
<%--   	   		processNecessaryInfo={         
	    		...
	    		businessId: ids.split("-")[0],         //业务主表主键值
	     		businessInfo:"压力检测施工设计文档审核",        //用于待审批界面展示业务信息
	     ...
	     document.getElementById("down_0110000061110000010").innerHTML="";// 1 
	     document.getElementById("down_0110000061110000011").innerHTML="";// 2 
	     document.getElementById("down_0110000061110000008").innerHTML="";// 3 
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/ConsdesignDoc/ws/ys_add_tdDocModify.jsp?docType=0110000061110000002&businessType='+businessType+'&fileAbbr='+fileAbbr+'&parent_file_id=<%=parent_file_id%>','750:680');
    }
...
/* 		if(ids.split("-")[1] == '1' || ids.split("-")[1] == '3'){
		...
		popWindow('<%=contextPath%>/td/ConsdesignDoc/ws/ys_add_tdDocModify.jsp?id='+ids.split("-")[0]+'&parent_file_id=<%=parent_file_id%>','750:680');
	}

...
<body style="background:#fff"  onload="refreshData()">
      	<div id="list_table">
			...
			<div id="table_box" style="overflow: auto;">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="{invoices_id}">退货单号</td>
			      <td class="bt_info_odd" exp="{total_money}">合计金额</td>
			      <td class="bt_info_even" exp="{storeroom}">供货商</td>
			      <td class="bt_info_even" exp="{out_date}">制表日期</td>
			...
			<div id="tag-container_3">
			  <ul id="tags" class="tags">
			    ...
			    <li id="tag3_1"><a href="#" onclick="getTab3(1)">退货明细</a></li>
			...
			<div id="tab_box" class="tab_box">
				<div id="tab_box_content0" class="tab_box_content">
				    ...
				    <tr>
				      ...
				      <td   class="inquire_form6" ><input id="out_info_id" class="input_width_no_color" type="text" value=""/> &nbsp;</td>
				      ...
				      <td   class="inquire_form6"  ><input id="storeroom" class="input_width_no_color" type="text"  value=""/> &nbsp;</td>
				     </tr>
				     <tr >
...
<script type="text/javascript">
	...
	function refreshData(){
		...
		var sql ="select * from gms_mat_out_info t where t.project_info_no='<%=projectInfoNo%>' and t.bsflag='0' and t.out_type='1' order by t.out_date desc,create_date desc";
		cruConfig.cdtType = 'form';
		cruConfig.queryStr = sql;
		cruConfig.currentPageUrl = "/mat/singleproject/warehouse/out/retpur/purItemList.jsp";
		queryData(1);
	...
	function loadDataDetail(shuaId){
		var retObj;
		if(shuaId!= undefined){
			 retObj = jcdpCallService("MatItemSrv", "getRetPur", "laborId="+shuaId);
		    ...
		    if(ids==''){ 
		     ...
		     retObj = jcdpCallService("MatItemSrv", "getRetPur", "laborId="+ids);
		}
		document.getElementById("procure_no").value = retObj.matInfo.procure_no;
		document.getElementById("out_info_id").value=retObj.matInfo.out_info_id;
		document.getElementById("out_date").value=retObj.matInfo.out_date;
		document.getElementById("storeroom").value=retObj.matInfo.storeroom;
	...
	function toOut(){
		popWindow("<%=contextPath%>/mat/singleproject/matLedger/outChange.jsp","680:800");
	}

	  function toAdd(){ 
		 
			  popWindow("<%=contextPath%>/mat/singleproject/warehouseDg/out/retpur/purOut.jsp","1000:680");
       ...
       function simpleSearch(){
    	   var sql ='';
			...
			sql+="select * from (select * from gms_mat_out_info t where t.project_info_no='<%=projectInfoNo%>' and t.bsflag='0' and t.out_type='1' order by t.out_date desc,create_date desc) ttt where ttt.invoices_id like'%"+wz_name+"%'"
			cruConfig.cdtType = 'form';
			cruConfig.queryStr = sql;
     ...
     //验收明细信息
  	 function taskShow(value){
  			...
  			var retObj = jcdpCallService("MatItemSrv", "findRetPur", "ids="+value);
      ...
      function toEdit(){
    	  ...
    	  popWindow("<%=contextPath%>/mat/singleproject/warehouse/out/retpur/purOutEdit.srq?laborId="+ids,"1000:680");
          }

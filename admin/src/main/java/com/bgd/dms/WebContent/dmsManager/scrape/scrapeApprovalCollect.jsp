...
var scrape_collect_id='<%=scrape_collect_id%>';
	function pass(){
			var form = document.getElementById("CheckForm");
			...
			//最后一级审批通过执行
			var result="";
			if(document.getElementById("nextNodeType")!=null)
			result = document.getElementById("nextNodeType").value;
			if(result=="END_NODE"){
					baseData = jcdpCallService("ScrapeSrv", "updateScrapeCollectInfo", "scrape_collect_id="+scrape_collect_id);
			}
				form.submit();	 
				window.close();
...
<div>
	  <ul id="tags" class="tags">
	    ...
	    <li id="tag3_1"><a href="#" onclick="getTab3(1)">报废及说明</a></li>
	    <!-- <li id="tag3_1"><a href="#" onclick="getTab3(1)">固定资产报废设备</a></li>
	    <li id="tag3_2"><a href="#" onclick="getTab3(2)">盘亏毁损报废设备</a></li>
	     <li id="tag3_3"><a href="#" onclick="getTab3(3)">其他说明</a></li> -->
	    <li id="tag3_4"><a href="#" onclick="getTab3(4)">流程轨迹</a></li>
	  </ul>
</div>

<div id="tab_box_content0" class="tab_box_content" style="height: 260px">
...
<div id="tab_box_content1" class="tab_box_content" style="display:none;height: 730px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/scrape/scrapeCollectAddForProc.jsp<%=linkParaStr%>'> </iframe>
</div>
<%-- <div id="tab_box_content1" class="tab_box_content" style="display:none;height: 530px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/scrape/scrapeApplyListForAssetProc.jsp<%=linkParaStr%>'> </iframe>
</div>
<div id="tab_box_content2" class="tab_box_content" style="display:none;height: 530px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/scrape/scrapeApplyListForDamageProc.jsp<%=linkParaStr%>'> </iframe>
</div>
<div id="tab_box_content3" class="tab_box_content" style="display:none;height: 530px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/scrape/scrapeApplyListForBakProc.jsp<%=linkParaStr%>'> </iframe>
</div> --%>
<div id="tab_box_content4" class="tab_box_content" style="display:none;height: 800px" >

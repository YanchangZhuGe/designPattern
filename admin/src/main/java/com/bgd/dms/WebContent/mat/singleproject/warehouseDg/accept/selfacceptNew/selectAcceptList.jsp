...
<%
  ...
  String wz_from = request.getParameter("wz_from");
%>
...
<script type="text/javascript">
  ...
  var retObj;
  retObj = jcdpCallService("MatItemSrv", "getSelectAcceptListDg", "teamOutId="+teamOutId+"&s_coding_code="+s_coding_code+"&s_wz_name="+s_wz_name+"&selectWzId="+selectWzId+"&wz_from="+wz_from);
	...
	if(datas==null||datas==""){
		...
		for (var i = 0; i<datas.length; i++) {		
			toAddLine(
					...
					datas[i].planFlatId ? datas[i].planFlatId : ""		
				);
		}		
	}
  }
  ...
  function toAddLine(wz_ids,wz_names,wz_prickies,demand_nums,mat_nums,wz_prices,num,coding_code_ids,plan_flat_ids){
		var wz_id = "";
		var wz_name = "";
		var wz_prickie = "";
		var demand_num = "";
		...
		if(plan_flat_ids != null && plan_flat_ids != ""){
			plan_flat_id = plan_flat_ids;
		}
		...
		if(wz_from!=null&&(wz_from=="C6000000000039"||wz_from=="C6000000000040"||wz_from=="C6000000005275"||wz_from=="C6000000005277"||wz_from=="C6000000005278"||wz_from=="C6000000005279"||wz_from=="C6000000005280")){
			td.innerHTML = "<input type='checkbox' name='rdo_entity_name' value='" + plan_flat_id + "'/>";
		}else{

...
<script type="text/javascript">
	...
	function toOut(){
		popWindow("<%=contextPath%>/mat/singleproject/matLedger/outChange.jsp","1024:800");
	}

	  function toAdd(){ 
		 
			  popWindow("<%=contextPath%>/mat/singleproject/warehouseDg/out/rettrac/matRepOut.jsp","1024:800");

...
<script type="text/javascript">
	...
	function dbclickRow(shuaId){
		var retObj;
		if(shuaId!=null){
			popWindow("<%=contextPath%>/hse/objAndTarget/hseAssess/addAssess33.jsp?hse_assess_id="+shuaId);
		}else{
			var ids = getSelIds('rdo_entity_id');
		    if(ids==''){ 
			    alert("请先选中一条记录!");
			...
			popWindow("<%=contextPath%>/hse/objAndTarget/hseAssess/addAssess33.jsp?hse_assess_id="+ids);
		}
	}

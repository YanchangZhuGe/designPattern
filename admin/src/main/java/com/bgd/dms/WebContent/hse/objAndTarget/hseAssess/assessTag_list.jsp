...
<script type="text/javascript">
	...
	function getTab3(index) {  
		...
		if(index==0){
			parent.assessframe.location.href = "<%=contextPath%>/hse/objAndTarget/hseAssess/assess11_list.jsp?project=<%=project %>";
		}else if(index==1){
			parent.assessframe.location.href = "<%=contextPath%>/hse/objAndTarget/hseAssess/assess22_list.jsp?project=<%=project %>";
		}else if(index==2){
			parent.assessframe.location.href = "<%=contextPath%>/hse/objAndTarget/hseAssess/assess33_list.jsp?project=<%=project %>";
		}
	}

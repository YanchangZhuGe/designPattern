...
<table  border="0" cellpadding="0" cellspacing="0" class="form_info" width="100%" style="margin-top:0px;">
  <tr class="odd">
    <td colspan="4" class="ali3">
        <% if("true".equals(request.getParameter("isSecond"))){%>
        	<input name="Submit2" type="button" class="iButton2" onClick="<%="view".equals(request.getParameter("action"))?"cancelNext()":"doSave();cancelNext();" %>" value="下一步"/>
        <%}else{ %>

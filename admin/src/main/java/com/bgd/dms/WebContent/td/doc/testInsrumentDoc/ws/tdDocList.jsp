			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <td class="bt_info_odd" exp="{title}">仪器名称</td>
			      <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">测试报告</td>
			      <td class="bt_info_even" exp="{written_time}">测试日期</td>
			      <td class="bt_info_odd" exp="{test_address}">测试地点</td>
			      <td class="bt_info_even" exp="{writer}">测试人</td>
			     </tr> 			        
			  </table>
			</div>
...
<script type="text/javascript">
	...
	function refreshData(str){
		cruConfig.queryStr = "select t.* from (select f.ucm_id,f.file_name,t.project_info_no,t.tecnical_id,t.title,written_time,t.writer,t.test_address "+
		"from gp_ws_tecnical_basic t "+
		"left join bgp_doc_gms_file f on t.tecnical_id = f.relation_id and f.doc_file_type = '0110000061000000043' and f.bsflag = '0' "+
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/doc/testInsrumentDoc/ws/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr,'800:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/doc/testInsrumentDoc/ws/add_tdDocModify.jsp?businessType='+businessType+'&id='+ids,'800:680');
	}

...
<div id="list_content" style="overflow: auto">
					...
					<tr>
						<td width="99%">
							<div class="tongyong_box">
								...
								href="#"></a></span><a href="#" id="_titleinfo">单机材料消耗钻取信息</a>
								<span class="gd"><a href="#"></a></span>
								<span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('sbdjclxhzqxx2')" title="导出excel"></a>
								</span>
								</div>
								<div class="tongyong_box_content_left" id="chartContainer2" style="height: 300px; ">
...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj2 = jcdpCallService("DevCommInfoSrv","getCostDrillForDetailTable","projectInfoNo=<%=projectInfoNo%>&repair_info=<%=repair_info%>");
	...
	function exportDataDoc(exportFlag){
		...
		var submitStr = "projectInfoNo=<%=projectInfoNo%>&repair_info=<%=repair_info%>&exportFlag="+exportFlag;

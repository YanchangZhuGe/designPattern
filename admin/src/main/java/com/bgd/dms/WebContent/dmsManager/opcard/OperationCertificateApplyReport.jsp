...
<div>
	  <ul id="tags" class="tags">
	    ...
	    <li id="tag3_1"><a href="#" onclick="getTab3(1)">申请操作证信息</a></li>
...
<div id="tab_box_content1" class="tab_box_content" style="display:none;height: 730px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/dmsManager/opcard/OperationCertificateApplyGZL.jsp?apply_id=<%=apply_id%>'> </iframe>
</div>

...
<table border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
    	<td colspan="6" align="center">Excel文档导入</td>
    </tr>
	 <tr>
     	<td class="inquire_item6">Excel：</td>
      	<td class="inquire_form6" colspan="4"><input type="file" name="doc_excel" class="input_width"/></td>
...
var message = "<%=message%>";
	...
	function save(){	
		...
		openMask();
		document.getElementById("form1").action="<%=contextPath%>/td/wt/saveTecnicalExcel.srq?business_type=<%=businessType%>";

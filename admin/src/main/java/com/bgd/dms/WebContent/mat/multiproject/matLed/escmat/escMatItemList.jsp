...
<script type="text/javascript">
	...
	function refreshData(){
		...
		if(codeId==null||codeId=='C105'){
		 	sql +="select i.*,c.code_name,t.stock_num from gms_mat_recyclemat_info t inner join (gms_mat_infomation i inner join gms_mat_coding_code c on i.coding_code_id=c.coding_code_id and i.bsflag='0' and c.bsflag='0') on t.wz_id=i.wz_id and t.bsflag='0'and t.wz_type='3'";
			}
		else{
		 	sql +="select i.*,c.code_name,t.stock_num from gms_mat_recyclemat_info t inner join (gms_mat_infomation i inner join gms_mat_coding_code c on i.coding_code_id=c.coding_code_id and i.bsflag='0' and c.bsflag='0'and i.coding_code_id like '%"+codeId+"%') on t.wz_id=i.wz_id and t.bsflag='0'and t.wz_type='3'";
		}
       ...
       //入库明细信息
    	 ...
    	 function taskOutShow(value){
    			...
    			for(var i =0; taskList!=null && i < taskList.length; i++){
    				...
    				var total_mpney = taskList[i].total_mpney;
    				var create_date = taskList[i].create_date;

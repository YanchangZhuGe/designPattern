...
String[][] infos = {
		  {"国际地震仪器动态","/pm/wr/weekRaoPPT/weekPPTRunqianReport.jsp?reportFileName=wr/instrumentInfoReport.raq&reportName=国际地震仪器动态"},
		  {"国内可控震源动态","/pm/wr/weekRaoPPT/weekPPTRunqianReport.jsp?reportFileName=wr/orgInstrumentInfoReport.raq&reportName=国内可控震源动态"},
		  {"检波器使用动态","/pm/wr/weekRaoPPT/weekPPTRunqianReport.jsp?reportFileName=wr/focusInfoReport.raq&reportName=检波器使用动态"},
		  {"国际可控震源动态","/pm/wr/weekRaoPPT/weekPPTRunqianReport.jsp?reportFileName=wr/focusInfoReport.raq&reportName=国际可控震源动态"},
		  {"国内可控震源动态","/pm/wr/weekRaoPPT/weekPPTRunqianReport.jsp?reportFileName=wr/focusInsideInfoReport.raq&reportName=国内可控震源动态"}
};
String rptParams= "";
String week_date = request.getParameter("week_date");
String week_end_date = request.getParameter("week_end_date");

rptParams = "week_date="+week_date+";"+"org_subjection_id="+org_subjection_id+"%;";

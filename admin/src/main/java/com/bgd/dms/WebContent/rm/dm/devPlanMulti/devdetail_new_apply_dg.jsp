  ...
  <div id="new_table_box_content" style="width:100%">
    <div id="new_table_box_bg" style="width:95%">
      <fieldset style="margin-left:2px">
      	 <% if(allappType.equals("S0000")||allappType.equals("S14050208")||allappType.equals("S9997")) {  //自有%>
					<legend>自有设备申请基本信息</legend>
		 <% } else if(allappType.equals("S9999")) { //外租%>
		  		<legend>外租设备申请基本信息</legend>
		  <% } else if(allappType.equals("S0623")) { //专业化震源%>
				<legend>专业化震源申请基本信息</legend>
		  <% } else if(allappType.equals("S1405")) { //专业化仪器%>
		  		<legend>专业化仪器申请基本信息</legend>
		  <% } else if(allappType.equals("S1404")) { //专业化测量%>
		  		 <legend>专业化测量申请基本信息</legend>
		  <% } else if(allappType.equals("S9998")) { //调剂设备%>
		  		<legend>调剂设备申请基本信息</legend>
		 <%} %>
      ...
      <fieldset style="margin-left:2px">
      	<% if(allappType.equals("S0000")) {  //自有%>
					<legend>单台设备申请基本信息</legend>
		 <% } else if(allappType.equals("S9999")) { //外租%>
		  		<legend>外租设备申请基本信息</legend>
		  <% } else if(allappType.equals("S0623")) { //专业化震源%>
				<legend>专业化震源申请基本信息</legend>
		  ...
		  <% } else if(allappType.equals("S1404")) { //专业化测量%>
		  		 <legend>专业化测量申请基本信息</legend>	 		  
		  <% } else if(allappType.equals("S14050208")) { //检波器%>
		  		 <legend>检波器申请基本信息</legend>	 		  
		  <% } else if(allappType.equals("S9997")) { //大港自有地震仪器%>
		  		 <legend>批量设备申请基本信息</legend>
		  <% } else if(allappType.equals("S9998")) { //大港调剂%>
		  		 <legend>调剂设备申请基本信息</legend>	 		  	 		  
		 <%} %>
		...
		<div id="tag-container_4" style="float:left">
		 ...
		 <% if(allappType.equals("S0000")) {  //自有%>
		  		 <li class="selectTag" id="tag3_0" ><a href="#" onclick="getContentTab(this,0)">单台设备</a></li>
		 <% } else if(allappType.equals("S9999")) { //外租%>
		  		 <li class="selectTag" id="tag3_0" ><a href="#" onclick="getContentTab(this,0)">外租设备</a></li>
		  <% } else if(allappType.equals("S0623")) { //专业化震源%>
		  		 <li class="selectTag" id="tag3_0" ><a href="#" onclick="getContentTab(this,0)">专业化震源</a></li>
		  <% } else if(allappType.equals("S1405")) { //专业化仪器%>
		  		 <li class="selectTag"  id="tag3_1"><a href="#" onclick="getContentTab(this,1)">专业化地震仪器</a></li>
		  <% } else if(allappType.equals("S1404")) { //专业化测量%>
		  		 <li class="selectTag" id="tag3_0" ><a href="#" onclick="getContentTab(this,0)">专业化测量</a></li>		  		 
		  <% } else if(allappType.equals("S14050208")) { //检波器%>
		  	 	 <li class="selectTag" id="tag3_0" ><a href="#" onclick="getContentTab(this,0)">检波器</a></li>
		 <% } else if(allappType.equals("S9997")) { //专业化地震仪器%>
		  		 <li class="selectTag"  id="tag3_1"><a href="#" onclick="getContentTab(this,1)">批量</a></li>
		 <% } else if(allappType.equals("S9998")) { //调剂设备%%>
		 		 <li class="selectTag"  id="tag3_1"><a href="#" onclick="getContentTab(this,0)">调剂设备</a></li>
		 <%} %>
		...
		<div id="oprdiv0" name="oprdiv" style="float:left;width:70%;overflow:auto;">
		 	...
		 	<% }else if(allappType.equals("S9999")) { //外租%>
		        	<a href="javascript:downloadModel('dev_model','外租设备配置计划模板')">外租设备配置计划模板</a>
		  	<% }else if(allappType.equals("S0623")) { //专业化震源%>
		        	<a href="javascript:downloadModel('dev_model','单台设备配置计划模板')">单台设备配置计划模板</a>
		  	<% }else if(allappType.equals("S1404")) { //专业化测量%>
		        	<a href="javascript:downloadModel('dev_model','单台设备配置计划模板')">单台设备配置计划模板</a>
		    <% }else if(allappType.equals("S9998")) { //调剂设备%>
		    		<a href="javascript:downloadModel('dev_model','调剂设备配置计划模板')">调剂设备配置计划模板</a>
		    <% }else if(allappType.equals("S14050208")) { //检波器%>
		    		<a href="javascript:downloadModel('dev_model','单台设备配置计划模板')">单台设备配置计划模板</a>
		    <% }else if(allappType.equals("S9997")) { //大港自有地震仪器%>
		    		<a href="javascript:downloadModel('dev_model','批量设备配置计划模板')">批量设备配置计划模板</a>
		 	<%}else{%>
			 		<a href="javascript:downloadModel('dev_model','单台设备配置计划模板')">单台设备配置计划模板</a>			 
		  <%  }%>
		  ...
		  <div id="oprdiv1" name="oprdiv" style="float:left;width:70%;overflow:auto;display:none">
	      	<table width="97%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
			  	<tr align="right">
			  		...
			  		<td class="ali_cdn_input" ></td>
			  		<td class="ali_cdn_name" >
		        	<!-- <a href="javascript:downloadModel('dev_model','自有设备配置计划模板')">批量设备配置计划模板</a></td>
...
$().ready(function(){
	...
	function addRows(value){
		if(value!="" && value !=undefined){
			...
			if('<%=allappType%>'=='S14050208'){
				innerhtml += "<td width='17%'><input name='devicename"+tr_id+"' id='devicename"+tr_id+"' style='line-height:15px' value='检波器' size='15' type='text' readonly/>";
			}else{
			...
			//查询公共代码，并且回填到界面的单位中---大港检波器只显示串和个
			var retObj;
			var unitSql = "select sd.coding_code_id,coding_name from comm_coding_sort_detail sd ";
				unitSql += "where coding_sort_id ='5110000038' ";
			if('<%=allappType%>'=='S14050208'){
				unitSql += "and (sd.coding_code_id = '5110000038000000005' or sd.coding_code_id = '5110000038000000011') ";
			}
				unitSql += "order by coding_code"				
			var unitRet = syncRequest('Post','<%=contextPath%>'+appConfig.queryListAction,'querySql='+unitSql+'&pageSize=1000');
				retObj = unitRet.datas;
			var optionhtml = "";
			for(var index=0;index<retObj.length;index++){
	...
	function addCollRows(value){
		if(value!="" && value !=undefined){
			...
			for(var i=0;i<trData.length;i++){
				...
				innerhtml += "<td><input name='collstartdate"+i+"' id='collstartdate"+i+"' value='"+startDateValue+"' style='line-height:15px' size='10' type='text' value='"+tdData[5]+"'/><img src='"+"<%=contextPath%>"+"/images/calendar.gif' id='colltributton2"+i+"' width='16' height='16' style='cursor: hand;'"+"onmouseover='calDateSelector(collstartdate"+i+",colltributton2"+i+");'/></td>";
				innerhtml += "<td><input name='collenddate"+i+"' id='collenddate"+i+"' value='"+endDateValue+"' style='line-height:15px' size='10' type='text' value='"+tdData[6]+"'/><img src='"+"<%=contextPath%>"+"/images/calendar.gif' id='colltributton3"+i+"' width='16' height='16' style='cursor: hand;'"+"onmouseover='calDateSelector(collenddate"+i+",colltributton3"+i+");'/></td>";
			...
			innerhtml += "<td><input name='colldevicename"+tr_id+"' id='colldevicename"+tr_id+"' style='line-height:15px' value='用户输入名称' onfocus='if(this.value==\""+'用户输入名称'+"\"){this.value=\""+''+"\"}' onblur='if(this.value==\""+''+"\"){this.value=\""+'用户输入名称'+"\"}' size='15' type='text' /></td>";			
			...
			innerhtml += "<td><input name='collstartdate"+tr_id+"' id='collstartdate"+tr_id+"' value='"+startDateValue+"' style='line-height:15px' size='10' type='text'/><img src='"+"<%=contextPath%>"+"/images/calendar.gif' id='colltributton2"+tr_id+"' width='16' height='16' style='cursor: hand;'"+"onmouseover='calDateSelector(collstartdate"+tr_id+",colltributton2"+tr_id+");'/></td>";
			innerhtml += "<td><input name='collenddate"+tr_id+"' id='collenddate"+tr_id+"' value='"+endDateValue+"' style='line-height:15px' size='10' type='text'/><img src='"+"<%=contextPath%>"+"/images/calendar.gif' id='colltributton3"+tr_id+"' width='16' height='16' style='cursor: hand;'"+"onmouseover='calDateSelector(collenddate"+tr_id+",colltributton3"+tr_id+");'/></td>";
	...
	function submitInfo(){
		...
		$("input[type='text'][name^='devicetype']").each(function(){
			if(this.value == ""){
				numflag = "13";
				return;
			}
		...
		$("input[type='text'][name^='colldevicename']").each(function(){
			if(this.value == "" || this.value == "用户输入名称"){
				numflag = "14";
				return;
			}
		});
		...
		document.getElementById("form1").action = "<%=contextPath%>/rm/dm/toSaveDevAllAppDetailInfo.srq?count="+count+"&line_infos="+line_infos+"&collcount="+collcount+"&collline_infos="+collline_infos+"&resourceFlag=<%=resourceFlag%>";
	...
	if('<%=allappType%>'=='S1405'||'S9997'=='<%=allappType%>'){
		$("#oprdiv0").hide();
		$("#resultdiv0").hide();		
		$("#oprdiv1").show();
		$("#resultdiv1").show();		

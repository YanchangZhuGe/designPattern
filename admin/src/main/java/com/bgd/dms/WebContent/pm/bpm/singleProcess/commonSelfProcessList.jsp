...
<%
	...
	String nodeType=resultMsg.getValue("nodeType");
 ...
 <body style="background:#fff" onload="refreshData()">
			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			     <tr>
			     <%int j=0;%>
			      <td class="bt_info_odd"  exp="<input type='checkbox' name='rdo_entity_id' value='{businessId}@{entityId}@{procinstId}@{taskinstId}@{businessType}@{nodeLink}@{nodeLinkType}' id='rdo_entity_id_{cost_project_schema_id}'   />" >选择</td>
...
<script type="text/javascript">
	...
	cruConfig.queryOp = "getWFProcessList";
	 <%
	    ...
	    %>
	    	cruConfig.submitStr="businessType=<%=businessType==null?"":businessType%>&nodeType=<%=nodeType%>";
	    <%
	    }
	 %>
	...
	function refreshData(ids){
		...
		cruConfig.submitStr=("&isDone="+$("#isdone").val()+"&nodeType=<%=nodeType%>");

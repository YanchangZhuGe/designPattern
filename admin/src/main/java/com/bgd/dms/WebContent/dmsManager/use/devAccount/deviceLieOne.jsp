...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function getAmountWhlFusionChart(){
			...
			chart1.setXMLUrl("<%=contextPath%>/dms/device/getDeviceLieOne.srq");
			chart1.render("chartContainer1");
			parent.mainRightframe.location.href = "<%=contextPath%>/dmsManager/use/devAccount/DevAccListUnUse.jsp";
		...
		function toQuery1(){
			...
			chartReference1.setXMLUrl("<%=contextPath%>/dms/device/getDeviceLieOne.srq?devTreeId="+devTreeId+"&country="+country);
			parent.mainRightframe.location.href = "<%=contextPath%>/dmsManager/use/devAccount/DevAccListUnUse.jsp?devTreeId="+devTreeId+"&country="+country;
		...
		function toClear(){
			...
			$("#dev_type_name").html("");
			var chartReference1 = FusionCharts("chart1"); 
			chartReference1.setXMLUrl("<%=contextPath%>/dms/device/getDeviceLieOne.srq");
			chart1.render("chartContainer1");
			parent.mainRightframe.location.href = "<%=contextPath%>/dmsManager/use/devAccount/DevAccListUnUse.jsp";
		}
		//弹出设备信息
		function popDevList(devTreeId,orgSubId,country){
			parent.mainRightframe.location.href = "<%=contextPath%>/dmsManager/use/devAccount/DevAccListUnUse.jsp?devTreeId="+devTreeId+"&orgSubId="+orgSubId+"&country="+country;

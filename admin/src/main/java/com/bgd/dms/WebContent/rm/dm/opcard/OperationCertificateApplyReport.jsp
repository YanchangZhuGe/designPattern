...
<div id="tab_box_content1" class="tab_box_content" style="display:none;height: 730px" >
	<iframe id="businessIframe" name="businessIframe" width="100%" height="100%" style="display: block" src='<%=contextPath%>/rm/dm/opcard/OperationCertificateApplyGZL.jsp?apply_id=<%=apply_id%>'> </iframe>
</div>

...
var queryRootIdSql = "select f.file_id from bgp_doc_gms_file f where f.bsflag = '0'   and f.file_name='HSE'  and f.project_info_no is null and f.is_file = '0' and f.is_template is null";
...
var querySql = "Select b.file_id,b.file_name,b.file_abbr FROM bgp_doc_gms_file b WHERE b.file_id = '"+rootMenuId+"' and b.bsflag='0' and b.is_file='0'   and b.ucm_id is null";

 ...
 <body style="background:#fff" onload="refreshData('');">
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      ...
		      <%} %>
			  	<td class="ali_cdn_name">施工设计报告</td>
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      ...
			      <%} %>
			      <td class="bt_info_odd" exp="<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId={ucm_id}&emflag=0>{file_name}</a>">施工设计报告</td>
			      <td class="bt_info_odd" exp="{written_unit}">编写单位</td>
...
<script type="text/javascript">
	...
	var businessType="5110000004100000088";
	...
	function refreshData(str){
		...
		cruConfig.queryStr = " select t.* from (select f.ucm_id,f.file_name,t.project_info_no,t.tecnical_id,t.title,t.written_unit,t.written_time,t.writer,t.auditor,t.leader,p.project_name "+
			"from gp_ws_tecnical_basic t  left join gp_task_project p on t.project_info_no = p.project_info_no and p.bsflag = '0' "+
			"left join bgp_doc_gms_file f on t.tecnical_id = f.relation_id and f.doc_file_type = '0110000061100000010' and f.bsflag = '0' "+
			...
			"where t.bsflag = '0' "+projStr+" and t.business_type = '"+businessType+"'  and dy.org_subjection_id like '"+orgCode+"%' "+str+" order by t.modifi_date desc) t where 1 = 1 ";
		queryData(1);
	}
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/ConsdesignDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&isSingle='+isSingle,'750:680');
    }
	...
	function toEdit() {
		...
		popWindow('<%=contextPath%>/td/ConsdesignDoc/wt/add_tdDocModify.jsp?businessType='+businessType+'&fileAbbr='+fileAbbr+'&id='+id+'&isSingle='+isSingle,'750:680');
	}

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function getFusionChart(){
			...
			//维修费用统计
			getRepairCostFusionChart();
		}
		//维修费用统计
		function getRepairCostFusionChart(){
		...
		function toClear(){
			...
			$('#year').numberspinner('setValue', new Date().getFullYear());
			var chartReference1 = FusionCharts("chart1"); 
			chartReference1.setXMLUrl("<%=contextPath%>/dms/repair/getRepairCostChartData.srq?year="+new Date().getFullYear());
		}
		//弹出维护,保养图表

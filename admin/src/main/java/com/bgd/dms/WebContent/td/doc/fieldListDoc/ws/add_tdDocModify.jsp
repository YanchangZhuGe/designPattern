...
<%
    ...
    String businessType_s = request.getParameter("businessType_s")==null?"":request.getParameter("businessType_s");
%>
...
function save(){
	...
	form.action = "<%=contextPath%>/td/ws/toSavefieldListDoc.srq?businessType=<%=businessType%>&businessType_s=<%=businessType_s%>";
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if(fileId!='null'){ 
		if (!isTextPropertyNotNull("pk_<%=businessType%>_0", "资料清单")) return false;
	}else{
		if (!isTextPropertyNotNull("<%=businessType%>_0", "资料清单")) return false;
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table id="tableDoc" width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item6"><span class="red_star">*</span>资料清单：</td>
									<td colspan="3">

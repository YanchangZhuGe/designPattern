			...
			if(str == '1'){//手工录入
				...
				if(vReturnValue != undefined){
					...
					for(var i=0;i<basedatas.length;i++){
						...
						newTr.insertCell().innerHTML="<font color=red>*</font>&nbsp;<input type='text' id='asign_num"+rownum+"' name='asign_num"+rownum+"'  value='"+basedatas[i].use_num+"' size='5' onkeyup='AutoCal(this,"+rownum+")'>";//消耗数量

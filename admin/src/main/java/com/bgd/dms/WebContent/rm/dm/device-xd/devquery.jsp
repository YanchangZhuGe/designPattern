    ...
    <div id="new_table_box_bg">
      <table id="table1" width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
         <tr>
          ...
          <td class="inquire_form4"><input name="dev_name" class="input_width" type="text" /></td>
          <td class="inquire_item4">规格型号:</td>
          <td class="inquire_form4"><input name="dev_model" class="input_width" type="text" /></td>
        </tr>
		...
		<tr>
          ...
          <td class="inquire_item4">资产编号:</td>
          <td class="inquire_form4"><input name="asset_coding" class="input_width" type="text" /></td>
         
        </tr>
        <tr>
		  <td class="inquire_item4">所属单位:</td>
          <td class="inquire_form4"><input name="owning_org_name" class="input_width" type="text" /></td>
...
<script type="text/javascript"> 
	...
	function submitInfo(){
		...
		var asset_stat = document.getElementById("asset_stat").value;
		var dev_model = document.getElementById("dev_model").value;
		var dev_sign = document.getElementById("dev_sign").value;
		var self_num = document.getElementById("self_num").value;
		var license_num = document.getElementById("license_num").value;
		var asset_coding = document.getElementById("asset_coding").value;
		var owning_org_name = document.getElementById("owning_org_name").value;
		var producting_date = document.getElementById("producting_date").value;
		ctt.refreshData(dev_name,asset_stat,dev_model,dev_sign,self_num,license_num,asset_coding,owning_org_name,producting_date);
		*/
		newClose();

...
<table border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td class="inquire_item6">
			<select name="input_storeroom" id="input_storeroom" onchange="changeStoreRoom()">
	...
	<tr>	
		...
		<td class="inquire_item6">
			<select name="out_reason" id="out_reason" class="select_width">
		...
		<td class="inquire_item6" id='wz_org_id2' style="display: none;">

			...
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    <td class="ali_cdn_name">物资名称</td>
		 	    <td class="ali_cdn_input"><input class="input_width" id="s_tamplate_name" name="s_tamplate_name" type="text" value="" /></td>
		 	    <td class="ali_cdn_name">物资编号</td>
		 	    <td class="ali_cdn_input"><input class="input_width" id="wz_id" name="wz_id" type="text" value="" /></td>
		 	     <td class="ali_cdn_name">物资分类码</td>
		 	    <td class="ali_cdn_input"><input class="input_width" id="coding_code_id" name="coding_code_id" type="text" value=""/></td>
			    <td >
...
<script type="text/javascript">
	...
	function refreshData(value){
		...
		cruConfig.queryOp = "getTemLeafDg";

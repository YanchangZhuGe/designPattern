												...
												<div class="tongyong_box_content_left" id="chartContainer1"
													...
													<table width="100%" border="0" cellspacing="0"
														...
														<tr class="trHeader">
															...
															<td class="bt_info_odd">照片</td>
															<td class="bt_info_even">操作</td>
														</tr>
...
var noimg='';
	...
	function get_data(){    /**填充申请单数据**/	
		$("#attachement").attr("src","<%=contextPath%>/doc/common/common_doc_list.jsp?relationId=<%=apply_id%>");
		 //申请单基本数据
		 ...
		 if (typeof retObj.datas != "undefined") {
			...
			var retObj1 = jcdpCallService("DevCardSrv", "getApplyDeviceInfoByApply_id","currentPage=1&pageSize=10&apply_id=<%=apply_id%>");				 
		...
		var retObj1 = jcdpCallService("DevCardSrv", "loadEmployeeInfoByApplID","apply_id=<%=apply_id%>");
	...
	function addEmployee(){
		...
		var htmls='<tr id="tr'+index+'">';
			...
			htmls=htmls+'<img src="<%=contextPath%>/images/calendar.gif" id="employeebutton'+index+'" width="16" height="16" style="cursor: pointer;" onmouseover="calDateSelector(start_work_date'+index+',employeebutton'+index+');" /></td>';

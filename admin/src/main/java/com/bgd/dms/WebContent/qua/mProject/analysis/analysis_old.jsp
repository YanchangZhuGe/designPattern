...
<div id="table_box" style="overflow-y: hidden; overflow-x: hidden;">
							...
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
											<div class="tongyong_box" >
												...
												<div class="tongyong_box_content_left" style="height: 200px;width: 300">
													<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="company_1">
														<tr>
									...
									<tr>
										<td colspan="3">
											<div class="tongyong_box" >
												<div class="tongyong_box_title"><span class="kb"><a href="#"></a></span><a href="#">质量管理文件</a></div>
												<div class="tongyong_box_content_left" style="height: 200px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="company_4">
														<tr>
														  	<td class="bt_info_odd"  >序号</td> 
									...
									<tr>
										<td>
											<div class="tongyong_box" >
												...
												<div class="tongyong_box_content_left" style="height: 195px;width: 300">
	...
	function company(){
		...
		if(retObj!=null && retObj.returnCode=='0'){
			...
			for(var i=0;i<retObj.datas.length && retObj.datas[i]!=null;i++){
				...
				var tr_1 = company_1.insertRow(i-(-1));
				var td_1 = tr_1.insertCell(0);
				td_1.innerHTML = i-(-1) + "<input type='hidden' name='org_subjection_id' value='"+org_subjection_id+"'/>";;
				td_1 = tr_1.insertCell(1);
				td_1.innerHTML = "<a href='#' onclick=getDetail('company_1','"+org_subjection_id+"')><font color='blue'>"+org_name+"</font></a>" ;
	...
	function getDetail(company ,org_subjection_id){
		if(company!=null && company =='company_1'){
			window.location.href = cruConfig.contextPath + "/qua/mProject/analysis/qualified.jsp?org_subjection_id="+org_subjection_id;
		}else if(company!=null && company =='company_2'){
			window.location.href = cruConfig.contextPath + "/qua/mProject/audit/audit.jsp?org_subjection_id="+org_subjection_id;
		}else if(company!=null && company =='company_3'){
			window.location.href = cruConfig.contextPath + "/qua/mProject/accident/accident.jsp?org_subjection_id="+org_subjection_id;
		}
	}
	...
	function wtc(){
		...
		var myChart = new FusionCharts("${applicationScope.fusionWidgetsURL}/Charts/AngularGauge.swf", "myChartId", "280", "155", "0", "1");
	 	...
	 	var retObj = jcdpCallService("QualitySrv", "qualityChart", substr);
	 	if(retObj!=null && retObj.returnCode=='0'){
	 		if(retObj.Str!=null){
	 			first = retObj.Str;
	 		}
	    ...
	    substr = "name=waster&project_info_no="+project_info_no;
	 	retObj = jcdpCallService("QualitySrv", "qualityChart", substr);
	 	if(retObj!=null && retObj.returnCode=='0'){
	 		if(retObj.Str!=null){
	 			waster = retObj.Str;
	 		}

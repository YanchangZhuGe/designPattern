...
<div id="qua_c640c21612a1d08ae0430a15082cd08e"  style="width:100%; height:100%; overflow:auto;"></div>
<script type="text/javascript">
    ...
    var str = "<%=contextPath%>/qua/common/shotChart.srq?project_info_no="+project_info_no;
    var substr = "project_info_no="+project_info_no;
	var retObj = jcdpCallServiceCache("QualityChartSrv", "shotChart", substr);
	var first ="";
    ...
    myChart.render("qua_c640c21612a1d08ae0430a15082cd08e");
</script>

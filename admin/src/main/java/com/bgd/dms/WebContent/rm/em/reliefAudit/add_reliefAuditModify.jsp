...
function notpass(){
	...
	form.action = "<%=contextPath%>/rm/em/toSaveReliefAudit.srq";
	form.submit();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
      <tr>
		...
		<td class="inquire_item6">申请单号：</td>
      	<td class="inquire_form6">
      	<input type="hidden" id="professNo" name="professNo" value="<%=applyInfo.getHumanReliefNo()==null?"":applyInfo.getHumanReliefNo() %>"/>
	...
	<table id="lineTable" width="100%" border="0" cellspacing="0" cellpadding="0"  style="margin-top:2px;" >
	  ...
	  %>
		...
		<td class="<%=className%>even"><input type="text" id="fy<%=i%>peopleNumber" name="fy<%=i%>peopleNumber" value="<%=applyDetailInfo.getPeopleNumber()==null?"":applyDetailInfo.getPeopleNumber()%>" class="input_width" readonly="readonly" /></td>
		...
		<input name="button" type="button" onclick="addDeploy('<%=i%>')" value="调配" /></td>	
		</tr>	
	  <%
		}
	  %>

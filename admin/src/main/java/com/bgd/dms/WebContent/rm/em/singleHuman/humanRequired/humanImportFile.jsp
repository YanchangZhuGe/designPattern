...
<body>
<form action="<%=contextPath%>/rm/em/singleHuman/humanRequired/humanImportFile_t.jsp?deviceCount=<%=deviceCount%>" id="fileForm" method="post" enctype="multipart/form-data" target="targetIframe">

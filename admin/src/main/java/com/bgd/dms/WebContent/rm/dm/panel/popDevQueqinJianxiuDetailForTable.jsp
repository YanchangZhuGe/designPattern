					...
					<tr>
						<td width="99%">
							<div class="tongyong_box">
								...
								href="#"></a></span><a href="#">地震队主要设备待工、检修统计</a>
								<span class="gd"><a href="#"></a></span>
								<span class="dc" style="float:right;margin-top:-4px;">
									<a href="#" onclick="exportDataDoc('dzdzysbdgjxtj')" title="导出excel"></a>
								</span>
								</div>
...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj = jcdpCallService("EarthquakeTeamStatistics","getDevQueqinJianxiuDetailForPop","projectInfoNo=<%=projectInfoNo%>&devaccid=<%=code%>");
	...
	function exportDataDoc(exportFlag){
		...
		var submitStr = "projectInfoNo=<%=projectInfoNo%>&devAccId=<%=code%>&exportFlag="+exportFlag;

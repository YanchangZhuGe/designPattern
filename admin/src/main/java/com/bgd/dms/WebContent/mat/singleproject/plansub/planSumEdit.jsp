...
<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			      ...
			      <td class="bt_info_even" exp="<input name='demand_num{wz_id}'  type='text' value='{demand_num}' readonly/>">需求数量</td>
			      ...
			      <td class="bt_info_even" exp="<input name='plan_money{wz_id}'  type='text' value='' readonly/>">计划金额</td>

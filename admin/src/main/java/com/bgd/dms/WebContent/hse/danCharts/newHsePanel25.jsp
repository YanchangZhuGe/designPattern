...
<%
	...
	String sqlLevel = "select count(t.hidden_no) hidden_num, t.hidden_level from bgp_hse_hidden_information t where t.bsflag = '0' and t.org_sub_id='"+second_org+"' group by t.hidden_level order by t.hidden_level asc ";
	...
	String sqlModify = "select count(d.mdetail_no) no_modify_dan from bgp_hse_hidden_information t left join bgp_hidden_information_detail d on t.hidden_no = d.hidden_no and d.bsflag = '0' where t.bsflag = '0' and t.org_sub_id='"+second_org+"' and d.rectification_state = '2'";

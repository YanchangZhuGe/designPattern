...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.TreeStore', {
        ...
        proxy: {
       	 type : 'ajax',
            method: 'get',
            url: '<%=contextPath%>/rm/dm/devRepair/getCollDeviceTreeOnlyUnit.srq',
            reader: {
                type : 'json'
            }
        },
    ...
    function cellclick(grid, colspan, colIndex, rowdata, rowspan, rowIndex, e) {
        ...
        var code = rowdata.data.code;
  		parent.mainRightframe.location.href = "<%= contextPath%>/rm/dm/devRepair/rfidDevAccList.jsp?is_leaf="+is_leaf+"&node_level="+node_level+"&code="+code;
    }
});

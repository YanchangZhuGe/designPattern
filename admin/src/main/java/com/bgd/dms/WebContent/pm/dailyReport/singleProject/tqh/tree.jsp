...
<%
	...
	System.out.print(projectInfoNo+"wbsBackUrl"+wbsBackUrl+"taskBackUrl"+taskBackUrl+"rootBackUrl"+rootBackUrl+"customKey"+customKey+"customValue"+customValue);
...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.TreeStore', {
        ...
        proxy: {
       	 type : 'ajax',
            method: 'get',
            url: '<%=contextPath%>/pm/dailyReport/singleProject/tqh/getTasks.srq?wbsOnly=<%=wbsOnly %>&checked=<%=checked %>&projectInfoNo=<%=projectInfoNo%>',
            reader: {
                type : 'json'
            }
        },

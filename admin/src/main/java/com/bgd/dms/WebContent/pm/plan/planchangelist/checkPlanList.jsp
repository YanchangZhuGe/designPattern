...
if("5000100004000000009".equals(projectType)){
	//综合物化探
	response.sendRedirect(contextPath+"/wt/pm/planManager/singlePlan/progress/planchangelist/checkPlanList.jsp");	
}else if("5000100004000000006".equals(projectType)){
	//深海
	response.sendRedirect(contextPath+"/pm/plan/planchangelist/sh/checkPlanList.jsp");	
}else if("5000100004000000008".equals(projectType)){
	//井中
	response.sendRedirect(contextPath+"/pm/plan/planchangelist/ws/checkPlanList.jsp");	
}else if (orgsubId.startsWith("C105007")){
	//大港
	response.sendRedirect(contextPath+"/pm/plan/planchangelist/dg/checkPlanList.jsp");	
}

...
<script language="javascript" type="text/javascript">
	...
	var sql = "select distinct dui.owning_org_id,org.org_abbreviation as owning_org_name,";
		...
		sql += "left join comm_org_information org on org.org_id = dui.owning_org_id ";
		sql += "where bad.device_backapp_id = '<%=devbackappid%>' ";

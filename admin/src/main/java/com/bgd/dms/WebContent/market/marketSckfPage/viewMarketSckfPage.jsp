...
<table border="0" cellpadding="0"  style="table-layout:auto;word-wrap:break-word;word-break:break-all" cellspacing="0" width="100%"  height="800" class="form_info">
	   ...
	   <tr class="odd">
        ...
        <td  colspan="3"  class="inquire_form" height="28px;">
          <%
         	...
         	%>
         	<li><a href="<%=contextPath%>/icg/file/DownloadFileAction.srq?pkValue=<%=fileMap.get("fileId")%>"><%=(String)fileMap.get("fileName")%></a></li>
         	<%
         			}
         		}
         	%>

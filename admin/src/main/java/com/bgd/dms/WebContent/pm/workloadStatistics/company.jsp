...
document.getElementById("end_date").value = endDate;
 ...
 function getFusionChart(){
	...
	var retObj = jcdpCallService("WorkloadStatisticsSrv","getCompanyWorkload","startDate=" + startDate + "&endDate="+endDate);
...
function inBrowse(orgId){
	var startDate = document.getElementById("start_date").value;
	var endDate =  document.getElementById("end_date").value;
	window.location.href = "<%=contextPath%>/pm/workloadStatistics/department.jsp?subOrgId="+orgId+"&startDate=" + startDate + "&endDate="+endDate;
}
</script>
<script type="text/javascript">
	/**/function frameSize() {

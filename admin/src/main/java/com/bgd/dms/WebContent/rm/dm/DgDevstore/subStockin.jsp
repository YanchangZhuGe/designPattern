      	...
      	<div id="list_table">
			<div id="inq_tool_box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			    ...
			    <td>&nbsp;</td>
			    <auth:ListButton functionId="" css="jh" event="onclick='toSumbitDevApp()'" title="JCDP_btn_submit"></auth:ListButton>
			...
			<div id="table_box">
			  <table style="width:98.5%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr id='device_appdet_id_{device_backapp_id}' name='device_backapp_id'>
			     	<td class="bt_info_odd" exp="<input type='checkbox' name='selectedbox' value='{device_backdet_id}' id='selectedbox_{device_backdet_id}' onclick='loadDataDetail();'/>" ><input type='checkbox' name='selectedbox' id='selectedbox' onclick='check()'/></td>
...
//		$("#selectedbox_"+retObj.devStockMap.device_backdet_id).attr("checked","checked");
	...
	function toSumbitDevApp(){
	  ...
	  selId = ids.split(','); 
	  editUrl = "<%=contextPath%>/rm/dm/DgDevstore/stockinSubmit.jsp?id={id}"+'&devaccidDui='+dev_acc_id;  

...
<script type="text/javascript">
	...
	function refreshData(){
		var sql ="select t.out_info_id,p.project_name as out_progect_name,gp.project_name as in_progect_name,t.out_date,t.operator,t.total_money from GMS_MAT_OUT_INFO t join gp_task_project p on t.project_info_no=p.project_info_no join gp_task_project gp on t.input_org = gp.project_info_no where t.project_info_no='<%=projectInfoNo%>'and t.out_type='4' and t.bsflag='0' order by t.out_date desc,t.modifi_date desc";
	...
	var showTabBox = document.getElementById("tab_box_content0");
       ...
       //汇总信息
 		...
 		function toChange(){
 			popWindow("<%=contextPath%>/mat/singleproject/warehouse/out/matremove/changeType.jsp",'1024:768');

...
function getSubNodes(parentNode) {
	...
	var querySql="select t.conf_id as id,t.conf_name as name from comm_autoscore_conf t where t.bsflag = '0' and t.conf_table_type='0' order by t.create_date ";
	var nodes;
	Ext.Ajax.request({

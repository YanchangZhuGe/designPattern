				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr style="background-color: #97cbfd">
						...
						<td class="inquire_form8"><input type="hidden"
							name="daily_no" id="daily_no" />
							 <input type="text" name="produceDate" id='produceDate' value='<%=produce_date%>' readonly="readonly" />&nbsp;&nbsp; 
...
function toSubmit(){
	...
	var produceDate = document.getElementById("produceDate").value;
				...
				var retObj = jcdpCallService("WtDailyReportSrv", "submitDailyReport", "dailyNo="+dailyNo+"&projectInfoNo="+projectInfoNo+"&produceDate="+produceDate+"&audit_status=1");

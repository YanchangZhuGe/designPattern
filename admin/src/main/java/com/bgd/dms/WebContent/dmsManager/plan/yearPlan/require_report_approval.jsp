...
<body style="background:#fff" scroll="no">
	<div id="list_table">
		<div id="tag-container_3">
		  	<span>&nbsp;&nbsp;</span>
		  	<a style="width: 105px;" href="#" onclick="getTab(0)"><span id="div_a_span0" style="font-size:16px;">非安装设备</span></a>
		  	<span>&nbsp;&nbsp;</span>
		  	<a style="width: 105px;" href="#" onclick="getTab(1)"><span id="div_a_span1" style="font-size:16px;">长期待摊</span></a>
		</div>
...
<script type="text/javascript">
	function getTab(index){
		...
		if(index==0){
			$("#iframe_list_0").attr("src","<%=contextPath%>/dmsManager/plan/yearPlan/noninstall_approval.jsp?applyId=<%=applyId%>&applyYear=<%=applyYear%>&isDone=<%=isDone%>");
		}else if(index==1){
			$("#iframe_list_1").attr("src","<%=contextPath%>/dmsManager/plan/yearPlan/longterm_approval.jsp?applyId=<%=applyId%>&applyYear=<%=applyYear%>");
		}
	}
	function frameSize(){

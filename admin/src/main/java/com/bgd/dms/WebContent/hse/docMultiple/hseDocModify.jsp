...
function save(){
	if(checkForm()){
		...
		form.action = "<%=contextPath%>/hse/doc/saveMultipleDoc.srq";
		form.submit();
//		newClose();
	}
}
...
<!-- 		<td class="inquire_item4">附件：</td>
           <td class="inquire_form4"><a id="doc_name" style="float: left;" href="" ></a>
 			...
 			<div id="file_content" style="float:left"><input type="file"  name="file" id="file"  onchange="writeDocName()"/>       </div>

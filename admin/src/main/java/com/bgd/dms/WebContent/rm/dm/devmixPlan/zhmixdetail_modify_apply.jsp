		  ...
		  <div style="height:250px;overflow:auto">
			  <table style="width:98%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		       <tr>
					...
					<td class="bt_info_even" width="7%">需求数量</td>
					<td class="bt_info_odd" width="7%">已申请数量</td>
					<td class="bt_info_even" width="7%">申请数量</td>
					<td class="bt_info_odd" width="15%">开始时间</td>
					<td class="bt_info_even" width="15%">结束时间</td>
	...
	function refreshData(){
		...
		if('<%=deviceappid%>'!=null){
			var prosql = "select dad.device_allapp_detid,dad.device_app_detid,dad.team,dad.teamid,dad.apply_num,dad.dev_ci_code,aad.isdevicecode,";
				prosql += "dad.dev_name as dev_ci_name,";
				prosql += "dad.dev_type as dev_ci_model, ";
				...
				prosql += "from gms_device_app_detail dad left join gms_device_app da on dad.device_app_id = da.device_app_id ";
				...
				prosql += "and dad.device_app_detid in (<%=deviceappdetid%>) ";
		...
		for(var index=0;index<retObj.length;index++){
			...
			innerhtml += "<td width='6%'><input name='deviceappdetid"+index+"' id='deviceappdetid"+index+"' value='"+retObj[index].device_app_detid+"' type='hidden' readonly/>";
			...
			innerhtml += "<input name='teamname"+index+"' id='teamname"+index+"' value='"+retObj[index].teamname+"' size='12' type='text' readonly/>";
			innerhtml += "<input name='team"+index+"' id='teamid"+index+"' value='"+retObj[index].team+"' type='hidden'/></td>";
			
			innerhtml += "<td width='12%'><input name='devicename"+index+"' id='devicename"+index+"' style='line-height:15px' value='"+retObj[index].dev_ci_name+"' size='12' type='text' readonly/></td>";
			innerhtml += "<td width='15%'><input name='devicetype"+index+"' id='devicetype"+index+"' value='"+retObj[index].dev_ci_model+"' size='14'  type='text' readonly/>";
			...
			var modify_end_num = parseInt(retObj[index].applyed_num)-parseInt(retObj[index].apply_num);

			innerhtml += "<td width='7%'><input name='neednum"+index+"' id='neednum"+index+"' value='"+retObj[index].require_num+"' size='4' type='text' readonly/></td>";
			//innerhtml += "<td width='7%'><input name='applyednum"+index+"' id='applyednum"+index+"' value='"+retObj[index].applyed_num+"' size='4' type='text' readonly/></td>";
			innerhtml += "<td width='7%'><input name='applyednum"+index+"' id='applyednum"+index+"' value='"+modify_end_num+"' size='4' type='text' readonly/></td>";
			innerhtml += "<td width='7%'><input name='applynum"+index+"' id='applynum"+index+"' detindex='"+index+"' value='"+retObj[index].apply_num+"' size='4' type='text'  onkeyup='checkAssignNum(this)'/>";
			//var checknum = parseInt(retObj[index].applyed_num)-parseInt(retObj[index].apply_num);
			var checknum = modify_end_num;
			
			innerhtml += "<input name='checknum"+index+"' id='checknum"+index+"'  value='"+checknum+"' type='hidden' /></td>";
			
			innerhtml += "<td width='15%'><input name='startdate"+index+"' id='startdate"+index+"' style='line-height:15px' value='"+retObj[index].plan_start_date+"' size='10' type='text' readonly/><img src='"+"<%=contextPath%>"+"/images/calendar.gif' id='tributton2"+index+"' width='16' height='16' style='cursor: hand;'"+"onmouseover='calDateSelector(startdate"+index+",tributton2"+index+");'/></td>";
			innerhtml += "<td width='15%'><input name='enddate"+index+"' id='enddate"+index+"' style='line-height:15px' value='"+retObj[index].plan_end_date+"' size='10' type='text' readonly/><img src='"+"<%=contextPath%>"+"/images/calendar.gif' id='tributton3"+index+"' width='16' height='16' style='cursor: hand;'"+"onmouseover='calDateSelector(enddate"+index+",tributton3"+index+");'/></td>";
			innerhtml += "<td width='12%'><input name='purpose"+index+"' id='purpose"+index+"' value='"+retObj[index].purpose+"' size='10' type='text' /></td>";

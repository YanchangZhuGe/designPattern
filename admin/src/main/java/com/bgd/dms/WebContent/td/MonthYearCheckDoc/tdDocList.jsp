      	...
      	<div id="list_table">
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr>
			      <td class="bt_info_odd" exp="<input type='checkbox' name='rdo_entity_id' value='{file_id}-{f_no}' id='rdo_entity_id_{file_id}' onclick='chooseOne(this);' />" >选择</td>
...
<script type="text/javascript">
	...
	function refreshData(){
		//此为井中业务要求
		var father_no=""; 
        var  querySql1 = "  select t.project_father_no  from gp_task_project t  where  t.project_type='5000100004000000008' and t.bsflag='0'    and t.project_info_no='<%=projectInfoNo%>' " ;
    ...
    function loadDataDetail(ids){
   	 ...
   	 var retObj = jcdpCallService("TdDocServiceSrv", "getEditDocInfo", "fileId="+ ids.split("-")[0]);		
    ...
    function toAdd(){
    	popWindow('<%=contextPath%>/td/ConsdesignDoc/add_tdDocModifyNew.jsp?docType='+codingCodeId);
	...
	function toEdit() {
		...
		if(f_no =='1'){
		  ...
		  popWindow('<%=contextPath%>/td/ConsdesignDoc/edit_tdDocModifyNew.jsp?id='+ids.split("-")[0]);
	}
...
/* 		var tempIds = ids.split(",");
		 ...
		 */
			jcdpCallService("TdDocServiceSrv","deleteTdDoc","id='"+ids.split("-")[0]+"' ");	
		var sql = "update bgp_doc_gms_file t set t.bsflag='1' where t.file_id ='"+ids.split("-")[0]+"' ";

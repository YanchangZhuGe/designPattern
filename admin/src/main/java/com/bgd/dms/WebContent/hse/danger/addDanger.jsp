...
<form name="form1" id="form1"  method="post" action="<%=contextPath%>/hse/addDanger.srq">
  ...
  <div id="new_table_box_content">
    ...
    <tr>
    	<td class="inquire_item6"><font color="red">*</font>隐患名称：</td>
      	<td class="inquire_form6"><input type="text" id="danger_name" name="danger_name" class="input_width"  value="" /></td>

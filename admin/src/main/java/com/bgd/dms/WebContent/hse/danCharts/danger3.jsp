				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box_title"><span class="kb"><a
							href="#"></a></span><a href="#">事故情况分布</a></div>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<div class="tongyong_box">
						<div class="tongyong_box_title"><span class="kb"><a
							href="#"></a></span><a href="#">各单位事故分布情况</a></div>
...
$("#chartContainer").css("width", "52%");
$("#chartContainer3").css("width", "48%");
var width = $("#tongyong_box").width()*0.1;

	var myChart = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Pie2D.swf", "myChartId1", "100%", "220", "0", "0" );    
	myChart.setXMLUrl("<%=contextPath%>/hse/chart/queryEventTypePie.srq?radius="+width);      
	myChart.render("chartContainer");  
	
	var myChart3 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Pie2D.swf", "myChartId2", "100%", "220", "0", "0" );    
	myChart3.setXMLUrl("<%=contextPath%>/hse/chart/queryEventLevelPie.srq?radius="+width);      

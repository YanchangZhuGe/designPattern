...
function refreshData(){
	...
	if('<%=dispose_method_id%>'!='null'){
		...
		if(baseData.datas1!=null)
		{
		optnum=baseData.datas1.length;
		for (var tr_id = 1; tr_id<=baseData.datas1.length; tr_id++) {
		...
		var innerhtml ="<input name='name_"+tr_id+"' id='name_"+tr_id+"'  class=input_width type=text value='"+baseData.datas1[tr_id-1].name+"' />"
		var innerhtml1="<input name='org_name_"+tr_id+"' id='org_name_"+tr_id+"'   class=input_width type=text  value='"+baseData.datas1[tr_id-1].org_name+"'/>";
		var innerhtml2="<input name='position_"+tr_id+"'  id='position_"+tr_id+"'   class=input_width type=text value='"+baseData.datas1[tr_id-1].position+"' />";
		newTd.innerHTML=innerhtml;
		newTd1.innerHTML=innerhtml1;
		newTd2.innerHTML=innerhtml2;
			}
		}
...
function addrow(obj)
{
	...
	var newTd2=newTr.insertCell();
	newTd2.className="inquire_form6";
	var innerhtml ="<input name='name_"+optnum+"' id='name_"+optnum+"'  class=input_width type=text />"
	var innerhtml1="<input name='org_name_"+optnum+"' id='org_name_"+optnum+"'   class=input_width type=text />";
	var innerhtml2="<input name='position_"+optnum+"'  id='position_"+optnum+"'   class=input_width type=text />";
	newTd.innerHTML=innerhtml;
	newTd1.innerHTML=innerhtml1;
	newTd2.innerHTML=innerhtml2;
}

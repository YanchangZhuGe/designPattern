...
<script type="text/javascript">
	...
	function getFusionChart(){
		var retObj2 = jcdpCallService("DevCommInfoSrv","getXYPDrillForPopWutan","code=<%=code%>&orgsubId=<%=orgsubId%>&drillLevel=1&proYear=<%=proYear%>");
		var dataXml2 = retObj2.dataXML;
		$("#chartContainer2").empty();
		$("#chartContainer2").append(dataXml2);
		//现场维修费用钻取信息-设备类型 
		exportFlag='xcwxfyzqxxxyp';
	}
	//钻取
	function drillXYPDrillForSingle(obj){
		var retObj2 = jcdpCallService("DevCommInfoSrv","getXYPDrillForPopWutanSingle","code=<%=code%>&orgsubId=<%=orgsubId%>&devaccid="+obj+"&drillLevel=1");
		var dataXml2 = retObj2.dataXML;
		$("#chartContainer2").empty();
		$("#chartContainer2").append(dataXml2);
		//现场维修费用钻取信息-设备信息
		exportFlag='xcwxfyzqxxxypxx';
		devaccid=obj;
	}

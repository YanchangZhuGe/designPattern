...
<%
    ...
    String spsfileNo = request.getParameter("spsfileNo");
%>
...
<input type="hidden" name="sps_file_no" value="<%=spsfileNo%>"/>
...
function loadData(){
	var retObj = jcdpCallService("DesignSpsSrv", "getDesignSpsById", "spsfileNo=<%=spsfileNo%>");
	if(retObj.project != null){
		document.getElementById("line_group_id").value = retObj.project.line_group_id;
	}
}

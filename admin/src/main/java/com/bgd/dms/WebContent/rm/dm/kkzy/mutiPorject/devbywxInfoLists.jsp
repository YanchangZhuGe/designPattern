      	...
      	<div id="list_table">
			...
			<div id="tab_box" class="tab_box">
				<div id="tab_box_content0" class="tab_box_content">
					<table id="devMap" width="96%" border="0" cellspacing="0" cellpadding="0" class="tab_info" style="margin-top:2px;" >
				    	  	<tr>
			...
			<div id="tab_box_content1" class="tab_box_content" style="display:none;">
					    ...
					    <td class="bt_info_odd">物料名称</td>
						<td class="bt_info_even">单价</td>
						<td class="bt_info_odd">计量单位</td>
						<td class="bt_info_even">库存数量</td>
						<td class="bt_info_odd">消耗数量</td>
						<td class="bt_info_even">备件类别</td>
					 </tr>	
...
<script type="text/javascript">
    ...
    function refreshData(v_self_num,s_wz_id){
		var str = "";
		str+="";
		str+=" select (case when l.bywx_type='0' then '更换' when l.bywx_type='1' then '维修' end) as bywx_type, (case when d.coding_name is null then '无' when d.coding_name is not null then d.coding_name end)  as zcj_type,l.bywx_id,l.bywx_date,l.work_hours,l.falut_desc,l.falut_case,l.maintenance_level,l.maintenance_desc,l.performance_desc,l.legacy,l.repair_unit,l.repair_men,l.bak, dui.self_num, dui.dev_acc_id  from gms_device_zy_bywx l  left join gms_device_account dui on dui.dev_acc_id = l.dev_acc_id  left join comm_coding_sort_detail d on d.coding_code_id=l.zcj_type  where  l.project_info_id is null and l.bsflag='0' and l.ORG_SUBJECTION_ID like '<%=orgSubId%>%'  ";
	...
	//打开新增界面
	 function toAdd(){   
	 	popWindow("<%=contextPath%>/rm/dm/kkzy/mutiPorject/acceptLedgerAdd.jsp",'1024:800'); 
	 }
	 ...
	 function toModifyXgll(){
			...
			popWindow('<%=contextPath%>/rm/dm/kkzy/mutiPorject/acceptLedgerAdd.jsp?wx_ids='+wz_ids,'1050:680');
	...
	*/
	function yzjl(shuaId){
				...
				var queryRet;
				queryRet = jcdpCallService("DevInsSrv", "getwxbyMatInfosId", "bywx_id="+shuaId);
			 var retObj;
		...
		$("#assign_body>tr:even>td:even",'#tab_box_content1').addClass("even_even");
		 ...
		 function showMatTreePage(){
			 ...
			 var obj = new Object();
				var vReturnValue = window.showModalDialog('<%=contextPath%>/rm/dm/kkzy/mutiPorject/selectMatList.jsp',obj,'dialogWidth=1024px;dialogHigth=400px');

...
function toAdd(){
	...
	var td = tr.insertCell();
	td.className = "scrollRowThead";
	td.innerHTML = '<input type="text" name="line_group_id_'+rowNum+'" size="10">';
	tr.insertCell().innerHTML = '<input type="text" name="measure_fullfold_area_'+rowNum+'" size="8" onkeypress="return key_press_check(this)" onchange="computeSum(\'measure_fullfold_area\')">';
...
function initData(){
	...
	if(retObj.datas != null){
		for(var i=0;i<retObj.datas.length;i++){
			...
			td.className = "scrollRowThead";
			td.innerHTML = '<input type="hidden" name="order" class="input_width" value="'+lineNum+'">'
										+'<input type="text" name="serialnum" size="2" value="'+lineNum+'" readonly>';
			var td = tr.insertCell();
			td.className = "scrollRowThead";
			td.innerHTML = '<input type="text" name="line_group_id_'+rowNum+'" value="'+record.line_group_id+'" size="10" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="measure_fullfold_area_'+rowNum+'" value="'+record.measure_fullfold_area+'"  size="8" onkeypress="return key_press_check(this)" onchange="computeSum(\'measure_fullfold_area\')" readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="full_fold_area_'+rowNum+'" value="'+record.full_fold_area+'"  size="8" onkeypress="return key_press_check(this)" onchange="computeSum(\'full_fold_len\')" readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="qualifier_ratio_'+rowNum+'" value="'+record.qualifier_ratio+'"  size="6" onkeypress="return key_press_check(this)" readonly readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="first_ratio_'+rowNum+'" value="'+record.first_ratio+'"  size="6" onkeypress="return key_press_check(this)" readonly readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="seconde_ratio_'+rowNum+'" value="'+record.seconde_ratio+'"  size="6" onkeypress="return key_press_check(this)" readonly readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="defective_product_ratio_'+rowNum+'" value="'+record.defective_product_ratio+'"  size="6" onkeypress="return key_press_check(this)" readonly readonly>';
			...
			tr.insertCell().innerHTML = '<input type="text" name="no_shoot_ratio_'+rowNum+'" value="'+record.no_shoot_ratio+'"  size="6" onkeypress="return key_press_check(this)" readonly readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="design_encrypt_sum_num_'+rowNum+'" value="'+record.design_encrypt_sum_num+'"  size="8" onkeypress="return key_press_check(this)" onchange="computeSum(\'design_encrypt_sum_num\')" readonly>';
			tr.insertCell().innerHTML = '<input type="text" name="infill_sp_num_'+rowNum+'" value="'+record.infill_sp_num+'"  size="8" onkeypress="return key_press_check(this)" onchange="computeSum(\'infill_sp_num\')" readonly>';
			...
			tr.insertCell().innerHTML = '<img src="<%=contextPath%>/images/delete.png" width="16" height="16" style="cursor:hand;" onclick="deleteLine(\'' + lineId + '\')"/>'
			+'<input type="hidden" name="record_id' + '_' + rowNum + '" value="'+record.wa3d_group_id+'"/>'
			+'<input type="hidden" name="bsflag' + '_' + rowNum + '" value="0"/>';
		...
		sumRow["2"] = "合计";
		sumRow["3"] = "";
		sumRow["4"] = document.getElementsByName("sum_measure_fullfold_area")[0].value;
		sumRow["5"] = document.getElementsByName("sum_measure_shot_num")[0].value;
		sumRow["6"] = document.getElementsByName("sum_full_fold_area")[0].value;
		sumRow["7"] = document.getElementsByName("sum_record_num")[0].value;
		sumRow["8"] = document.getElementsByName("sum_acceptable_product_num")[0].value;
		sumRow["9"] = document.getElementsByName("sum_qualifier_ratio")[0].value;
		sumRow["10"] = document.getElementsByName("sum_first_num")[0].value;
		sumRow["11"] = document.getElementsByName("sum_first_ratio")[0].value;
		sumRow["12"] = document.getElementsByName("sum_seconde_num")[0].value;
		sumRow["13"] = document.getElementsByName("sum_seconde_ratio")[0].value;
		sumRow["14"] = document.getElementsByName("sum_defective_product_num")[0].value;
		sumRow["15"] = document.getElementsByName("sum_defective_product_ratio")[0].value;
		sumRow["16"] = document.getElementsByName("sum_no_shoot_num")[0].value;
		sumRow["17"] = document.getElementsByName("sum_no_shoot_ratio")[0].value;
		sumRow["18"] = document.getElementsByName("sum_design_encrypt_sum_num")[0].value;
		sumRow["19"] = document.getElementsByName("sum_infill_sp_num")[0].value;
		sumRow["20"] = "";
		sumRow["21"] = "";
...
function toSave(){
	...
	for(var i=0;i<orders.length;i++){
		...
		//
		var measure_fullfold_area = document.getElementsByName("measure_fullfold_area"+"_"+rowNum)[0].value;
		if(measure_fullfold_area.length > 0){
			rowParam['measure_fullfold_area'] = measure_fullfold_area;
		}
		//
		var measure_shot_num=document.getElementsByName("measure_shot_num"+"_"+rowNum)[0].value;
		...
		rowParam['construct_begin_end_date'] = document.getElementsByName("construct_begin_end_date"+"_"+rowNum)[0].value;
		rowParam['notes'] = document.getElementsByName("notes"+"_"+rowNum)[0].value;
		
		if(record_id !=""){
			rowParam['wa3d_group_id'] = record_id;
	...
	saveFunc("gp_ops_wa3d_group_finish ",rows);
}
...
function downloadTemplate(){
	window.location.href="<%=contextPath%>/pm/dailyReport/singleProject/download.jsp?path=/pm/lineCompleted/3dLineCompletedTemp.xls&filename=3dLineCompleted_template.xls";
}
...
function importData(){
	...
	if(checkFile(filename)){
		document.getElementById("fileForm").action = "<%=contextPath%>/pm/gpe/importLineCompleted.srq?workMethod=3&teamName="+team_name;
...
<table id="lineTable" width="100%" border="0" cellspacing="0"  align="center" cellpadding="0" class="scrolltable">
   ...
   <tr class="scrollColThead td_head">
    ...
    <tr class="scrollColThead td_head">
      ...
      <td class="scrollRowThead scrollCR bt_info_even">线束号</td>
      <td>满覆盖面积</td>
      <td>炮数</td>
      <td>满覆盖面积</td>
      <td>炮数</td>
    ...
    <tr class="even" style="display:none" id="trlinesum">
    	...
    	<td class="scrollRowThead scrollCR"><input type="text" size="10" value="       --" readonly/></td>
    	<td><input type="text" name="sum_measure_fullfold_area" size="8" readonly/></td>

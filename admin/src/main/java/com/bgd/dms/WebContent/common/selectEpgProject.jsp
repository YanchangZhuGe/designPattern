...
/*  
var querySql = " select  t.project_name,t.project_info_no from gp_ops_epg_task_project t";
var queryOrgRet = syncRequest('Post',cruConfig.contextPath+appConfig.queryListAction,'querySql='+querySql); */
var rootMenuName ="甲方项目名称" 
</script>
...
function getSubNodes(parentNode) {
	...
	Ext.Ajax.request({
		...
		params : {
			currentPage:"1",
			pageSize:"10000",
			querySql:"select * from gp_ops_epg_task_project t"
		},
		method : 'Post',

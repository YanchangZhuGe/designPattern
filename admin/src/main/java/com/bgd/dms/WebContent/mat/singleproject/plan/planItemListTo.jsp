...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
	<tr>
		<td class="bt_info_odd"
			exp="<input name = 'rdo_entity_name' id='rdo_entity_id' type='checkbox' value='{submite_number}' onclick='loadDataDetail();'/>">选择</td>
	 ...
	 function toAdd(){ 
		 ...
		 ids = getSelIds('rdo_entity_id');
			if (ids == '') {
			   ...
			   popWindow("<%=contextPath%>/mat/singleproject/plan/tree.jsp?laborId="+ids+"&projectInfoNo="+projectInfoNo,'600:800');
			   window.close();
				} 

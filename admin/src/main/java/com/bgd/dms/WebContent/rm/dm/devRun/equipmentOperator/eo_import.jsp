...
<%
	...
	String message = "";
	if(resultMsg != null){
		message = resultMsg.getValue("errorMessage");
	}
%>
...
<table border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
    	<td colspan="6" align="center">Excel油料导入</td>
    </tr>
	 <tr>
     	<td class="inquire_item6">Excel：</td>
      	<td class="inquire_form6"><input type="file" name="doc_excel"  /></td>
...
if(message != "" && message != 'null'){
	if(message=="导入成功!"){ 
		alert(message);
		window.parent.frames['list'].refreshData();
		newClose();
	}else{
		alert(message);
	}
	...
	function save(){	
		openMask();
		document.getElementById("form1").action="<%=contextPath%>/mat/singleproject/matLedger/saveMatExcelnews.srq";

	  ...
	  function toSave(){ 
		  ...
		  ids = getSelIds('rdo_entity_id');
			if (ids == '') {
				...
				document.getElementById("form1").action="<%=contextPath%>/mat/singleproject/plan/savePlan.srq?plannum="+plannum;
...
//	    	var applyTeamList=jcdpCallService("HumanCommInfoSrv","queryApplyTeam","");	
	...
	function checkText(){
	 ...
	 function AddExcelData(){
		 var obj=window.showModalDialog('<%=contextPath%>/mat/singleproject/plan/planExcelAddDg.jsp',"","dialogHeight:500px;dialogWidth:600px");

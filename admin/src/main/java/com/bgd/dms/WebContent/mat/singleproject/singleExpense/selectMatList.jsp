      	...
      	<div id="list_table">
			...
			<div id="table_box" >
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">
			    <tr>
			        <td class="bt_info_odd" exp="<input name = 'rdo_entity_name' id='rdo_entity_id' type='checkbox'  value='{tamplate_detail_id}' {disabled} onclick='loadDataDetail();'/>"> <input type='checkbox' name='rdo_entity_name' value='' onclick='check()'/></td>
...
<script type="text/javascript">
    ...
    var tamplateId = getQueryString("tamplateId");
    var ids = getQueryString("ids");
	cruConfig.contextPath =  "<%=contextPath%>";
	cruConfig.pageSize ='500';
	cruConfig.cdtType = 'form';
	cruConfig.queryStr = "";
	function refreshData(value){
			cruConfig.queryService = "MatItemSrv";
			cruConfig.queryOp = "getTemMat";
			cruConfig.submitStr ="ids="+tamplateId;
			queryData(1);
	}
       ...
       function simpleSearch(){
			...
			if(tamplate_name =='' && wz_id =='' && coding_code_id==''){
					    ...
					    if(tamplate_name !='' && wz_id !='' && coding_code_id!=''){
						    	cruConfig.queryService = "MatItemSrv";
								cruConfig.queryOp = "queryTemMatLeaf";
								cruConfig.submitStr ="tamplate_name="+tamplate_name+"&wz_id="+wz_id+"&coding_code_id="+coding_code_id+"&ids="+ids+"&tamplateId="+tamplateId;
								queryData(1);

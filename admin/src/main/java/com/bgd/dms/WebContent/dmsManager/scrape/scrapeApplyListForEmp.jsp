...
<script type="text/javascript">
	...
	cruConfig.queryOp = "queryScrapeApplyListForEmp";
    ...
    function refreshData(scrape_apply_no, scrape_apply_name){
      	var temp = "";
    ...
    function loadDataDetail(scrape_apply_id){
		...
		var curbusinesstype="5110000181000000003";
	...
	function toAddScrapePage(){
		popWindow('<%=contextPath%>/dmsManager/scrape/scrapeApply_add.jsp','','报废申请');
	}
	function toModifyScrapePage(){
		...
		popWindow('<%=contextPath%>/dmsManager/scrape/scrapeApply_add.jsp?scrape_apply_id='+ids,'','报废申请');
	}
	...
	function byjh(){
		...
		if (shuaId != null) {
			var baseData = jcdpCallService("ScrapeSrvNew", "getScrapeEmpOpinionByEmp", "scrape_apply_id="+shuaId);

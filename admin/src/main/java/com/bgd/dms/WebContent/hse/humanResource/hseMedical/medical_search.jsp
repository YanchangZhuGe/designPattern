...
cruConfig.contextPath =  "<%=contextPath%>";
	function submit(){
		...
		if(work_type!=''&&work_type!=null){
			sql = sql+" and work_type like '%"+work_type+"%'";
		}

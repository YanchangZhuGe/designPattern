...
function getFusionChart(){
	...
	if(buildMethod == "5000100003000000001" || buildMethod == "5000100003000000004" || buildMethod == "5000100003000000005" || buildMethod == "5000100003000000007"){
		var retObj3 = jcdpCallService("DailyReportAnalysisSrv","getDailyActivity","type=drilldailylist&project_info_no="+projectInfoNo);
	...
	var retObj1 = jcdpCallService ("DailyReportAnalysisSrv","getDailyActivity","type=measuredailylist&project_info_no="+projectInfoNo);
	var measureDataXml = retObj1.xmlData;
	//var chatInfo1 = retObj1.chatInfo;
	//document.getElementById("chartInfo1").innerHTML = chatInfo1;
	
	var retObj5 = jcdpCallService ("DailyReportAnalysisSrv","getDailyActivity","type=colldailylist&project_info_no="+projectInfoNo);

...
<%
	...
	String duiSubId = request.getParameter("duisubid");
					...
					<table id="main_grid">
						<thead>
							<tr>
								...
								<th data-options="field:'projectname',align:'center',sortable:'true'" width="110">项目名称</th>
								<th data-options="field:'state',align:'center',sortable:'true'" formatter='showState' width="20">状态</th>
								<th data-options="field:'startdate',align:'center',sortable:'true'" width="30">开始时间</th>
								<th data-options="field:'enddate',align:'center',sortable:'true'" width="30">结束时间</th>
								<th data-options="field:'chkdesc',align:'center',sortable:'true'" width="80">标准说明</th>
							</tr>
						</thead>
					</table>
...
$(function(){
	...
	$("#main_grid").datagrid({ 
		...
		url:"${pageContext.request.contextPath}/rm/dm/getListDataBySrvAndMethod.srq?JCDP_SRV_NAME=AssessPlatInfoSrv&JCDP_OP_NAME=queryDuiProStateMonitorInfo",
		onLoadSuccess : function(data1) {
			$("#main_grid").datagrid("autoMergeCells", ['chkdesc']);
        }
	});

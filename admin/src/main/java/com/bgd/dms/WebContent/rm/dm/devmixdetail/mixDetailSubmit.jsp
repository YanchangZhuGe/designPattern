...
<%
	...
	String device_mixinfo_id = request.getParameter("devicemixinfoid");
...
<script type="text/javascript"> 
	...
	function refreshData(){
		...
		for(var listindex=0;listindex<listObj.length;listindex++){
			...
			innerhtml += "<td><input type='checkbox' name='idinfo' id='"+listObj[listindex].device_mix_id+"' disabled/></td>";

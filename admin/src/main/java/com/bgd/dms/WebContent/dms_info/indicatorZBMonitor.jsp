					...
					<table id="main_grid">
						<thead>
							<tr>
								...
								<th data-options="field:'yqfwzx',align:'center',sortable:'true'" formatter='showState' width="25">仪器服务中心</th>
								<th data-options="field:'clfwzx',align:'center',sortable:'true'" formatter='showState' width="25">测量服务中心</th>
								<th data-options="field:'zyfwzx',align:'center',sortable:'true'" formatter='showState' width="25">震源服务中心</th>
								<th data-options="field:'bjzyb',align:'center',sortable:'true'" formatter='showState' width="20">北疆作业部</th>
								<th data-options="field:'dhzyb',align:'center',sortable:'true'" formatter='showState' width="20">敦煌作业部</th>
								<th data-options="field:'hbzyb',align:'center',sortable:'true'" formatter='showState' width="20">华北作业部</th>
								<th data-options="field:'lhzyb',align:'center',sortable:'true'" formatter='showState' width="20">辽河作业部</th>
								<th data-options="field:'tlmzyb',align:'center',sortable:'true'" formatter='showState' width="25">塔里木作业部</th>
								<th data-options="field:'thzyb',align:'center',sortable:'true'" formatter='showState' width="20">吐哈作业部</th>
								<th data-options="field:'xqzyb',align:'center',sortable:'true'" formatter='showState' width="20">新区作业部</th>
								<th data-options="field:'cqzyb',align:'center',sortable:'true'" formatter='showState' width="20">长庆作业部</th>
							</tr>
						</thead>
					</table>
...
$(function(){
	...
	$("#main_grid").datagrid({ 
		...
		url:"${pageContext.request.contextPath}/rm/dm/getListDataBySrvAndMethod.srq?JCDP_SRV_NAME=AssessPlatInfoSrv&JCDP_OP_NAME=queryHomeZBMinitorList",

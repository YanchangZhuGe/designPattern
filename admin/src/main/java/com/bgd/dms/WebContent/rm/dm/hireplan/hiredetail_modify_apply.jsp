		  ...
		  <div style="height:105px;overflow:auto">
			  <table width="97%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
		       <tr>
					...
					<td class="bt_info_even" width="8%">预计租赁费</td>
					<td class="bt_info_odd" width="8%">出租方单位名称</td>
	...
	function refreshData(){
		...
		if('<%=devicehireappid%>'!=null){
			var prosql = "select dad.device_allapp_detid,dad.device_app_detid,dad.team,dad.teamid,dad.apply_num,dad.dev_ci_code,aad.isdevicecode,";
				...
				prosql += "sd.coding_name as unit_name,teamsd.coding_name as teamname,aad.approve_num as require_num,dad.purpose,";
				prosql += "dad.plan_start_date,dad.plan_end_date,dad.unitinfo,dad.devrental,dad.rentname,nvl(wfmiddle.proc_status,'') as state,";
				...
				prosql += "from gms_device_hireapp_detail dad ";
				prosql += "left join gms_device_hireapp da on dad.device_hireapp_id = da.device_hireapp_id ";
				prosql += "left join common_busi_wf_middle wfmiddle on wfmiddle.business_id = da.device_hireapp_id  ";
				...
				prosql += "left join gms_device_codetype ct on aad.dev_ci_code = ci.dev_ct_code ";
				...
				prosql += "where da.device_hireapp_id='<%=devicehireappid%>' and da.bsflag='0' and aad.bsflag='0' and allapp.bsflag='0' and pro.bsflag='0' ";
		...
		if(retObj[0].state=='1'||retObj[0].state=='3'){
			$("#oper_div2").show();
			$("#oper_div").hide();
		}
		for(var index=0;index<retObj.length;index++){
			...
			innerhtml += "<input name='teamname"+index+"' id='teamname"+index+"' value='"+retObj[index].teamname+"' type='text' readonly/>";
			...
			innerhtml += "<td><input name='devrental"+index+"' id='devrental"+index+"' style='line-height:15px' value='"+retObj[index].devrental+"' size='10' type='text' onkeyup='checkDevrental(this)'/></td>";
			innerhtml += "<td><input name='rentname"+index+"' id='rentname"+index+"' style='line-height:15px' value='"+retObj[index].rentname+"' size='10' type='text' /></td>";

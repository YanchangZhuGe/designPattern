...
<div id="chart_c640c8b06d7020ece0430a15182c2102" style="width:100%; height:100%; overflow:auto;"></div>   

<script type="text/javascript">
	var myChart2 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/MSColumn3D.swf", "myChartId2", "100%", "100%", "0", "0" );    
	myChart2.setXMLUrl("<%=contextPath%>/cache/op/OpCostSrv/getTeamTargetActualInfo.srq?parentId=S01001003&projectInfoNo=<%=projectInfoNo%>");      
	myChart2.render("chart_c640c8b06d7020ece0430a15182c2102"); 

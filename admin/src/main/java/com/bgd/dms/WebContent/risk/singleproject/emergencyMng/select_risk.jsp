...
<script type="text/javascript">
	...
	function refreshData(){
		cruConfig.submitStr = "riskConfirm=1";	
		queryData(1);
	}
	...
	function selectRisks(){
	    ...
	    for(var i=0;i<params.length;i++){
	    	...
	    	riskNames = riskNames+","+params[i].split(":")[1];
	    }
	    riskIds = riskIds.substr(1);
	    riskNames = riskNames.substr(1);
	    
		window.opener.setRiskValues(riskIds, riskNames);

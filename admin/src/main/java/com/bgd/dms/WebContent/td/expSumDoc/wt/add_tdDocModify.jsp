...
function save(){
	...
	form.action = "<%=contextPath%>/td/wt/toSaveExpSumDoc.srq?isSingle="+isSingle;
	form.submit();
	newClose();
}
						...
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									...
									<td colspan="2">
										<input type="hidden" id="pk_0110000061100000014" name="pk_0110000061100000014" value=""/>
										<input type="file" name="0110000061100000014" id="0110000061100000014" class="input_width"/>
					    				<div id="down_0110000061100000014"></div>
									</td>
									<td class="inquire_form4"></td>
								</tr>
								<tr>
									<td class="inquire_item4">审核意见：</td>
									<td colspan="2">
								...
								<tr>
									<td class="inquire_item4">试验总结文档：</td>
									<td colspan="2">

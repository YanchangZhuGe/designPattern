										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">月度支出同比折线图</a><span class="gd"><a href="#"></a> </span>
												</div>
										...
										<td width="49%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">二三维支出对比图</a><span class="gd"><a href="#"></a> </span>
												</div>
										...
										<td width="100%">
											<div class="tongyong_box">
												<div class="tongyong_box_title">
													...
													</span><a href="#">项目支出对比图</a><span class="gd"><a href="#"></a> </span>
												</div>
...
<script type="text/javascript">
 function getFusionChart(){
	...
	myChart1.setXMLUrl("<%=contextPath%>/op/OpCostSrv/getOutcomeCompareYearInfo.srq?orgSubjectionId=<%=orgSubjectionId%>");      
	myChart1.render("chartContainer1");  
	
	var myChart2 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/Pie3D.swf", "myChartId2", "100%", "230", "0", "0" );    
	myChart2.setXMLUrl("<%=contextPath%>/op/OpCostSrv/getOutcomeCompareTwoTreePieInfo.srq?orgSubjectionId=<%=orgSubjectionId%>");      
	myChart2.render("chartContainer2");  
	
	var myChart3 = new FusionCharts( "${applicationScope.fusionChartsURL}/Charts/MSColumn3D.swf", "myChartId3", "100%", "230", "0", "0" );    
	myChart3.setXMLUrl("<%=contextPath%>/op/OpCostSrv/getSectionTeamOutcomeInfo.srq?orgId=<%=orgSubjectionId%>");      
 ...
 function drillxmmx(obj){
	 window.showModalDialog("<%=contextPath%>/op/costDashBoard/team7.jsp?projectInfoNo="+obj,obj,"dialogWidth=800px;dialogHeight=600px");
 	}
</script>  
<script type="text/javascript">
	/**/function frameSize() {

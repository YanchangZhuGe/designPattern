			...
			<div id="table_box">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_info" id="queryRetTable">		
			     <tr id='device_backdet_id{device_backdet_id}' name='device_backdet_id'>
					...
					<td class="bt_info_even" exp="{back_num}">返还数量</td>
					...
					<td class="bt_info_even" exp="{devremark}">备注</td>
			     </tr> 
			  </table>
			</div>
			...
			<div id="tab_box" class="tab_box">
				<div id="tab_box_content0" name="tab_box_content0" class="tab_box_content">
				    ...
				    <td  class="inquire_item6">离队数量：</td>
				     ...
				     <td  class="inquire_form6">实际离场时间</td> 
				     <td  class="inquire_item6"><input id="planning_out_time" class="input_width" type="text"  value="" disabled/> &nbsp;</td>
...
<script type="text/javascript">	
	//打开新增界面
	function toAddPage(){
		popWindow('<%=contextPath%>/rm/dm/collectDevBackBad/backbaddetail_new_apply.jsp?projectInfoNo=<%=projectInfoNo%>&devicebackappid=<%=devicebackappid%>','1050:680');
	}
	//打开修改界面
	function toModifyPage(){
		...
		popWindow('<%=contextPath%>/rm/dm/collectDevBackBad/backbaddetail_modify_apply.jsp?projectInfoNo=<%=projectInfoNo%>&devicebackappid=<%=devicebackappid%>&devicebackdetids='+selectedid,'1050:680');
	}
	function dbclickRow(shuaId){
		popWindow('<%=contextPath%>/rm/dm/collectDevBackBad/backbaddetail_modify_apply.jsp?projectInfoNo=<%=projectInfoNo%>&devicebackappid=<%=devicebackappid%>&devicebackdetids='+shuaId,'1050:680');
	}

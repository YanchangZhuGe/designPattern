...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		var check_numbers = document.getElementById("check_numbers").value;   
		...
		if(check_numbers!=''&&check_numbers!=null){
			sql = sql+" and tr.check_numbers like '%"+check_numbers+"%'";
		}
		...
		if(rectification_time!=''&&rectification_time!=null){
			sql = sql+" and tr.rectification_time >= to_date('"+rectification_time+"','yyyy-MM-dd')";
		}
		if(rectification_time2!=''&&rectification_time2!=null){
			sql = sql+" and tr.rectification_time <= to_date('"+rectification_time2+"','yyyy-MM-dd')";
		}
		
		 
		sql = sql+" order by tr.modifi_date desc";
     	top.frames('list').frames[2].refreshData2(sql);	
		newClose();
	}
  ...
  <div id="new_table_box_content">
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
	    <td class="inquire_item6">检查编号：</td>
	    <td class="inquire_form6">
	    <input type="text" id="check_numbers" name="check_numbers" class="input_width"    />    					    
	    </td>	
		  ...
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton2" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(check_time2,tributton2);" />&nbsp;</td>
        </tr>
        ...
        <tr> 
		  ...
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton3" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(rectification_time,tributton3);" />&nbsp;</td>
		  <td class="inquire_item6">至</td>
		  ...
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton4" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(rectification_time2,tributton4);" />&nbsp;</td>
        </tr>
      </table>

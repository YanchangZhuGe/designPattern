...
if(message != "" && message != 'null'){
	...
	function uploadFile(){		
		...
		if(check(filename)){
			...
			document.getElementById("fileForm").action = "<%=contextPath%>/rm/em/importExcelHuman.srq?paramsType="+paramsType+"&orgId="+orgId+"&subId="+subId;
...
<table id="buttonTable" border="0" cellpadding="0" cellspacing="0" class="form_info">
	<tr align="right">
		<td>
		<a href="<%=contextPath%>/rm/em/humanLabor/download.jsp?path=/rm/em/commHumanInfo/ImpleHumanMessage.xls&filename=正式工信息导入模板.xls"><font color=red>下载导入模板</font></a>

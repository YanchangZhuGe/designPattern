	...
	function refreshData(v_appinfo_no,v_opr_state_desc, v_appinfo_name, v_project_name){
		...
		if(orgType=="YN"){//原综合物化探代码
			str += "select device_app_name,dev1.device_app_id,device_app_no,to_char(appdate, 'yyyy-mm-dd') as appdate,"
				...
				str += "select tp.project_name,mif.device_app_id, mif.device_mixinfo_id,mif.mixinfo_no,mixorg.org_abbreviation as mix_org_name,"
				...
				if(orgType=='Y'){
					str +="and mif.out_org_id like '<%=subid%>%' "
				}

...
<%
	...
	String explosives_no="";
	if(request.getParameter("explosives_no") != null){
		explosives_no=request.getParameter("explosives_no");	
	}
...
cruConfig.cdtType = 'form';
 var explosives_no='<%=explosives_no%>';
...
function checkText0(){
    ...
    if (!re.test(second_org))
   {
	...
	if(explosives_no !=null){
		var querySql = "";
		var queryRet = null;
		var  datas =null;		
		
		querySql = " select   tr.project_no,tr.org_sub_id, tr.explosives_no,tr.if_build,tr.if_library,tr.inventory,tr.consumption,tr.spare1,tr.equipment_total ,  tr.second_org,tr.third_org,oi3.org_abbreviation as org_name,tr.creator,tr.create_date,tr.bsflag, tr.modifi_date, tr.updator,oi1.org_abbreviation as second_org_name,oi2.org_abbreviation as third_org_name from BGP_EXPLOSIVES_MANAGEMENT tr    left join comm_org_subjection os1 on tr.second_org = os1.org_subjection_id  and os1.bsflag = '0' left join comm_org_information oi1  on oi1.org_id = os1.org_id  and oi1.bsflag = '0' left join comm_org_subjection os2  on tr.third_org = os2.org_subjection_id  and os2.bsflag = '0' left join comm_org_information oi2 on oi2.org_id = os2.org_id  and oi2.bsflag = '0' left join comm_org_subjection os3 on tr.org_sub_id=os3.org_subjection_id and os3.bsflag='0' left join comm_org_information oi3  on oi3.org_id = os3.org_id and oi3.bsflag='0'    where tr.bsflag = '0' and tr.explosives_no='"+explosives_no+"'";				 	 

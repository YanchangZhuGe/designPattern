...
<div id="new_table_box">
  <div id="new_table_box_content">
    <div id="new_table_box_bg">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr>
          ...
          <td class="inquire_form4" colspan="3">
          	...
          	<input name="device_addapp_id" id="device_addapp_id" type="hidden" value="<%=deviceappid%>" />
      ...
      <fieldset style="margin:2px:padding:2px;"><legend>配置补充计划基本信息</legend>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        <tr>
        ...
        <tr>
          <td class="inquire_item4">配置补充计划单号:</td>
          <td class="inquire_form4">
          	<input name="device_addapp_no" id="device_addapp_no" class="input_width" type="text" value="" style="" readonly/>
          </td>
...
<script type="text/javascript">
	function saveInfo(){
		//调配申请保存
		document.getElementById("form1").action = "<%=contextPath%>/rm/dm/toSaveDevAllAddAppBaseInfo.srq?state=0";
	...
	function refreshData(){
		...
		if('<%=projectInfoNo%>'!=null){
			//查询基本信息
			var querySql = "select devapp.device_addapp_no,devapp.device_addapp_name,devapp.appdate,";
			querySql += "allapp.device_allapp_id,allapp.device_allapp_no,allapp.device_allapp_name,allapp.appdate as allappdate,";
			querySql += "pro.project_name,to_char(sysdate,'yyyy-mm-dd') as currentdate,org.org_name,emp.employee_name ";
			querySql += "from gms_device_allapp_add devapp ";
			...
			querySql += " and allwfmiddle.proc_status='3' and devapp.device_addapp_id='<%=deviceappid%>'";
			...
			$("#device_addapp_no").val(basedatas[0].device_addapp_no);
			$("#device_addapp_name").val(basedatas[0].device_addapp_name);

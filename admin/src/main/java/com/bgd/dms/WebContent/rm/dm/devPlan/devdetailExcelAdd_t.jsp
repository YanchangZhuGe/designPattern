					...
					for (int i = 1; i <= sheet.getLastRowNum(); i++) {   
						...
						for (int j = row.getFirstCellNum(); j < row.getLastCellNum(); j++) {
							...
							if(ss!=null && !"".equals(ss.toString())){
								...
								case 1:ss.setCellType(1); devName = ss.getStringCellValue(); break;
								case 2:ss.setCellType(1); devUnit = ss.getStringCellValue(); break;
								case 3:ss.setCellType(1); devNum = ss.getStringCellValue(); break;
								case 4:ss.setCellType(1); startDate = ss.getStringCellValue(); break;
								case 5:ss.setCellType(1); endDate = ss.getStringCellValue();  break;
								case 6:ss.setCellType(1); purpose = ss.getStringCellValue();  break;
								case 7:ss.setCellType(1); coll = ss.getStringCellValue();  break;
								default:break;
								}
							}
						}

	...
	function dbclickRow(ids){
		...
		if(ids=="cs"){
		    var obj = new Object();
	             ...
	             obj.name = "4";
	             obj.sew = "5";
		    window.showModalDialog('<%=contextPath%>/pm/project/wt/queryMeasureListCs.srq?action=<%=action%>&projectInfoNo=<%=project_info_no%>&measureType=0&viewmeasurement=<%=view_measurement%>&lineUnit=<%=lineUnit%>',obj,'dialogWidth=1000px;dialogHeight=500px');
		}
	}

...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.TreeStore', {
        ...
        proxy: {
       	 type : 'ajax',
            method: 'get',
            url: '<%=contextPath%>/rm/em/getHumanCodingSortDetail.srq?planIds='+planIds+'&spare5=1&codeId='+codeId+'&projectInfoNo='+projectInfoNo,
            reader: {
                type : 'json'
            }
        },
...
function toBack(){
	 window.location="<%=contextPath%>/rm/em/singleHuman/humanCostPlan/humanCostPlanSupplyList.jsp?projectInfoNo="+projectInfoNo;	
}
</script>
</html>
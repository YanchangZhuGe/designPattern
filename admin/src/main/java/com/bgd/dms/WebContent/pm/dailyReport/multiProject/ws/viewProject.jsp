				...
				<div id="tab_box" class="tab_box" style="overflow: hidden;">
					<div id="tab_box_content0" class="tab_box_content">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
							...
							<tr>
								...
								<td class="inquire_form4"><input type="text" id="zone" name="zone" value="" class="input_width" readonly="readonly"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="inquire_form4"><input type="text" id="project_cost" name="project_cost" value="" class="input_width" readonly="readonly"/>
								</td>
							...
							<tr>
								...
								<td class="inquire_form4"><input type="text" id="unit_one" name="unit_one" value="" class="input_width" readonly="readonly"/>
								</td>
								<td class="inquire_item4">二级构造单元：</td>
								<td class="inquire_form4"><input type="text" id="unit_two" name="unit_two" value="" class="input_width" readonly="readonly"/>
								</td>
							</tr>
							<tr>
								<td class="inquire_item4">项目来源：</td>
								<td class="inquire_form4">
								<select class=select_width name="project_source" id="project_source" disabled='disabled'>
								...
								<td class="inquire_form4"><input type="text" id="instrument_model" name="instrument_model" value="" class="input_width" readonly="readonly"/>
								</td>
							</tr>
							<tr>
								<td class="inquire_item4">井下仪器级数：</td>
								<td class="inquire_form4"><input type="text" id="instrument_num" name="instrument_num" value="" class="input_width" readonly="readonly"/>
								</td>
								<td class="inquire_item4">井下仪器间距：</td>
								<td class="inquire_form4"><input type="text" id="instrument_space" name="instrument_space" value="" class="input_width" readonly="readonly"/>
								</td>
							</tr>
							<tr>
					...
					<div id="tab_box_content1" class="tab_box_content" style="display:none;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height" id="workload_table">
						  ...
						  <tr>
						  	<td class="inquire_item6"  id="full_fold_workload_td">设计试验炮：</td>
						   ...
						   <tr id="tr1_9">
						    ...
						    <td class="inquire_form6" id="item1_8" style="display:block;"><input type="text" id="design_drill_num" name="design_drill_num" class="input_width" />&nbsp;个</td>
						    <td class="inquire_item6" id="item1_9_title">测量总公里数：</td>
						    <td class="inquire_form6" id="item1_9"><input type="text" id="measure_km" name="measure_km" class="input_width" />&nbsp;km</td>
						   </tr>
						   <tr id="tr_press" style="display:block;">
						    <td class="inquire_item6" id="item1_press_title" style="display:block;">压裂监测井段：</td>
						    <td class="inquire_form6" id="item1_press" style="display:block;"><input type="text" id="press_well_num" name="press_well_num" class="input_width" />&nbsp;</td>
						   ...
						   <tr style="display: none;" id="tr1_10">
						   	<td class="inquire_item6"  id="item1_11_1">设计有资料面积：</td>
						    ...
						    <td class="inquire_form6" id="item1_10" style="display: none;">
						    <input type="text" id="design_geophone_area" name="design_geophone_area" class="input_width" />&nbsp;km²
						    ...
						    <tr>
						     ...
						     <tr>
						      ...
						      <td class="inquire_form6" colspan="5">
						      	<textarea id="earth_remark"  name="earth_remark" cols="45" rows="5" class="textarea"></textarea>
						      </td>
						     </tr>
						</table>
					</div>
					...
					<div id="tab_box_content4" class="tab_box_content" style="display:none;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
						  ...
						  <tr>
						    ...
						    <td class="inquire_form6" colspan="3"  id="td_down1"></td>
						    <td class="inquire_item6">&nbsp;</td>
						    <td class="inquire_form6">&nbsp;</td>
						    <td class="inquire_item6">&nbsp;</td>
						    <td class="inquire_form6">&nbsp;</td>
						  ...
						  <tr>
						    ...
						    <td class="inquire_form6" colspan="3"  id="td_down2"></td>
						    <td class="inquire_item6">&nbsp;</td>
						    <td class="inquire_form6">&nbsp;</td>
						    <td class="inquire_item6">&nbsp;</td>
						    <td class="inquire_form6">&nbsp;</td>
					...
					<div id="tab_box_content5" class="tab_box_content" style="display:none;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
						  <tr>
						    ...
						    <td class="inquire_form4"><input type="text" id="unit" name="unit" class="input_width" /></td>
						    <td class="inquire_item4"><span class="red_star">*</span>队号：</td>
						    <td class="inquire_form4"><input type="text" id="team_no" name="team_no" class="input_width" /></td>
						  </tr>
						  <tr>
						  ...
						  <tr>
						    ...
						    <td class="inquire_form4" colspan="2"  id="td_zz1"></td>
						    <td class="inquire_form4">&nbsp;</td>
						  </tr>
						  <tr>
						  	<td class="inquire_item4">资质资质：</td>
						    <td class="inquire_form4" colspan="2"  id="td_zz2"></td>
						    <td class="inquire_item4">&nbsp;</td>
						  </tr>
						</table>
					</div>
...
var retObj = jcdpCallService("WsProjectSrv", "getProjectInfo", "projectInfoNo=<%=projectInfoNo%>");
...
//井中项目
if(retObj.map.project_type=="5000100004000000008"){
...
var projType=retObj.map.project_type;
//井中项目
if(projType=="5000100004000000008"){
	...
	document.getElementById("design_object_workload1_td").innerHTML= '设计工作量：';
	...
	document.getElementById("full_fold_workload_td").innerHTML= '试验炮数：';

	document.getElementById("item1_9_title").innerHTML= '设计总公里数：';
	//document.getElementById("item1_9").innerHTML= '<input type="text" id="measure_km" name="measure_km" class="input_width" />&nbsp;km';
	//document.getElementById("measure_km").value= retObj.dynamicMap.measure_km;
...
$("#measurement")[0].src = "<%=contextPath%>/ws/pm/measurement/measurementList.jsp?projectInfoNo=<%=projectInfoNo %>&viewmeasurement=1";
...
if(well_no != null && well_no != ""){
	var wellObj = jcdpCallService("WsWellholeSrv", "getWellhole", "&welNo="+well_no);//获取井筒信息
	...
	if(wellObj.wellMap.ucm_id1!= null &&wellObj.wellMap.ucm_id1!= ""){
		document.getElementById("td_down1").innerHTML += "&nbsp;<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId="+wellObj.wellMap.ucm_id1+"&emflag=0>"+wellObj.wellMap.file_name1+"</a>";
	}
	if(wellObj.wellMap.ucm_id2 != null && wellObj.wellMap.ucm_id2 != ""){
		document.getElementById("td_down2").innerHTML += "&nbsp;<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId="+wellObj.wellMap.ucm_id2+"&emflag=0>"+wellObj.wellMap.file_name2+"</a>";
	}
}

//队伍信息
if(qualification_no != null && qualification_no != ""){
	var qualObj = jcdpCallService("WsQualificationSrv", "getQualification", "&qualificationNo="+qualification_no);
	document.getElementById("unit").value = qualObj.qualMap.unit;
	document.getElementById("team_no").value = qualObj.qualMap.team_no;
	...
	if(qualObj.qualMap.ucm_id1!= null &&qualObj.qualMap.ucm_id1!= ""){
		document.getElementById("td_zz1").innerHTML += "&nbsp;<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId="+qualObj.qualMap.ucm_id1+"&emflag=0>"+qualObj.qualMap.file_name1+"</a>";
	}
	if(qualObj.qualMap.ucm_id2 != null && qualObj.qualMap.ucm_id2 != ""){
		document.getElementById("td_zz2").innerHTML += "&nbsp;<a style='color:blue;' href=<%=contextPath%>/doc/downloadDocByUcmId.srq?docId="+qualObj.qualMap.ucm_id2+"&emflag=0>"+qualObj.qualMap.file_name2+"</a>";
	}
}

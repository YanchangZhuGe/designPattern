...
<script type="text/javascript">
	...
	function validate(){
		...
		var retObj = jcdpCallService("WsDailyReportSrv", "getDailyReportInfo", "projectInfoNo=<%=projectInfoNo %>&produceDate="+produce_date);
		debugger;
		
	
		
		if(retObj == null || retObj.build == null || retObj.build.dailyNoWs== null){
			...
			g('flag').value = "notSaved";
				...
				document.getElementById("daily_no_ws").value="";
			
	
		} else if(retObj.build.auditStatus=="0"){
			
			var dailyNoWs=retObj.build.dailyNoWs;
		...
		document.getElementById("daily_no_ws").value=dailyNoWs;
		...
		} else if(retObj.build.auditStatus=="1"){
			var dailyNoWs=retObj.build.dailyNoWs;
			var if_build=retObj.build.ifBuild;
			var audit_status=retObj.build.auditStatus;
		...
		//debugger;
		retObj = jcdpCallService("WsDailyReportSrv", "queryDailyQuestion", "projectInfoNo=<%=projectInfoNo %>&produceDate="+produce_date);
	    var lineNum = 0;
...
<form name="form1" action="<%=contextPath%>/pm/dailyReport/singleProject/ws/saveOrUpdateWsDailyReport.srq" method="post">

<input id="project_info_no" name="project_info_no" value="<%=projectInfoNo %>" type="hidden" />
<input id="daily_no_ws" name="daily_no_ws" value="" type="hidden"/>
...
<tr class="odd">
		...
		<td class="inquire_form6">
			<select name="weather" id="weather" class="select_width">
				...
				<option value="7">霾</option>
				<option value="8">霜冻</option>
				<option value="9">暴风</option>
				<option value="10">台风</option>
				<option value="11">暴风雪</option>
				<option value="12">雪</option>
				<option value="13">雨夹雪</option>
				<option value="14">冰雹</option>
				<option value="15">浮尘</option>
				<option value="16">扬沙</option>

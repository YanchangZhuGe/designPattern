...
cruConfig.contextPath = "<%=contextPath%>";
	function submit(){
		...
		var change_date2 = document.getElementById("change_date2").value;   
		...
		if(change_name!=''&&change_name!=null){
			sql = sql+" and tr.change_name  like '%"+change_name+"%'";
		}
		
		if(change_type!=''&&change_type!=null){
			sql = sql+" and tr.change_type = '"+change_type+"'";
		}
 
 
		if(change_date!=''&&change_date!=null){
			sql = sql+" and tr.change_date >= to_date('"+change_date+"','yyyy-MM-dd') ";
		}
		if(change_date2!=''&&change_date2!=null){
			sql = sql+" and tr.change_date <= to_date('"+change_date2+"','yyyy-MM-dd') ";
		}
    ...
    <div id="new_table_box_bg">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
        ...
        <tr>
		  ...
		  <td class="inquire_form6"><input type="text" id="change_date2" name="change_date2" class="input_width" readonly="readonly"/>
		  &nbsp;<img src="<%=contextPath%>/images/calendar.gif" id="tributton2" width="16" height="16" style="cursor: hand;" onmouseover="calDateSelector(change_date2,tributton2);" />&nbsp;</td>
        </tr>

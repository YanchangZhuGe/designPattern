...
Ext.onReady(function() {
    ...
    function cellclick(grid,colspan, colIndex, rowdata, rowspan,rowIndex,e) {
        ...
        if(leaf == true){
  			parent.mainRightframe.location.href = "<%= contextPath%>/pm/wr/"+url+"&week_date=<%=week_date%>&week_end_date=<%=week_end_date%>&org_id=<%=org_id%>&action=<%=action%>";
  		}
    }

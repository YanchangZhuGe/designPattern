...
function save(){
	...
	form.action = "<%=contextPath%>/td/ws/toSaveTdDesignDoc.srq";
	form.submit();
	newClose();
}
...
function checkForm(){
	...
	if(fileId!='null'){ 
		if (!isTextPropertyNotNull("pk_0110000061100000009", "技术设计报告")) return false;		
	}else{
		if (!isTextPropertyNotNull("0110000061100000009", "技术设计报告")) return false;	
					...
					<div id="tab_box" class="tab_box">
						<div id="tab_box_content0" class="tab_box_content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_line_height">
								...
								<tr>
									<td class="inquire_item4"><span class="red_star">*</span>技术设计报告：</td>
									<td colspan="2">
										<input type="hidden" id="pk_0110000061100000009" name="pk_0110000061100000009" value=""/>
										<input type="file" name="0110000061100000009" id="0110000061100000009" class="input_width"/>

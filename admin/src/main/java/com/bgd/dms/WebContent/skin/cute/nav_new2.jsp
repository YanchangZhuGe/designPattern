...
var imgDir;
function init(){
	imgDir = document.getElementById('imgDir').value;
var index1 = imgDir.indexOf('/');
var index2 = imgDir.lastIndexOf('/');
imgDir = imgDir.substring(index1+1,index2);
...
var picHtml = "<img name=\""+ menu1List[i].id +"\" id=\"menu1Pic"+(i)+"\" pic=\""+menu1List[i].imgUrl+"\" src=\"<%=contextPath %>/img/"+ imgDir + "/m1_"+menu1List[i].imgUrl+"_n.jpg\""
+" onClick=\"menu1_click(this)\""
+" onMouseOver=\"menu1_hover(this)\" onMouseOut=\"menu1_out(this)\" />"; 
...
//	$("#menu1Pic0").attr("src","images/m1_"+ menu1List[0].imgUrl + "_c.jpg");
	...
	$(selPic).attr("src","<%=contextPath%>/img/"+imgDir+"/m1_"+ menu1List[menuConfig.selMenu1Index].imgUrl + "_c.jpg");
...
function menu1_click(obj){
	...
	lastSelImg.src = "<%=contextPath%>/img/"+imgDir+"/m1_"+lastSelImg.pic+"_n.jpg";	
	var selPic = obj.id;
	...
	obj.src = "<%=contextPath%>/img/"+imgDir+"/m1_"+obj.pic+"_c.jpg";
...
function menu1_hover(obj){
	...
	obj.src = "<%=contextPath%>/img/"+imgDir+"/m1_"+obj.pic+"_h.jpg";
}

function menu1_out(obj){
	var selPic = obj.src;
	if(selPic.substr(selPic.length-6) == "_c.jpg") return;
	obj.src = "<%=contextPath%>/img/"+imgDir+"/m1_"+obj.pic+"_n.jpg";
}
...
<body onLoad="init()">
<input type='hidden' id='imgDir' value='href="css/JCDP_SAIS_CSS/style.css"'>

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function getAmountWhlFusionChart(){
			...
			chart1.setXMLUrl("<%=contextPath%>/dms/use/getAssetsBenefitData.srq?level=2");
		...
		function toQuery1(){
			...
			chartReference1.setXMLUrl("<%=contextPath%>/dms/use/getAssetsBenefitData.srq?orgSubId="+orgSubId+"&country="+country);
		}
		//清除
		function toClear(){
			$('#org_sub_id_1') .val('');

...
function getSubNodes(parentNode) {
	...
	Ext.Ajax.request({
		...
		params : {
			currentPage:"1",
			pageSize:"10000",
			querySql:"select distinct colldui.out_org_id,org.org_name,org.org_abbreviation as short_org_name ,'1' as is_leaf from gms_device_coll_account_dui colldui left join comm_org_information org on colldui.out_org_id=org.org_id where colldui.project_info_id='<%=projectinfono%>' order by out_org_id"
		},
		method : 'Post',
...
function getTreeNode(nodeData){
	var treeNode = new Ext.tree.AsyncTreeNode({
			id : nodeData.out_org_id+"~"+nodeData.short_org_name,
			text : nodeData.short_org_name,// 显示内容									
			leaf : false,

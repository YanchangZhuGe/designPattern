...
public class ExportBalanceStaticExcelZipBusiness extends ExcelTemplateBusiness {
    final static Logger log = Logger.getLogger(ExportBalanceStaticExcelZipBusiness.class);
    private String ids;
    private String orderIds;
    private String makeDate;
    private String checkUser;

    private final String tempPath = FtpTools.getPollingInfo("tempPath") + File.separator + "brs_service";
    ...
    public void doExecute() throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < idSplit.length; i++) {
                ...
                File file = new File(filePath + File.separator + "余额调节表_" + orderIdsSplit[i] + ".xlsx");
                if (file.exists()) {
                    file.delete();
                }

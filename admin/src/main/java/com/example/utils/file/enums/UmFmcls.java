...
public enum UmFmcls {
     ...
     * 担保替换
     */
	GWMS_FM012("GWMS_FM012","担保合同替换", BizFlowEnum.GWMS_FM012)
	,GWMS_FM014("GWMS_FM014","担保合同替换", BizFlowEnum.GWMS_FM014)
	,GWMS_FM015("GWMS_FM015","担保占用释放", BizFlowEnum.GWMS_FM015),
	/***担保合同修正**/

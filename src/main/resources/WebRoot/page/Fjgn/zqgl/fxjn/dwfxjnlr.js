    ...
    var items_toolbar_btns = {
        ...
        update: {
            ...
            handler: function (btn) {
                ...
                $.post("/selectDwFxjnDataById.action", {
            ...
            handler: function (btn) {
                ...
                Ext.Msg.confirm('提示', '请确认是否删除！', function (btn_confirm) {
                    if (btn_confirm == 'yes') {
                        ...
                        //发送ajax请求，删除数据
                        $.post("/deleteDwFxjnDataById.action", {
                            ids: ids
                        }, function (data) {
                            if (data.success) {
                                Ext.toast({
...
function initContentGrid() {
    ...
    return DSYGrid.createGrid({
        ...
        dataUrl: '/getDwFxjnMainList.action',
        checkBox: true,
        border: false,
        height: '50%',
        tbar: [
...
function initContentDetailGrid() {
    var headerJson = [
        ...
        {text: "单位", dataIndex: "AG_NAME", type: "string", width: 150, hidden: true},
    ...
    return DSYGrid.createGrid({
        ...
        dataUrl: '/getDwFxjnDetailList.action',
        checkBox: false,
        border: false,
        height: '50%',
        pageConfig: {
...
function initWindow_select_fxjn_grid() {
    ...
    return DSYGrid.createGrid({
        ...
        dataUrl: '/getDwFxjnSelectList.action',
        tbar: [
            {
                xtype: "treecombobox",
                name: "ZQLB_ID",
        ...
        buttons: [
            {
                ...
                handler: function (btn) {
                    ...
                    initWindow_select_fxjn().show();
                    fxjn_id = form.getForm().findField('FXJN_ID').getValue();
                    DSYGrid.getGrid('window_select_fxjn_grid').getStore().getProxy().extraParams['FXJN_ID'] = fxjn_id;
                    DSYGrid.getGrid('window_select_fxjn_grid').getStore().loadPage(1);
...
function initWindow_save_fxjn_form() {
    return Ext.create('Ext.form.Panel', {
        ...
        items: [
            {fieldLabel: 'FXJN_ID', name: 'FXJN_ID', xtype: 'textfield', readOnly: true, fieldCls: 'form-unedit', hidden: true},
            ...
            },
            {
                ...
                allowBlank: false,
                format: 'Y-m-d',
                fieldCls: IS_EDIT ? 'form-edit' : 'form-unedit',
                readOnly: !IS_EDIT
            },
...
function initWindow_save_fxjn_grid() {
    var headerJson = [
        ...
        },
        {
            ...
            type: "float",
            width: 180,
            tdCls: IS_EDIT ? 'grid-cell' : 'grid-cell-unedit',
            editor: {
                hideTrigger: true,
                xtype: 'numberFieldFormat',
                allowBlank: false,
